...
description: "IncorrectFontDataException 构造函数。初始化新的 FontAgrumentException 对象。"
type: docs
weight: 10
url: /zh/net/aspose.font.exceptions/incorrectfontdataexception/incorrectfontdataexception/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 信息 | SerializationInfo | 保存序列化对象数据的对象。 |
| 上下文 | StreamingContext | 关于源或目标的上下文信息。 |
