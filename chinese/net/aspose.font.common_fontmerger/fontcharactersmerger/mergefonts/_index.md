...
description: "FontCharactersMerger 方法。根据传入的字形列表合并字体。为每个传入的字形搜索字符代码，并将找到的字符代码与相应的字形添加到生成的新字体中。"
type: docs
weight: 30
url: /zh/net/aspose.font.common_fontmerger/fontcharactersmerger/mergefonts/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| primaryFontGlyphs | GlyphId[] | 从主字体中获取的字形列表 |
| secondaryFontGlyphs | GlyphId[] | 从次字体中获取的字形列表 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| primaryFontCharCodes | UInt32[] | 从主字体中获取的代码 |
| secondaryFontCharCodes | UInt32[] | 从次要字体中获取的代码 |
| newFontName | String | 生成字体的期望名称 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| primaryFontDict | IDictionary`2 | 来自主字体的 [symbol code, glyph identifier] 对应的字典 |
| secondaryFontDict | IDictionary`2 | 来自次要字体的 [symbol code, glyph identifier] 对应的字典 |
| newFontName | String | 生成字体的期望名称 |
