...
description: "Aspose.Font.RenderingPath 命名空间提供描述在 Aspose.Font 中使用的图形路径对象的类"
type: docs
weight: 110
url: /zh/net/aspose.font.renderingpath/
---
**Aspose.Font.RenderingPath** 命名空间提供描述在 Aspose.Font 中使用的图形路径对象的类。
...
| 接口 | 描述 |
| --- | --- |
| [IPathSegment](./ipathsegment/) | 表示任何路径段的接口。 |
