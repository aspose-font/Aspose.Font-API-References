...
description: "表示 Font 转换异常。"
type: docs
weight: 36
url: /zh/java/com.aspose.font/fontconversionexception/
---
**Inheritance:**
...
表示字体转换异常。该异常可能在字体转换过程出现错误时抛出。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [FontConversionException()](#FontConversionException--) | 初始化新的 FontConversionException 对象。 |
| [FontConversionException(String message)](#FontConversionException-java.lang.String-) | 初始化新的 FontConversionException 对象。 |
| [FontConversionException(String message, RuntimeException innerException)](#FontConversionException-java.lang.String-java.lang.RuntimeException-) | 初始化新的 FontConversionException 对象。 |
## 方法
...
初始化新的 FontConversionException 对象。
