...
description: "表示 Font 合并异常。"
type: docs
weight: 43
url: /zh/java/com.aspose.font/fontmergeexception/
---
**Inheritance:**
...
表示字体合并异常。当合并字体时出现错误可能会抛出此异常。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [FontMergeException()](#FontMergeException--) | 初始化新的 FontMergeException 对象。 |
| [FontMergeException(String message)](#FontMergeException-java.lang.String-) | 初始化新的 FontMergeException 对象。 |
| [FontMergeException(String message, RuntimeException innerException)](#FontMergeException-java.lang.String-java.lang.RuntimeException-) | 初始化新的 FontMergeException 对象。 |
## 方法
