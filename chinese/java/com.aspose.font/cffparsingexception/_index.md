...
description: "表示 cff 格式字体的解析异常。"
type: docs
weight: 23
url: /zh/java/com.aspose.font/cffparsingexception/
---
**Inheritance:**
...
表示 cff 格式字体的解析异常。若在字体解析过程中出现错误，则会抛出此异常。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [CffParsingException()](#CffParsingException--) | 初始化新的 CffParsingException 对象。 |
| [CffParsingException(String message)](#CffParsingException-java.lang.String-) | 初始化新的 CffParsingException 对象。 |
| [CffParsingException(String message, RuntimeException innerException)](#CffParsingException-java.lang.String-java.lang.RuntimeException-) | 初始化新的 CffParsingException 对象。 |
## 方法
