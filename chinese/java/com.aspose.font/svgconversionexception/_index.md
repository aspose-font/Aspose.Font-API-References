...
description: "表示 SVG 格式的字体转换异常。"
type: docs
weight: 76
url: /zh/java/com.aspose.font/svgconversionexception/
---
**Inheritance:**
...
表示 SVG 格式的字体转换异常。若在字体转换过程中出现错误，则会抛出此异常。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [SvgConversionException()](#SvgConversionException--) | 初始化新的 SvgConversionException 对象。 |
| [SvgConversionException(String message)](#SvgConversionException-java.lang.String-) | 初始化新的 SvgConversionException 对象。 |
| [SvgConversionException(String message, RuntimeException innerException)](#SvgConversionException-java.lang.String-java.lang.RuntimeException-) | 初始化新的 SvgConversionException 对象。 |
## 方法
...
初始化新的 SvgConversionException 对象。
