...
description: "表示在尝试执行受评估模式限制的功能时可能抛出的异常。"
type: docs
weight: 60
url: /zh/java/com.aspose.font/licenserestrictionexception/
---
**Inheritance:**
...
表示在尝试执行受评估模式限制的功能时可能抛出的异常。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [LicenseRestrictionException()](#LicenseRestrictionException--) | 初始化新的  FontCreationException  对象。 |
| [LicenseRestrictionException(String message)](#LicenseRestrictionException-java.lang.String-) | 初始化新的  FontCreationException  对象。 |
| [LicenseRestrictionException(String message, RuntimeException innerException)](#LicenseRestrictionException-java.lang.String-java.lang.RuntimeException-) | 初始化新的  FontCreationException  对象。 |
## 方法
