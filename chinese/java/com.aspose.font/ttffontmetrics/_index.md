...
description: "表示 TTF 字体度量。"
type: docs
weight: 95
url: /zh/java/com.aspose.font/ttffontmetrics/
---
**Inheritance:**
...
| [getFontMatrix()](#getFontMatrix--) | 获取 FontBBox 值。 |
| [getGlyphBBox(GlyphId glyphId)](#getGlyphBBox-com.aspose.font.GlyphId-) | 返回字形 Bbox。 |
| [getGlyphWidth(GlyphId glyphId)](#getGlyphWidth-com.aspose.font.GlyphId-) | 返回按 glyph id 的字形宽度。 |
...
| [measureString(long[] charCodes, double fontSize)](#measureString-long---double-) | 测量表示为字符代码数组的文本并返回字符串宽度。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAscender(double value)](#setAscender-double-) | 设置 ascender 值。 |
| [setDescender(double value)](#setDescender-double-) | 设置下行线值。 |
...
测量表示为字符代码数组的文本并返回字符串宽度。

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| charCodes | long[] | 文本字符串表示为字符代码数组。 |
| fontSize | double | 字体大小。 |
