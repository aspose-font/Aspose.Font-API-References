...
description: "表示不支持的操作异常。"
type: docs
weight: 45
url: /zh/java/com.aspose.font/fontnotsupportedoperationexception/
---
**Inheritance:**
...
表示不支持的操作异常。当某些操作对特定字体类型不受支持时，可能会抛出此异常。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [FontNotSupportedOperationException()](#FontNotSupportedOperationException--) | 初始化新的 FontNotSupportedOperationException 对象。 |
| [FontNotSupportedOperationException(String message)](#FontNotSupportedOperationException-java.lang.String-) | 初始化新的 FontNotSupportedOperationException 对象。 |
| [FontNotSupportedOperationException(String message, RuntimeException innerException)](#FontNotSupportedOperationException-java.lang.String-java.lang.RuntimeException-) | 初始化新的 FontNotSupportedOperationException 对象。 |
## 方法
...
初始化新的 FontNotSupportedOperationException 对象。
