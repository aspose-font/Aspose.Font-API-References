...
type: docs
weight: 19
url: /zh/java/com.aspose.font/cfffont/
---
**Inheritance:**
...
| [getClass()](#getClass--) |  |
| [getCommonFontsSettings()](#getCommonFontsSettings--) | 获取 CFF 字体的通用设置。 |
| [getEncoding()](#getEncoding--) | 获取 Font 编码。 |
| [getFontDefinition()](#getFontDefinition--) | 获取字体定义。 |
...
| [getIndexDataProvider(CffIndexProviderType indexType)](#getIndexDataProvider-com.aspose.font.CffIndexProviderType-) | 获取指定 CFF INDEX 结构类型的提供程序。 |
...
| [hashCode()](#hashCode--) |  |
| [isCidKeyedFont()](#isCidKeyedFont--) | 获取指示字体为 cid-keyed 的值。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCommonFontsSettings(CffFontsSettings value)](#setCommonFontsSettings-com.aspose.font.CffFontsSettings-) | 指定 CFF 字体的通用设置。 |
...
返回字体中所有可用字形 ID 的数组。字形 ID 是字形的唯一编号，取决于字体类型。CFF 字体的字形 ID 可以是 ( GlyphStringId ) 类的实例或 ( GlyphUInt32Id ) 类的实例。
...
获取 CFF 字体的通用设置。这些设置在不同场景中使用，并且可以针对每个单独的字体进行更改。
...
根据字形 ID 返回字形。字形 ID 是字形的唯一编号，取决于字体类型。CFF 字体的字形 ID 可以是 ( GlyphStringId ) 类的实例或 ( GlyphInt32Id ) 类的实例。
...
获取指定 CFF INDEX 结构类型的提供程序。

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| indexType | [CffIndexProviderType](../../com.aspose.font/cffindexprovidertype) | INDEX 结构的类型。 |
...
获取指示字体为 cid-keyed 的值。

**Returns:**
boolean - 指示字体为 cid-keyed 的值。
### notify() {#notify--}
```
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [CffFontsSettings](../../com.aspose.font/cfffontssettings) | 字体定义。 |
