...
type: docs
weight: 51
url: /zh/java/com.aspose.font/glyphidlist/
---
**Inheritance:**
...
| [add(E arg0)](#add-E-) |  |
| [add(GlyphId glyphId)](#add-com.aspose.font.GlyphId-) | 向列表中添加字形 ID。 |
...
| [clear()](#clear--) | 清除列表。 |
| [clone()](#clone--) |  |
| [contains(GlyphId glyphId)](#contains-com.aspose.font.GlyphId-) | 如果字形 ID 在列表中，则返回 true。 |
...
| [get(int index)](#get-int-) | 根据索引返回字形 ID。 |
| [getClass()](#getClass--) |  |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(GlyphId glyphId)](#remove-com.aspose.font.GlyphId-) | 从列表中移除字形 ID。 |
...
**Returns:**
布尔型 - 如果字形 ID 在列表中则为 true，否则为 false
### contains(Object arg0) {#contains-java.lang.Object-}
```
