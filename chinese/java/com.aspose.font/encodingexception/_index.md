...
type: docs
weight: 30
url: /zh/java/com.aspose.font/encodingexception/
---
**Inheritance:**
...
表示编码异常。该异常可能在编码/解码文本出现问题时抛出。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [EncodingException()](#EncodingException--) | 初始化新的  EncodingException  对象。 |
| [EncodingException(String message)](#EncodingException-java.lang.String-) | 初始化新的  EncodingException  对象。 |
| [EncodingException(String message, RuntimeException innerException)](#EncodingException-java.lang.String-java.lang.RuntimeException-) | 初始化新的  EncodingException  对象。 |
## 方法
