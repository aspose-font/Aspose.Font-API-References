...
description: "表示轴值表格式 1"
type: docs
weight: 13
url: /zh/java/com.aspose.font/axisvaluetableformat1/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [AxisValueTableFormat1(int flags, int valueNameId, int axisIndex, float value)](#AxisValueTableFormat1-int-int-int-float-) | 构造函数 |
## 方法
