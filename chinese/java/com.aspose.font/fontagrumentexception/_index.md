...
description: "表示 Font 参数异常。"
type: docs
weight: 33
url: /zh/java/com.aspose.font/fontagrumentexception/
---
**Inheritance:**
...
表示字体参数异常。当参数使用不当时可能抛出此异常。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [FontAgrumentException()](#FontAgrumentException--) | 初始化新的 FontAgrumentException 对象。 |
| [FontAgrumentException(String message)](#FontAgrumentException-java.lang.String-) | 初始化新的 FontAgrumentException 对象。 |
| [FontAgrumentException(String message, RuntimeException innerException)](#FontAgrumentException-java.lang.String-java.lang.RuntimeException-) | 初始化新的 FontAgrumentException 对象。 |
## 方法
