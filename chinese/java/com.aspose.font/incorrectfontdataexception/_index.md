...
description: "表示当 Font 对象的某些值无效时的异常情况。"
type: docs
weight: 57
url: /zh/java/com.aspose.font/incorrectfontdataexception/
---
**Inheritance:**
...
表示当 Font 对象的某些值无效时的异常情况。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [IncorrectFontDataException()](#IncorrectFontDataException--) | 初始化新的 FontAgrumentException 对象。 |
| [IncorrectFontDataException(String message)](#IncorrectFontDataException-java.lang.String-) | 初始化新的 FontAgrumentException 对象。 |
| [IncorrectFontDataException(String message, RuntimeException innerException)](#IncorrectFontDataException-java.lang.String-java.lang.RuntimeException-) | 初始化新的 FontAgrumentException 对象。 |
## 方法
...
初始化新的 FontAgrumentException 对象。
