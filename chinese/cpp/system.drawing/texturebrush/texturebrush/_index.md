---
title: "System::Drawing::TextureBrush::TextureBrush 构造函数"
linktitle: "TextureBrush"
second_title: "Aspose.Font 适用于 C++"
description: "System::Drawing::TextureBrush::TextureBrush 构造函数。构造一个使用指定图像的 TextureBrush 类的新实例，在 C++ 中。"
type: docs
weight: 100
url: /zh/cpp/system.drawing/texturebrush/texturebrush/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 图像 | const SharedPtr\<Image\>\& | 用于画刷填充形状内部的图像 |
| wrap_mode | Drawing2D::WrapMode | 指定画刷对象的平铺方式 |
| dst_rect | 矩形 | 指定画笔的边界矩形 |
...
| 图像 | const SharedPtr\<Image\>\& | 用于画刷填充形状内部的图像 |
| dst_rect | 矩形 | 指定画笔的边界矩形 |
| image_attrs | const SharedPtr\<Imaging::ImageAttributes\>\& | 图像属性 |
