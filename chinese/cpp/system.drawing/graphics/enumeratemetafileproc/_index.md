...
description: "System::Drawing::Graphics::EnumerateMetafileProc typedef。该类型是用于 C++ 中 EnumerateMetafile 方法的回调函数对象的参数类型。"
type: docs
weight: 9100
url: /zh/cpp/system.drawing/graphics/enumeratemetafileproc/
---
## EnumerateMetafileProc typedef


用于 EnumerateMetafile 方法参数的回调函数对象的类型。
