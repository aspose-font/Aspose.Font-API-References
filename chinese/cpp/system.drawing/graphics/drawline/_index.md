---
title: "System::Drawing::Graphics::DrawLine 方法"
linktitle: "DrawLine"
second_title: "Aspose.Font 适用于 C++"
description: "System::Drawing::Graphics::DrawLine 方法。使用指定的笔在 C++ 中绘制指定的直线。"
type: docs
weight: 2100
url: /zh/cpp/system.drawing/graphics/drawline/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| pen | const SharedPtr\<Pen\>\& | 一个 [Pen](../../pen/) 对象，用于指定要绘制的线的图形属性 |
| x1 | float | 绘制线段的第一个点的 X 坐标 |
| y1 | float | 绘制线段的第一个点的 Y 坐标 |
| x2 | float | 绘制线段的第二个点的 X 坐标 |
| y2 | float | 绘制线段的第二个点的 Y 坐标 |
...
| --- | --- | --- |
| pen | const SharedPtr\<Pen\>\& | 一个 [Pen](../../pen/) 对象，用于指定要绘制的线的图形属性 |
| x1 | int | 绘制线段的第一个点的 X 坐标 |
| y1 | int | 绘制线段的第一个点的 Y 坐标 |
| x2 | int | 绘制线段的第二个点的 X 坐标 |
| y2 | int | 绘制线段的第二个点的 Y 坐标 |
...
| --- | --- | --- |
| pen | const SharedPtr\<Pen\>\& | 一个 [Pen](../../pen/) 对象，用于指定要绘制的线的图形属性 |
| pt1 | PointF | 绘制线段的第一个点 |
| pt2 | PointF | 绘制线段的第二个点 |
