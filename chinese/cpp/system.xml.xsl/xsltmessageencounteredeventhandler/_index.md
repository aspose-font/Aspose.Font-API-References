...
description: "System::Xml::Xsl::XsltMessageEncounteredEventHandler typedef。表示将在 C++ 中处理 XsltArgumentList::XsltMessageEncountered 事件的方法。"
type: docs
weight: 1000
url: /zh/cpp/system.xml.xsl/xsltmessageencounteredeventhandler/
---
## XsltMessageEncounteredEventHandler typedef


表示将处理 **XsltArgumentList::XsltMessageEncountered** 事件的方法。
