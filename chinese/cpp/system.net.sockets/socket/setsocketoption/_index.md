---
title: "System::Net::Sockets::Socket::SetSocketOption 方法"
linktitle: "SetSocketOption"
second_title: "Aspose.Font 适用于 C++"
description: "System::Net::Sockets::Socket::SetSocketOption 方法。将指定的套接字选项设置为 C++ 中的指定值。"
type: docs
weight: 6200
url: /zh/cpp/system.net.sockets/socket/setsocketoption/
---
...
| optionName | SocketOptionName | 必须更新的选项名称。 |
| optionValue | bool | 必须设置为指定选项的值。 |
...
| optionLevel | SocketOptionLevel | 套接字选项级别。 |
| optionName | SocketOptionName | 必须更新的选项名称。 |
| optionValue | int32_t | 必须设置为指定选项的值。 |
...
| optionLevel | SocketOptionLevel | 套接字选项级别。 |
| optionName | SocketOptionName | 必须更新的选项名称。 |
| optionValue | System::ArrayPtr\<uint8_t\> | 必须设置为指定选项的值。 |
...
| optionLevel | SocketOptionLevel | 套接字选项级别。 |
| optionName | SocketOptionName | 必须更新的选项名称。 |
| optionValue | System::SharedPtr\<Object\> | 必须设置为指定选项的值。 |
