...
description: "System::Xml::XPath::XPathNavigator::MoveToPrevious 方法。 当在派生类中重写时，将 XPathNavigator 移动到当前节点的前一个兄弟节点（C++）。"
type: docs
weight: 6400
url: /zh/cpp/system.xml.xpath/xpathnavigator/movetoprevious/
---
## XPathNavigator::MoveToPrevious method


当在派生类中重写时，将 [XPathNavigator](../) 移动到当前节点的前一个兄弟节点。
