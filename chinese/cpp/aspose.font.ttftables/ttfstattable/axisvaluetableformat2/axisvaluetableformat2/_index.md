...
description: "Aspose::Font::TtfTables::TtfStatTable::AxisValueTableFormat2::AxisValueTableFormat2 构造函数。C++ 中的构造函数。"
type: docs
weight: 100
url: /zh/cpp/aspose.font.ttftables/ttfstattable/axisvaluetableformat2/axisvaluetableformat2/
---
...
| --- | --- | --- |
| 标志 | uint16_t | 标志 |
| valueNameId | uint16_t | 用于在 'name' 表中提供此属性值显示字符串的条目的名称 ID |
| axisIndex | uint16_t | 规格：指向轴记录数组的零基索引，用于标识此轴值表适用的设计变体轴。必须小于 designAxisCount。 |
