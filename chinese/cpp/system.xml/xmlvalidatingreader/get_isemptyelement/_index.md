---
title: "System::Xml::XmlValidatingReader::get_IsEmptyElement 方法"
linktitle: "get_IsEmptyElement"
second_title: "Aspose.Font 适用于 C++"
description: "System::Xml::XmlValidatingReader::get_IsEmptyElement 方法。返回一个值，指示当前节点是否为空元素（例如，<MyElement/>），在 C++ 中。"
type: docs
weight: 1300
url: /zh/cpp/system.xml/xmlvalidatingreader/get_isemptyelement/
---
## XmlValidatingReader::get_IsEmptyElement method


返回一个值，指示当前节点是否为空元素（例如，**<MyElement/>**）。
