---
title: "System::Xml::XmlElement::SetAttribute 方法"
linktitle: "SetAttribute"
second_title: "Aspose.Font 适用于 C++"
description: "System::Xml::XmlElement::SetAttribute 方法。设置具有指定本地名称和命名空间 URI 的属性值（在 C++ 中）。"
type: docs
weight: 2600
url: /zh/cpp/system.xml/xmlelement/setattribute/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 名称 | String | 要创建或修改的属性名称。这是一个限定名称。如果名称包含冒号，则会解析为前缀和本地名称部分。 |
| 值 | String | 要为属性设置的值。 |
