---
title: "System::Text::UnicodeEncoding::UnicodeEncoding 构造函数"
linktitle: "UnicodeEncoding"
second_title: "Aspose.Font 适用于 C++"
description: "System::Text::UnicodeEncoding::UnicodeEncoding 构造函数。C++ 中的构造函数。"
type: docs
weight: 100
url: /zh/cpp/system.text/unicodeencoding/unicodeencoding/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| big_endian | bool | 如果为 true，则使用大端序，否则使用小端序。 |
| byte_order_mark | bool | 如果为 true，则提供 BOM。 |
...
| big_endian | bool | 如果为 true，则使用大端序，否则使用小端序。 |
| byte_order_mark | bool | 如果为 true，则提供 BOM。 |
| throw_on_invalid_bytes | bool | 如果为 true，则在遇到无效字节时抛出异常，否则跳过它们。 |
