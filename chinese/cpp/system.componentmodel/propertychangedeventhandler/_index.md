...
description: "System::ComponentModel::PropertyChangedEventHandler typedef. 用于在 C++ 中处理 PropertyChanged 事件的处理程序类型。"
type: docs
weight: 1700
url: /zh/cpp/system.componentmodel/propertychangedeventhandler/
---
## PropertyChangedEventHandler typedef


处理 PropertyChanged 事件的处理程序类型。
