---
title: "System::IO::File::WriteAllText 方法"
linktitle: "WriteAllText"
second_title: "Aspose.Font 适用于 C++"
description: "System::IO::File::WriteAllText 方法。创建新文本文件或覆盖已有文件，并使用指定的编码在 C++ 中将指定字符串的内容写入其中。"
type: docs
weight: 3700
url: /zh/cpp/system.io/file/writealltext/
---
