---
title: "System::IO::BasicSystemIOStreamBuf::BasicSystemIOStreamBuf 构造函数"
linktitle: "BasicSystemIOStreamBuf"
second_title: "Aspose.Font 适用于 C++"
description: "System::IO::BasicSystemIOStreamBuf::BasicSystemIOStreamBuf 构造函数。构造一个新的 BasicSystemIOStreamBuf 实例（在 C++ 中）。"
type: docs
weight: 100
url: /zh/cpp/system.io/basicsystemiostreambuf/basicsystemiostreambuf/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| right | BasicSystemIOStreamBuf\&& | [Object](../../../system/object/) 以进行移动 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| str | const SharedPtr\<Stream\>\& | 指向流的智能指针 |
| mode | SystemIOStreamWrappingMode | 包装模式 |
