---
title: "System::IO::BasicSTDIOStreamWrapper::BasicSTDIOStreamWrapper 构造函数"
linktitle: "BasicSTDIOStreamWrapper"
second_title: "Aspose.Font 适用于 C++"
description: "System::IO::BasicSTDIOStreamWrapper::BasicSTDIOStreamWrapper 构造函数。复制构造函数。在 C++ 中已删除。"
type: docs
weight: 100
url: /zh/cpp/system.io/basicstdiostreamwrapper/basicstdiostreamwrapper/
---
...
构造一个新的 [BasicSTDIOStreamWrapper](../) 实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| str | std::basic_iostream\<char_type, traits_type\>\& | 对流的引用 |
