---
title: "System::Net::NetworkCredential::GetCredential 方法"
linktitle: "GetCredential"
second_title: "Aspose.Font 适用于 C++"
description: "System::Net::NetworkCredential::GetCredential 方法。返回在 C++ 中针对指定主机名、端口和身份验证类型的凭据。"
type: docs
weight: 500
url: /zh/cpp/system.net/networkcredential/getcredential/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| uri | System::SharedPtr\<Uri\> | 该 URI。 |
| authenticationType | String | 身份验证类型。 |
