...
description: "System::Collections::Generic::operator<< 方法。使用 UTF-8 编码在 C++ 中将数据插入流。"
type: docs
weight: 5400
url: /zh/cpp/system.collections.generic/operator__/
---
...
| pair | const KeyValuePair\<TKey, TValue\>\& | 用于插入的 [Data](../../system.data/)。 |
