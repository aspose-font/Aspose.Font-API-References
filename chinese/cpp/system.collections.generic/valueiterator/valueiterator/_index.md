...
description: "System::Collections::Generic::ValueIterator::ValueIterator 构造函数。C++ 中的构造函数。"
type: docs
weight: 100
url: /zh/cpp/system.collections.generic/valueiterator/valueiterator/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 迭代器 | const typename Dict::map_t::const_iterator\& | 用于保存的迭代器。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 迭代器 | typename Dict::map_t::const_iterator\&& | 用于保存的迭代器。 |
