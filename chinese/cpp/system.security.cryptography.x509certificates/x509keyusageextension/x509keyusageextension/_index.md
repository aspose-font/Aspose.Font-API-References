---
title: "System::Security::Cryptography::X509Certificates::X509KeyUsageExtension::X509KeyUsageExtension 构造函数"
linktitle: "X509KeyUsageExtension"
second_title: "Aspose.Font 适用于 C++"
description: "System::Security::Cryptography::X509Certificates::X509KeyUsageExtension::X509KeyUsageExtension 构造函数。C++ 中的 RTTI 信息。"
type: docs
weight: 100
url: /zh/cpp/system.security.cryptography.x509certificates/x509keyusageextension/x509keyusageextension/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| encoded_key_usage | const SharedPtr\<AsnEncodedData\>\& | 密钥用法的编码数据。 |
| 关键 | bool | 关键性标志。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| key_usages | X509KeyUsageFlags | 密钥用法。 |
| 关键 | bool | 关键性标志。 |
