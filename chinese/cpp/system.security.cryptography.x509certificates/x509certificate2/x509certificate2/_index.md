---
title: "System::Security::Cryptography::X509Certificates::X509Certificate2::X509Certificate2 构造函数"
linktitle: "X509Certificate2"
second_title: "Aspose.Font 适用于 C++"
description: "System::Security::Cryptography::X509Certificates::X509Certificate2::X509Certificate2 构造函数。构造空的 X509Certificate2（在 C++ 中）。"
type: docs
weight: 100
url: /zh/cpp/system.security.cryptography.x509certificates/x509certificate2/x509certificate2/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | 表示已编码证书的字节序列。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | 表示已编码证书（公钥部分）的字节序列。 |
| private_key | const ByteArrayPtr\& | 表示私钥的字节序列。 |
| key_storage_flags | X509KeyStorageFlags | 指示如何存储密钥的标志。 |
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | 表示已编码证书的字节序列。 |
| password | const SecureStringPtr\& | 证书密码。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| cert | const SharedPtr\<X509Certificate\>\& | 一个 [X509Certificate](../../x509certificate/) 对象。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| filename | const String\& | 用于加载证书的文件。 |
