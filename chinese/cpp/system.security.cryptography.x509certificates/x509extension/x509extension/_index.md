---
title: "System::Security::Cryptography::X509Certificates::X509Extension::X509Extension 构造函数"
linktitle: "X509Extension"
second_title: "Aspose.Font 适用于 C++"
description: "System::Security::Cryptography::X509Certificates::X509Extension::X509Extension 构造函数。C++ 中的 RTTI 信息。"
type: docs
weight: 100
url: /zh/cpp/system.security.cryptography.x509certificates/x509extension/x509extension/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| encoded_extension | const SharedPtr\<AsnEncodedData\>\& | 与证书关联的已编码数据。 |
| 关键 | bool | 关键性标志。 |
## 备注
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| oid | const SharedPtr\<Oid\>\& | [Object](../../../system/object/) 与扩展关联的标识符。 |
| raw_data | const ByteArrayPtr\& | 与证书关联的原始数据。 |
| 关键 | bool | 关键性标志。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| oid | const String\& | [Object](../../../system/object/) 与扩展关联的标识符。 |
| raw_data | const ByteArrayPtr\& | 与证书关联的原始数据。 |
| 关键 | bool | 关键性标志。 |
