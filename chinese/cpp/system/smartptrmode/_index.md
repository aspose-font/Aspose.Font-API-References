...
description: "System::SmartPtrMode enum。SmartPtr 指针类型：weak 或 shared。定义在 C++ 中决定是否删除对象时，指针是否计入引用计数。"
type: docs
weight: 8500
url: /zh/cpp/system/smartptrmode/
---
## SmartPtrMode enum
...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| Shared | 0 | Shared 模式：指针参与引用计数。 |
| Weak | 1 | Weak 模式：指针不参与引用计数。 |
