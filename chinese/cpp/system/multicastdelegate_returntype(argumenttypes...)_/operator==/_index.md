...
description: "System::MulticastDelegate< ReturnType(ArgumentTypes...)>::operator== 方法。确定在 C++ 中两个 MulticastDelegate 实例——当前对象和指定对象——是否相等。"
type: docs
weight: 1900
...
确定两个 MulticastDelegate 实例——当前对象和指定对象——是否相等。
