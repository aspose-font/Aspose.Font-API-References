---
title: "System::DateTimeOffset::DateTimeOffset 构造函数"
linktitle: "DateTimeOffset"
second_title: "Aspose.Font 适用于 C++"
description: "System::DateTimeOffset::DateTimeOffset 构造函数。C++ 中的默认构造函数。"
type: docs
weight: 100
url: /zh/cpp/system/datetimeoffset/datetimeoffset/
---
...
| 秒 | int | 秒（0 到 59）。 |
| 毫秒 | int | 毫秒（0 到 999）。 |
| 日历 | const SharedPtr\<Globalization::Calendar\>\& | 用于解释年、月和日的日历。 |
| offset | TimeSpan | 相对于 UTC 的时间偏移。 |
