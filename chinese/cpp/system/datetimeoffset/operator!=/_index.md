...
description: "System::DateTimeOffset::operator!= 方法。确定当前对象和指定的 DateTimeOffset 对象在 C++ 中是否表示不同的日期和时间值。"
type: docs
weight: 3300
...
确定当前对象和指定的 [DateTimeOffset](../) 对象是否表示不同的日期和时间值。
...
如果当前对象和指定对象表示不同的日期和时间值，则为 true；否则为 false
