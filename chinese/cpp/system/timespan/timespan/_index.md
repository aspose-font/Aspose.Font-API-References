---
title: "System::TimeSpan::TimeSpan 构造函数"
linktitle: "TimeSpan"
second_title: "Aspose.Font 适用于 C++"
description: "System::TimeSpan::TimeSpan 构造函数。构造一个表示零时间间隔的 TimeSpan 对象（C++）。"
type: docs
weight: 100
url: /zh/cpp/system/timespan/timespan/
---
...
构造一个 [TimeSpan](../) 对象，其表示的时间间隔等于指定的 [TimeSpan](../) 对象所表示的时间间隔。
...
构造一个 [TimeSpan](../) 类的实例，表示的时间间隔等于指定的小时、分钟、秒和毫秒之和。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 天数 | int | 构造的实例所表示的时间间隔中天组件的天数 |
| 小时 | int | 构造的实例所表示的时间间隔中小时组件的小时数 |
| 分钟 | int | 构造的实例所表示的时间间隔中分钟组件的分钟数 |
| 秒 | int | 构造的实例所表示的时间间隔中秒组件的秒数 |
| 毫秒 | int | 构造的实例所表示的时间间隔中毫秒组件的毫秒数 |
...
构造一个 [TimeSpan](../) 类的实例，表示的时间间隔等于指定的小时、分钟和秒之和。
