---
title: "System::TimeSpan::TryParseExact 方法"
linktitle: "TryParseExact"
second_title: "Aspose.Font 适用于 C++"
description: "如何在 C++ 中使用 System::TimeSpan 类的 TryParseExact 方法。"
type: docs
weight: 4500
url: /zh/cpp/system/timespan/tryparseexact/
---
...
| styles | Globalization::TimeSpanStyles | 定义输入字符串中可能出现的元素。 |
| result | TimeSpan\& | 与字符串对应的时间间隔。 |

### ReturnValue

如果字符串成功转换则为 True；否则为 false。
