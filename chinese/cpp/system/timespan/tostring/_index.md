---
title: "System::TimeSpan::ToString 方法"
linktitle: "ToString"
second_title: "Aspose.Font 适用于 C++"
description: "System::TimeSpan::ToString 方法。返回当前对象表示的时间间隔的字符串表示（C++）。"
type: docs
weight: 3400
url: /zh/cpp/system/timespan/tostring/
---
## TimeSpan::ToString() const method


返回当前对象所表示的时间间隔的字符串表示形式。
...
使用指定的格式和格式提供程序将当前对象的值转换为等效的字符串表示形式。
