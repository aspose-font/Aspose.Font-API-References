---
title: "System::TimeZoneInfo::ConvertTimeBySystemTimeZoneId 方法"
linktitle: "ConvertTimeBySystemTimeZoneId"
second_title: "Aspose.Font 适用于 C++"
description: "System::TimeZoneInfo::ConvertTimeBySystemTimeZoneId 方法。将时间转换为 C++ 中指定时区的时间。"
type: docs
weight: 300
url: /zh/cpp/system/timezoneinfo/converttimebysystemtimezoneid/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| date_time_offset | const DateTimeOffset\& | 要转换的日期和时间。 |
| destination_time_zone_id | const String\& | 目标时区的标识符。 |
...
| --- | --- | --- |
| date_time | DateTime | 要转换的日期和时间。 |
| source_time_zone_id | const String\& | 源时区的标识符。 |
| destination_time_zone_id | const String\& | 目标时区的标识符。 |
