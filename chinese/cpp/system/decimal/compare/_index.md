---
title: "System::Decimal::Compare 方法"
linktitle: "Compare"
second_title: "Aspose.Font 适用于 C++"
description: "System::Decimal::Compare 方法。确定由第一个 Decimal 对象表示的值是否小于、等于或大于由第二个 Decimal 对象表示的值（C++）。"
type: docs
weight: 3400
url: /zh/cpp/system/decimal/compare/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| d1 | const Decimal\& | 第一个比较数 |
| d2 | const Decimal\& | 第二个比较数 |
