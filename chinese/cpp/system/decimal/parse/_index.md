---
title: "System::Decimal::Parse 方法"
linktitle: "解析"
second_title: "Aspose.Font 适用于 C++"
description: "System::Decimal::Parse 方法。将十进制数字的字符串表示转换为等效的 Decimal 类实例（在 C++ 中）。"
type: docs
weight: 4200
url: /zh/cpp/system/decimal/parse/
---
## Decimal::Parse(const String\&) method


将十进制数字的字符串表示转换为等效的 [Decimal](../) 类实例。
...
使用指定的格式提供程序，将十进制数字的字符串表示转换为等效的 [Decimal](../) 类实例。
...
| --- | --- | --- |
| s | const String\& | 要转换的十进制值的字符串表示 |
| styles | Globalization::NumberStyles | 一个枚举值的按位组合，提供关于 **s** 的附加信息、关于 **s** 中可能出现的样式元素的信息，或关于从 **s** 到 [Decimal](../) 对象的转换信息 |
