---
title: "System::Decimal::ToString 方法"
linktitle: "ToString"
second_title: "Aspose.Font 适用于 C++"
description: "System::Decimal::ToString 方法。返回对象所表示的值在 C++ 中的字符串表示形式。"
type: docs
weight: 3000
url: /zh/cpp/system/decimal/tostring/
---
...
使用指定的字符串格式和由指定的 [IFormatProvider](../../iformatprovider/) 对象提供的特定文化格式信息，将当前对象转换为其字符串表示形式。
