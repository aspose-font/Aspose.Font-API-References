---
title: "System::Char::IsSeparator 方法"
linktitle: "IsSeparator"
second_title: "Aspose.Font 适用于 C++"
description: "System::Char::IsSeparator 方法。确定指定字符是否被归类为 C++ 中的分隔符字符。"
type: docs
weight: 1500
url: /zh/cpp/system/char/isseparator/
---
...
如果指定字符是分隔符字符，则为 true，否则为 false
...
如果指定索引处的字符是分隔符字符，则为 true，否则为 false
