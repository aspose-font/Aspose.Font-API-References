---
title: "System::Char::ToUpper 方法"
linktitle: "ToUpper"
second_title: "Aspose.Font 适用于 C++"
description: "System::Char::ToUpper 方法。将指定字符转换为 C++ 中的大写字符。"
type: docs
weight: 2400
url: /zh/cpp/system/char/toupper/
---
...
| --- | --- | --- |
| c | char_t | 要转换的字符 |
| 文化 | const SharedPtr\<Globalization::CultureInfo\>\& | 提供特定文化大小写规则的对象。 |
