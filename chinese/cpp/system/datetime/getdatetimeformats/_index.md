---
title: "System::DateTime::GetDateTimeFormats 方法"
linktitle: "GetDateTimeFormats"
second_title: "Aspose.Font 适用于 C++"
description: "System::DateTime::GetDateTimeFormats 方法。返回字符串数组，其中每个元素都是当前对象使用标准日期和时间格式说明符之一格式化后的字符串表示（在 C++ 中）。"
type: docs
weight: 2700
url: /zh/cpp/system/datetime/getdatetimeformats/
---
## DateTime::GetDateTimeFormats() const method


返回字符串数组，其中每个元素是使用标准日期时间格式说明符之一格式化当前对象后的字符串表示。
...
返回字符串数组，其中每个元素是使用指定的标准日期时间格式说明符格式化当前对象后的字符串表示。
...
返回字符串数组，其中每个元素是使用指定的标准日期时间格式说明符和格式提供程序格式化当前对象后的字符串表示。
...
返回字符串数组，其中每个元素是使用标准日期时间格式说明符之一和指定的格式提供程序格式化当前对象后的字符串表示。
