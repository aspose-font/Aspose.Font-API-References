...
description: "System::operator<< 方法。使用 UTF-8 编码在 C++ 中将字符串输出到输出流。"
type: docs
weight: 29200
url: /zh/cpp/system/operator__/
---
...
| decimal | const Decimal\& | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| exception | const Exception\& | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| guid | const Guid\& | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| value | const Nullable\<T\>\& | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| os | const OperatingSystem\& | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| object_ptr | const SharedPtr\<T\>\& | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| object | const System::Object\& | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| type_info | const TypeInfo\& | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| version | const Version\& | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| object_ptr | const WeakPtr\<T\>\& | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| date_time | DateTime | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| value | DateTimeOffset | 用于插入的 [Data](../../system.data/)。 |
...
| --- | --- | --- |
| 流 | std::ostream\\& | 用于插入数据的输出流。 |
| time_span | TimeSpan | 用于插入的 [Data](../../system.data/)。 |
...
description: 'System::operator>> 方法。使用 UTF-8 编码在 C++ 中从输入流获取字符串。'
类型: 文档
weight: 35200
