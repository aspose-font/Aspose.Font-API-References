---
title: "System::Collections::Specialized::StringCollection::rend 方法"
linktitle: "rend"
second_title: "Aspose.Font 适用于 C++"
description: "System::Collections::Specialized::StringCollection::rend 方法. 返回一个指向已反转容器中最后一个元素之后的元素的反向迭代器。它对应于未反转容器中第一个元素之前的元素。该元素充当占位符，尝试访问它将在 C++ 中导致未定义行为。"
type: docs
weight: 2400
url: /zh/cpp/system.collections.specialized/stringcollection/rend/
---
