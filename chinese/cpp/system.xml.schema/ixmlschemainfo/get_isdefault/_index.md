---
title: "System::Xml::Schema::IXmlSchemaInfo::get_IsDefault 方法"
linktitle: "get_IsDefault"
second_title: "Aspose.Font 适用于 C++"
description: "System::Xml::Schema::IXmlSchemaInfo::get_IsDefault 方法。返回一个值，指示此已验证 XML 节点是否因在 C++ 中进行 XML 架构定义语言 (XSD) 架构验证时应用默认值而被设置。"
type: docs
weight: 100
url: /zh/cpp/system.xml.schema/ixmlschemainfo/get_isdefault/
---
