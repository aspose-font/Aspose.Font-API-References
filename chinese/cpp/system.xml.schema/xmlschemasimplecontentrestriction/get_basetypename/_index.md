...
description: "System::Xml::Schema::XmlSchemaSimpleContentRestriction::get_BaseTypeName method. 返回此类型派生自的内置数据类型或简单类型的名称（在 C++ 中）。"
type: docs
weight: 500
url: /zh/cpp/system.xml.schema/xmlschemasimplecontentrestriction/get_basetypename/
---
## XmlSchemaSimpleContentRestriction::get_BaseTypeName method


返回此类型派生自的内置数据类型或简单类型的名称。
