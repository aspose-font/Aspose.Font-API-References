...
description: "System::Xml::Schema::XmlSchemaMinInclusiveFacet 类。表示由万维网联盟（W3C）指定的 XML Schema 中的 minInclusive 元素。此类可用于指定 simpleType 元素的最小值限制。该元素的值必须大于或等于 C++ 中 minInclusive 元素的值。"
type: docs
weight: 4600
...
表示来自 XML [Schema](../) 的 **minInclusive** 元素，依据万维网 [Web](../../system.web/) 联盟 (W3C) 的规定。此类可用于指定 simpleType 元素的最小值限制。该元素的值必须大于或等于 **minInclusive** 元素的值。
