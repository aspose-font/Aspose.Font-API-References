---
title: "System::Xml::Schema::XmlSchema::Write 方法"
linktitle: "Write"
second_title: "Aspose.Font 适用于 C++"
description: "System::Xml::Schema::XmlSchema::Write 方法。将 XML 模式写入提供的数据流，使用 C++。"
type: docs
weight: 2800
url: /zh/cpp/system.xml.schema/xmlschema/write/
---
...
使用指定的 [XmlNamespaceManager](../../../system.xml/xmlnamespacemanager/)，将 XML [Schema](../../) 写入提供的流。
...
| --- | --- | --- |
| 流 | const SharedPtr\<IO::Stream\>\& | 提供的数据流。 |
| namespaceManager | const SharedPtr\<XmlNamespaceManager\>\& | 该 [XmlNamespaceManager](../../../system.xml/xmlnamespacemanager/)。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| writer | const SharedPtr\<IO::TextWriter\>\& | 用于写入的 [IO::TextWriter](../../../system.io/textwriter/)。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| writer | const SharedPtr\<XmlWriter\>\& | 用于写入的 [XmlWriter](../../../system.xml/xmlwriter/)。 |
