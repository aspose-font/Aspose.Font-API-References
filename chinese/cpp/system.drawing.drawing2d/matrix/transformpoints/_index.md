---
title: "System::Drawing::Drawing2D::Matrix::TransformPoints 方法"
linktitle: "TransformPoints"
second_title: "Aspose.Font 适用于 C++"
description: "System::Drawing::Drawing2D::Matrix::TransformPoints 方法。 在 C++ 中将当前对象表示的矩阵定义的几何变换应用于指定的点。"
type: docs
weight: 1800
url: /zh/cpp/system.drawing.drawing2d/matrix/transformpoints/
---
## Matrix::TransformPoints(const ArrayPtr\<Point\>\&) method


将当前对象表示的矩阵定义的几何变换应用于指定的点。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| pts | const ArrayPtr\<Point\>\& | 包含要转换的点的数组 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| pts | const ArrayPtr\<PointF\>\& | 包含要转换的点的数组 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| pts | const System::Details::ArrayView\<Point\>\& | 包含要转换的点的数组视图 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| pts | const System::Details::ArrayView\<PointF\>\& | 包含要转换的点的数组视图 |
