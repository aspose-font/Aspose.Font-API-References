---
title: "System::Drawing::Drawing2D::LinearGradientBrush::LinearGradientBrush 构造函数"
linktitle: "LinearGradientBrush"
second_title: "Aspose.Font 适用于 C++"
description: "System::Drawing::Drawing2D::LinearGradientBrush::LinearGradientBrush 构造函数。在 C++ 中构造 LinearGradientBrush 的新实例。"
type: docs
weight: 100
url: /zh/cpp/system.drawing.drawing2d/lineargradientbrush/lineargradientbrush/
---
## LinearGradientBrush::LinearGradientBrush(const Point\&, const Point\&, const Color\&, const Color\&) constructor


构造一个新的 [LinearGradientBrush](../) 实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| point1 | const Point\& | 渐变的起始点 |
| point2 | const Point\& | 渐变的结束点 |
| color1 | const Color\& | 渐变的起始颜色 |
| color2 | const Color\& | 渐变的结束颜色 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| point1 | const PointF\& | 渐变的起始点 |
| point2 | const PointF\& | 渐变的结束点 |
| color1 | const Color\& | 渐变的起始颜色 |
| color2 | const Color\& | 渐变的结束颜色 |
## 备注
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| rect | const Rectangle\& | 渐变的边界矩形 |
| color1 | const Color\& | 渐变的起始颜色 |
| color2 | const Color\& | 渐变的结束颜色 |
| 角度 | float | 渐变方向线的角度；以度为单位，顺时针从 x 轴测量 |
| isAngleScaleable | bool | 指定渐变的角度是否受刷子关联的变换影响 |
...
| color1 | const Color\& | 渐变的起始颜色 |
| color2 | const Color\& | 渐变的结束颜色 |
| linearGradientMode | LinearGradientMode | 渐变方向 |
