...
description: "System::Text::RegularExpressions::GroupCollectionPtr::GroupCollectionPtr 构造函数。C++ 中的空指针构造函数。"
type: docs
weight: 100
url: /zh/cpp/system.text.regularexpressions/groupcollectionptr/groupcollectionptr/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| obj | const SharedPtr\<GroupCollection\>\& | [Object](../../../system/object/) 用于引用。 |
