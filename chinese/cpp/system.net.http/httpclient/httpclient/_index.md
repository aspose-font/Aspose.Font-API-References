---
title: "System::Net::Http::HttpClient::HttpClient 构造函数"
linktitle: "HttpClient"
second_title: "Aspose.Font 适用于 C++"
description: "System::Net::Http::HttpClient::HttpClient 构造函数。 在 C++ 中构造一个新实例。"
type: docs
weight: 100
url: /zh/cpp/system.net.http/httpclient/httpclient/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 处理程序 | System::SharedPtr\<HttpMessageHandler\> | 用于发送请求的 HTTP 处理程序。 |
