---
title: "System::Security::Cryptography::CspParameters::CspParameters 构造函数"
linktitle: "CspParameters"
second_title: "Aspose.Font 适用于 C++"
description: "System::Security::Cryptography::CspParameters::CspParameters 构造函数。C++ 中的构造函数。"
type: docs
weight: 100
url: /zh/cpp/system.security.cryptography/cspparameters/cspparameters/
---
...
| --- | --- | --- |
| dwTypeIn | int | 提供程序类型代码；已忽略。 |
| strProviderNameIn | const System::String\& | 提供程序名称；已忽略。 |
...
| dwTypeIn | int | 提供程序类型代码；已忽略。 |
| strProviderNameIn | const System::String\& | 提供程序名称；已忽略。 |
| strContainerNameIn | const System::String\& | 容器名称；已忽略。 |
