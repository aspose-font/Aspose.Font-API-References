---
title: "System::Security::Cryptography::DSACryptoServiceProvider::DSACryptoServiceProvider 构造函数"
linktitle: "DSACryptoServiceProvider"
second_title: "Aspose.Font 适用于 C++"
description: "System::Security::Cryptography::DSACryptoServiceProvider::DSACryptoServiceProvider 构造函数。构造函数。使用 C++ 中的默认参数。"
type: docs
weight: 100
url: /zh/cpp/system.security.cryptography/dsacryptoserviceprovider/dsacryptoserviceprovider/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 参数 | const SharedPtr\<CspParameters\>\& | 算法参数。 |
