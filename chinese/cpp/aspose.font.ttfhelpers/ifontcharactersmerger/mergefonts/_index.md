---
title: "Aspose::Font::TtfHelpers::IFontCharactersMerger::MergeFonts 方法"
linktitle: "MergeFonts"
second_title: "Aspose.Font 适用于 C++"
description: "Aspose::Font::TtfHelpers::IFontCharactersMerger::MergeFonts 方法。合并基于传入的字形列表的字体。为每个传入的字形搜索字符代码，并将找到的字符代码与相应的字形添加到结果新字体中，使用 C++。"
type: docs
weight: 100
url: /zh/cpp/aspose.font.ttfhelpers/ifontcharactersmerger/mergefonts/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| font1Glyphs | System::ArrayPtr\<System::SharedPtr\<Glyphs::GlyphId\>\> | 第一个字体的字形列表 |
| font2Glyphs | System::ArrayPtr\<System::SharedPtr\<Glyphs::GlyphId\>\> | 第二个字体的字形列表 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| font1CharCodes | System::ArrayPtr\<uint32_t\> | 从第一个字体获取的代码 |
| font2CharCodes | System::ArrayPtr\<uint32_t\> | 从第二个字体获取的代码 |
| newFontName | System::String | 生成字体的期望名称 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| font1Dict | System::SharedPtr\<System::Collections::Generic::IDictionary\<uint32_t, System::SharedPtr\<Glyphs::GlyphId\>\>\> | 来自第一个字体的 [symbol code, glyph identifier] 键值对字典 |
| font2Dict | System::SharedPtr\<System::Collections::Generic::IDictionary\<uint32_t, System::SharedPtr\<Glyphs::GlyphId\>\>\> | 来自第二个字体的 [symbol code, glyph identifier] 键值对字典 |
| newFontName | System::String | 生成字体的期望名称 |
