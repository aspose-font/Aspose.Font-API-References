...
Schreibt ein Element mit dem angegebenen lokalen Namen, der Namespace‑URI und dem Wert.
...
Schreibt ein Element mit dem angegebenen Präfix, lokalen Namen, der Namespace‑URI und dem Wert.
...
| localName | const String\& | Der lokale Name des Elements. |
| ns | const String\& | Die Namespace-URI des Elements. |
| Wert | const String\& | Der Wert des Elements. |
