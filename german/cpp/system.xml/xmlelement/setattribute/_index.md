---
title: "System::Xml::XmlElement::SetAttribute Methode"
linktitle: "SetAttribute"
second_title: "Aspose.Font für C++"
description: "System::Xml::XmlElement::SetAttribute Methode. Setzt den Wert des Attributs mit dem angegebenen lokalen Namen und Namespace-URI in C++."
type: docs
weight: 2600
url: /de/cpp/system.xml/xmlelement/setattribute/
---
...
| Wert | String | Der zu setzende Wert für das Attribut. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Name | String | Der Name des zu erstellenden oder zu ändernden Attributs. Dies ist ein qualifizierter Name. Enthält der Name einen Doppelpunkt, wird er in Präfix- und lokalen Namensbestandteil zerlegt. |
| Wert | String | Der zu setzende Wert für das Attribut. |
