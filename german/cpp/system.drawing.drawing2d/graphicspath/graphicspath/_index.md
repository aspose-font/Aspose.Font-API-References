...
| --- | --- | --- |
| pts | const ArrayPtr\<Point\>\& | Ein Array, das die Punkte enthält, die den Pfad angeben, der durch das zu erstellende Objekt dargestellt werden soll. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| pts | const ArrayPtr\<PointF\>\& | Ein Array, das die Punkte enthält, die den Pfad angeben, der durch das zu erstellende Objekt dargestellt werden soll. |
| Typen | const ArrayPtr\<uint8_t\>\& | Ein Array, das die Werte enthält, die die Typen der entsprechenden Punkte im **pts** array angeben. |
| fillMode | FillMode | Gibt an, wie das Innere des vom zu erstellenden Objekt dargestellten geschlossenen Pfads gefüllt werden soll. |
