...
description: "System::Drawing::Drawing2D::GraphicsPath::AddString-Methode. Fügt eine Textzeichenkette zum Pfad hinzu, der durch das aktuelle Objekt in C++ dargestellt wird."
type: docs
weight: 1600
...
Fügt eine Textzeichenfolge zum Pfad hinzu, der vom aktuellen Objekt dargestellt wird.
...
| style | int | Ein [FontStyle](../../../system.drawing/fontstyle/)-Aufzählungswert, der den zu verwendenden Schriftstil angibt. |
| emSize | float | Die Höhe des em-Quadrat-Containers, der jedes Zeichen der Zeichenkette umschließt. |
...
| style | int | Ein [FontStyle](../../../system.drawing/fontstyle/)-Aufzählungswert, der den zu verwendenden Schriftstil angibt. |
| emSize | float | Die Höhe des em-Quadrat-Containers, der jedes Zeichen der Zeichenkette umschließt. |
| layoutRect | Rechteck | Ein Rechteck, das den Text umschließt. |
| stringFormat | const SharedPtr\<StringFormat\>\& | Das Format der Zeichenkette. |
...
| style | int | Ein [FontStyle](../../../system.drawing/fontstyle/)-Aufzählungswert, der den zu verwendenden Schriftstil angibt. |
| emSize | float | Die Höhe des em-Quadrat-Containers, der jedes Zeichen der Zeichenkette umschließt. |
| layoutRect | RectangleF | Ein Rechteck, das den Text umschließt. |
| stringFormat | const SharedPtr\<StringFormat\>\& | Das Format der Zeichenkette. |
