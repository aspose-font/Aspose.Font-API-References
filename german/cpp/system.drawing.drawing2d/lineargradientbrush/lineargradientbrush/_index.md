...
Konstruiert eine neue Instanz von [LinearGradientBrush](../).
...
| color1 | const Color\& | Die Startfarbe des Farbverlaufs |
| color2 | const Color\& | Die Endfarbe des Farbverlaufs |
| Winkel | float | Der Winkel der Orientierungslinie des Farbverlaufs; gemessen in Grad im Uhrzeigersinn von der x-Achse |
| isAngleScaleable | bool | Gibt an, ob der Winkel des Farbverlaufs von der mit dem Pinsel verbundenen Transformation beeinflusst wird |
