...
description: "System::Xml::Resolvers::XmlPreloadedResolver::SupportsType Methode. Bestimmt, ob der Resolver andere Typen als nur Stream in C++ unterstützt."
type: docs
weight: 800
...
| --- | --- | --- |
| absoluteUri | SharedPtr\<Uri\> | Der absolute URI zum Überprüfen. |
| Typ | const TypeInfo\& | Der zurückzugebende Typ. |
