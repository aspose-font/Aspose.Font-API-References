...
description: "System::Xml::XPath::XPathNavigator::AppendChild Methode. Gibt ein XmlWriter-Objekt zurück, das verwendet wird, um ein oder mehrere neue Kindknoten am Ende der Liste der Kindknoten des aktuellen Knotens in C++ zu erstellen."
type: docs
weight: 100
...
| --- | --- | --- |
| newChild | SharedPtr\<XmlReader\> | Ein [XmlReader](../../../system.xml/xmlreader/)-Objekt, das auf die XML-Daten des neuen Kindknotens positioniert ist. |
...
Erstellt einen neuen Kindknoten am Ende der Kindknotenliste des aktuellen Knotens unter Verwendung der angegebenen XML‑Datenzeichenfolge.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| newChild | String | Die XML-Datenzeichenfolge für den neuen Kindknoten. |
