...
description: "System::PrintTo Methode. Schreibt den von dem angegebenen Objekt repräsentierten Wert in den angegebenen Ausgabestream in C++."
type: docs
weight: 35400
...
Schreibt den von dem angegebenen Objekt repräsentierten Wert in den angegebenen Ausgabestream.
...
| --- | --- | --- |
| d | const Decimal\& | Das [Decimal](../decimal/)-Objekt zum Ausgeben in den Stream. |
