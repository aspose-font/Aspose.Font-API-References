...
description: "System::Array::Reverse method. Kehrt die Elemente im angegebenen Array in C++ um."
type: docs
weight: 5700
url: /de/cpp/system/array/reverse/
---
## Array::Reverse(const ArrayPtr\<Type\>\&) method


Kehrt die Elemente im angegebenen Array um.
...
Kehrt einen Bereich von Elementen im angegebenen Array um.
...
| --- | --- | --- |
| arr | const ArrayPtr\<Type\>\& | Ziel-Array |
| startIndex | int | Index im Array, an dem der umzukehrende Bereich beginnt |
| count | int | Die Größe des umzukehrenden Bereichs |
