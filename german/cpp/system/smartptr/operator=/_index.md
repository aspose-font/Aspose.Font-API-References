...
Kopiert und weist das [SmartPtr](../)-Objekt zu. Führt die erforderlichen Typkonvertierungen durch.
...
Kopiert und weist das [SmartPtr](../)-Objekt zu.
...
Weist den Rohzeiger dem [SmartPtr](../)-Objekt zu.
...
Verschiebt und weist das [SmartPtr](../)-Objekt zu. x wird unbenutzbar.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| x | SmartPtr_\&& | Zeiger für Move-Zuweisung. |
