...
description: "System::ExceptionWrapper::ExceptionWrapper Konstruktor. Konstruktor, der Parameter an die Konstruktoren der Exception‑Klasse weiterleitet und einen Smart‑Pointer erstellt, der eine neue Instanz der Exception‑Klasse hält, in C++."
type: docs
weight: 100
url: /de/cpp/system/exceptionwrapper/exceptionwrapper/
---
## ExceptionWrapper::ExceptionWrapper(Args\&&...) constructor


Konstruktor, der Parameter an die Konstruktoren der [Exception](../../exception/)‑Klasse weiterleitet und einen Smart‑Pointer erstellt, der eine neue [Exception](../../exception/)‑Klasseninstanz hält.
...
Konstruiert eine Instanz der [ExceptionWrapper](../)‑Klasse, die den übergebenen Zeiger enthält.
...
| --- | --- | --- |
| ptr | const ExceptionPtr\& | Smart‑Pointer zur Instanz der [Exception](../../exception/)‑Klasse. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| andere | const ExceptionWrapper\& | Andere Instanz der Wrapper‑Klasse, die kopiert werden muss. |
...
Konstruiert eine Null‑Instanz der [ExceptionWrapper](../)‑Klasse, die keine Ausnahme darstellt.
