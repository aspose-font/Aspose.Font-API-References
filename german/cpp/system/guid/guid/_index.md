...
description: "System::Guid::Guid-Konstruktor. Erstellt ein Objekt, das eine GUID darstellt, die ausschließlich aus Nullen besteht, in C++."
type: docs
weight: 100
...
Erstellt eine Instanz der [Guid](../)-Klasse aus den angegebenen GUID-Komponenten.
...
Erstellt eine Instanz der [Guid](../)-Klasse aus den angegebenen vorzeichenlosen Ganzzahlen und Bytes.
