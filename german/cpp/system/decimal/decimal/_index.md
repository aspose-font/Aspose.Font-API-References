---
title: "Konstruktor System::Decimal::Decimal"
linktitle: "Decimal"
second_title: "Aspose.Font für C++"
description: "Konstruktor System::Decimal::Decimal. Erstellt eine Instanz, die 0 in C++ repräsentiert."
type: docs
weight: 100
...
Erstellt eine Instanz der Klasse [Decimal](../) aus einem Integer-Array, das eine binäre Darstellung enthält.
...
Erstellt eine Instanz der Klasse [Decimal](../), die dieselbe Zahl wie das angegebene [Decimal](../) Objekt repräsentiert.
...
Erstellt eine Instanz der Klasse [Decimal](../), die den angegebenen Wert repräsentiert.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | const number_type\& | Eine konstante Referenz auf den Wert, der durch das zu konstruierende Objekt repräsentiert werden soll |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| d | double | Der double-precision Fließkommawert, der vom zu konstruierenden [Decimal](../) Objekt repräsentiert werden soll |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| f | float | Der single-precision Fließkommawert, der vom zu konstruierenden [Decimal](../) Objekt repräsentiert werden soll |
...
| mid | int32_t | Die mittleren 32 Bits des Wertes |
| hallo | int32_t | Die hohen 32 Bits des Wertes |
