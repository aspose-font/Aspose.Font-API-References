...
description: "System::setter_post_increment_wrap method. Translator übersetzt C#''s Post-Inkrement‑Ausdrücke, die auf die Eigenschaft einer Instanz abzielen, für die Setter und Getter definiert sind, in den Aufruf dieser Funktion (Überladung für const‑Getter) in C++."
type: docs
weight: 38000
...
Translator übersetzt C#'s Post-Inkrement‑Ausdrücke, die auf die Eigenschaft einer Instanz abzielen, für die Setter und Getter definiert sind, in den Aufruf dieser Funktion (Überladung für const‑Getter).
...
Translator übersetzt C#'s Post-Inkrement‑Ausdrücke, die auf die Eigenschaft einer Instanz abzielen, für die Setter und Getter definiert sind, in den Aufruf dieser Funktion (Überladung für non‑const‑Getter).
...
Der Übersetzer übersetzt C#-Postinkrement‑Ausdrücke, die auf die Eigenschaft einer Klasse abzielen, für die Setter und Getter definiert sind, in einen Aufruf dieser Funktion.
