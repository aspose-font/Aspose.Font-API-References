...
description: "System::String::operator+= Methode. Konkatenationszuweisungsoperator in C++."
type: docs
weight: 2900
...
| --- | --- | --- |
| c | char_t | Zeichen, das am Ende des aktuellen Strings angehängt wird. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| str | const String\& | [String](../) zum Anhängen an das Ende des aktuellen Strings. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | double | [Double](../../double/) zum Anhängen an das Ende des aktuellen Strings. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | int16_t | Short zum Anhängen an das Ende des aktuellen Strings. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | int32_t | Int zum Anhängen an das Ende des aktuellen Strings. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | int64_t | Long zum Anhängen an das Ende des aktuellen Strings. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | T | [Boolean](../../boolean/) zum Anhängen an das Ende des aktuellen Strings. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | uint16_t | Unsigned short zum Anhängen an das Ende des aktuellen Strings. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | uint32_t | Unsigned int zum Anhängen an das Ende des aktuellen Strings. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | uint64_t | Unsigned long zum Anhängen an das Ende des aktuellen Strings. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | uint8_t | [Byte](../../byte/) zum Anhängen an das Ende des aktuellen Strings. |
