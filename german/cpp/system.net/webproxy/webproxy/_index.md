...
| Adresse | String | Die Adresse des Proxy‑Servers. |
| BypassOnLocal | bool | Ein Wert, der angibt, ob der Proxy-Server für lokale Adressen verwendet werden muss. |
| BypassList | System::ArrayPtr\<String\> | Die Liste der Adressen, die den Proxy-Server nicht verwenden. |
...
| BypassOnLocal | bool | Ein Wert, der angibt, ob der Proxy-Server für lokale Adressen verwendet werden muss. |
| BypassList | System::ArrayPtr\<String\> | Die Liste der Adressen, die den Proxy-Server nicht verwenden. |
| Credentials | System::SharedPtr\<ICredentials\> | Die Anmeldeinformationen, die zur Authentifizierung an den Proxy-Server gesendet werden. |
