...
description: "System::IO::TextWriter::WriteLine Methode. Schreibt Zeilenabschlusszeichen zum Stream in C++."
type: docs
weight: 1000
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | Decimal | Das zu schreibende Objekt |
...
Schreibt die Zeichenkettenrepräsentation des angegebenen double‑Präzisions‑Gleitkommawerts, gefolgt von den Zeilenabschlusszeichen, in den Stream.
...
Schreibt die Zeichenkettenrepräsentation des angegebenen single‑precision Gleitkommawerts, gefolgt von den Zeilenabschlusszeichen, in den Stream.
...
Schreibt die Zeichenkettenrepräsentation des angegebenen unsigned 32‑Bit‑Ganzzahlwerts, gefolgt von den Zeilenabschlusszeichen, in den Stream.
...
Schreibt die Zeichenkettenrepräsentation des angegebenen unsigned 64‑Bit‑Ganzzahlwerts, gefolgt von den Zeilenabschlusszeichen, in den Stream.
