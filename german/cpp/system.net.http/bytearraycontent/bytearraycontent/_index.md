...
description: "System::Net::Http::ByteArrayContent::ByteArrayContent Konstruktor. RTTI-Informationen in C++."
type: docs
weight: 100
url: /de/cpp/system.net.http/bytearraycontent/bytearraycontent/
---
...
| --- | --- | --- |
| Inhalt | System::ArrayPtr\<uint8_t\> | Inhalt, der verwendet wird, um eine neue Instanz zu initialisieren. |
## Hinweise
...
| count | int32_t | Die Anzahl der Bytes im angegebenen Array, beginnend beim Parameter 'offset'. |
