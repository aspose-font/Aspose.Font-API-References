...
| --- | --- | --- |
| Schlüssel | const Botan::ECDSA_PrivateKey\& | Botan-Privatschlüssel. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| curve | const ECCurve\& | Kurve, die zum Erstellen des öffentlichen/privaten Schlüsselpaares verwendet wird. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Parameter | const ECParameters\& | Algorithmus-Parameter. |
