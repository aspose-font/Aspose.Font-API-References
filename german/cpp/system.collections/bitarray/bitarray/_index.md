...
| --- | --- | --- |
| Bits | const BitArray\& | Container zum Kopieren von Daten. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Bits | const bitset\& | Container zum Kopieren von Daten. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Werte | const System::ArrayPtr\<bool\>\& | Container zum elementweisen Kopieren von Daten. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Werte | const System::ArrayPtr\<int\>\& | Container zum bitweisen Kopieren von Daten. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Bytes | const System::ArrayPtr\<uint8_t\>\& | Container zum bitweisen Kopieren von Daten. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Länge | int | Anzahl der zu füllenden Elemente. |
