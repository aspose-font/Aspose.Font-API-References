...
description: "System::Drawing::Pen::Pen-Konstruktor. Erstellt ein neues Pen‑Objekt, das die angegebene Farbe in C++ darstellt."
type: docs
weight: 100
url: /de/cpp/system.drawing/pen/pen/
---
...
| --- | --- | --- |
| Farbe | const Color\& | Die Farbe des Pen, das vom zu konstruierenden Objekt dargestellt wird. |
...
| --- | --- | --- |
| Farbe | const Color\& | Die Farbe des Pen, das vom zu konstruierenden Objekt dargestellt wird. |
| width | float | Die Breite des Pen, das vom zu konstruierenden Objekt dargestellt wird. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| brush | const SharedPtr\<Brush\>\& | Das [Brush](../../brush/)-Objekt, das die Füll‑Eigenschaften des Pen, das vom zu konstruierenden Objekt dargestellt wird, festlegt. |
