---
title: "System::Drawing::Region::Union-Methode"
linktitle: "Union"
second_title: "Aspose.Font für C++"
description: "System::Drawing::Region::Union-Methode. Ersetzt die vom aktuellen Objekt repräsentierte Region durch das Ergebnis der Vereinigung dieser Region und einer durch das angegebene Rechteck definierten Region in C++."
type: docs
weight: 1900
url: /de/cpp/system.drawing/region/union/
---
...
| --- | --- | --- |
| rect | const Rectangle\& | Ein Rechteck, das eine Region definiert, mit der diese Region vereinigt wird. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| rect | const RectangleF\& | Ein Rechteck, das eine Region definiert, mit der diese Region vereinigt wird. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Pfad | const SharedPtr\<Drawing2D::GraphicsPath\>\& | Ein Pfad, der eine Region definiert, mit der diese Region vereinigt wird. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Region | const SharedPtr\<Region\>\& | Eine Region, mit der diese Region vereinigt wird. |
