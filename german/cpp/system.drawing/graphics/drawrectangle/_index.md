---
title: "System::Drawing::Graphics::DrawRectangle-Methode"
linktitle: "DrawRectangle"
second_title: "Aspose.Font für C++"
description: "System::Drawing::Graphics::DrawRectangle-Methode. Zeichnet das angegebene Rechteck mit dem angegebenen Stift auf der von dem aktuellen Objekt dargestellten Oberfläche in C++."
type: docs
weight: 2600
url: /de/cpp/system.drawing/graphics/drawrectangle/
---
## Graphics::DrawRectangle(const SharedPtr\<Pen\>\&, float, float, float, float) method


Zeichnet das angegebene Rechteck mit dem angegebenen Stift auf der vom aktuellen Objekt dargestellten Fläche.
...
| --- | --- | --- |
| Stift | const SharedPtr\<Pen\>\& | Ein Stift, der beim Zeichnen des Rechtecks verwendet wird |
...
| --- | --- | --- |
| Stift | const SharedPtr\<Pen\>\& | Ein Stift, der beim Zeichnen des Rechtecks verwendet wird |
| rect | Rectangle | Ein [Rectangle](../../rectangle/)-Objekt, das die Position und Größe des zu zeichnenden Rechtecks angibt |
