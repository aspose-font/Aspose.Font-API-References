...
description: "System::Drawing::Graphics::DrawCurve Methode. Zeichnet eine Spline mit dem angegebenen Stift in C++."
type: docs
weight: 1400
...
Zeichnet eine Kurve mit dem angegebenen Stift.
...
| --- | --- | --- |
| Stift | const SharedPtr\<Pen\>\& | Ein Stift, der beim Zeichnen der Spline verwendet wird. |
