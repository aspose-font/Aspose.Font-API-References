...
| Punkte | const ArrayPtr\<Point\>\& | Ein Array, das die Punkte enthält, die das Polygon definieren |
...
| --- | --- | --- |
| brush | const SharedPtr\<Brush\>\& | Ein [Brush](../../brush/) Objekt, das die Parameter der Füllung angibt |
| Punkte | const ArrayPtr\<PointF\>\& | Ein Array, das die Punkte enthält, die das Polygon definieren |
| fillMode | Drawing2D::FillMode | Der Füllmodus |
