---
title: "System::Drawing::Graphics::FillPie Methode"
linktitle: "FillPie"
second_title: "Aspose.Font für C++"
description: "System::Drawing::Graphics::FillPie Methode. Füllt das angegebene Kuchenstück mit dem angegebenen Brush auf der Oberfläche, die durch das aktuelle Objekt in C++ dargestellt wird."
type: docs
weight: 3500
url: /de/cpp/system.drawing/graphics/fillpie/
---
## Graphics::FillPie(const SharedPtr\<Brush\>\&, float, float, float, float, float, float) method


Füllt das angegebene Kuchenstück mit dem angegebenen Pinsel auf der Oberfläche, die vom aktuellen Objekt dargestellt wird.
...
| --- | --- | --- |
| brush | const SharedPtr\<Brush\>\& | Ein Brush, der beim Füllen des Kuchenstücks verwendet wird. |
