...
description: "System::Drawing::Graphics::DrawImage method. NICHT IMPLEMENTIERT in C++."
type: docs
weight: 1800
...
| srcRect | Rechteck | Ein Rechteck, das den Bereich des angegebenen Bildes definiert, das gezeichnet werden soll |
...
| srcRect | const RectangleF\& | Ein Rechteck, das den Bereich des angegebenen Bildes definiert, das gezeichnet werden soll |
| srcUnit | GraphicsUnit | Die Maßeinheiten, die vom Parameter **srcRect** verwendet werden |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| destPoints | const System::Details::ArrayView\<PointF\>\& | Eine Array-Ansicht, die drei Punkte enthält, die ein Parallelogramm auf der Zeichenfläche definieren, auf das Bild gezeichnet werden soll |
| srcRect | const RectangleF\& | Ein Rechteck, das den Bereich des angegebenen Bildes definiert, das gezeichnet werden soll |
| srcUnit | GraphicsUnit | Die Maßeinheiten, die vom Parameter **srcRect** verwendet werden |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Gibt Farb- und Gamma-Informationen für das Bild an |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| destPoints | const System::Details::StackArray\<PointF, N\>\& | Ein Stack-Array, das drei Punkte enthält, die ein Parallelogramm auf der Zeichenfläche definieren, auf das Bild gezeichnet werden soll |
| srcRect | const RectangleF\& | Ein Rechteck, das den Bereich des angegebenen Bildes definiert, das gezeichnet werden soll |
| srcUnit | GraphicsUnit | Die Maßeinheiten, die vom Parameter **srcRect** verwendet werden |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Gibt Farb- und Gamma-Informationen für das Bild an |
...
| x | float | Die X-Koordinate der oberen linken Ecke des Rechtecks, in das das Bild gezeichnet wird |
| y | float | Die Y-Koordinate der oberen linken Ecke des Rechtecks, in das das Bild gezeichnet wird |
| srcRect | RectangleF | Ein Rechteck, das den Bereich des angegebenen Bildes definiert, das gezeichnet werden soll |
| srcUnit | GraphicsUnit | Die Maßeinheiten, die vom Parameter **srcRect** verwendet werden |
...
| srcWidth | float | Die Breite der oberen linken Ecke des Rechtecks, das den Teil des Bildes angibt, der gezeichnet werden soll |
| srcHeight | float | Die Höhe der oberen linken Ecke des Rechtecks, das den Teil des Bildes angibt, der gezeichnet werden soll |
| srcUnit | GraphicsUnit | Die Maßeinheiten, in denen die Parameter **srcX**, **srcY**, **srcWidth** und **srcHeight** angegeben werden |
...
| srcWidth | int | Die Breite der oberen linken Ecke des Rechtecks, das den Teil des Bildes angibt, der gezeichnet werden soll |
| srcHeight | int | Die Höhe der oberen linken Ecke des Rechtecks, das den Teil des Bildes angibt, der gezeichnet werden soll |
| srcUnit | GraphicsUnit | Die Maßeinheiten, in denen die Parameter **srcX**, **srcY**, **srcWidth** und **srcHeight** angegeben werden |
