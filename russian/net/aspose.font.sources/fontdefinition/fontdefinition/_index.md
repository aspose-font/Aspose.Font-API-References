...
description: Создает однофайловое определение шрифта.
type: docs
weight: 10
url: /ru/net/aspose.font.sources/fontdefinition/fontdefinition/
---
## FontDefinition(FontType, string, StreamSource) {#constructor_3}

Создает однофайловое определение шрифта.
...
Создает многофайловое определение шрифта.
