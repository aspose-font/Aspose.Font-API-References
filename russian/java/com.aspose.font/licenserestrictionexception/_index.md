...
description: "Представляет исключение, которое может быть выброшено при попытке выполнить функциональность, ограниченную в режиме оценки."
type: docs
weight: 60
url: /ru/java/com.aspose.font/licenserestrictionexception/
---
**Inheritance:**
...
Представляет исключение, которое может быть выброшено при попытке выполнить функциональность, ограниченную в режиме оценки.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [LicenseRestrictionException()](#LicenseRestrictionException--) | Инициализирует новый объект  FontCreationException  . |
| [LicenseRestrictionException(String message)](#LicenseRestrictionException-java.lang.String-) | Инициализирует новый объект  FontCreationException  . |
| [LicenseRestrictionException(String message, RuntimeException innerException)](#LicenseRestrictionException-java.lang.String-java.lang.RuntimeException-) | Инициализирует новый объект  FontCreationException  . |
## Методы
...
Инициализирует новый объект  FontCreationException  .
