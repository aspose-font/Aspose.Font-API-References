...
type: docs
weight: 95
url: /ru/java/com.aspose.font/ttffontmetrics/
---
**Inheritance:**
...
| [getFontMatrix()](#getFontMatrix--) | Получает значение FontBBox. |
| [getGlyphBBox(GlyphId glyphId)](#getGlyphBBox-com.aspose.font.GlyphId-) | Возвращает Bbox глифа. |
| [getGlyphWidth(GlyphId glyphId)](#getGlyphWidth-com.aspose.font.GlyphId-) | Возвращает ширину глифов по идентификатору глифа. |
...
| [measureString(long[] charCodes, double fontSize)](#measureString-long---double-) | Измеряет текст, представленный массивом кодов символов, и возвращает ширину строки. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAscender(double value)](#setAscender-double-) | Устанавливает значение ascender. |
| [setDescender(double value)](#setDescender-double-) | Устанавливает значение нижнего выносного знака. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| charCodes | long[] | Текстовая строка, представленная как массив кодов символов. |
| fontSize | double | Размер шрифта. |
...
Устанавливает значение нижнего выносного знака.
