...
description: "Указывает тип шрифта."
type: docs
weight: 135
url: /ru/java/com.aspose.font/fontsavingformats/
---
**Inheritance:**
...
| Поле | Описание |
| --- | --- |
| [OTF](#OTF) | Шрифт OpenType. |
| [SVG](#SVG) | SVG(Scalable Vector Graphics) формат шрифта |
| [TTF](#TTF) | TTF (TrueType) формат шрифта. |
| [WOFF](#WOFF) | WOFF(Web Open Font Format). |
| [WOFF2](#WOFF2) | WOFF Формат файла 2.0 |
## Методы
...
Шрифт OpenType. Формат шрифта OpenType является расширением формата TrueType, добавляя поддержку данных шрифта PostScript.
...
SVG(Scalable Vector Graphics) формат шрифта
