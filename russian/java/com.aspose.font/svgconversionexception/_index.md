...
description: "Представляет исключение преобразования шрифта для формата SVG."
type: docs
weight: 76
url: /ru/java/com.aspose.font/svgconversionexception/
---
**Inheritance:**
...
Представляет исключение конвертации шрифта для формата SVG. Исключение может быть выброшено в случае ошибок во время процесса конвертации шрифта.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [SvgConversionException()](#SvgConversionException--) | Инициализирует новый объект SvgConversionException. |
| [SvgConversionException(String message)](#SvgConversionException-java.lang.String-) | Инициализирует новый объект SvgConversionException. |
| [SvgConversionException(String message, RuntimeException innerException)](#SvgConversionException-java.lang.String-java.lang.RuntimeException-) | Инициализирует новый объект SvgConversionException. |
## Методы
...
Инициализирует новый объект SvgConversionException.
