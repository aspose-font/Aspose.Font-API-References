...
type: docs
weight: 10
url: /ru/java/com.aspose.font/renderingutils.linespacingtype/
---
**Inheritance:**
...
Тип межстрочного интервала. Количество пикселей или процент от высоты шрифта.
## Поля

| Поле | Описание |
| --- | --- |
| [PercentOfFontHeight](#PercentOfFontHeight) | Значение межстрочного интервала задаётся в процентах от высоты шрифта. |
| [Pixels](#Pixels) | Значение межстрочного интервала задаётся в пикселях. |
## Методы
...
Значение межстрочного интервала задаётся в процентах от высоты шрифта.
...
Значение межстрочного интервала задаётся в пикселях.
