...
description: "Представляет исключение объединения Font."
type: docs
weight: 43
url: /ru/java/com.aspose.font/fontmergeexception/
---
**Inheritance:**
...
Представляет исключение слияния шрифтов. Исключение может быть выброшено в случае ошибок при объединении шрифтов.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [FontMergeException()](#FontMergeException--) | Инициализирует новый объект FontMergeException. |
| [FontMergeException(String message)](#FontMergeException-java.lang.String-) | Инициализирует новый объект FontMergeException. |
| [FontMergeException(String message, RuntimeException innerException)](#FontMergeException-java.lang.String-java.lang.RuntimeException-) | Инициализирует новый объект FontMergeException. |
## Методы
...
Инициализирует новый объект FontMergeException.
