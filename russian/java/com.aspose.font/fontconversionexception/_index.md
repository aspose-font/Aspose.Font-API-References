...
description: "Представляет исключение преобразования Font."
type: docs
weight: 36
url: /ru/java/com.aspose.font/fontconversionexception/
---
**Inheritance:**
...
Представляет исключение преобразования шрифта. Исключение может быть выброшено в случае ошибок во время процесса преобразования шрифта.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [FontConversionException()](#FontConversionException--) | Инициализирует новый  FontConversionException  объект. |
| [FontConversionException(String message)](#FontConversionException-java.lang.String-) | Инициализирует новый  FontConversionException  объект. |
| [FontConversionException(String message, RuntimeException innerException)](#FontConversionException-java.lang.String-java.lang.RuntimeException-) | Инициализирует новый  FontConversionException  объект. |
## Методы
...
Инициализирует новый  FontConversionException  объект.
