...
type: docs
weight: 10
url: /ru/java/com.aspose.font/fontenvironment.parsingstrictness/
---
**Inheritance:**
...
| Поле | Описание |
| --- | --- |
| [Strict](#Strict) | Указывает строгий тип. |
| [Tolerant](#Tolerant) | Указывает тип с допуском. |
## Методы
