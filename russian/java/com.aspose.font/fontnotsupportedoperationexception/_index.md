...
description: "Представляет исключение неподдерживаемой операции."
type: docs
weight: 45
url: /ru/java/com.aspose.font/fontnotsupportedoperationexception/
---
**Inheritance:**
...
Представляет исключение неподдерживаемой операции. Исключение может быть выброшено, если какая‑то операция не поддерживается для конкретного типа шрифта.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [FontNotSupportedOperationException()](#FontNotSupportedOperationException--) | Инициализирует новый объект  FontNotSupportedOperationException . |
| [FontNotSupportedOperationException(String message)](#FontNotSupportedOperationException-java.lang.String-) | Инициализирует новый объект  FontNotSupportedOperationException . |
| [FontNotSupportedOperationException(String message, RuntimeException innerException)](#FontNotSupportedOperationException-java.lang.String-java.lang.RuntimeException-) | Инициализирует новый объект  FontNotSupportedOperationException . |
## Методы
...
Инициализирует новый объект  FontNotSupportedOperationException .
