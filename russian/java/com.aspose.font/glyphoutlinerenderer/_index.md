...
description: "Представляет рендерер контура глифа."
type: docs
weight: 52
url: /ru/java/com.aspose.font/glyphoutlinerenderer/
---
**Inheritance:**
...
Представляет рендерер контура глифа.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [GlyphOutlineRenderer(IGlyphOutlinePainter painter)](#GlyphOutlineRenderer-com.aspose.font.IGlyphOutlinePainter-) | Инициализирует новый  GlyphOutlineRenderer  объект. |
## Методы
...
Инициализирует новый  GlyphOutlineRenderer  объект.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| painter | [IGlyphOutlinePainter](../../com.aspose.font/iglyphoutlinepainter) | Рисователь глифов. |
