...
description: "Представляет исключение разбора для шрифтов формата cff."
type: docs
weight: 23
url: /ru/java/com.aspose.font/cffparsingexception/
---
**Inheritance:**
...
Представляет исключение разбора для шрифтов формата cff. Исключение может быть выброшено в случае ошибок во время процесса разбора шрифта.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CffParsingException()](#CffParsingException--) | Инициализирует новый объект CffParsingException. |
| [CffParsingException(String message)](#CffParsingException-java.lang.String-) | Инициализирует новый объект CffParsingException. |
| [CffParsingException(String message, RuntimeException innerException)](#CffParsingException-java.lang.String-java.lang.RuntimeException-) | Инициализирует новый объект CffParsingException. |
## Методы
...
Инициализирует новый объект CffParsingException.
