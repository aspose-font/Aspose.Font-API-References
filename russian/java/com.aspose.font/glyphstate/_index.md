...
description: "Указывает состояние глифа."
type: docs
weight: 138
url: /ru/java/com.aspose.font/glyphstate/
---
**Inheritance:**
...
Указывает состояние глифа.
## Поля

| Поле | Описание |
| --- | --- |
| [ParsedWithErrors](#ParsedWithErrors) | Глиф был разобран с ошибками. |
| [Success](#Success) | Глиф был успешно разобран. |
## Методы
