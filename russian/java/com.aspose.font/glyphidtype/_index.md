...
description: "Указывает типы идентификаторов глифов."
type: docs
weight: 137
url: /ru/java/com.aspose.font/glyphidtype/
---
**Inheritance:**
...
Указывает типы идентификаторов глифов.
## Поля

| Поле | Описание |
| --- | --- |
| [ASCIIStringName](#ASCIIStringName) | ASCII-строка имени глифа. |
| [Int32Index](#Int32Index) | Целочисленный индекс глифа. |
## Методы
