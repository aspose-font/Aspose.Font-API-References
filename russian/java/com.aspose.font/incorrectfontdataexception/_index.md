...
description: "Представляет исключения для случаев, когда некоторые значения объекта Font недействительны."
type: docs
weight: 57
url: /ru/java/com.aspose.font/incorrectfontdataexception/
---
**Inheritance:**
...
Представляет исключения для случаев, когда некоторые значения объекта Font недействительны.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [IncorrectFontDataException()](#IncorrectFontDataException--) | Инициализирует новый объект FontAgrumentException. |
| [IncorrectFontDataException(String message)](#IncorrectFontDataException-java.lang.String-) | Инициализирует новый объект FontAgrumentException. |
| [IncorrectFontDataException(String message, RuntimeException innerException)](#IncorrectFontDataException-java.lang.String-java.lang.RuntimeException-) | Инициализирует новый объект FontAgrumentException. |
## Методы
...
Инициализирует новый объект FontAgrumentException.
