...
description: "Указывает структуры INDEX, поддерживаемые семейством интерфейсов поставщика индексов."
type: docs
weight: 133
url: /ru/java/com.aspose.font/cffindexprovidertype/
---
**Inheritance:**
...
Указывает структуры INDEX, поддерживаемые семейством интерфейсов поставщика индексов.
## Поля

| Поле | Описание |
| --- | --- |
| [NameIndex](#NameIndex) | Имя INDEX |
