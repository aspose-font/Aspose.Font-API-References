...
description: "Представляет Compact Font Format CFF."
type: docs
weight: 19
url: /ru/java/com.aspose.font/cfffont/
---
**Inheritance:**
...
| [getClass()](#getClass--) |  |
| [getCommonFontsSettings()](#getCommonFontsSettings--) | Получает настройки, общие для шрифтов CFF. |
...
| [getIndexDataProvider(CffIndexProviderType indexType)](#getIndexDataProvider-com.aspose.font.CffIndexProviderType-) | Получает провайдера для указанного типа структуры CFF INDEX. |
...
| [hashCode()](#hashCode--) |  |
| [isCidKeyedFont()](#isCidKeyedFont--) | Получает значение, указывающее, что шрифт использует cid‑ключ. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCommonFontsSettings(CffFontsSettings value)](#setCommonFontsSettings-com.aspose.font.CffFontsSettings-) | Указывает настройки, общие для шрифтов CFF. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| indexType | [CffIndexProviderType](../../com.aspose.font/cffindexprovidertype) | Тип структуры INDEX. |
...
**Returns:**
boolean — значение, указывающее, что шрифт использует cid‑ключ.
### notify() {#notify--}
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [CffFontsSettings](../../com.aspose.font/cfffontssettings) | Определение шрифта. |
