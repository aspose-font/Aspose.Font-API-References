...
description: "Представляет исключение аргумента Font."
type: docs
weight: 33
url: /ru/java/com.aspose.font/fontagrumentexception/
---
**Inheritance:**
...
Представляет исключение аргумента шрифта. Исключение может быть выброшено в случае неправильного использования аргументов.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [FontAgrumentException()](#FontAgrumentException--) | Инициализирует новый объект FontAgrumentException. |
| [FontAgrumentException(String message)](#FontAgrumentException-java.lang.String-) | Инициализирует новый объект FontAgrumentException. |
| [FontAgrumentException(String message, RuntimeException innerException)](#FontAgrumentException-java.lang.String-java.lang.RuntimeException-) | Инициализирует новый объект FontAgrumentException. |
## Методы
