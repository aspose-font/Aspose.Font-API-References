...
description: "Представляет общее исключение, связанное с обработкой Font."
type: docs
weight: 40
url: /ru/java/com.aspose.font/fontexception/
---
**Inheritance:**
...
Представляет общее исключение, связанное с обработкой Font.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [FontException()](#FontException--) | Инициализирует новый  FontException  объект. |
| [FontException(String message)](#FontException-java.lang.String-) | Инициализирует новый  FontException  объект. |
| [FontException(String message, RuntimeException innerException)](#FontException-java.lang.String-java.lang.RuntimeException-) | Инициализирует новый  FontException  объект. |
## Методы
...
Инициализирует новый  FontException  объект.
