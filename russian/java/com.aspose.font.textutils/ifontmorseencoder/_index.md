...
description: "Объявляет функциональность для кодирования текста с помощью кода Морзе и получения результата в виде глифов шрифта."
type: docs
weight: 12
url: /ru/java/com.aspose.font.textutils/ifontmorseencoder/
---```
