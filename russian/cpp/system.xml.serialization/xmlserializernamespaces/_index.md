...
Содержит пространства имён XML и префиксы, которые [Serialization::XmlSerializer](../xmlserializer/) использует для создания квалифицированных имён в экземпляре XML‑документа.
