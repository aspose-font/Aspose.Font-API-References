---
title: "System::Xml::Serialization::XmlSerializer::Serialize метод"
linktitle: "Serialize"
second_title: "Aspose.Font для C++"
description: "System::Xml::Serialization::XmlSerializer::Serialize метод. Сериализует документ в XML в C++."
type: docs
weight: 300
...
| поток | System::SharedPtr\<IO::Stream\> | Поток назначения. |
| o | System::SharedPtr\<Object\> | [Object](../../../system/object/) для сериализации. |
| пространства имён | System::SharedPtr\<XmlSerializerNamespaces\> | Хранилище пространств имен. |
...
| пространства имён | System::SharedPtr\<XmlSerializerNamespaces\> | Хранилище пространств имен. |
| encodingStyle | String | Стиль, используемый при сериализации объекта. |
| id | String | [Object](../../../system/object/) идентификатор, используемый при сериализации. |
