...
| [get_SchemaLocation](./get_schemalocation/)() | Возвращает расположение Uniform Resource Identifier (URI) для схемы, которое указывает процессору схемы, где схема физически находится. |
...
| [set_SchemaLocation](./set_schemalocation/)(const String\&) | Устанавливает расположение Uniform Resource Identifier (URI) для схемы, которое указывает процессору схемы, где схема физически находится. |
