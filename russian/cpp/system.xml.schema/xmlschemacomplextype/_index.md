...
| [get_AttributeUses](./get_attributeuses/)() | Возвращает коллекцию всех скомпилированных атрибутов этого сложного типа и его базовых типов. |
...
| [get_BlockResolved](./get_blockresolved/)() | Возвращает значение после того, как тип был скомпилирован в набор информации после проверки схемы (infoset). Это значение указывает, как тип применяется, когда **xsi:type** используется в документе экземпляра. |
| [get_ContentModel](./get_contentmodel/)() | Возвращает посткомпиляционный [XmlSchemaContentModel](../xmlschemacontentmodel/) этого сложного типа. |
| [get_ContentType](./get_contenttype/)() | Возвращает модель содержимого сложного типа, которая содержит посткомпиляционное значение. |
| [get_ContentTypeParticle](./get_contenttypeparticle/)() | Возвращает частицу, которая содержит посткомпиляционное значение частицы [XmlSchemaComplexType::get_ContentType](./get_contenttype/). |
...
| [set_ContentModel](./set_contentmodel/)(const SharedPtr\<XmlSchemaContentModel\>\&) | Устанавливает посткомпиляционный [XmlSchemaContentModel](../xmlschemacontentmodel/) этого сложного типа. |
