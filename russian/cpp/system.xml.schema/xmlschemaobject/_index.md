...
description: "System::Xml::Schema::XmlSchemaObject class. Представляет корневой класс для иерархии модели объектов Xml схемы и служит базовым классом для таких классов, как класс XmlSchema на C++."
type: docs
weight: 5000
...
| [get_LinePosition](./get_lineposition/)() | Возвращает позицию символа в строке в файле, к которому относится элемент **schema**. |
| [get_Namespaces](./get_namespaces/)() | Возвращает XmlSerializerNamespaces, используемые с этим объектом схемы. |
...
| [set_LinePosition](./set_lineposition/)(int32_t) | Устанавливает позицию символа в строке в файле, к которому относится элемент **schema**. |
