...
description: "Класс System::Xml::Schema::XmlSchemaObjectCollection. Коллекция XmlSchemaObjects в C++."
type: docs
weight: 5100
...
| [IndexOf](./indexof/)(const SharedPtr\<XmlSchemaObject\>\&) | Возвращает индекс коллекции, соответствующий указанному [XmlSchemaObject](../xmlschemaobject/). |
