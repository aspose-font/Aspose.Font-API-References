...
description: "System::Xml::Schema::XmlSchemaSimpleContent class. Представляет элемент simpleContent из XML Schema, как указано World Wide Web Consortium (W3C). Этот класс предназначен для простых и сложных типов с простой моделью содержимого в C++."
type: docs
weight: 5900
...
| Метод | Описание |
| --- | --- |
| [get_Content](./get_content/)() override | Возвращает один из элементов [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) или [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
| [set_Content](./set_content/)(SharedPtr\<XmlSchemaContent\>) override | Возвращает один из элементов [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) или [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
## Typedefs
