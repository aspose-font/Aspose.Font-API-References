---
title: "System::Xml::Schema::XmlSchemaInclude класс"
linktitle: "XmlSchemaInclude"
second_title: "Aspose.Font для C++"
description: "System::Xml::Schema::XmlSchemaInclude класс. Представляет элемент include из XML Schema, как указано World Wide Web Consortium (W3C). Этот класс используется для включения объявлений и определений из внешней схемы. Включённые объявления и определения затем доступны для обработки в содержащей схеме в C++."
type: docs
weight: 3600
...
Представляет элемент **include** из XML [Schema](../), как указано World Wide [Web](../../system.web/) Consortium (W3C). Этот класс используется для включения объявлений и определений из внешней схемы. Включённые объявления и определения затем доступны для обработки в содержащей схеме.
