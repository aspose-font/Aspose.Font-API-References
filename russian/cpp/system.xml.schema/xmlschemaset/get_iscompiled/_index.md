...
description: "System::Xml::Schema::XmlSchemaSet::get_IsCompiled метод. Возвращает значение, указывающее, были ли схемы языка определения XML Schema (XSD) в XmlSchemaSet скомпилированы в C++."
type: docs
weight: 1100
