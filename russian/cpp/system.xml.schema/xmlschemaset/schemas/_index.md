...
description: "System::Xml::Schema::XmlSchemaSet::Schemas метод. Возвращает коллекцию всех схем языка определения XML Schema (XSD) в XmlSchemaSet в C++."
type: docs
weight: 1600
...
Возвращает коллекцию всех схем языка определения XML [Schema](../../) (XSD) в [XmlSchemaSet](../).
...
Возвращает коллекцию всех схем языка определения XML [Schema](../../) (XSD) в [XmlSchemaSet](../), принадлежащих указанному пространству имён.
...
Объект IList, содержащий все схемы, добавленные в [XmlSchemaSet](../) и принадлежащие указанному пространству имён. Если в [XmlSchemaSet](../) не добавлено схем, возвращается пустая коллекция.
