...
description: "System::Xml::Schema::XmlSchemaSet::Add метод. Добавляет указанную XmlSchema в XmlSchemaSet в C++."
type: docs
weight: 200
...
Добавляет указанную [XmlSchema](../../xmlschema/) в [XmlSchemaSet](../).
...
Добавляет все XML [Schema](../../) схемы языка определения (XSD) из указанного [XmlSchemaSet](../) в [XmlSchemaSet](../).
