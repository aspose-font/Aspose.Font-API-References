...
Представляет элемент **attributeGroup** из XML [Schema](../) в соответствии с World Wide [Web](../../system.web/) Consortium (W3C). AttributesGroups предоставляет механизм группировки набора объявлений атрибутов, чтобы их можно было включить как группу в определения сложных типов.
