---
title: "System::Xml::Schema::XmlSchemaCollection класс"
linktitle: "XmlSchemaCollection"
second_title: "Aspose.Font для C++"
description: "System::Xml::Schema::XmlSchemaCollection класс. Содержит кэш схем определения XML Schema (XSD) и XML-Data Reduced (XDR) в C++."
type: docs
weight: 1500
...
| [Add](./add/)(const SharedPtr\<XmlSchemaCollection\>\&) | Добавляет все пространства имён, определённые в заданной коллекции (включая связанные схемы), в эту коллекцию. |
| [Contains](./contains/)(const SharedPtr\<XmlSchema\>\&) | Возвращает значение, указывающее, находится ли **targetNamespace** указанной [XmlSchema](../xmlschema/) в коллекции. |
