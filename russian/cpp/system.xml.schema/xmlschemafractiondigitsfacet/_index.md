...
Указывает ограничение на количество цифр, которые могут быть введены для дробного значения элемента simpleType. Значение fractionDigits должно быть единственным положительным целым числом. Представляет фасет **fractionDigits** World Wide [Web](../../system.web/) Consortium (W3C).
