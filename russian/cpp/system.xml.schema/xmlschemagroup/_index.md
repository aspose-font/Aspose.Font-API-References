...
description: "System::Xml::Schema::XmlSchemaGroup класс. Представляет элемент **group** из XML Schema, как определено World Wide Web Consortium (W3C). Этот класс определяет группы на уровне **schema**, которые используются в сложных типах. Он группирует набор объявлений элементов, чтобы их можно было включить как группу в определения сложных типов в C++."
type: docs
weight: 3100
...
Представляет элемент **group** из XML [Schema](../), как определено World Wide [Web](../../system.web/) Consortium (W3C). Этот класс определяет группы на уровне **schema**, которые используются в сложных типах. Он группирует набор объявлений элементов, чтобы их можно было включить как группу в определения сложных типов.
