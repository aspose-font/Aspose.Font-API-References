---
title: "Конструктор System::Xml::Schema::XmlSchemaValidator::XmlSchemaValidator"
linktitle: "XmlSchemaValidator"
second_title: "Aspose.Font для C++"
description: "Конструктор System::Xml::Schema::XmlSchemaValidator::XmlSchemaValidator. Инициализирует новый экземпляр класса XmlSchemaValidator в C++."
type: docs
weight: 100
...
| validationFlags | XmlSchemaValidationFlags | Значение [XmlSchemaValidationFlags](../../xmlschemavalidationflags/), указывающее параметры проверки схемы. |
