---
title: "System::Xml::Schema::XmlSchemaSimpleContentRestriction класс"
linktitle: "XmlSchemaSimpleContentRestriction"
second_title: "Aspose.Font для C++"
description: "System::Xml::Schema::XmlSchemaSimpleContentRestriction класс. Представляет элемент restriction для простого содержимого из XML Schema, как указано World Wide Web Consortium (W3C). Этот класс может использоваться для получения простых типов посредством ограничения. Такие производные могут использоваться для ограничения диапазона значений элемента до подмножества значений, указанных в унаследованном простом типе в C++."
type: docs
weight: 6100
...
Представляет элемент **restriction** для простого содержимого из XML [Schema](../) в соответствии с World Wide [Web](../../system.web/) Consortium (W3C). Этот класс может использоваться для получения простых типов посредством ограничения. Такие производные могут использоваться для ограничения диапазона значений элемента до подмножества значений, указанных в унаследованном простом типе.
