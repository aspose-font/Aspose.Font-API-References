...
| --- | --- | --- |
| validationEventHandler | ValidationEventHandler | Обработчик события проверки, получающий информацию об ошибках проверки XML [Schema](../../). |
| resolver | const SharedPtr\<XmlResolver\>\& | Объект [XmlResolver](../../../system.xml/xmlresolver/), используемый для разрешения пространств имён, указанных в элементах **include** и **import**. |
