---
title: "Класс System::Xml::Schema::XmlSchema"
linktitle: "XmlSchema"
second_title: "Aspose.Font для C++"
description: "Класс System::Xml::Schema::XmlSchema. Представление XML-схемы в памяти, как указано в World Wide Web Consortium (W3C) и в C++."
type: docs
weight: 400
...
| Метод | Описание |
| --- | --- |
| [Compile](./compile/)(ValidationEventHandler) | Компилирует XML [Schema](../)[Object](../../system/object/) Model (SOM) в информацию схемы для проверки. Используется для проверки синтаксической и семантической структуры программно построенного SOM. Проверка семантической валидации выполняется во время компиляции. |
| [Compile](./compile/)(ValidationEventHandler, const SharedPtr\<XmlResolver\>\&) | Компилирует XML [Schema](../)[Object](../../system/object/) Model (SOM) в информацию схемы для проверки. Используется для проверки синтаксической и семантической структуры программно построенного SOM. Проверка семантической валидации выполняется во время компиляции. |
...
| [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Возвращает позицию символа в строке в файле, к которому относится элемент **schema**. |
| [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Возвращает XmlSerializerNamespaces, используемые с этим объектом схемы. |
...
| [set_LinePosition](../xmlschemaobject/set_lineposition/)(int32_t) | Устанавливает позицию символа в строке в файле, к которому относится элемент **schema**. |
...
| [set_Parent](../xmlschemaobject/set_parent/)(const SharedPtr\<XmlSchemaObject\>\&) | Устанавливает родителя для этого [XmlSchemaObject](../xmlschemaobject/). |
