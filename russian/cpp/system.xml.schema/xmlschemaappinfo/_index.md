...
description: "System::Xml::Schema::XmlSchemaAppInfo класс. Представляет элемент appinfo World Wide Web Consortium (W3C) в C++."
type: docs
weight: 1000
...
Представляет элемент World Wide [Web](../../system.web/) Consortium (W3C) **appinfo**.
