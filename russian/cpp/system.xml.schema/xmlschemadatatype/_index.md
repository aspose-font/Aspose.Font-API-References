...
description: "System::Xml::Schema::XmlSchemaDatatype класс. Класс XmlSchemaDatatype является абстрактным классом для отображения типов языка определения XML Schema (XSD) в типы выполнения в C++."
type: docs
weight: 2400
