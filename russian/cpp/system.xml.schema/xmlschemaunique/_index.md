...
description: "System::Xml::Schema::XmlSchemaUnique класс. Представляет элемент unique из XML Schema, определённый World Wide Web Consortium (W3C). Этот класс может использоваться для идентификации уникального ограничения среди набора элементов в C++."
type: docs
weight: 6900
...
Представляет элемент **unique** из XML [Schema](../), определённый World Wide [Web](../../system.web/) Consortium (W3C). Этот класс может использоваться для идентификации уникального ограничения среди набора элементов.
