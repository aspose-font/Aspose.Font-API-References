...
description: "System::Xml::Schema::XmlSchemaInference class. Выводит схему XML Schema Definition Language (XSD) из XML‑документа. Класс XmlSchemaInference нельзя наследовать в C++."
type: docs
weight: 3700
