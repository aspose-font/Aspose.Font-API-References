...
Выводит схему XML [Schema](../../) Definition Language (XSD) из XML‑документа, содержащегося в объекте [XmlReader](../../../system.xml/xmlreader/), указанном.
...
Выводит схему XML [Schema](../../) Definition Language (XSD) из XML‑документа, содержащегося в объекте [XmlReader](../../../system.xml/xmlreader/), указанном, и уточняет полученную схему, используя существующую схему в объекте [XmlSchemaSet](../../xmlschemaset/), указанном с тем же целевым пространством имён.
