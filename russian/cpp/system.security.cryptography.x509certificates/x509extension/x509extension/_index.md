...
description: "System::Security::Cryptography::X509Certificates::X509Extension::X509Extension конструктор. Информация RTTI в C++."
type: docs
weight: 100
...
| критический | bool | Знак критичности. |
## Примечания
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| oid | const SharedPtr\<Oid\>\& | [Object](../../../system/object/) идентификатор, связанный с расширением. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| oid | const String\& | [Object](../../../system/object/) идентификатор, связанный с расширением. |
| raw_data | const ByteArrayPtr\& | Необработанные данные, связанные с сертификатом. |
| критический | bool | Знак критичности. |
