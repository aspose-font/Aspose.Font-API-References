...
description: "System::Security::Cryptography::X509Certificates::X509Certificate::Export method. Экспортирует текущий объект в массив байтов, используя указанный формат. НЕ РЕАЛИЗОВАНО в C++."
type: docs
weight: 400
...
Экспортирует текущий объект в массив байтов с использованием указанного формата. НЕ РЕАЛИЗОВАНО.
