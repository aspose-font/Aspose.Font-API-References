...
description: "Конструктор System::Security::Cryptography::X509Certificates::X500DistinguishedName::X500DistinguishedName. Конструктор на C++."
type: docs
weight: 100
...
| --- | --- | --- |
| encoded_distinguished_name | const ByteArrayPtr\& | Закодированное различительное имя. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| encoded_distinguished_name | const SharedPtr\<AsnEncodedData\>\& | [Object](../../../system/object/) представляет различительное имя. |
## Примечания
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| distinguishedName | const SharedPtr\<X500DistinguishedName\>\& | Различительное имя, из которого копировать данные. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| distinguished_name | const String\& | Различительное имя. |
...
| --- | --- | --- |
| distinguished_name | const String\& | Различительное имя. |
| флаги | X500DistinguishedNameFlags | Битово‑комбинированные флаги, определяющие свойства построения имени. |
