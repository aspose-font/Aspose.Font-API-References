...
description: "System::Drawing::Drawing2D::GraphicsPath::AddString method. Добавляет строку текста к пути, представленному текущим объектом в C++."
type: docs
weight: 1600
...
| --- | --- | --- |
| текст | const String\& | Текст для добавления |
| family | const SharedPtr\\<FontFamily\\>\\& | Семейство шрифтов, используемое для отрисовки текста |
...
| origin | Point | Указывает местоположение, где начинается текст |
...
| style | int | Значение перечисления [FontStyle](../../../system.drawing/fontstyle/), указывающее стиль шрифта для использования |
| emSize | float | Высота квадратного блока em, ограничивающего каждый символ строки |
| origin | PointF | Указывает местоположение, где начинается текст |
| stringFormat | const SharedPtr\<StringFormat\>\& | Формат строки |
