...
| Метод | Описание |
| --- | --- |
| [get_Data](./get_data/)() | Возвращает массив байтов, содержащий данные, определяющие регион. |
...
| [set_Data](./set_data/)(const ArrayPtr\<uint8_t\>\&) | Устанавливает данные региона для текущего объекта. |
## См. также
