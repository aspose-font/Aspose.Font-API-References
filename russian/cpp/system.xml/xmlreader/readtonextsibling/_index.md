...
description: "System::Xml::XmlReader::ReadToNextSibling метод. Перемещает XmlReader к следующему соседнему элементу с указанным локальным именем и URI пространства имён в C++."
type: docs
weight: 7300
...
| namespaceURI | String | URI пространства имён соседнего элемента, к которому вы хотите переместиться. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| имя | String | Квалифицированное имя соседнего элемента, к которому вы хотите переместиться. |
