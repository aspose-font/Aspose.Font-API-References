...
description: "Метод System::Xml::XmlReader::get_IsEmptyElement. При переопределении в производном классе получает значение, указывающее, является ли текущий узел пустым элементом (например, <MyElement/>) в C++."
type: docs
weight: 1300
