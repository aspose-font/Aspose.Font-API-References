...
description: "System::Xml::XmlReader::ReadValueChunk метод. Считывает большие потоки текста, встроенные в XML‑документ, в C++."
type: docs
weight: 7400
...
Количество символов, считанных в буфер. Значение ноль возвращается, когда больше нет текстового содержимого.
