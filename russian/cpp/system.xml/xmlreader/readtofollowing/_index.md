...
description: "System::Xml::XmlReader::ReadToFollowing метод. Считывает до тех пор, пока не будет найден элемент с указанным локальным именем и URI пространства имён в C++."
type: docs
weight: 7200
