...
| dateTimeOption | XmlDateTimeSerializationMode | Одно из значений перечисления, указывающее, следует ли преобразовывать дату во местное время или сохранять её как всемирное координированное время (UTC), если это UTC‑дата. |
