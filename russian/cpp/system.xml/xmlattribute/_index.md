---
title: "System::Xml::XmlAttribute класс"
linktitle: "XmlAttribute"
second_title: "Aspose.Font для C++"
description: "System::Xml::XmlAttribute класс. Представляет атрибут. Допустимые и значения по умолчанию для атрибута определяются в определении типа документа (DTD) или схеме в C++."
type: docs
weight: 600
