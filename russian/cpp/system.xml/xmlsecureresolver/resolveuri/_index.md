...
description: "System::Xml::XmlSecureResolver::ResolveUri метод. Разрешает абсолютный URI из базового и относительного URI, вызывая ResolveUri у базового XmlResolver в C++."
type: docs
weight: 300
