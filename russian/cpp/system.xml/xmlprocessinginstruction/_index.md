---
title: "System::Xml::XmlProcessingInstruction класс"
linktitle: "XmlProcessingInstruction"
second_title: "Aspose.Font для C++"
description: "System::Xml::XmlProcessingInstruction класс. Представляет инструкцию обработки, которую XML определяет для сохранения специфичной для процессора информации в тексте документа в C++."
type: docs
weight: 3100
