---
title: "System::Xml::XmlReaderSettings::get_CloseInput метод"
linktitle: "get_CloseInput"
second_title: "Aspose.Font для C++"
description: "System::Xml::XmlReaderSettings::get_CloseInput метод. Возвращает значение, указывающее, следует ли закрывать базовый поток или TextReader при закрытии читателя в C++."
type: docs
weight: 500
url: /ru/cpp/system.xml/xmlreadersettings/get_closeinput/
---
