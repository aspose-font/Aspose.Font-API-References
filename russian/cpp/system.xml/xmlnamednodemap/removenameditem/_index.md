...
[XmlNode](../../xmlnode/) удалённый или **nullptr**, если совпадающий узел не найден.
...
[XmlNode](../../xmlnode/) удалённый из этого [XmlNamedNodeMap](../) или **nullptr**, если совпадающий узел не найден.
