---
title: "Класс System::Xml::XmlResolver"
linktitle: "XmlResolver"
second_title: "Aspose.Font для C++"
description: "Класс System::Xml::XmlResolver. Разрешает внешние XML-ресурсы, указанные Унифицированным Идентификатором Ресурса (URI), в C++."
type: docs
weight: 3500
...
| virtual [set_Credentials](./set_credentials/)(SharedPtr\<Net::ICredentials\>) | При переопределении в производном классе задает учетные данные, используемые для аутентификации веб‑запросов. |
