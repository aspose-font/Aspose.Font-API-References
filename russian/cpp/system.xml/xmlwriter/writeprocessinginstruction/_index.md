...
При переопределении в производном классе, выводит инструкцию обработки с пробелом между именем и текстом следующим образом: **<?name text?>**.
...
| текст | String | Текст, который следует включить в инструкцию обработки. |
## Примечания
