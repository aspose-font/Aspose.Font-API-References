---
title: "Метод System::Xml::XmlWriter::WriteChars"
linktitle: "WriteChars"
second_title: "Aspose.Font для C++"
description: "Метод System::Xml::XmlWriter::WriteChars. При переопределении в производном классе записывает текст буфер за буфером в C++."
type: docs
weight: 1500
url: /ru/cpp/system.xml/xmlwriter/writechars/
---
## XmlWriter::WriteChars method


При переопределении в производном классе, записывает текст по одному буферу за раз.
