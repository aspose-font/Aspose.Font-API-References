...
description: "Класс System::Xml::XmlNamespaceManager. Разрешает, добавляет и удаляет пространства имён в коллекцию и обеспечивает управление областью видимости этих пространств имён в C++."
type: docs
weight: 2300
...
| virtual [HasNamespace](./hasnamespace/)(String) | Возвращает значение, указывающее, определено ли пространство имён для указанного префикса в текущей добавленной области видимости. |
...
| virtual [RemoveNamespace](./removenamespace/)(String, String) | Удаляет указанный пространственный идентификатор для данного префикса. |
