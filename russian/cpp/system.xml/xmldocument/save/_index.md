...
| Параметр | Тип | Описание |
| --- | --- | --- |
| писатель | SharedPtr\<IO::TextWriter\> | TextWriter, в который вы хотите сохранить. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| w | SharedPtr\<XmlWriter\> | Это [XmlWriter](../../xmlwriter/), в который вы хотите сохранить. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| filename | String | Местоположение файла, в котором вы хотите сохранить документ. |
