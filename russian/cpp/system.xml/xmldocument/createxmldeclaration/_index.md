...
Примечание: Если [XmlDocument](../) сохраняется в объект TextWriter или в [XmlTextWriter](../../xmltextwriter/), значение этой кодировки отбрасывается. Вместо этого используется кодировка TextWriter или [XmlTextWriter](../../xmltextwriter/). Это гарантирует, что записанный XML можно будет прочитать обратно с правильной кодировкой.
## См. также
