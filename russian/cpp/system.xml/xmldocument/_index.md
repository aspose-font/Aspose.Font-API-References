...
| [get_NameTable](./get_nametable/)() | Возвращает [XmlNameTable](../xmlnametable/), связанную с этой реализацией. |
...
| virtual [GetElementById](./getelementbyid/)(String) | Возвращает [XmlElement](../xmlelement/) с указанным идентификатором. |
...
| virtual [GetElementsByTagName](./getelementsbytagname/)(String, String) | Возвращает [XmlNodeList](../xmlnodelist/), содержащий список всех дочерних элементов, которые соответствуют указанному [XmlDocument::get_LocalName](./get_localname/) и [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
...
| [set_PreserveWhitespace](./set_preservewhitespace/)(bool) | Устанавливает значение, указывающее, сохранять ли пробельные символы в содержимом элемента. |
...
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | Сохраняет всех дочерних элементов узла [XmlDocument](./) в указанный [XmlWriter](../xmlwriter/). |
