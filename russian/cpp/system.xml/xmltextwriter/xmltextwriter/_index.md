...
| encoding | const SharedPtr\<Text::Encoding\>\& | Кодировка для генерации. Если кодировка **nullptr**, поток записывается как UTF-8 и атрибут кодировки опускается в **ProcessingInstruction**. |
...
| encoding | const SharedPtr\<Text::Encoding\>\& | Кодировка для генерации. Если кодировка **nullptr**, файл записывается как UTF-8 и атрибут кодировки опускается в **ProcessingInstruction**. |
