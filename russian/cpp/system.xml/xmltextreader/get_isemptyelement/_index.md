---
title: "System::Xml::XmlTextReader::get_IsEmptyElement метод"
linktitle: "get_IsEmptyElement"
second_title: "Aspose.Font для C++"
description: "System::Xml::XmlTextReader::get_IsEmptyElement метод. Возвращает значение, указывающее, является ли текущий узел пустым элементом (например, <MyElement/>) в C++."
type: docs
weight: 1500
url: /ru/cpp/system.xml/xmltextreader/get_isemptyelement/
---
