---
title: "System::Xml::XmlTextReader::LookupNamespace метод"
linktitle: "LookupNamespace"
second_title: "Aspose.Font для C++"
description: "System::Xml::XmlTextReader::LookupNamespace метод. Разрешает префикс пространства имён в области текущего элемента в C++."
type: docs
weight: 3700
