...
description: "Класс System::Xml::XmlTextReader. Представляет читатель, который обеспечивает быстрый, некешированный, последовательный доступ к XML‑данным в C++."
type: docs
weight: 3900
...
| [GetNamespacesInScope](./getnamespacesinscope/)(XmlNamespaceScope) override | Возвращает коллекцию, содержащую все пространства имён, находящиеся в текущей области видимости. |
| [GetRemainder](./getremainder/)() | Возвращает остаток буферизованного XML. |
