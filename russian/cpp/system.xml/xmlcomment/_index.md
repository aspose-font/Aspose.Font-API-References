---
title: "System::Xml::XmlComment класс"
linktitle: "XmlComment"
second_title: "Aspose.Font для C++"
description: "System::Xml::XmlComment класс. Представляет содержимое XML‑комментария в C++."
type: docs
weight: 1100
...
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | Сохраняет всех дочерних узлов узла в указанный [XmlWriter](../xmlwriter/). Поскольку узлы комментариев не имеют дочерних элементов, этот метод не имеет эффекта. |
