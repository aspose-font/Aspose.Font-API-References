...
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | Сохраняет всех дочерних узлов узла в указанный [XmlWriter](../xmlwriter/). Узлы [XmlText](./) не имеют дочерних элементов, поэтому этот метод не оказывает влияния. |
