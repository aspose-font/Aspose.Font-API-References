...
description: "System::Xml::XmlAttributeCollection::idx_get метод. Возвращает атрибут с указанным локальным именем и URI пространства имён в C++."
type: docs
weight: 300
...
| namespaceURI | const String\& | URI пространства имён атрибута. |
