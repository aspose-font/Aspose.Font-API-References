...
description: "System::Xml::XmlNodeReader::ReadContentAsBinHex метод. Считывает содержимое и возвращает двоичные байты, декодированные из BinHex, в C++."
type: docs
weight: 3300
...
Читает содержимое и возвращает бинарные байты, декодированные из BinHex.
