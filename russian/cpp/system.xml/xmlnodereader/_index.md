...
description: "Класс System::Xml::XmlNodeReader. Представляет читатель, который обеспечивает быстрый, некешированный, только прямой доступ к XML-данным в XmlNode на C++."
type: docs
weight: 2800
...
| [get_CanReadBinaryContent](./get_canreadbinarycontent/)() override | Возвращает значение, указывающее, реализует ли [XmlNodeReader](./) методы чтения бинарного содержимого. |
