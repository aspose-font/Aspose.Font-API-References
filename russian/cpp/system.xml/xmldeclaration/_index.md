...
| [get_InnerText](./get_innertext/)() override | Возвращает конкатенированные значения [XmlDeclaration](./). |
...
| [set_InnerText](./set_innertext/)(String) override | Устанавливает конкатенированные значения [XmlDeclaration](./). |
