...
| --- | --- | --- |
| localName | String | Локальное имя атрибута для поиска. |
| namespaceURI | String | URI пространства имён атрибута для поиска. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| имя | String | Имя атрибута для поиска. Это квалифицированное имя. Оно сравнивается со значением **get_Name** соответствующего узла. |
