---
title: "System::Threading::ThreadPool класс"
linktitle: "ThreadPool"
second_title: "Aspose.Font для C++"
description: "System::Threading::ThreadPool класс. API пула потоков, позволяющий помещать задачи в очередь для обработки пулом рабочих потоков. Это статический тип без сервисов экземпляров. Вы никогда не должны создавать его экземпляры каким-либо способом в C++."
type: docs
weight: 1300
...
| static [JoinAllThreads](./joinallthreads/)() | Ожидает завершения всех принадлежащих потоков. Ждёт бесконечно. |
| [operator=](./operator=/)(const ThreadPool\&) | Копирование запрещено. |
| static [QueueUserWorkItem](./queueuserworkitem/)(WaitCallback) | Помещает элемент работы в очередь, который присутствует с обратным вызовом без параметров. |
| static [QueueUserWorkItem](./queueuserworkitem/)(WaitCallback, const System::SharedPtr\<System::Object\>\&) | Помещает элемент работы в очередь, который присутствует с обратным вызовом без параметров. |
