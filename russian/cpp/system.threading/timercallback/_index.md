...
description: "System::Threading::TimerCallback typedef. Функция обратного вызова, вызываемая таймером в C++."
type: docs
weight: 2400
url: /ru/cpp/system.threading/timercallback/
---
## TimerCallback typedef


Функция обратного вызова, вызываемая таймером.
