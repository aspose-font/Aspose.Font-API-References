---
title: "System::Threading::Monitor класс"
linktitle: "Monitor"
second_title: "Aspose.Font для C++"
description: "System::Threading::Monitor класс. Класс Monitor предоставляет механизм, который синхронизирует доступ к объектам в C++."
type: docs
weight: 800
...
Класс [Monitor](./) предоставляет механизм, который синхронизирует доступ к объектам.
...
| static [IsEntered](./isentered/)(const System::SharedPtr\<Object\>\&) | Определяет, удерживает ли текущий поток блокировку на указанном объекте. |
...
| static [Wait](./wait/)(const SharedPtr\<Object\>\&, int32_t, bool) | Снимает блокировку с объекта и блокирует текущий поток, пока он не получит блокировку снова. Если указанный интервал тайм‑аута истекает, поток переходит в очередь готовых. При необходимости выходит из домена синхронизации для синхронизированного контекста перед ожиданием и повторно входит в домен после него. Не реализовано. |
| static [Wait](./wait/)(const SharedPtr\<Object\>\&, TimeSpan, bool) | Снимает блокировку с объекта и блокирует текущий поток, пока он не получит блокировку снова. Если указанный интервал тайм‑аута истекает, поток переходит в очередь готовых. При необходимости выходит из домена синхронизации для синхронизированного контекста перед ожиданием и повторно входит в домен после него. Не реализовано. |
| static [Wait](./wait/)(const SharedPtr\<Object\>\&, int32_t) | Снимает блокировку с объекта и блокирует текущий поток, пока он не получит блокировку снова. Если указанный интервал тайм‑аута истекает, поток переходит в очередь готовых. Не реализовано. |
| static [Wait](./wait/)(const SharedPtr\<Object\>\&, TimeSpan) | Снимает блокировку с объекта и блокирует текущий поток, пока он не получит блокировку снова. Если указанный интервал тайм‑аута истекает, поток переходит в очередь готовых. Не реализовано. |
| static [Wait](./wait/)(const SharedPtr\<Object\>\&) | Снимает блокировку с объекта и блокирует текущий поток, пока он не получит блокировку снова. Не реализовано. |
## Примечания
