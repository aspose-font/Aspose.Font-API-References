...
description: "System::Threading::Monitor::Enter метод. Захватывает эксклюзивную блокировку на указанном объекте в C++."
type: docs
weight: 100
...
| --- | --- | --- |
| obj | const SharedPtr\<Object\>\& | Объект, на котором необходимо захватить монитор-блокировку. |
