...
| [Join](./join/)() | Ожидает завершения управляемого потока. При необходимости выполняет неограниченное ожидание. |
