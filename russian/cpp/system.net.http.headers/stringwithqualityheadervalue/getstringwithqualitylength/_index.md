...
description: "Метод System::Net::Http::Headers::StringWithQualityHeaderValue::GetStringWithQualityLength. Преобразует переданную строку, начиная с указанного индекса, в экземпляр класса StringWithQualityHeaderValue на C++."
type: docs
weight: 700
