---
title: "System::Net::Http::Headers::RangeConditionHeaderValue::RangeConditionHeaderValue конструктор"
linktitle: "RangeConditionHeaderValue"
second_title: "Aspose.Font для C++"
description: "System::Net::Http::Headers::RangeConditionHeaderValue::RangeConditionHeaderValue конструктор. Создаёт новый экземпляр в C++."
type: docs
weight: 100
url: /ru/cpp/system.net.http.headers/rangeconditionheadervalue/rangeconditionheadervalue/
---
...
| --- | --- | --- |
| дата | DateTimeOffset | Значение даты. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| entityTag | String | Строковое представление значения заголовка 'ETag'. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| entityTag | System::SharedPtr\<EntityTagHeaderValue\> | Значение заголовка 'ETag'. |
