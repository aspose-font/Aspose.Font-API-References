---
title: "System::Net::Http::Headers::ProductHeaderValue::ProductHeaderValue конструктор"
linktitle: "ProductHeaderValue"
second_title: "Aspose.Font для C++"
description: "System::Net::Http::Headers::ProductHeaderValue::ProductHeaderValue конструктор. Создаёт новый экземпляр в C++."
type: docs
weight: 100
url: /ru/cpp/system.net.http.headers/productheadervalue/productheadervalue/
---
...
| --- | --- | --- |
| имя | String | Имя токена продукта. |
...
| --- | --- | --- |
| имя | String | Имя токена продукта. |
| версия | String | Версия токена продукта. |
