...
| Метод | Описание |
| --- | --- |
| [Add](./add/)(String, System::SharedPtr\<Collections::Generic::IEnumerable\<String\>\>) | Проверяет новую пару имён‑значений и добавляет её в текущую коллекцию. |
...
| [SetOrRemoveParsedValue](./setorremoveparsedvalue/)(String, System::SharedPtr\<Object\>) | Получает заголовок по указанному имени и устанавливает или удаляет его значение. Значение заголовка будет удалено, когда параметр 'value' равен nullptr, иначе будет установлено разобранное значение. |
| [SetParsedValue](./setparsedvalue/)(String, System::SharedPtr\<Object\>) | Получает заголовок по указанному имени и устанавливает разобранное значение в заголовок. |
