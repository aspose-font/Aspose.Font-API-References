---
title: "System::Net::Http::Headers::ProductInfoHeaderValue::ProductInfoHeaderValue конструктор"
linktitle: "ProductInfoHeaderValue"
second_title: "Aspose.Font для C++"
description: "System::Net::Http::Headers::ProductInfoHeaderValue::ProductInfoHeaderValue конструктор. Создаёт новый экземпляр на C++."
type: docs
weight: 100
url: /ru/cpp/system.net.http.headers/productinfoheadervalue/productinfoheadervalue/
---
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| productName | String | Имя токена продукта. |
| productVersion | String | Версия токена продукта. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| product | System::SharedPtr\<ProductHeaderValue\> | Экземпляр класса ProductHeaderValue, используемый для инициализации нового экземпляра. |
