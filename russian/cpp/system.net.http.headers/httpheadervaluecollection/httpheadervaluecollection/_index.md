---
title: "System::Net::Http::Headers::HttpHeaderValueCollection::HttpHeaderValueCollection конструктор"
linktitle: "HttpHeaderValueCollection"
second_title: "Aspose.Font для C++"
description: "System::Net::Http::Headers::HttpHeaderValueCollection::HttpHeaderValueCollection конструктор. Создаёт новый экземпляр в C++."
type: docs
weight: 100
url: /ru/cpp/system.net.http.headers/httpheadervaluecollection/httpheadervaluecollection/
---
...
| хранилище | System::SharedPtr\<HttpHeaders\> | Коллекция HTTP-заголовков. |
...
| headerName | String | Имя заголовка. |
| хранилище | System::SharedPtr\<HttpHeaders\> | Коллекция HTTP-заголовков. |
| валидатор | Action\<System::SharedPtr\<HttpHeaderValueCollection\<T\>\>, T\> | Делегат, который используется для проверки добавленных элементов. |
