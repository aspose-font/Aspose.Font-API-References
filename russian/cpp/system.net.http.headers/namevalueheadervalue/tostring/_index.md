...
description: "Метод System::Net::Http::Headers::NameValueHeaderValue::ToString. Аналог метода C# Object.ToString(). Позволяет преобразовывать пользовательские объекты в строку в C++."
type: docs
weight: 700
...
| leadingSeparator | bool | Значение, указывающее, должен ли строковый разделитель добавляться перед первым элементом коллекции. |
