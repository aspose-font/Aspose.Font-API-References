...
description: "Метод System::Net::Http::Headers::NameValueHeaderValue::GetNameValueLength. Преобразует переданную строку, начиная с указанного индекса, в экземпляр класса NameValueHeaderValue в C++."
type: docs
weight: 900
