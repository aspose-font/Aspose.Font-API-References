...
description: "Метод System::ObjectExt::Equals. Замена вызовов C# Object.Equals, работающая для любого типа в C++. Перегрузка для строкового литерала с сравнением строк в C++."
type: docs
weight: 800
...
Замена вызовов C# [Object.Equals](../../object/equals/) работающая для любого типа в C++. Перегрузка для строкового литерала с сравнением строк.
...
Подстановка для вызовов C# [Object.Equals](../../object/equals/) работающих с любым типом в C++. Перегрузка для типов умных указателей.
...
Подстановка для вызовов C# [Object.Equals](../../object/equals/) работающих с любым типом в C++. Перегрузка для скалярных типов.
...
Подстановка для вызовов C# [Object.Equals](../../object/equals/) работающих с любым типом в C++. Перегрузка для структурных типов.
