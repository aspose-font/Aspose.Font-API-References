...
description: "Метод System::ObjectExt::CoalesceInternal. Реализация перевода оператора ''??'' для non-nullable‑типов. Перегрузка для случая, когда RT2 преобразуем к RT1 в C++."
type: docs
weight: 700
