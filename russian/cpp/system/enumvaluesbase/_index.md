---
title: "Класс System::EnumValuesBase"
linktitle: "EnumValuesBase"
second_title: "Aspose.Font для C++"
description: "Класс System::EnumValuesBase. Базовый класс для класса, представляющего метаинформацию типа перечисления в C++."
type: docs
weight: 2400
...
| static [Parse](./parse/)(const TypeInfo\&, const String\&, bool) | Возвращает объект, представляющий значение константы перечисления указанного типа перечисления с указанным именем. |
