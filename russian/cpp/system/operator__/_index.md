...
description: "Метод System::operator<<. Выводит строку в поток вывода, используя кодировку UTF-8 в C++."
type: docs
weight: 29200
...
| --- | --- | --- |
| os | std::ostream\& | Объект потока вывода (инстанцирование **basic_ostream** с **char**). |
| str | const String\& | Строка, которую нужно отправить в поток вывода. |

### ReturnValue

Поток вывода, в который была добавлена строка.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| os | std::wostream\& | Объект потока вывода (инстанцирование **basic_ostream** с **wchar_t**). |
| str | const String\& | Строка, которую нужно отправить в поток вывода. |
...
description: 'Метод System::operator>>. Получает строку из входного потока, используя кодировку UTF-8 в C++.'
тип: docs
weight: 35200
