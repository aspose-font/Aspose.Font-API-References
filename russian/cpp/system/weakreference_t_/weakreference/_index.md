...
description: "System::WeakReference< T >::WeakReference method. Конструктор по умолчанию в C++."
type: docs
weight: 100
url: /ru/cpp/system/weakreference_t_/weakreference/
---
...
| --- | --- | --- |
| data | const SmartPtr\<T\>\& | [Object](../../object/) для хранения. |
...
| --- | --- | --- |
| data | const SmartPtr\<T\>\& | [Object](../../object/) для хранения. |
| trackResurrection | bool | Игнорируется. |
