---
title: "Метод System::Console::Write"
linktitle: "Write"
second_title: "Aspose.Font для C++"
description: "Метод System::Console::Write. Выводит строковое представление значения bool в стандартный поток вывода в C++."
type: docs
weight: 1000
url: /ru/cpp/system/console/write/
---
...
Выводит указанное значение символа в стандартный поток вывода.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| buffer | const ArrayPtr\<char_t\>\& | Массив символов |
| индекс | int32_t | Индекс в массиве, с которого начинается диапазон вывода |
| count | int32_t | Количество элементов в диапазоне вывода |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | const Decimal\& | Значение для вывода |
...
Выводит строковое представление указанных аргументов, отформатированных согласно указанному формату, в стандартный поток вывода.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | const TypeInfo\& | Значение для вывода |
...
Выводит строковое представление значения двойной точности с плавающей запятой в стандартный поток вывода.
...
Выводит строковое представление значения одинарной точности с плавающей запятой в стандартный поток вывода.
...
Выводит строковое представление значения 32-битного целого числа в стандартный поток вывода.
...
Выводит строковое представление значения 64-битного целого числа в стандартный поток вывода.
...
Выводит строковое представление значения беззнакового 32-битного целого числа в стандартный поток вывода.
...
Выводит строковое представление значения беззнакового 64-битного целого числа в стандартный поток вывода.
