---
title: "Метод System::String::StartsWith"
linktitle: "StartsWith"
second_title: "Aspose.Font для C++"
description: "Метод System::String::StartsWith. Проверяет, начинается ли строка с указанной подстрокой в C++."
type: docs
weight: 4400
url: /ru/cpp/system/string/startswith/
---
...
| --- | --- | --- |
| значение | const String\& | Строка поиска. |

### ReturnValue

true, если строка начинается с указанной подстрокой, иначе false.
...
| культура | const SharedPtr\<System::Globalization::CultureInfo\>\& | Культура, используемая при выполнении сравнения строк. |
...
| --- | --- | --- |
| значение | const String\& | Строка поиска. |
| comparisonType | System::StringComparison | [Сравнение](../../comparison/) режим, см. [System::StringComparison](../../stringcomparison/) для деталей. |
