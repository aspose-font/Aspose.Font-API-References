...
Возвращает новый экземпляр класса [Decimal](../decimal/), представляющий значение, которое является суммой указанного значения и значения, представленного указанным объектом [Decimal](../decimal/).
...
| Параметр | Описание |
| --- | --- |
| T | [String](../string/) литеральный тип. |
