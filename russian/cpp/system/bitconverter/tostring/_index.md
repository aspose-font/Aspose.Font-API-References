...
description: "Метод System::BitConverter::ToString. Преобразует все значения указанного массива байтов в их шестнадцатеричное строковое представление. Регистр букв, используемых в шестнадцатеричной нотации, и разделитель, вставляемый между каждой парой соседних байтов, задаются соответствующими аргументами в C++."
type: docs
weight: 1200
...
| верхний регистр | bool | Указывает регистр букв, используемых в результирующем шестнадцатеричном представлении |
...
| --- | --- | --- |
| value | const ArrayPtr\<uint8_t\>\& | [Array](../../array/) содержащий байты для преобразования |
| startIndex | int | Индекс в указанном массиве, с которого начинается преобразование |
