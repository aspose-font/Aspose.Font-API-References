...
description: "System::DateTimeOffset::operator- метод. Возвращает экземпляр класса TimeSpan, представляющий интервал времени между значениями даты и времени, представленными текущим и указанным объектами в C++."
type: docs
weight: 3500
...
| --- | --- | --- |
| other | const DateTimeOffset\& | Экземпляр класса [DateTime](../../datetime/), отмечающий один конец вычисляемого интервала |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | TimeSpan | Интервал времени для вычитания |
