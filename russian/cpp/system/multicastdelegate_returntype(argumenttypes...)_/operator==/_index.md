...
description: "System::MulticastDelegate< ReturnType(ArgumentTypes...)>::operator== метод. Определяет, являются ли два экземпляра MulticastDelegate — текущий объект и указанный объект — равными в C++."
type: docs
weight: 1900
...
Определяет, равны ли два экземпляра MulticastDelegate — текущий объект и указанный объект.
...
| --- | --- | --- |
| другой | const MulticastDelegate\& | Объект MulticastDelegate для сравнения |

### ReturnValue

Истина, если оба объекта представляют одну и ту же коллекцию делегатов, иначе — ложь
...
Определяет, пуста ли коллекция делегатов.
...
Истина, если коллекция делегатов пуста, иначе — ложь
