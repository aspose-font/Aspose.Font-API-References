---
title: "System::TimeSpan::Parse метод"
linktitle: "Разбор"
second_title: "Aspose.Font для C++"
description: "System::TimeSpan::Parse метод. Преобразует строку в эквивалентный объект TimeSpan в C++."
type: docs
weight: 4200
url: /ru/cpp/system/timespan/parse/
---
...
Преобразует строку в эквивалентный объект [TimeSpan](../), используя указанный поставщик формата.
...
| --- | --- | --- |
| input | const String\& | Входная строка. |
| поставщик | const SharedPtr\<IFormatProvider\>\& | Поставщик формата, предоставляющий информацию о форматировании, специфичную для культуры. |
