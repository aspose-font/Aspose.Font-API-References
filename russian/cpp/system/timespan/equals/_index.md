---
title: "System::TimeSpan::Equals метод"
linktitle: "Equals"
second_title: "Aspose.Font для C++"
description: "System::TimeSpan::Equals метод. Определяет, равен ли временной интервал, представленный текущим объектом, временному интервалу, представленному указанным объектом, в C++."
type: docs
weight: 500
url: /ru/cpp/system/timespan/equals/
---
