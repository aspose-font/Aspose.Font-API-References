...
description: "Метод System::Nullable::operator&= . Применяет operator&=() к значению, представленному текущим объектом, используя указанное значение в качестве правого аргумента в C++."
type: docs
weight: 1100
