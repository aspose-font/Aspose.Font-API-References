---
title: "System::Nullable::Nullable конструктор"
linktitle: "Nullable"
second_title: "Aspose.Font для C++"
description: "System::Nullable::Nullable конструктор. Создаёт экземпляр, представляющий null-значение, в C++."
type: docs
weight: 100
...
Создаёт экземпляр, представляющий значение, которое представлено указанным объектом [Nullable](../). Указанный объект nullable может представлять значение другого типа, чем базовый тип создаваемого экземпляра, в этом случае представленное значение преобразуется к типу T.
