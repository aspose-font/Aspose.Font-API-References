...
description: "Метод System::operator*. Возвращает новый экземпляр класса Decimal, представляющий значение, полученное в результате умножения указанного значения и значения, представленного указанным объектом Decimal в C++."
type: docs
weight: 27500
...
Определяет, меньше ли указанное значение, чем значение, представленное указанным объектом [Nullable](../nullable/), применяя [operator<()](./) к этим значениям.
...
Истина, если первый сравниваемый меньше второго сравниваемого, иначе — false
...
Определяет, больше ли указанное значение, чем значение, представленное указанным объектом [Nullable](../nullable/), применяя [operator>()](./) к этим значениям.
...
Истина, если первый сравниваемый больше второго сравниваемого, иначе — false
