...
description: "System::TimeZoneInfo::AdjustmentRule::CreateAdjustmentRule метод. Создаёт экземпляр класса AdjustmentRule, представляющий правило корректировки времени, описанное заданными параметрами, в C++."
type: docs
weight: 1000
...
Создаёт экземпляр класса [AdjustmentRule](../), представляющего правило корректировки времени, описанное заданными параметрами.
...
| daylight_transition_start | const TransitionTime\& | Информация о переходе от летнего времени к стандартному времени. |
| daylight_transition_end | const TransitionTime\& | Информация о переходе от стандартного времени к летнему времени. |
| base_utc_offset_delta | TimeSpan | Разница от стандартного смещения UTC. |
