---
title: "System::ExplicitCast метод"
linktitle: "ExplicitCast"
second_title: "Aspose.Font для C++"
description: "System::ExplicitCast метод. Приводит исходный тип к типу результата с помощью явного приведения. Используется, когда исходный и результирующий типы одинаковы в C++."
type: docs
weight: 18600
...
Преобразует тип источника в тип результата с помощью явного приведения. Используется, когда и источник, и результат являются умными указателями (без явного [SmartPtr<...>](../smartptr/) в типе результата).
...
Преобразует тип источника в тип результата с помощью явного приведения. Используется, когда и источник, и результат являются умными указателями (с явным [SmartPtr<...>](../smartptr/) в типе результата).
