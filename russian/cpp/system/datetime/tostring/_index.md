---
title: "Метод System::DateTime::ToString"
linktitle: "ToString"
second_title: "Aspose.Font для C++"
description: "Метод System::DateTime::ToString. Возвращает строковое представление значения даты и времени, представленного текущим объектом, используя правила форматирования, определённые текущей культурой в C++."
type: docs
weight: 5200
