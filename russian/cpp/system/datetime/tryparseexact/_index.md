---
title: "Метод System::DateTime::TryParseExact"
...
| provider | const SharedPtr\<IFormatProvider\>\& | Объект [IFormatProvider](../../iformatprovider/), предоставляющий сведения о форматах, специфичных для культуры. |
| styles | Globalization::DateTimeStyles | Битовая комбинация значений перечисления, предоставляющая дополнительную информацию о **s**, о стилевых элементах, которые могут присутствовать в **s**, или о преобразовании из **s** в объект [DateTime](../). |
| result | DateTime\& | Выходной аргумент, который, если преобразование успешно, содержит результат преобразования. |
...
Преобразует указанное строковое представление значения даты и времени в эквивалентный объект [DateTime](../), используя указанный формат, специфичную для культуры информацию о формате и стиль. Формат строкового представления должен точно соответствовать указанному формату.
