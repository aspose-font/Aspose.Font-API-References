...
description: "Метод System::Uri::Compare. Сравнивает указанные объекты Uri, используя заданные правила сравнения, в C++."
type: docs
weight: 3500
...
| --- | --- | --- |
| uri1 | const SharedPtr\<Uri\>\& | Первый операнд |
| uri2 | const SharedPtr\<Uri\>\& | Второй операнд |
