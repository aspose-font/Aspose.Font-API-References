---
title: "System::Func::Func конструктор"
linktitle: "Func"
second_title: "Aspose.Font для C++"
description: "System::Func::Func конструктор. Конструктор по умолчанию, создающий null-Func в C++."
type: docs
weight: 100
url: /ru/cpp/system/func/func/
---
...
Конструктор, который создает объект [Func](../) и присваивает ему значение (либо реальный обратный вызов, либо nullptr).
