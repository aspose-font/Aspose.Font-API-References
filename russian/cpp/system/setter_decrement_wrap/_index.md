...
description: "метод System::setter_decrement_wrap. Переводчик переводит префиксные операции декремента C#''s, направленные на свойство экземпляра, у которого определены сеттер и геттер, в вызов этой функции (перегрузка для const getter) в C++."
type: docs
weight: 37200
