...
description: "System::PrintTo method. Записывает значение, представленное указанным объектом, в указанный поток вывода в C++."
type: docs
weight: 35400
...
| --- | --- | --- |
| d | const Decimal\& | Объект [Decimal](../decimal/), который будет выведен в поток |
| os | ::std::ostream * | Поток, в который будет выведен указанный объект |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | const System::String\& | для вывода. |
