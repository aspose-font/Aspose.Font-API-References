...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | const std::vector\<Q\>\& | std::vector, из которого копировать значения |
...
Создает объект [Array](../) и заполняет его значениями из указанного списка инициализации, содержащего элементы типа bool.
...
Создает объект [Array](../) и заполняет его значениями из указанного списка инициализации, содержащего элементы типа **[UnderlyingType](../underlyingtype/)**.
...
Создает объект [Array](../) и заполняет его значениями, перемещенными из объекта std::vector, тип значений которого совпадает с **T**, но отличается от **[UnderlyingType](../underlyingtype/)**.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | std::vector\<Q\>\&& | std::vector, из которого копировать значения |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | vector_t\&& | std::vector, элементы которого получаются массивом |
