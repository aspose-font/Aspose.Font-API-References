---
title: "Метод System::Array::ConvertAll"
linktitle: "ConvertAll"
second_title: "Aspose.Font для C++"
description: "Метод System::Array::ConvertAll. Создаёт новый объект Array и заполняет его элементами указанного массива, преобразованными в тип OutputType с помощью указанного делегата‑конвертера в C++."
type: docs
weight: 4800
