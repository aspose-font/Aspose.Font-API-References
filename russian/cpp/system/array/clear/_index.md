---
title: "System::Array::Clear метод"
linktitle: "Clear"
second_title: "Aspose.Font для C++"
description: "System::Array::Clear метод. Не поддерживается, потому что массив, представляемый текущим объектом, является только для чтения в C++."
type: docs
weight: 600
...
Не поддерживается, поскольку массив, представляемый текущим объектом, доступен только для чтения.
