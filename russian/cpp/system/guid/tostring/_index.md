---
title: "Метод System::Guid::ToString"
linktitle: "ToString"
second_title: "Aspose.Font для C++"
description: "Метод System::Guid::ToString. Преобразует GUID, представленный текущим объектом, в его строковое представление в C++."
type: docs
weight: 1000
url: /ru/cpp/system/guid/tostring/
---
...
| --- | --- | --- |
| формат | const String\& | Формат для использования |
...
| --- | --- | --- |
| формат | const String\& | Формат для использования |
| культура | const SharedPtr\<Globalization::CultureInfo\>\& | Культура для использования |
