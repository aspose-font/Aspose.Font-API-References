...
description: "Конструктор System::Guid::Guid. Создаёт объект, представляющий GUID, состоящий из нулей, в C++."
type: docs
weight: 100
...
Создаёт объект, представляющий GUID, заданный массивом беззнаковых 8‑битных целочисленных значений.
...
Создаёт объект, представляющий GUID, заданный строкой.
...
Создаёт объект, представляющий GUID, заданный представлением массива беззнаковых 8‑битных целочисленных значений.
...
Создаёт экземпляр класса [Guid](../) из указанных беззнаковых целых и байтов.
