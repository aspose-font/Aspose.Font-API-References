...
description: "Метод System::setter_post_decrement_wrap. Переводчик переводит постдекрементные выражения C#, направленные на свойство экземпляра, у которого определены сеттер и геттер, в вызов этой функции (перегрузка для const‑геттера) в C++."
type: docs
weight: 37700
...
Переводчик переводит постдекрементные выражения C#, направленные на свойство экземпляра, у которого определены сеттер и геттер, в вызов этой функции (перегрузка для const‑геттера).
...
Переводчик переводит постдекрементные выражения C#, направленные на свойство экземпляра, у которого определены сеттер и геттер, в вызов этой функции (перегрузка для non‑const геттера).
