...
| [get_IetfLanguageTag](./get_ietflanguagetag/)() const | Получает имя RFC 4646 для языка. |
...
| virtual [get_OptionalCalendars](./get_optionalcalendars/)() const | Список календарей, которые можно использовать с этой культурой. |
...
| virtual [get_ThreeLetterISOLanguageName](./get_threeletterisolanguagename/)() const | Получает трехбуквенный код языка ISO 639-2. |
| virtual [get_ThreeLetterWindowsLanguageName](./get_threeletterwindowslanguagename/)() const | Получает трехбуквенный код языка, определенный в API [Windows](../../system.windows/). |
...
| static [GetCultures](./getcultures/)(CultureTypes) | Получает культуры, соответствующие указанным типам. |
...
| static [ReadOnly](./readonly/)(const CultureInfoPtr\&) | Возвращает только‑читаемую версию культуры. |
