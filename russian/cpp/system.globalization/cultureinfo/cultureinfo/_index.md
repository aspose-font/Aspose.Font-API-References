...
description: "System::Globalization::CultureInfo::CultureInfo конструктор. Конструктор на C++."
type: docs
weight: 100
...
| --- | --- | --- |
| имя | const String\& | Название культуры. |
| use_user_override | bool | Если true, используйте пользовательские значения вместо системных; ПАРАМЕТР ИГНОРИРУЕТСЯ. |
