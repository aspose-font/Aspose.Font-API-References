---
title: "System::Globalization::CompareInfo::IndexOf метод"
linktitle: "IndexOf"
second_title: "Aspose.Font для C++"
description: "System::Globalization::CompareInfo::IndexOf метод. Ищет указанный символ в C++."
type: docs
weight: 900
url: /ru/cpp/system.globalization/compareinfo/indexof/
---
## CompareInfo::IndexOf(const String\&, char16_t) const method


Ищет указанный символ.
...
| --- | --- | --- |
| источник | const String\& | Строка источника. |
| значение | char16_t | Символ. |

### ReturnValue

Индекс искомого значения в исходной строке или -1, если не найдено.
...
Ищет указанный символ. Поддерживается только режим Ordinal.
...
| источник | const String\& | Строка источника. |
| значение | char16_t | Символ. |
| опции | CompareOptions | Параметры поиска. |
...
| источник | const String\& | Строка источника. |
| значение | char16_t | Символ. |
| start_index | int | Индекс начала поиска в исходной строке. |
...
| --- | --- | --- |
| источник | const String\& | Строка источника. |
| значение | const String\& | Значение для поиска. |
...
Ищет подстроку. Поддерживается только режим Ordinal.
