---
title: "System::Globalization::CompareInfo::GetHashCode метод"
linktitle: "GetHashCode"
second_title: "Aspose.Font для C++"
description: "System::Globalization::CompareInfo::GetHashCode метод. Аналог метода C# Object.GetHashCode(). Позволяет хешировать пользовательские объекты в C++."
type: docs
weight: 700
...
| --- | --- | --- |
| значение | const String\& | Входная строка. |
