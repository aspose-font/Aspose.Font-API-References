...
| [get_AutoReset](./get_autoreset/)() const | Проверяет, находится ли таймер в режиме авто‑сброса. |
...
| [set_AutoReset](./set_autoreset/)(bool) | Устанавливает таймер в режим авто‑сброса или отключает его. |
