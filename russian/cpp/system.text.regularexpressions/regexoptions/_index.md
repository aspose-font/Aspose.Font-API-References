...
| --- | --- | --- |
| Нет | 0 | Поведение по умолчанию. |
| Compiled | 1 | Компилировать регулярное выражение для повышения производительности. Выполняется по умолчанию. |
| CultureInvariant | 2 | Использовать сопоставление, независимое от культуры. Игнорируется. |
| ECMAScript | 4 | Используйте синтаксис ECMAScript. Игнорируется. |
