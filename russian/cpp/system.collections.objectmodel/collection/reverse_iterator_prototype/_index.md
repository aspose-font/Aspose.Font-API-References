---
title: "Класс System::Collections::ObjectModel::Collection::reverse_iterator_prototype"
linktitle: "reverse_iterator_prototype"
second_title: "Aspose.Font для C++"
description: "Класс System::Collections::ObjectModel::Collection::reverse_iterator_prototype. Итерация элементов последовательного контейнера в обратном порядке в C++."
type: docs
weight: 2700
url: /ru/cpp/system.collections.objectmodel/collection/reverse_iterator_prototype/
---
## reverse_iterator_prototype class


Итерирует элементы последовательного контейнера в обратном порядке.
