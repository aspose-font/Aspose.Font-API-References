...
| static [GetCurrentMethod](./getcurrentmethod/)(const String\&) | Этот метод позволяет получить текущее имя метода. Переводчик автоматически подставляет ASPOSE_CURRENT_FUNCTION в качестве параметра. |
