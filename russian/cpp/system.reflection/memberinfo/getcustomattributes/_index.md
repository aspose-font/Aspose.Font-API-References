---
title: "System::Reflection::MemberInfo::GetCustomAttributes метод"
linktitle: "GetCustomAttributes"
second_title: "Aspose.Font для C++"
description: "System::Reflection::MemberInfo::GetCustomAttributes метод. Возвращает массив, содержащий объекты, представляющие все пользовательские атрибуты, применённые к типу, представляемому текущим объектом в C++."
type: docs
weight: 700
...
Возвращает массив, содержащий объекты, представляющие все пользовательские атрибуты, применённые к типу, представленному текущим объектом.
