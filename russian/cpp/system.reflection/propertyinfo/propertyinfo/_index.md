...
Создаёт информацию о свойстве типа int64_t из класса с const‑геттером.
...
Создаёт информацию о свойстве [Decimal](../../../system/decimal/) из класса с константным геттером.
