---
title: "System::Net::IPEndPoint::IPEndPoint конструктор"
linktitle: "IPEndPoint"
second_title: "Aspose.Font для C++"
description: "System::Net::IPEndPoint::IPEndPoint конструктор. Создаёт новый экземпляр в C++."
type: docs
weight: 100
url: /ru/cpp/system.net/ipendpoint/ipendpoint/
---
...
| --- | --- | --- |
| address | int64_t | IP-адрес хоста. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| address | System::SharedPtr\<IPAddress\> | IP-адрес хоста. |
| port | int32_t | Номер порта. |
