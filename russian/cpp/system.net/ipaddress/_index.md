...
| static [IsLoopback](./isloopback/)(System::SharedPtr\<IPAddress\>) | Возвращает значение, указывающее, является ли указанный адрес адресом обратной связи (loopback). |
| [MapToIPv4](./maptoipv4/)() | Отображает адрес в IPv4‑адрес. |
| [MapToIPv6](./maptoipv6/)() | Отображает адрес на IPv6‑адрес. |
...
| static [IPv6Any](./ipv6any/) | IPv6‑адрес, указывающий, что сервер должен прослушивать все сетевые интерфейсы. |
| static [IPv6Loopback](./ipv6loopback/) | IPv6‑адрес обратной связи. |
| static [IPv6None](./ipv6none/) | IPv6‑адрес, указывающий, что сервер не должен прослушивать ни один сетевой интерфейс. |
| static [Loopback](./loopback/) | IPv4‑адрес обратной связи. |
| static [None](./none/) | IPv4‑адрес, указывающий, что сервер не должен прослушивать ни один сетевой интерфейс. |
## Typedefs
