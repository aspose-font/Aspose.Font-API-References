---
title: "System::Net::SocketAddress класс"
...
| [idx_get](./idx_get/)(int32_t) | Получает значение внутреннего буфера по указанному индексу. |
| [idx_set](./idx_set/)(int32_t, uint8_t) | Устанавливает значение внутреннего буфера по указанному индексу. |
