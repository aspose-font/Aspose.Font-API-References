---
title: "System::Net::WebProxy::WebProxy конструктор"
linktitle: "WebProxy"
second_title: "Aspose.Font для C++"
description: "System::Net::WebProxy::WebProxy конструктор. Создаёт новый экземпляр в C++."
type: docs
weight: 100
...
| BypassOnLocal | bool | Значение, указывающее, должен ли прокси‑сервер использоваться для локальных адресов. |
| BypassList | System::ArrayPtr\<String\> | Список адресов, которые не используют прокси‑сервер. |
| Credentials | System::SharedPtr\<ICredentials\> | Учётные данные, которые отправляются прокси‑серверу для аутентификации. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| Address | System::SharedPtr\<Uri\> | Адрес прокси‑сервера. |
