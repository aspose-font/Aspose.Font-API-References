---
title: "System::Net::NetworkCredential::GetCredential метод"
linktitle: "GetCredential"
second_title: "Aspose.Font для C++"
description: "System::Net::NetworkCredential::GetCredential метод. Возвращает учетные данные для указанного имени хоста, порта и типа аутентификации в C++."
type: docs
weight: 500
url: /ru/cpp/system.net/networkcredential/getcredential/
---
