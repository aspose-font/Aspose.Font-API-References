...
| Метод | Описание |
| --- | --- |
| [Enumerator](./enumerator/)(const ThisPtr\&) | Создаёт перечислитель, перебирающий конкретный список. |
## См. также
