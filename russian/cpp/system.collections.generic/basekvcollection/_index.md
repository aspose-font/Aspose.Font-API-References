...
| [SetTemplateWeakPtr](./settemplateweakptr/)(uint32_t) override | Обеспечивает компиляцию, но на самом деле ничего не делает, поскольку эта структура не владеет данными. |
