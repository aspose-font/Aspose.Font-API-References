...
description: "System::Collections::Generic::EnumeratorWrapperIterator класс. Итератор, который оборачивает предварительно созданный перечислитель и перенаправляет все вызовы к нему в C++."
type: docs
weight: 1500
...
| [IncrementIterator](./incrementiterator/)() override | Перемещает итератор на шаг вперёд. Должен обновлять m_is_end и m_pointer. |
