...
description: "System::Collections::Generic::Queue класс. Прямое объявление класса Queue в C++."
type: docs
weight: 3600
...
| virtual [Contains](./contains/)(const T\&) const | Проверяет, содержит ли очередь определённый элемент, используя оператор == для сравнения элементов. |
