...
description: "System::Collections::Generic::SortedSet класс. Предварительное объявление класса SortedSet в C++."
type: docs
weight: 4400
...
Предварительное объявление класса [SortedSet](./).
...
| [SortedSet](./sortedset/)(const SharedPtr\<IEnumerable\<T\>\>\&) | Создаёт [SortedSet](./) на основе перечислимых значений. |
## Typedefs
