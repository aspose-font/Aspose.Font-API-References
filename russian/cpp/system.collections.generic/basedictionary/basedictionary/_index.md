---
title: "Конструктор System::Collections::Generic::BaseDictionary::BaseDictionary"
linktitle: "BaseDictionary"
second_title: "Aspose.Font для C++"
description: "Конструктор System::Collections::Generic::BaseDictionary::BaseDictionary. Создаёт пустую структуру данных в C++."
type: docs
weight: 100
url: /ru/cpp/system.collections.generic/basedictionary/basedictionary/
---
...
| --- | --- | --- |
| src | BaseType * | [Object](../../../system/object/) для копирования данных из. |
...
| Параметр | Описание |
| --- | --- |
| Аргументы | Типы аргументов конструктора map. |

| Параметр | Тип | Описание |
| --- | --- | --- |
| src | BaseType * | [Object](../../../system/object/) для копирования данных из. |
| args | const Args\&... | Аргументы, передаваемые конструктору базового map. |
...
Перенаправляющий конструктор, передающий аргументы в конструктор базовой карты.
...
| Параметр | Описание |
| --- | --- |
| Аргументы | Типы аргументов, передаваемых в map. |

| Параметр | Тип | Описание |
| --- | --- | --- |
| args | int | Аргументы, передаваемые в базовый map. |
