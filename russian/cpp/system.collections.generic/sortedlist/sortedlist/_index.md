---
title: "Конструктор System::Collections::Generic::SortedList::SortedList"
linktitle: "SortedList"
second_title: "Aspose.Font для C++"
description: "Конструктор System::Collections::Generic::SortedList::SortedList. Создаёт пустой список в C++."
type: docs
weight: 100
url: /ru/cpp/system.collections.generic/sortedlist/sortedlist/
---
...
| --- | --- | --- |
| map | const map_t\& | Map, из которого копировать данные. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| comparer | const SharedPtr\<IComparer\<TKey\>\>\& | [Comparer](../../comparer/) для использования. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| src | const SharedPtr\<IDictionary\<TKey, TValue\>\>\& | [Dictionary](../../dictionary/) для копирования данных из. |
