---
title: "Метод System::Collections::Generic::DictionaryPtr::operator[] method"
linktitle: "operator[]"
second_title: "Aspose.Font для C++"
description: "Метод System::Collections::Generic::DictionaryPtr::operator[] method. Оператор доступа в C++."
type: docs
weight: 200
url: /ru/cpp/system.collections.generic/dictionaryptr/operator[]/
---
...
| --- | --- | --- |
| key | const T\& | Ключ [Dictionary](../../dictionary/). |
...
| Параметр | Описание |
| --- | --- |
| X | Тип исходного ключа. |

| Параметр | Тип | Описание |
| --- | --- | --- |
| key | const X\& | Ключ [Dictionary](../../dictionary/). |
