...
description: "System::Collections::Generic::LinkedList::Enumerator::get_Current method. Получает текущий элемент в C++."
type: docs
weight: 200
...
Элемент, на который указывает перечислитель.
