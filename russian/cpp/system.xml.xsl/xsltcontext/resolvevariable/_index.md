---
title: "System::Xml::Xsl::XsltContext::ResolveVariable метод"
linktitle: "ResolveVariable"
second_title: "Aspose.Font для C++"
description: "System::Xml::Xsl::XsltContext::ResolveVariable метод. При переопределении в производном классе разрешает ссылку на переменную и возвращает IXsltContextVariable, представляющий переменную в C++."
type: docs
weight: 500
