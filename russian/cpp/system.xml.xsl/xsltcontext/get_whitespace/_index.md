---
title: "System::Xml::Xsl::XsltContext::get_Whitespace метод"
linktitle: "get_Whitespace"
second_title: "Aspose.Font для C++"
description: "System::Xml::Xsl::XsltContext::get_Whitespace метод. При переопределении в производном классе получает значение, указывающее, следует ли включать узлы пробельных символов в вывод в C++."
type: docs
weight: 200
