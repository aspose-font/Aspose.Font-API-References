...
| Метод | Описание |
| --- | --- |
| virtual [CompareDocument](./comparedocument/)(String, String) | При переопределении в производном классе сравнивает базовые Uniform Resource Identifiers (URI) двух документов в зависимости от порядка, в котором документы были загружены процессором XSLT (то есть классом [XslTransform](../xsltransform/)). |
