...
description: "System::Xml::Xsl::XslTransform класс. Преобразует XML-данные, используя таблицу стилей Extensible Stylesheet Language for Transformations (XSLT) в C++."
type: docs
weight: 700
