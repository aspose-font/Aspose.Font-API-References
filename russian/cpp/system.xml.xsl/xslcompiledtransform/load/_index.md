...
Компилирует XSLT‑таблицу стилей, содержащуюся в [XmlReader](../../../system.xml/xmlreader/). [XmlResolver](../../../system.xml/xmlresolver/) разрешает любые элементы **import** или **include** XSLT, а настройки XSLT определяют разрешения для таблицы стилей.
...
Загружает и компилирует XSLT‑таблицу стилей, указанную в URI. [XmlResolver](../../../system.xml/xmlresolver/) разрешает любые элементы **import** или **include** XSLT, а настройки XSLT определяют разрешения для таблицы стилей.
...
| stylesheetUri | const String\& | URI таблицы стилей. |
| settings | const SharedPtr\<XsltSettings\>\& | Настройки [XsltSettings](../../xsltsettings/), применяемые к таблице стилей. Если значение **nullptr**, применяется настройка [XsltSettings::get_Default](../../xsltsettings/get_default/). |
| stylesheetResolver | const SharedPtr\<XmlResolver\>\& | Объект [XmlResolver](../../../system.xml/xmlresolver/), используемый для разрешения URI таблицы стилей и любых таблиц стилей, указанных в элементах XSLT **import** и **include**. |
