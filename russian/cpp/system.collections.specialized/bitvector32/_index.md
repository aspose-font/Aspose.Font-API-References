...
description: "System::Collections::Specialized::BitVector32 класс. Предоставляет простой лёгкий битовый вектор с простым целочисленным или Boolean доступом к 32‑битному хранилищу в C++."
type: docs
weight: 100
...
Предоставляет простой лёгкий битовый вектор с простым целочисленным или [Boolean](../../system/boolean/) доступом к 32‑битному хранилищу.
