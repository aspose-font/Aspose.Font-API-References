...
description: "System::Resources::ResourceManager::GetString method. Получает строковый ресурс в C++."
type: docs
weight: 300
url: /ru/cpp/system.resources/resourcemanager/getstring/
---
## ResourceManager::GetString(String) method


Получает строковый ресурс.
...
| --- | --- | --- |
| имя | String | Имя ресурса. |
| культура | SharedPtr\<System::Globalization::CultureInfo\> | Культура, используемая при поиске ресурсов и декодировании. |
