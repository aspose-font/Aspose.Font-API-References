---
title: "Метод System::Security::Cryptography::ECDsa::Create"
linktitle: "Create"
second_title: "Aspose.Font для C++"
description: "Метод System::Security::Cryptography::ECDsa::Create. Создаёт реализацию алгоритма ECDSA по умолчанию в C++."
type: docs
weight: 1100
...
Создаёт реализацию алгоритма ECDSA по умолчанию с вновь созданным ключом для указанной кривой.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| algorithm | const String\& | Имя алгоритма. |
