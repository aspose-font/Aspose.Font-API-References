...
description: "System::Security::Cryptography::operator<< method. Вставляет данные в поток, используя кодировку UTF-8 в C++."
type: docs
weight: 6600
url: /ru/cpp/system.security.cryptography/operator__/
---
...
| name | const HashAlgorithmName\& | [Data](../../system.data/) для вставки. |
