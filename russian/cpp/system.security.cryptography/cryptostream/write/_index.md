---
title: "Метод System::Security::Cryptography::CryptoStream::Write"
linktitle: "Write"
second_title: "Aspose.Font для C++"
description: "Метод System::Security::Cryptography::CryptoStream::Write. Записывает данные в поток в C++."
type: docs
weight: 1400
url: /ru/cpp/system.security.cryptography/cryptostream/write/
---
...
| --- | --- | --- |
| buffer | const ArrayPtr\<uint8_t\>\& | Исходный буфер данных. |
| смещение | int32_t | Смещение в исходном буфере. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| buffer | const System::Details::ArrayView\<uint8_t\>\& | Исходный буфер данных. |
| смещение | int32_t | Смещение в исходном буфере. |
| count | int32_t | Количество байтов для записи. |
