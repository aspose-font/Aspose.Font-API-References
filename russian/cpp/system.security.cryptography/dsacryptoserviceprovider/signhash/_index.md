...
description: "System::Security::Cryptography::DSACryptoServiceProvider::SignHash method. Вычисляет подпись указанного входного значения в C++."
type: docs
weight: 1600
...
| --- | --- | --- |
| rgb_hash | const ByteArrayPtr\& | Хеш-значение данных, которые необходимо подписать. |
