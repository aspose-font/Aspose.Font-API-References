---
title: "Метод System::Security::Cryptography::RSACryptoServiceProvider::Decrypt"
linktitle: "Decrypt"
second_title: "Aspose.Font для C++"
description: "Метод System::Security::Cryptography::RSACryptoServiceProvider::Decrypt. Расшифровывает входные данные, используя указанный режим заполнения, в C++."
type: docs
weight: 200
...
| --- | --- | --- |
| data | ByteArrayPtr | [Byte](../../../system/byte/) массив для расшифровки. |
