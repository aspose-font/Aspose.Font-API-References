...
description: "System::Security::Cryptography::DSA::Create method. Создает реализацию алгоритма DSA по умолчанию в C++."
type: docs
weight: 900
...
| --- | --- | --- |
| parameters | const DSAParameters\& | Параметры алгоритма [DSA](../). |
