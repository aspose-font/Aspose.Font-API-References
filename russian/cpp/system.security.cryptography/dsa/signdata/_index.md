...
description: "System::Security::Cryptography::DSA::SignData method. Вычисляет хеш-значение указанного массива данных с использованием указанного хеш-алгоритма и подписывает результат в C++."
type: docs
weight: 500
