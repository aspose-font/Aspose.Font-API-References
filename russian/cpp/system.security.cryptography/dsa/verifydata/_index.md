...
description: "Метод System::Security::Cryptography::DSA::VerifyData. Проверяет, что подпись указанных данных действительна в C++."
type: docs
weight: 700
...
| signature | const ByteArrayPtr\& | Данные подписи. |
