---
title: "System::Security::Cryptography::ECDsaBotan::ECDsaBotan конструктор"
linktitle: "ECDsaBotan"
second_title: "Aspose.Font для C++"
description: "System::Security::Cryptography::ECDsaBotan::ECDsaBotan конструктор. Конструктор. Использует параметры по умолчанию в C++."
type: docs
weight: 100
url: /ru/cpp/system.security.cryptography/ecdsabotan/ecdsabotan/
---
