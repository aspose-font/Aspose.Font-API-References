...
description: "System::Security::Cryptography::RC2Managed::CreateDecryptor метод. Создаёт объект дешифратора с параметрами, определёнными объектом алгоритма в C++."
type: docs
weight: 100
