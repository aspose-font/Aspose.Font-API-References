---
title: "System::Net::Http::HttpResponseMessage класс"
...
| [get_ReasonPhrase](./get_reasonphrase/)() const | Получает Reason-Phrase, который серверы отправляют вместе с кодом состояния. |
...
| [set_ReasonPhrase](./set_reasonphrase/)(String) | Устанавливает Reason-Phrase, который серверы отправляют вместе с кодом состояния. |
