...
| [get_MaxResponseContentBufferSize](./get_maxresponsecontentbuffersize/)() | Получает максимальное количество байт содержимого ответа. |
...
| [set_MaxResponseContentBufferSize](./set_maxresponsecontentbuffersize/)(int64_t) | Устанавливает максимальное количество байт содержимого ответа. |
| [set_Timeout](./set_timeout/)(TimeSpan) | Устанавливает интервал времени ожидания до истечения тайм‑аута запроса. |
## См. также
