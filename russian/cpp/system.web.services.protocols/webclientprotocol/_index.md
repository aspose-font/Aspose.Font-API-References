...
| [get_UseDefaultCredentials](./get_usedefaultcredentials/)() | Получает значение, указывающее, равно ли свойство 'Credential' свойству 'DefaultCredentials'. |
...
| [set_Timeout](./set_timeout/)(int32_t) | Устанавливает интервал времени ожидания до истечения тайм‑аута запроса. |
...
| [set_UseDefaultCredentials](./set_usedefaultcredentials/)(bool) | Устанавливает значение, указывающее, равно ли свойство 'Credential' свойству 'DefaultCredentials'. |
## См. также
