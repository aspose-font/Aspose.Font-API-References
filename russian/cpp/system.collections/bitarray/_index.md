...
| [Or](./or/)(const BitArrayPtr\&) | Вычисляет побитовое 'or' между двумя BitSet. |
...
| [SetAll](./setall/)(bool) | Устанавливает все элементы в конкретное значение. |
| [SetTemplateWeakPtr](./settemplateweakptr/)(uint32_t) override | Формальная реализация механизма слабых шаблонных аргументов; не применима к этому классу. |
