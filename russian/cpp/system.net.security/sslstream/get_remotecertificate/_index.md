...
description: "System::Net::Security::SslStream::get_RemoteCertificate метод. Возвращает сертификат, используемый для аутентификации удалённого конечного узла в C++."
type: docs
weight: 2900
