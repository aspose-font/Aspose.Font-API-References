...
description: "System::Net::Security::SslStream::Write method. Записывает указанный массив байтов в поток в C++."
type: docs
weight: 3800
url: /ru/cpp/system.net.security/sslstream/write/
---
...
| --- | --- | --- |
| buffer | const ArrayPtr\<uint8_t\>\& | Массив байтов для записи. |
