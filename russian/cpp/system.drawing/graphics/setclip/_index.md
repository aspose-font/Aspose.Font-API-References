---
title: "System::Drawing::Graphics::SetClip метод"
linktitle: "SetClip"
second_title: "Aspose.Font для C++"
description: "System::Drawing::Graphics::SetClip метод. Устанавливает область отсечения поверхности рисования, представленной текущим объектом Graphics, в результат указанной операции, которая объединяет текущую область отсечения и область, заданную графическим путем, в C++."
type: docs
weight: 8600
...
Устанавливает область отсечения поверхности рисования, представленной текущим объектом [Graphics](../), в результат указанной операции, которая объединяет текущую область отсечения и область, заданную графическим путем.
