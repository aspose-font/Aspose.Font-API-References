---
title: "Метод System::Drawing::Graphics::DrawEllipse"
linktitle: "DrawEllipse"
second_title: "Aspose.Font для C++"
description: "Метод System::Drawing::Graphics::DrawEllipse. Рисует указанный эллипс с использованием указанного пера на поверхности, представленной текущим объектом, в C++."
type: docs
weight: 1500
url: /ru/cpp/system.drawing/graphics/drawellipse/
---
## Graphics::DrawEllipse(const SharedPtr\<Pen\>\&, float, float, float, float) method


Рисует указанный эллипс, используя указанное перо, на поверхности, представленной текущим объектом.
...
| --- | --- | --- |
| перо | const SharedPtr\<Pen\>\& | Перо, используемое при рисовании эллипса |
