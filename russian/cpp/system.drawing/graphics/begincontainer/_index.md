...
| srcrect | Rectangle | Прямоугольник, который задает масштабное преобразование нового контейнера. Используется вместе с **dstrect** |
| единица | GraphicsUnit | Значение, которое задает единицу измерения нового контейнера |
...
| srcrect | RectangleF | Прямоугольник, который задает масштабное преобразование нового контейнера. Используется вместе с **dstrect** |
| единица | GraphicsUnit | Значение, которое задает единицу измерения нового контейнера |
