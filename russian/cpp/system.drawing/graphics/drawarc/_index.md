---
title: "System::Drawing::Graphics::DrawArc метод"
linktitle: "DrawArc"
second_title: "Aspose.Font для C++"
description: "System::Drawing::Graphics::DrawArc метод. Рисует указанный дугу с использованием указанной ручки на поверхности, представленной текущим объектом, в C++."
type: docs
weight: 1000
...
Рисует указанную дугу, используя указанное перо, на поверхности, представленной текущим объектом.
...
| --- | --- | --- |
| перо | const SharedPtr\<Pen\>\& | Ручка, используемая при рисовании дуги |
...
| sweepAngle | float | Угол в градусах, измеренный по часовой стрелке от **startAngle** до конечной точки дуги |
...
| sweepAngle | int32_t | Угол в градусах, измеренный по часовой стрелке от **startAngle** до конечной точки дуги |
