---
title: "System::Drawing::Graphics::DrawImage метод"
linktitle: "DrawImage"
second_title: "Aspose.Font для C++"
description: "System::Drawing::Graphics::DrawImage метод. НЕ РЕАЛИЗОВАНО в C++."
type: docs
weight: 1800
...
| --- | --- | --- |
| image | const SharedPtr\<Image\>\& | Изображение для рисования |
| destPoints | const ArrayPtr\<Point\>\& | Массив, содержащий три точки, определяющие параллелограмм на поверхности рисования, в который будет отрисовано изображение |
...
| --- | --- | --- |
| image | const SharedPtr\<Image\>\& | Изображение для рисования |
| destPoints | const System::ArrayPtr\<PointF\>\& | Массив, содержащий три точки, определяющие параллелограмм на поверхности рисования, в который будет отрисовано изображение |
...
| --- | --- | --- |
| image | const SharedPtr\<Image\>\& | Изображение для рисования |
| destPoints | const System::Details::ArrayView\<PointF\>\& | Представление массива, содержащего три точки, определяющие параллелограмм на поверхности рисования, в который будет отрисовано изображение |
| srcRect | const RectangleF\& | Прямоугольник, определяющий область указанного изображения для отрисовки |
| srcUnit | GraphicsUnit | Единицы измерения, используемые параметром **srcRect** |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Указывает информацию о цвете и гамме изображения |
...
| --- | --- | --- |
| image | const SharedPtr\<Image\>\& | Изображение для рисования |
| x | float | Координата X левого верхнего угла рисуемого изображения |
| y | float | Координата Y левого верхнего угла рисуемого изображения |
...
| width | float | Ширина верхнего левого угла прямоугольника, в который будет отрисовано изображение |
| height | float | Высота верхнего левого угла прямоугольника, в который будет отрисовано изображение |
...
| --- | --- | --- |
| image | const SharedPtr\<Image\>\& | Изображение для рисования |
| x | int | Координата X левого верхнего угла рисуемого изображения |
| y | int | Координата Y левого верхнего угла рисуемого изображения |
...
| width | int | Ширина верхнего левого угла прямоугольника, в который будет отрисовано изображение |
| height | int | Высота верхнего левого угла прямоугольника, в который будет отрисовано изображение |
...
| --- | --- | --- |
| image | const SharedPtr\<Image\>\& | Изображение для рисования |
| pt | Point | Расположение верхнего левого угла нарисованного изображения |
...
| --- | --- | --- |
| image | const SharedPtr\<Image\>\& | Изображение для рисования |
| pt | PointF | Расположение верхнего левого угла нарисованного изображения |
