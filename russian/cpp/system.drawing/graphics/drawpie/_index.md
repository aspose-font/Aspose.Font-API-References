---
title: "System::Drawing::Graphics::DrawPie метод"
linktitle: "DrawPie"
second_title: "Aspose.Font для C++"
description: "System::Drawing::Graphics::DrawPie метод. Рисует указанный сектор, используя указанный перо, на поверхности, представленной текущим объектом, в C++."
type: docs
weight: 2400
url: /ru/cpp/system.drawing/graphics/drawpie/
---
...
| --- | --- | --- |
| перо | const SharedPtr\<Pen\>\& | Перо, используемое при рисовании сектора |
| x | float | Координата X левого верхнего угла прямоугольника, определяющего эллипс |
| y | float | Координата Y левого верхнего угла прямоугольника, определяющего эллипс |
| width | float | Ширина прямоугольника, определяющего эллипс |
| height | float | Высота прямоугольника, определяющего эллипс |
| startAngle | float | Угол в градусах, измеряемый по часовой стрелке от оси X до начальной точки сектора |
| sweepAngle | float | Угол в градусах, измеряемый по часовой стрелке от **startAngle** до конечной точки сектора |
...
| --- | --- | --- |
| перо | const SharedPtr\<Pen\>\& | Перо, используемое при рисовании сектора |
| x | int32_t | Координата X левого верхнего угла прямоугольника, определяющего эллипс |
| y | int32_t | Координата Y левого верхнего угла прямоугольника, определяющего эллипс |
| width | int32_t | Ширина прямоугольника, определяющего эллипс |
| height | int32_t | Высота прямоугольника, определяющего эллипс |
| startAngle | int32_t | Угол в градусах, измеряемый по часовой стрелке от оси X до начальной точки сектора |
| sweepAngle | int32_t | Угол в градусах, измеряемый по часовой стрелке от **startAngle** до конечной точки сектора |
