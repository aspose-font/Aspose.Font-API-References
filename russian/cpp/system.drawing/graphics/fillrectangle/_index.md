---
title: "System::Drawing::Graphics::FillRectangle метод"
linktitle: "FillRectangle"
second_title: "Aspose.Font для C++"
description: "System::Drawing::Graphics::FillRectangle метод. Заполняет указанный прямоугольник указанной кистью в C++."
type: docs
weight: 3700
url: /ru/cpp/system.drawing/graphics/fillrectangle/
---
## Graphics::FillRectangle(const SharedPtr\<Brush\>\&, float, float, float, float) method


Заполняет указанный прямоугольник указанной кистью.
...
| --- | --- | --- |
| brush | const SharedPtr\<Brush\>\& | Объект [Brush](../../brush/) для заполнения |
| rect | Rectangle | Объект [Rectangle](../../rectangle/) который определяет расположение и размер прямоугольника для заполнения |
...
| --- | --- | --- |
| brush | const SharedPtr\<Brush\>\& | Объект [Brush](../../brush/) для заполнения |
| rect | RectangleF | Объект [RectangleF](../../rectanglef/) который определяет расположение и размер прямоугольника для заполнения |
