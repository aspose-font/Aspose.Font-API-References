...
description: "System::Drawing::Graphics::FillClosedCurve метод. Рисует замкнутый сплайн, используя указанную кисть в C++."
type: docs
weight: 3200
...
Рисует замкнутый сплайн, используя указанную кисть.
...
| --- | --- | --- |
| кисть | const SharedPtr\<Brush\>\& | Кисть, используемая при рисовании сплайна |
