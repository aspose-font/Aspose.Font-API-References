...
Создаёт новый экземпляр класса [Font](../), представляющий указанный существующий шрифт с указанным стилем шрифта.
...
| new_style | FontStyle | Стиль шрифта, применяемый к новому шрифту |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| family | const SharedPtr\\<FontFamily\\>\\& | Семейство шрифтов нового шрифта |
