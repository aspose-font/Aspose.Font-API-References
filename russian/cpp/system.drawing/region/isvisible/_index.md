---
title: "Метод System::Drawing::Region::IsVisible"
linktitle: "IsVisible"
second_title: "Aspose.Font для C++"
description: "Метод System::Drawing::Region::IsVisible. Определяет, содержится ли указанная точка внутри региона, представленного текущим объектом, в C++."
type: docs
weight: 1400
url: /ru/cpp/system.drawing/region/isvisible/
---
## Region::IsVisible(const Point\&) const method


Определяет, содержится ли указанная точка внутри региона, представленного текущим объектом.
...
Определяет, содержится ли указанная точка внутри региона, представленного текущим объектом, с использованием указанных графических средств.
...
| --- | --- | --- |
| точка | const Point\& | Точка для проверки |
| графика | const SharedPtr\<Graphics\>\& | Контекст графики |
...
Определяет, содержится ли какая-либо часть указанного прямоугольника внутри региона, представленного текущим объектом.
...
Определяет, содержится ли какая-либо часть указанного прямоугольника внутри региона, представленного текущим объектом, с использованием указанных графических средств.
