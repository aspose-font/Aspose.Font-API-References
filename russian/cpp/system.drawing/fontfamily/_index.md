...
| [FontFamily](./fontfamily/)(const String\&) | Создает новый экземпляр класса [FontFamily](./), представляющий семейство шрифтов с указанным именем. |
| [FontFamily](./fontfamily/)(const String\&, const SharedPtr\<Text::FontCollection\>\&) | Создает новый экземпляр [FontFamily](./) в указанной FontCollection с заданным именем. |
| [FontFamily](./fontfamily/)(Text::GenericFontFamilies) | Создает новый экземпляр [FontFamily](./) из указанного общего семейства шрифтов. |
...
| [get_Name](./get_name/)() const | Возвращает имя семейства шрифтов, представленного текущим объектом. |
...
| [GetName](./getname/)(int) const | Возвращает имя семейства шрифтов, представленного текущим объектом. |
