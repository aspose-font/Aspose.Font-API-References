...
description: "System::Xml::XPath::XPathDocument класс. Предоставляет быстрое, только для чтения, представление XML‑документа в памяти, используя модель данных XPath в C++."
type: docs
weight: 200
...
| [XPathDocument](./xpathdocument/)(const SharedPtr\<XmlReader\>\&, XmlSpace) | Инициализирует новый экземпляр класса [XPathDocument](./) из XML-данных, содержащихся в указанном объекте [XmlReader](../../system.xml/xmlreader/) с заданной обработкой пробельных символов. |
