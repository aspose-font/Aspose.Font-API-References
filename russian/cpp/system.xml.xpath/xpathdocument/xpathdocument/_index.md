---
title: "System::Xml::XPath::XPathDocument::XPathDocument конструктор"
linktitle: "XPathDocument"
second_title: "Aspose.Font для C++"
description: "System::Xml::XPath::XPathDocument::XPathDocument конструктор. Инициализирует новый экземпляр класса XPathDocument из XML-данных в указанном объекте Stream в C++."
type: docs
weight: 100
