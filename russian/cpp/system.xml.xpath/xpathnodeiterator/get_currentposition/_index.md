...
description: "System::Xml::XPath::XPathNodeIterator::get_CurrentPosition method. При переопределении в производном классе получает индекс текущей позиции в выбранном наборе узлов в C++."
type: docs
weight: 500
