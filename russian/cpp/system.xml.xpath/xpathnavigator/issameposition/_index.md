...
description: "System::Xml::XPath::XPathNavigator::IsSamePosition method. При переопределении в производном классе определяет, находится ли текущий XPathNavigator в той же позиции, что и указанный XPathNavigator в C++."
type: docs
weight: 4600
url: /ru/cpp/system.xml.xpath/xpathnavigator/issameposition/
---
...
| --- | --- | --- |
| other | SharedPtr\<XPathNavigator\> | Экземпляр [XPathNavigator](../), с которым сравнивается данный [XPathNavigator](../). |
