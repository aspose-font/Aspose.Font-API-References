...
description: "Метод System::Xml::XPath::XPathNavigator::MoveToPrevious. При переопределении в производном классе перемещает XPathNavigator к предыдущему узлу‑сиблинг текущего узла в C++."
type: docs
weight: 6400
...
При переопределении в производном классе перемещает [XPathNavigator](../) к предыдущему узлу‑сиблинг текущего узла.
