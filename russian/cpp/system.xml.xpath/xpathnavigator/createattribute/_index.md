---
title: "Метод System::Xml::XPath::XPathNavigator::CreateAttribute"
linktitle: "CreateAttribute"
second_title: "Aspose.Font для C++"
description: "Метод System::Xml::XPath::XPathNavigator::CreateAttribute. Создаёт узел атрибута в текущем элементе, используя префикс пространства имён, локальное имя и URI пространства имён, указанные вместе со значением в C++."
type: docs
weight: 700
...
Создаёт узел атрибута в текущем элементе, используя указанный префикс пространства имён, локальное имя и URI пространства имён, а также указанное значение.
...
| namespaceURI | String | URI пространства имён нового узла атрибута (если есть). |
