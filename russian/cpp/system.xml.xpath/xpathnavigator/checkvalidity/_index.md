...
description: "Метод System::Xml::XPath::XPathNavigator::CheckValidity. Проверяет, соответствуют ли XML‑данные в XPathNavigator схеме XML Schema (XSD), предоставленной в C++."
type: docs
weight: 300
...
Проверяет, соответствуют ли XML‑данные в [XPathNavigator](../) схеме XML [Schema](../../../system.xml.schema/) (XSD), предоставленной.
...
| --- | --- | --- |
| schemas | SharedPtr\<System::Xml::Schema::XmlSchemaSet\> | Объект XmlSchemaSet, содержащий схемы, используемые для проверки XML‑данных, содержащихся в [XPathNavigator](../). |
