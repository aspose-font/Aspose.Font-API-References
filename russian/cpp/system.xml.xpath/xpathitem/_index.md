...
description: "System::Xml::XPath::XPathItem класс. Представляет элемент в модели данных XQuery 1.0 и XPath 2.0 в C++."
type: docs
weight: 400
...
| virtual [get_XmlType](./get_xmltype/)() | При переопределении в производном классе возвращает XmlSchemaType для элемента. |
| virtual [ValueAs](./valueas/)(const TypeInfo\&) | Возвращает значение элемента в указанном типе. |
| virtual [ValueAs](./valueas/)(const TypeInfo\&, SharedPtr\<IXmlNamespaceResolver\>) | При переопределении в производном классе возвращает значение элемента в типе, указанном с помощью объекта [IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/), предназначенного для разрешения префиксов пространств имён. |
## Typedefs
