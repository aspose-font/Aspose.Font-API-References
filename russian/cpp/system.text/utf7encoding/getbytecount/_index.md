---
title: "Метод System::Text::UTF7Encoding::GetByteCount"
linktitle: "GetByteCount"
second_title: "Aspose.Font для C++"
description: "Метод System::Text::UTF7Encoding::GetByteCount. Получить количество символов, необходимых для кодирования буфера символов в C++."
type: docs
weight: 400
...
| --- | --- | --- |
| chars | ArrayPtr\<char_t\> | Буфер символов. |
...
Получить количество символов, необходимых для кодирования строки.
