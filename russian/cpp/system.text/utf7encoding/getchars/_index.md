---
title: "Метод System::Text::UTF7Encoding::GetChars"
linktitle: "GetChars"
second_title: "Aspose.Font для C++"
description: "Метод System::Text::UTF7Encoding::GetChars. Получает символы, полученные в результате декодирования буфера байтов в C++."
type: docs
weight: 700
...
| --- | --- | --- |
| bytes | ArrayPtr\<uint8_t\> | [Buffer](../../../system/buffer/) для чтения байтов из. |
