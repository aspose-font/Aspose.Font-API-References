...
description: "System::Text::StringBuilder класс. Буфер для накопления строки по частям. Этот тип может быть выделен либо в стеке как тип значения, либо в куче с помощью функции System::MakeObject(). После выделения объекта никогда не смешивайте эти два случая использования: наличие указателей SmartPtr на объекты, выделенные в стеке, строго запрещено в C++."
type: docs
weight: 2400
