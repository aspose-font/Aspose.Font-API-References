---
title: "System::Text::StringBuilder::StringBuilder конструктор"
linktitle: "StringBuilder"
second_title: "Aspose.Font для C++"
description: "System::Text::StringBuilder::StringBuilder конструктор. Конструктор в C++."
type: docs
weight: 100
url: /ru/cpp/system.text/stringbuilder/stringbuilder/
---
...
| --- | --- | --- |
| str | const String\& | Начальное значение. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | const String\& | Начальное значение. |
| ёмкость | int | Начальная ёмкость строки. |
...
| --- | --- | --- |
| значение | const String\& | Начальное значение. |
| startIndex | int | Индекс начала среза начального значения. |
| длина | int | Длина среза начального значения. |
| ёмкость | int | Начальная ёмкость строки. |
