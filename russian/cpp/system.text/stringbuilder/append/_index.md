...
description: "System::Text::StringBuilder::Append метод. Добавляет символ в построитель в C++."
type: docs
weight: 300
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| построитель | const SharedPtr\<StringBuilder\>\& | Построитель, из которого добавлять содержимое. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | T | Значение для сериализации и добавления. |
