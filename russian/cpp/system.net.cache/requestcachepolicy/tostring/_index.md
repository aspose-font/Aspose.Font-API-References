...
description: "System::Net::Cache::RequestCachePolicy::ToString method. Аналог метода C# Object.ToString(). Позволяет преобразовывать пользовательские объекты в строку в C++."
type: docs
weight: 300
url: /ru/cpp/system.net.cache/requestcachepolicy/tostring/
---
