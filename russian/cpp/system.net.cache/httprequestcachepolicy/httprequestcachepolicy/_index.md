---
title: "System::Net::Cache::HttpRequestCachePolicy::HttpRequestCachePolicy конструктор"
linktitle: "HttpRequestCachePolicy"
second_title: "Aspose.Font для C++"
description: "System::Net::Cache::HttpRequestCachePolicy::HttpRequestCachePolicy конструктор. Создаёт новый экземпляр в C++."
type: docs
weight: 100
url: /ru/cpp/system.net.cache/httprequestcachepolicy/httprequestcachepolicy/
---
...
| --- | --- | --- |
| cacheSyncDate | DateTime | Время, когда ресурсы, хранящиеся в кэше, должны быть переоценены. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| cacheAgeControl | HttpCacheAgeControl | Управляет поведением кэширования ресурсов. |
| ageOrFreshOrStale | TimeSpan | Отрезок времени. |
...
| --- | --- | --- |
| cacheAgeControl | HttpCacheAgeControl | Управляет поведением кэширования ресурсов. |
| maxAge | TimeSpan | Максимальный возраст, разрешённый для ресурсов. |
| freshOrStale | TimeSpan | Отрезок времени. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| уровень | HttpRequestCacheLevel | Поведение кэширования ресурсов. |
