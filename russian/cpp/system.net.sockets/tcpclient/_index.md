...
| [get_NoDelay](./get_nodelay/)() | Получает значение, указывающее, использует ли текущий экземпляр алгоритм Nagle. |
| [get_ReceiveBufferSize](./get_receivebuffersize/)() | Получает размер буфера, используемого для приёма данных. |
| [get_ReceiveTimeout](./get_receivetimeout/)() | Получает значение, указывающее количество времени, после которого приём данных завершится тайм‑аутом. |
| [get_SendBufferSize](./get_sendbuffersize/)() | Получает размер буфера, используемого для отправки данных. |
| [get_SendTimeout](./get_sendtimeout/)() | Получает значение, указывающее количество времени, после которого отправка данных будет прервана по тайм-ауту. |
...
| [set_ReceiveTimeout](./set_receivetimeout/)(int32_t) | Устанавливает значение, указывающее количество времени, после которого получение данных будет прервано по тайм-ауту. |
| [set_SendBufferSize](./set_sendbuffersize/)(int32_t) | Устанавливает размер буфера, используемого для отправки данных. |
| [set_SendTimeout](./set_sendtimeout/)(int32_t) | Устанавливает значение, указывающее количество времени, после которого отправка данных будет прервана по тайм-ауту. |
