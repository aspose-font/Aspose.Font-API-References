---
title: "System::Net::Sockets::Socket::BeginConnect метод"
linktitle: "BeginConnect"
second_title: "Aspose.Font для C++"
description: "System::Net::Sockets::Socket::BeginConnect метод. Инициирует асинхронную операцию подключения в C++."
type: docs
weight: 700
...
| --- | --- | --- |
| host | String | Удалённое имя хоста. |
...
| состояние | System::SharedPtr\<Object\> | Данные, предоставленные пользователем, используемые для уникальной идентификации каждой асинхронной операции подключения. |
