---
title: "Метод System::Net::Sockets::Socket::ReceiveMessageFrom"
linktitle: "ReceiveMessageFrom"
second_title: "Aspose.Font для C++"
description: "Метод System::Net::Sockets::Socket::ReceiveMessageFrom. Принимает данные от указанной конечной точки и записывает их в указанный массив байтов в C++."
type: docs
weight: 4500
...
| socketFlags | SocketFlags\& | Поведение приёма. |
