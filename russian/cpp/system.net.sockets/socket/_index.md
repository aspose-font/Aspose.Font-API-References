...
| [get_NoDelay](./get_nodelay/)() | Получает значение, указывающее, использует ли сокет алгоритм Найгла. |
...
| [set_MulticastLoopback](./set_multicastloopback/)(bool) | Устанавливает значение, указывающее, получает ли сокет исходящие мультикастовые пакеты. |
| [set_NoDelay](./set_nodelay/)(bool) | Устанавливает значение, указывающее, использует ли сокет алгоритм Nagle. |
...
| [Shutdown](./shutdown/)(SocketShutdown) | Отключает операции отправки и приёма сокета. |
