...
| --- | --- | --- |
| buffer | System::ArrayPtr\<uint8_t\> | Буфер для чтения данных. |
...
| состояние | System::SharedPtr\<Object\> | Данные, предоставленные пользователем, используемые для уникальной идентификации каждой асинхронной операции отправки. |
