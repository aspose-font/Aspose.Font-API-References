---
title: "Метод System::Net::Sockets::Socket::GetSocketOption"
linktitle: "GetSocketOption"
second_title: "Aspose.Font для C++"
description: "Метод System::Net::Sockets::Socket::GetSocketOption. Возвращает значение, соответствующее указанному имени параметра в C++."
type: docs
weight: 3900
