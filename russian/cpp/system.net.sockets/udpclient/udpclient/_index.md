...
description: "System::Net::Sockets::UdpClient::UdpClient constructor. Инициализирует новый экземпляр класса UdpClient в C++."
type: docs
weight: 100
...
| --- | --- | --- |
| family | AddressFamily | значение, указывающее схему адресации сокета. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| hostname | String | Имя удалённого DNS‑хоста, к которому вы планируете подключиться. |
| port | int32_t | Локальный номер порта, из которого вы планируете общаться. |
