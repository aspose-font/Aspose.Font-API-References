---
title: "Метод System::Net::Sockets::NetworkStream::Write"
linktitle: "Write"
second_title: "Aspose.Font для C++"
description: "Метод System::Net::Sockets::NetworkStream::Write. Записывает указанный поддиапазон байтов из заданного массива байтов в поток в C++."
type: docs
weight: 2500
