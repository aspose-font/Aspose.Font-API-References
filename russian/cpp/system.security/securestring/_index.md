...
| [Copy](./copy/)() const | Создаёт дубликат этой защищённой строки. |
...
| [MakeReadOnly](./makereadonly/)() | Помечает эту защищённую строку как только для чтения. |
