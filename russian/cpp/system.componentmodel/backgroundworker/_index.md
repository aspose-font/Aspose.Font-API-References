...
| [get_WorkerReportsProgress](./get_workerreportsprogress/)() const | Возвращает значение, указывающее, может ли [System::ComponentModel::BackgroundWorker](./) сообщать об обновлениях прогресса. |
