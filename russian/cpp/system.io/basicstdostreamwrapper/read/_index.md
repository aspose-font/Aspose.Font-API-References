---
title: "System::IO::BasicSTDOStreamWrapper::Read метод"
linktitle: "Read"
second_title: "Aspose.Font для C++"
description: "System::IO::BasicSTDOStreamWrapper::Read метод. Если режим обёртывания бинарный, считывает указанное количество байтов из потока, иначе считывает указанное количество символов и преобразует их в тип uint8_t. Записывает результат чтения в указанный массив байтов. Не поддерживается! в C++."
type: docs
weight: 400
