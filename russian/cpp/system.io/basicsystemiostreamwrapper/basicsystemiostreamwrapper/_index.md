---
title: "System::IO::BasicSystemIOStreamWrapper::BasicSystemIOStreamWrapper конструктор"
linktitle: "BasicSystemIOStreamWrapper"
second_title: "Aspose.Font для C++"
description: "System::IO::BasicSystemIOStreamWrapper::BasicSystemIOStreamWrapper конструктор. Перемещающий конструктор в C++."
type: docs
weight: 100
url: /ru/cpp/system.io/basicsystemiostreamwrapper/basicsystemiostreamwrapper/
---
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| str | SharedPtr\<Stream\> | Указатель на поток |
