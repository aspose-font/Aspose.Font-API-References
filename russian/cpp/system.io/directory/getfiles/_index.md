...
description: "System::IO::Directory::GetFiles метод. Ищет файлы, которые соответствуют указанным критериям поиска, либо в указанном каталоге, либо во всём дереве каталогов, корневым в указанном каталоге, в C++."
type: docs
weight: 1200
