---
title: "System::IO::BinaryWriter::Write метод"
linktitle: "Write"
second_title: "Aspose.Font для C++"
description: "System::IO::BinaryWriter::Write метод. Записывает один байт со значением 0, если значение ''true'', и 1, если значение ''false'', в выходной поток в C++."
type: docs
weight: 800
url: /ru/cpp/system.io/binarywriter/write/
---
...
| --- | --- | --- |
| значение | bool | Булево значение, указывающее байтовое значение для записи в выходной поток |
...
Записывает указанное 16-битное значение широкого символа в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | char16_t | Значение для записи |
...
Записывает указанный поддиапазон символов UTF-16 из указанного массива символов в выходной поток.
...
| индекс | int | Нулевой индекс элемента в **buffer**, с которого начинается поддиапазон для записи |
...
Записывает указанный поддиапазон байтов из указанного массива байтов в выходной поток.
...
| индекс | int | Нулевой индекс элемента в **buffer**, с которого начинается поддиапазон для записи |
| count | int | Количество элементов в поддиапазоне для записи; -1 указывает, что поддиапазон заканчивается там, где заканчивается массив **buffer** |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | const char_t * | C-строка для записи |
...
Записывает байтовое представление указанного значения [Decimal](../../../system/decimal/) в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | const Decimal\& | Значение для записи |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | const String\& | Строка для записи |
...
Записывает указанное значение с двойной точностью плавающей запятой в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | double | Значение для записи |
...
Записывает указанное значение с одинарной точностью плавающей запятой в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | float | Значение для записи |
...
Записывает указанное 32-битное целочисленное значение в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | int | Значение для записи |
...
Записывает указанное 16-битное целочисленное значение в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | int16_t | Значение для записи |
...
Записывает указанное 64-битное целочисленное значение в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | int64_t | Значение для записи |
...
Записывает указанное беззнаковое 16-битное целочисленное значение в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | uint16_t | Значение для записи |
...
Записывает указанное беззнаковое 32-битное целочисленное значение в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | uint32_t | Значение для записи |
...
Записывает указанное беззнаковое 64-битное целочисленное значение в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | uint64_t | Значение для записи |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | uint8_t | Значение для записи |
