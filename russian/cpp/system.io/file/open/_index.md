...
description: "System::IO::File::Open метод. Открывает указанный файл в указанном режиме для чтения и записи без совместного доступа в C++."
type: docs
weight: 1900
...
Открывает указанный файл в заданном режиме для чтения и записи без совместного доступа.
...
Открывает указанный файл в заданном режиме, с указанным типом доступа и параметром совместного доступа.
...
| путь | const String\& | Путь к файлу, который нужно открыть |
| режим | FileMode | Указывает режим, в котором открывать файл |
| access | FileAccess | Запрашиваемый тип доступа |
