---
title: "Метод System::IO::File::AppendText"
linktitle: "AppendText"
second_title: "Aspose.Font для C++"
description: "Метод System::IO::File::AppendText. Создаёт объект StreamWriter, который добавляет текст в указанный файл, используя кодировку UTF-8. Если указанный файл не существует, он создаётся в C++."
type: docs
weight: 300
...
Указатель shared pointer на созданный объект [StreamWriter](../../streamwriter/) , связанный с указанным файлом
