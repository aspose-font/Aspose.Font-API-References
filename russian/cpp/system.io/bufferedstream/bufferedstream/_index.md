---
title: "System::IO::BufferedStream::BufferedStream конструктор"
linktitle: "BufferedStream"
second_title: "Aspose.Font для C++"
description: "System::IO::BufferedStream::BufferedStream конструктор. Создаёт объект BufferedStream, который оборачивает указанный поток и использует буфер длиной 4096 байт в C++."
type: docs
weight: 100
...
| --- | --- | --- |
| stream | const SharedPtr\<Stream\>\& | Базовый объект [Stream](../../stream/) |
