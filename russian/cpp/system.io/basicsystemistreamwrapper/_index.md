...
description: "System::IO::BasicSystemIStreamWrapper класс. Представляет обёртку, похожую на std::istream, которая использует BasicSystemIOStreamBuf в качестве внутреннего буфера в C++."
type: docs
weight: 600
...
| [operator=](./operator=/)(const BasicSystemIStreamWrapper\&) | Оператор копирующего присваивания. Удалён. |
