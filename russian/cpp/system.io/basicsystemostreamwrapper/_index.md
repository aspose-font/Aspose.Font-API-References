---
title: "Класс System::IO::BasicSystemOStreamWrapper"
linktitle: "BasicSystemOStreamWrapper"
second_title: "Aspose.Font для C++"
description: "Класс System::IO::BasicSystemOStreamWrapper. Представляет обёртку, похожую на std::ostream, которая использует BasicSystemIOStreamBuf в качестве внутреннего буфера в C++."
type: docs
weight: 700
...
| [operator=](./operator=/)(const BasicSystemOStreamWrapper\&) | Оператор копирующего присваивания. Удалён. |
