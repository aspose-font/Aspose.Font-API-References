...
| смещение | int | Смещение, начинающееся с 0, в **buffer**, указывающее позицию, с которой начинать запись прочитанных данных. |
...
| состояние | System::SharedPtr\<System::Object\> | Пользовательские данные, используемые для уникальной идентификации каждой асинхронной операции чтения. |
