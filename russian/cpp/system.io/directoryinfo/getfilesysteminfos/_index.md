...
description: "System::IO::DirectoryInfo::GetFileSystemInfos method. Возвращает массив, содержащий разделяемые указатели на объекты FileSystemInfo, представляющие все файлы и каталоги, расположенные в каталоге, представляемом текущим объектом, в C++."
type: docs
weight: 1400
