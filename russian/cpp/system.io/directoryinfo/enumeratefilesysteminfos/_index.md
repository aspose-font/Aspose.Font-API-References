...
description: "System::IO::DirectoryInfo::EnumerateFileSystemInfos метод. Возвращает перечисляемую коллекцию, содержащую все файлы и каталоги, расположенные в директории, представленной текущим объектом, в C++."
type: docs
weight: 700
