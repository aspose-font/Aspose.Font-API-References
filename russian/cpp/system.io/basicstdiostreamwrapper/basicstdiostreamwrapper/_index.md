---
title: "Конструктор System::IO::BasicSTDIOStreamWrapper::BasicSTDIOStreamWrapper"
linktitle: "BasicSTDIOStreamWrapper"
second_title: "Aspose.Font для C++"
description: "Конструктор System::IO::BasicSTDIOStreamWrapper::BasicSTDIOStreamWrapper. Конструктор копирования. Удалён в C++."
type: docs
weight: 100
url: /ru/cpp/system.io/basicstdiostreamwrapper/basicstdiostreamwrapper/
---
...
| --- | --- | --- |
| str | std::basic_iostream\<char_type, traits_type\>\& | Ссылка на поток |
| режим | STDIOStreamWrappingMode | Режим обёртывания |
| pref_pos | STDIOStreamPositionPreference | Позиция, которая будет предпочтительной в качестве позиции чтения и записи, если они различаются |
