...
description: "System::IO::BasicSTDIOStreamWrapper::Read method. Если режим обёртывания бинарный, считывает указанное количество байтов из потока, иначе считывает указанное количество символов и преобразует их в тип uint8_t. Записывает результат чтения в указанный массив байтов в C++."
type: docs
weight: 400
