...
| [Find](./find/)(const System::String\&, bool) const | Ищет указанный элемент управления в коллекции. При необходимости рекурсивно проверяет коллекции вложенных элементов управления. |
