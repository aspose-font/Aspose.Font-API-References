...
description: "Класс System::Threading::Tasks::ResultValueTask. Представляет гибридный тип, похожий на задачу, который может обернуть либо прямое значение результата, либо ResultTask<T> в C++."
type: docs
weight: 500
