...
description: "System::Threading::Tasks::Task::ConfigureAwait метод. Настраивает поведение ожиданий этой задачи относительно захвата контекста в C++."
type: docs
weight: 700
...
Настраивает, как ожидания этой задачи должны вести себя относительно захвата контекста.
