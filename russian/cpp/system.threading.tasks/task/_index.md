...
| [Task](./task/)(const Action\<SharedPtr\<Object\>\>\&, const SharedPtr\<Object\>\&) | Создаёт [Task](./) с состоянием‑зависимым действием и объектом состояния. |
| [Task](./task/)(const Action\<SharedPtr\<Object\>\>\&, const SharedPtr\<Object\>\&, const CancellationToken\&) | Создаёт [Task](./) с состоянием‑зависимым действием, состоянием и токеном отмены. |
