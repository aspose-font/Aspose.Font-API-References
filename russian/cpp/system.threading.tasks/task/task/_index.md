---
title: "конструктор System::Threading::Tasks::Task::Task"
linktitle: "Task"
second_title: "Aspose.Font для C++"
description: "конструктор System::Threading::Tasks::Task::Task. Внутренний конструктор для создания неинициализированных задач в C++."
type: docs
weight: 100
...
| --- | --- | --- |
| действие | const Action\<SharedPtr\<Object\>\>\& | Действие для выполнения (принимает объект состояния) |
| состояние | const SharedPtr\<Object\>\& | Определяемый пользователем объект состояния, передаваемый действию |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| действие | const Action<>\& | Действие для асинхронного выполнения |
