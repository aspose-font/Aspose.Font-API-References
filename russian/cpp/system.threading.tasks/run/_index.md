...
Объект [Task](../task/), представляющий работу, помещённую в очередь для выполнения в пуле потоков.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| function | const Func\<TaskPtr\>\& | Работа, которую необходимо выполнить асинхронно и которая возвращает [Task](../task/). |

### ReturnValue

Объект [Task](../task/), представляющий прокси для [Task](../task/), возвращаемого функцией.
...
Помещает указанную работу в очередь для выполнения в пуле потоков и возвращает дескриптор [Task<TResult>](../task/) для этой работы.
...
Объект [Task<TResult>](../task/) представляет работу, помещённую в очередь для выполнения в пуле потоков.
