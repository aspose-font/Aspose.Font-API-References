---
title: "Aspose::Font::operator== метод"
linktitle: "operator=="
second_title: "Aspose.Font для C++"
description: "Aspose::Font::operator== метод. Реализация оператора равенства в C++."
type: docs
weight: 3900
url: /ru/cpp/aspose.font/operator==/
---
...
| --- | --- | --- |
| obj1 | const System::SharedPtr\<MultiLanguageString\>\& | первый объект для сравнения |
| obj2 | const System::String\& | второй объект для сравнения |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| obj1 | const System::String\& | строка для сравнения |
| obj2 | const System::SharedPtr\<MultiLanguageString\>\& | многоязычная строка для сравнения |
