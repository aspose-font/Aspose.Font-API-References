---
title: "System::Collections::Generic::DictionaryIterator::DictionaryIterator yapıcı"
linktitle: "DictionaryIterator"
second_title: "Aspose.Font için C++"
description: "System::Collections::Generic::DictionaryIterator::DictionaryIterator yapıcı. C++'ta yapıcı."
type: docs
weight: 100
url: /tr/cpp/system.collections.generic/dictionaryiterator/dictionaryiterator/
---
...
| --- | --- | --- |
| iterator | const typename Dict::map_t::const_iterator\& | Tutmak için yineleyici. |
| end | const typename Dict::map_t::const_iterator\& | Konteynerin sonundaki yineleyici. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| diğer | DictionaryIterator\&& | Veri taşımak için yineleyici. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| iterator | typename Dict::map_t::const_iterator\&& | Tutmak için yineleyici. |
| end | typename Dict::map_t::const_iterator\&& | Konteynerin sonundaki yineleyici. |
