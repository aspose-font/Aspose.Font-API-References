---
title: "System::Drawing::Drawing2D::Matrix::Matrix yapıcı"
linktitle: "Matrix"
second_title: "Aspose.Font için C++"
description: "System::Drawing::Drawing2D::Matrix::Matrix yapıcı. C++'ta bir birim matrisi temsil eden Matrix sınıfının yeni bir örneğini oluşturur."
type: docs
weight: 100
...
[Matrix](../) sınıfının bir birim matrisi temsil eden yeni bir örneğini oluşturur.
...
Belirtilen dikdörtgen ve nokta dizisi tarafından tanımlanan geometrik dönüşüme göre [Matrix](../) sınıfının yeni bir örneğini oluşturur.
...
[Matrix](../) sınıfının yeni bir örneğini oluşturur ve belirtilen değerlerle başlatır.
