...
description: "System::Drawing::Drawing2D::GraphicsPath::AddString yöntemi. Metin dizesini, mevcut nesne tarafından temsil edilen yola C++ içinde ekler."
type: docs
weight: 1600
...
Geçerli nesne tarafından temsil edilen yola bir metin dizesi ekler.
...
| --- | --- | --- |
| metin | const String\& | Eklenecek metin |
| aile | const SharedPtr\<FontFamily\>\& | Metni çizerken kullanılan yazı tipi ailesi |
| style | int | Kullanılacak yazı tipi stilini belirten bir [FontStyle](../../../system.drawing/fontstyle/) enum değeridir |
