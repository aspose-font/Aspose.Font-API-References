---
title: "System::Security::Cryptography::Xml::XmlDsigEnvelopedSignatureTransform sınıfı"
linktitle: "XmlDsigEnvelopedSignatureTransform"
second_title: "Aspose.Font için C++"
description: "System::Security::Cryptography::Xml::XmlDsigEnvelopedSignatureTransform sınıfı. XML imzası için kapsüllenmiş imza dönüşümünü temsil eder. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu tip bir örneği yığına (stack) veya new operatörüyle oluşturmayın, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi C++ içinde işlevlere argüman olarak geçirin."
type: docs
weight: 1600
url: /tr/cpp/system.security.cryptography.xml/xmldsigenvelopedsignaturetransform/
---
## XmlDsigEnvelopedSignatureTransform class


XML imzası için kapsüllenmiş imza dönüşümünü temsil eder. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak tahsis edilmelidir. Bu tip bir örneği yığına (stack) veya new operatörüyle oluşturmayın, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi işlevlere argüman olarak geçirin.
