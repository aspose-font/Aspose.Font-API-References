---
title: "System::Net::WebProxy::WebProxy yapıcı"
linktitle: "WebProxy"
second_title: "Aspose.Font için C++"
description: "System::Net::WebProxy::WebProxy yapıcı. C++'de yeni bir örnek oluşturur."
type: docs
weight: 100
url: /tr/cpp/system.net/webproxy/webproxy/
---
...
| --- | --- | --- |
| Adres | Dize | Vekil sunucu adresi. |
...
| --- | --- | --- |
| Adres | Dize | Vekil sunucu adresi. |
| BypassOnLocal | bool | Yerel adresler için proxy sunucusunun kullanılması gerekip gerekmediğini belirten bir değer. |
...
| Adres | Dize | Vekil sunucu adresi. |
| BypassOnLocal | bool | Yerel adresler için proxy sunucusunun kullanılması gerekip gerekmediğini belirten bir değer. |
| BypassList | System::ArrayPtr\<String\> | Proxy sunucusunu kullanmayan adreslerin listesi. |
...
| BypassOnLocal | bool | Yerel adresler için proxy sunucusunun kullanılması gerekip gerekmediğini belirten bir değer. |
| BypassList | System::ArrayPtr\<String\> | Proxy sunucusunu kullanmayan adreslerin listesi. |
| Credentials | System::SharedPtr\<ICredentials\> | Kimlik doğrulama için proxy sunucusuna gönderilen kimlik bilgileri. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| Adres | System::SharedPtr\<Uri\> | Vekil sunucu adresi. |
