---
title: "System::Text::Encoding::GetEncoding yöntemi"
linktitle: "GetEncoding"
second_title: "Aspose.Font için C++"
description: "System::Text::Encoding::GetEncoding yöntemi. C++'ta adıyla kodlamayı alır."
type: docs
weight: 4100
url: /tr/cpp/system.text/encoding/getencoding/
---
## Encoding::GetEncoding(const String\&) method


Kodlamayı ada göre alır.
...
| --- | --- | --- |
| name | const String\& | [Encoding](../) adı. |
...
| --- | --- | --- |
| name | const String\& | [Encoding](../) adı. |
| encoder_fallback | const EncoderFallbackPtr\& | Kodlama için kullanılacak geri dönüş. |
| decoder_fallback | const DecoderFallbackPtr\& | Kod çözme için kullanılacak geri dönüş. |
...
Kodlamayı kod sayfasına göre alır.
