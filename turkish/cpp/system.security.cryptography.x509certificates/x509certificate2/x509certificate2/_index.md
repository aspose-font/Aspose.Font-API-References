...
description: "System::Security::Cryptography::X509Certificates::X509Certificate2::X509Certificate2 yapıcı. Boş bir X509Certificate2 nesnesi C++'da oluşturur."
type: docs
weight: 100
...
Boş bir [X509Certificate2](../) oluşturur.
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Kodlanmış sertifikayı temsil eden bayt dizisi. |
| password | const SecureStringPtr\& | Sertifika parolası. |
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Kodlanmış sertifikayı temsil eden bayt dizisi. |
| password | const String\& | Sertifika parolası. |
