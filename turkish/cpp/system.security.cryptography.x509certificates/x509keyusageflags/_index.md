...
description: "System::Security::Cryptography::X509Certificates::X509KeyUsageFlags enum. Sertifika anahtarının C++'ta nasıl kullanılabileceğini tanımlar."
type: docs
weight: 2200
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Yok | 0 | Anahtar kullanım parametresi yok. |
