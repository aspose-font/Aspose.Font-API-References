---
title: "System::Security::Cryptography::X509Certificates::X509Certificate::Import yöntemi"
linktitle: "Import"
second_title: "Aspose.Font için C++"
description: "System::Security::Cryptography::X509Certificates::X509Certificate::Import yöntemi. Belirtilen sertifika verisinden bilgileri içe aktarır. C++'ta HENÜZ UYGULANMADI."
type: docs
weight: 2500
url: /tr/cpp/system.security.cryptography.x509certificates/x509certificate/import/
---
## X509Certificate::Import(const ByteArrayPtr\&) method


Belirtilen sertifika verisinden bilgileri içe aktarır. NOT IMPLEMENTED.
...
| --- | --- | --- |
| veri | const ByteArrayPtr\& | Sertifika dosya adı. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| veri | const ByteArrayPtr\& | X.509 sertifika verileri. |
| password | const SecureStringPtr\& | Sertifika verilerine erişmek için gerekli şifre. |
...
| --- | --- | --- |
| veri | const ByteArrayPtr\& | Sertifika dosya adı. |
| password | const String\& | Sertifika verilerine erişmek için gerekli şifre. |
| key_storage_flags | X509KeyStorageFlags |  |
...
Belirtilen sertifika dosyasından bilgileri içe aktarır. NOT IMPLEMENTED.
