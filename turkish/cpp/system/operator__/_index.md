...
description: "System::operator<< yöntemi. C++'ta UTF-8 kodlamasını kullanarak bir dizeyi çıktı akışına yazar."
type: docs
weight: 29200
url: /tr/cpp/system/operator__/
---
...
| decimal | const Decimal\& | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| exception | const Exception\& | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| guid | const Guid\& | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| value | const Nullable\<T\>\& | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| os | const OperatingSystem\& | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| object_ptr | const SharedPtr\<T\>\& | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| object | const System::Object\& | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| type_info | const TypeInfo\& | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| version | const Version\& | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| object_ptr | const WeakPtr\<T\>\& | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| date_time | DateTime | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| value | DateTimeOffset | [Data](../../system.data/) eklemek için. |
...
| --- | --- | --- |
| akış | std::ostream\& | Veri eklemek için çıktı akışı. |
| time_span | TimeSpan | [Data](../../system.data/) eklemek için. |
...
bağlantıbaşlığı: operator>>
ikinci başlık: Aspose.Font for C++
açıklama: 'System::operator>> yöntemi. C++'ta UTF-8 kodlamasını kullanarak giriş akışından bir dize alır.'
tür: docs
ağırlık: 35200
