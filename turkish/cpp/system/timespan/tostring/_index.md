---
title: "System::TimeSpan::ToString yöntemi"
linktitle: "ToString"
second_title: "Aspose.Font için C++"
description: "System::TimeSpan::ToString yöntemi. Mevcut nesne tarafından temsil edilen zaman aralığının dize temsilini C++'da döndürür."
type: docs
weight: 3400
url: /tr/cpp/system/timespan/tostring/
---
## TimeSpan::ToString() const method


Geçerli nesne tarafından temsil edilen zaman aralığının dize temsilini döndürür.
...
Geçerli nesnenin değerini, belirtilen biçimi kullanarak eşdeğer dize temsiline dönüştürür.
...
Geçerli nesnenin değerini, belirtilen biçim ve biçim sağlayıcısını kullanarak eşdeğer dize temsiline dönüştürür.
