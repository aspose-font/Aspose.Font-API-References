...
description: "System::Timers::Timer sınıfı. C++'de delegeyi döngü içinde çağıran zamanlayıcı."
type: docs
weight: 200
...
| Yöntem | Açıklama |
| --- | --- |
| [Close](./close/)() | Zamanlayıcıyı durdurur, tahsis edilen kaynakları serbest bırakır. |
| [Dispose](./dispose/)() | Zamanlayıcıyı durdurur, tahsis edilen kaynakları serbest bırakır. |
