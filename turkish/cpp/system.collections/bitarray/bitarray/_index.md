---
title: "System::Collections::BitArray::BitArray yapıcı"
linktitle: "BitArray"
second_title: "Aspose.Font için C++"
description: "System::Collections::BitArray::BitArray yapıcı. C++'da kopya yapıcı."
type: docs
weight: 100
url: /tr/cpp/system.collections/bitarray/bitarray/
---
...
| --- | --- | --- |
| bitler | const BitArray\& | Veri kopyalanacak kapsayıcı. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| array | const BitArrayPtr\& | [BitArray](../) kopyalanacak veri. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| bitler | const bitset\& | Veri kopyalanacak kapsayıcı. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değerler | const System::ArrayPtr\<bool\>\& | Eleman bazında veri kopyalanacak kapsayıcı. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değerler | const System::ArrayPtr\<int\>\& | Bit bazında veri kopyalanacak kapsayıcı. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| bayt | const System::ArrayPtr\<uint8_t\>\& | Bit bazında veri kopyalanacak kapsayıcı. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| uzunluk | int | Doldurulacak eleman sayısı. |
| defaultValue | bool | Doldurma değeri. |
