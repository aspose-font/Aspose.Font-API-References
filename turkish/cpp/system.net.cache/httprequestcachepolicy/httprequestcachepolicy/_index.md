---
title: "System::Net::Cache::HttpRequestCachePolicy::HttpRequestCachePolicy yapıcı"
linktitle: "HttpRequestCachePolicy"
second_title: "Aspose.Font için C++"
description: "System::Net::Cache::HttpRequestCachePolicy::HttpRequestCachePolicy yapıcı. C++'ta yeni bir örnek oluşturur."
type: docs
weight: 100
url: /tr/cpp/system.net.cache/httprequestcachepolicy/httprequestcachepolicy/
---
...
| --- | --- | --- |
| cacheSyncDate | DateTime | Önbellekte depolanan kaynakların yeniden doğrulanması gereken zaman. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| cacheAgeControl | HttpCacheAgeControl | Kaynaklar için önbellekleme davranışını kontrol eder. |
| ageOrFreshOrStale | TimeSpan | Bir zaman miktarı. |
...
| --- | --- | --- |
| cacheAgeControl | HttpCacheAgeControl | Kaynaklar için önbellekleme davranışını kontrol eder. |
| maxAge | TimeSpan | Kaynaklar için izin verilen maxAge. |
| freshOrStale | TimeSpan | Bir zaman miktarı. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| seviye | HttpRequestCacheLevel | Kaynaklar için önbellekleme davranışı. |
