...
description: "System::Drawing::Font::Font yapıcı. Belirtilen mevcut fontu belirtilen font stilinde temsil eden Font sınıfının yeni bir örneğini C++'da oluşturur."
type: docs
weight: 100
...
Belirtilen mevcut fontu belirtilen font stilinde temsil eden [Font](../) sınıfının yeni bir örneğini oluşturur.
...
| --- | --- | --- |
| prototip | const SharedPtr\<Font\>\& | Yeni fontun oluşturulacağı mevcut font |
| new_style | FontStyle | Yeni fonta uygulanacak bir font stili |
...
| em_size | float | Yeni yazı tipinin em boyutu, **unit** parametresi tarafından belirtilen birimlerde |
