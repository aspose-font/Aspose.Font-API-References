---
title: "System::Drawing::ImageFormatConverter::ConvertTo metodu"
linktitle: "ConvertTo"
second_title: "Aspose.Font için C++"
description: "System::Drawing::ImageFormatConverter::ConvertTo metodu. C++'de nesneyi belirli bir türe dönüştürür."
type: docs
weight: 300
url: /tr/cpp/system.drawing/imageformatconverter/convertto/
---
...
| --- | --- | --- |
| context | const SharedPtr\<ComponentModel::ITypeDescriptorContext\>\& | [Object](../../../system/object/) dönüştürme bağlamı bilgisi. |
| kültür | const SharedPtr\<Globalization::CultureInfo\>\& | Nesneleri dönüştürürken kullanılacak kültür. |
| value | const SharedPtr\<Object\>\& | [Object](../../../system/object/) dönüştürülecek. |
