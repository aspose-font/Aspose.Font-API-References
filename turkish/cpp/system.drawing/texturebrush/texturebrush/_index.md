...
description: "System::Drawing::TextureBrush::TextureBrush yapıcı. Belirtilen görüntüyü kullanan TextureBrush sınıfının yeni bir örneğini C++'da oluşturur."
type: docs
weight: 100
...
[TextureBrush](../) sınıfının belirtilen görüntüyü kullanan yeni bir örneğini oluşturur.
