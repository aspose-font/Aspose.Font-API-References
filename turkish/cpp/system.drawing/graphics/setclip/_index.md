...
description: "System::Drawing::Graphics::SetClip yöntemi. C++'ta mevcut Graphics nesnesi tarafından temsil edilen çizim yüzeyinin kırpma bölgesini, mevcut kırpma bölgesi ile bir grafik yolu tarafından belirtilen bölgeyi birleştiren belirtilen işlemin sonucuna ayarlar."
type: docs
weight: 8600
...
Mevcut [Graphics](../) nesnesi tarafından temsil edilen çizim yüzeyinin kırpma bölgesini, mevcut kırpma bölgesi ile bir grafik yolu tarafından belirtilen bölgeyi birleştiren belirtilen işlemin sonucuna ayarlar.
...
Mevcut [Graphics](../) nesnesi tarafından temsil edilen çizim yüzeyinin kırpma bölgesini, mevcut kırpma bölgesi ile belirtilen bölgeyi birleştiren belirtilen işlemin sonucuna ayarlar.
