---
title: "System::Drawing::Graphics::DrawArc yöntemi"
linktitle: "DrawArc"
second_title: "Aspose.Font için C++"
description: "System::Drawing::Graphics::DrawArc yöntemi. C++'da mevcut nesne tarafından temsil edilen yüzeyde belirtilen kalemi kullanarak belirtilen yayı çizer."
type: docs
weight: 1000
url: /tr/cpp/system.drawing/graphics/drawarc/
---
## Graphics::DrawArc(const SharedPtr\<Pen\>\&, float, float, float, float, float, float) method


Mevcut nesne tarafından temsil edilen yüzeyde belirtilen kalemi kullanarak belirtilen yayı çizer.
...
| --- | --- | --- |
| kalem | const SharedPtr\<Pen\>\& | Yarı çizerken kullanılacak bir kalem |
...
| sweepAngle | float | Kemerin bitiş noktasına doğru **startAngle**'den saat yönünde ölçülen açı (derece) |
...
| startAngle | int32_t | X ekseninden yay başlangıç noktasına doğru saat yönünde ölçülen açı (derece cinsinden) |
| sweepAngle | int32_t | Kemerin bitiş noktasına doğru **startAngle**'den saat yönünde ölçülen açı (derece) |
