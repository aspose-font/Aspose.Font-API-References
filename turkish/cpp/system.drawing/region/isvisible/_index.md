---
title: "System::Drawing::Region::IsVisible yöntemi"
linktitle: "IsVisible"
second_title: "Aspose.Font için C++"
description: "System::Drawing::Region::IsVisible yöntemi. Belirtilen noktanın, mevcut nesnenin temsil ettiği bölge içinde bulunup bulunmadığını C++'ta belirler."
type: docs
weight: 1400
url: /tr/cpp/system.drawing/region/isvisible/
---
## Region::IsVisible(const Point\&) const method


Belirtilen noktanın, geçerli nesne tarafından temsil edilen bölge içinde bulunup bulunmadığını belirler.
...
| --- | --- | --- |
| nokta | const Point\& | Kontrol edilecek nokta |
...
Belirtilen grafikleri kullanarak, belirtilen noktanın geçerli nesne tarafından temsil edilen bölge içinde bulunup bulunmadığını belirler.
...
| --- | --- | --- |
| nokta | const Point\& | Kontrol edilecek nokta |
| grafik | const SharedPtr\<Graphics\>\& | Grafik bağlamı |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| nokta | const PointF\& | Kontrol edilecek nokta |
...
Belirtilen dikdörtgenin herhangi bir kısmının, geçerli nesne tarafından temsil edilen bölge içinde bulunup bulunmadığını belirler.
...
Belirtilen grafikleri kullanarak, belirtilen dikdörtgenin herhangi bir kısmının geçerli nesne tarafından temsil edilen bölge içinde bulunup bulunmadığını belirler.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| x | float | Kontrol edilecek noktanın X koordinatı |
| y | float | Kontrol edilecek noktanın Y koordinatı |
