---
title: "System::Xml::XPath::XPathDocument::XPathDocument yapıcı"
linktitle: "XPathDocument"
second_title: "Aspose.Font için C++"
description: "System::Xml::XPath::XPathDocument::XPathDocument yapıcı. Belirtilen Stream nesnesindeki XML verilerinden XPathDocument sınıfının yeni bir örneğini C++'ta başlatır."
type: docs
weight: 100
url: /tr/cpp/system.xml.xpath/xpathdocument/xpathdocument/
---
## XPathDocument::XPathDocument(const SharedPtr\<IO::Stream\>\&) constructor


Belirtilen Stream nesnesindeki XML verilerinden [XPathDocument](../) sınıfının yeni bir örneğini başlatır.
...
| --- | --- | --- |
| akış | const SharedPtr\<IO::Stream\>\& | XML verilerini içeren Stream nesnesi. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| textReader | const SharedPtr\<IO::TextReader\>\& | XML verilerini içeren TextReader nesnesi. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| reader | const SharedPtr\<XmlReader\>\& | XML verilerini içeren [XmlReader](../../../system.xml/xmlreader/) nesnesi. |
...
Belirtilen boşluk işleme ayarıyla, belirtilen [XmlReader](../../../system.xml/xmlreader/) nesnesinde bulunan XML verilerinden [XPathDocument](../) sınıfının yeni bir örneğini başlatır.
...
| --- | --- | --- |
| reader | const SharedPtr\<XmlReader\>\& | XML verilerini içeren [XmlReader](../../../system.xml/xmlreader/) nesnesi. |
| space | XmlSpace | [XmlSpace](../../../system.xml/xmlspace/) nesnesi. |
...
Belirtilen dosyadaki XML verilerinden [XPathDocument](../) sınıfının yeni bir örneğini başlatır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| uri | const String\& | XML verilerini içeren dosyanın yolu. |
...
Belirtilen boşluk işleme ayarıyla, belirtilen dosyadaki XML verilerinden [XPathDocument](../) sınıfının yeni bir örneğini başlatır.
