...
description: "System::Globalization::RegionInfo sınıfının RegionInfo yapıcısını C++'de nasıl kullanılır."
type: docs
weight: 100
...
| --- | --- | --- |
| ad | const String\& | Dil & Bölge çifti (sadece bölge değil). Örneğin: "en-US" veya "en_US". |
## Açıklamalar
