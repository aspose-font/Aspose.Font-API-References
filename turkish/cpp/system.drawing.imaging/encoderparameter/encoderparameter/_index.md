---
title: "System::Drawing::Imaging::EncoderParameter::EncoderParameter yapıcı"
linktitle: "EncoderParameter"
second_title: "Aspose.Font için C++"
description: "System::Drawing::Imaging::EncoderParameter::EncoderParameter yapıcı. C++'da EncoderParameter sınıfının yeni bir örneğini oluşturur."
type: docs
weight: 100
url: /tr/cpp/system.drawing.imaging/encoderparameter/encoderparameter/
---
## EncoderParameter::EncoderParameter() constructor


[EncoderParameter](../) sınıfının yeni bir örneğini oluşturur.
...
[EncoderParameter](../) sınıfının değerler dizisini temsil eden yeni bir örneğini oluşturur.
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| değer | const ArrayPtr\<int16_t\>\& | Oluşturulan nesne tarafından temsil edilecek 16-bit tamsayı değerlerinden oluşan bir dizi. |
...
[EncoderParameter](../) sınıfının kesirler dizisini temsil eden yeni bir örneğini oluşturur.
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| pay | const ArrayPtr\<int32_t\>\& | Oluşturulan nesne tarafından temsil edilecek kesirlerin paylarından oluşan bir dizi |
| payda | const ArrayPtr\<int32_t\>\& | Oluşturulan nesne tarafından temsil edilecek kesirlerin paydalarından oluşan bir dizi |
...
[EncoderParameter](../) sınıfının kesir aralıkları dizisini temsil eden yeni bir örneğini oluşturur.
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| pay1 | const ArrayPtr\<int32_t\>\& | Her aralığın en küçük kesirlerinin paylarını içeren bir dizi |
| numerator2 | const ArrayPtr\<int32_t\>\& | Her aralığın kesirlerinin paylarını içeren bir dizi |
| denominator1 | const ArrayPtr\<int32_t\>\& | Her aralığın en küçük kesirlerinin paydalarını içeren bir dizi |
| denominator2 | const ArrayPtr\<int32_t\>\& | Her aralığın en büyük kesirlerinin paydalarını içeren bir dizi |
...
Tam sayılar aralığının bir dizisini temsil eden yeni bir [EncoderParameter](../) sınıfı örneği oluşturur.
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| rangebegin | const ArrayPtr\<int64_t\>\& | Her aralığın en küçük değerlerini içeren bir dizi |
| rangeend | const ArrayPtr\<int64_t\>\& | Her aralığın en büyük değerlerini içeren bir dizi |
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| değer | const ArrayPtr\<int64_t\>\& | Oluşturulan nesne tarafından temsil edilecek 64-bit tam sayı değerlerinden oluşan bir dizi |
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| değer | const ArrayPtr\<uint8_t\>\& | Oluşturulan nesne tarafından temsil edilecek işaretsiz 8-bit tam sayı değerlerinden oluşan bir dizi |
| undefined | bool | Doğru ise **value** dizisindeki değerler tanımsız bir tipe sahip olarak ele alınmalı, aksi takdirde - yanlış |
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| değer | const String\& | Oluşturulan nesne tarafından temsil edilecek bir dize |
...
Belirtilen tampondan okunan, belirtilen tipteki belirtilen sayıda değeri temsil eden yeni bir [EncoderParameter](../) sınıfı örneği oluşturur.
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| numberValues | int | Değer sayısını belirtir |
| tür | EncoderParameterValueType | Değerlerin tipini belirtir |
| değer | void * | Değerlerin okunacağı tamponun bir işaretçisi |
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| değer | int16_t | Oluşturulan nesne tarafından temsil edilecek 16-bit tam sayı değeri |
...
Bir kesiri temsil eden yeni bir [EncoderParameter](../) sınıfı örneği oluşturur.
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| pay | int32_t | Oluşturulan nesne tarafından temsil edilecek kesirin payı |
| payda | int32_t | Oluşturulan nesne tarafından temsil edilecek kesrin paydası |
...
Kesir aralığını temsil eden yeni bir [EncoderParameter](../) sınıfı örneği oluşturur.
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| pay1 | int32_t | Aralıktaki en küçük kesrin payı |
| numerator2 | int32_t | Aralıktaki en büyük kesrin payı |
| demoninator1 | int32_t | Aralıktaki en küçük kesrin paydası |
| demoninator2 | int32_t | Aralıktaki en büyük kesrin paydası |
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| değer | int32_t | Oluşturulan nesne tarafından temsil edilecek 32-bit tam sayı değeri |
...
Tam sayı değer aralığını temsil eden yeni bir [EncoderParameter](../) sınıfı örneği oluşturur.
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| rangebegin | int64_t | Aralıktaki en küçük değer |
| rangeend | int64_t | Aralıktaki en büyük değer |
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| değer | int64_t | Oluşturulan nesne tarafından temsil edilecek 64-bit tam sayı değeri |
...
| --- | --- | --- |
| kodlayıcı | const SharedPtr\<Encoder\>\& | Parametre kategorisini belirtir |
| değer | uint8_t | Oluşturulan nesne tarafından temsil edilecek işaretsiz 8-bit tam sayı değeri |
| undefined | bool | Eğer **value** tanımsız bir tipe sahip olarak ele alınmalıysa true, aksi takdirde false |
