...
description: "System::IO::BinaryWriter::Write yöntemi. Değer ''true'' ise 0, ''false'' ise 1 değerinde tek bir bayt yazar ve bunu C++'ta çıktı akışına gönderir."
type: docs
weight: 800
...
| count | int | Yazılacak alt aralıktaki karakter sayısı; -1, alt aralığın **buffer** dizisinin bittiği yerde sona erdiğini belirtir |
...
Belirtilen [Decimal](../../../system/decimal/) değerinin bayt temsiliğini çıktı akışına yazar.
