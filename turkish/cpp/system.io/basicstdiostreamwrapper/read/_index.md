...
description: "System::IO::BasicSTDIOStreamWrapper::Read yöntemi. Sarma modu ikili ise, akıştan belirtilen sayıda baytı okur, aksi takdirde belirtilen sayıda karakteri okur ve uint8_t tipine dönüştürür. Okumanın sonucunu C++'ta belirtilen bayt dizisine yazar."
type: docs
weight: 400
