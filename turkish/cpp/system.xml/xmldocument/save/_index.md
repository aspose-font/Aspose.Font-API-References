...
description: "System::Xml::XmlDocument::Save yöntemi. XML belgesini belirtilen akışa C++'ta kaydeder."
type: docs
weight: 3700
url: /tr/cpp/system.xml/xmldocument/save/
---
...
| --- | --- | --- |
| outStream | SharedPtr\<IO::Stream\> | Kaydetmek istediğiniz akış. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| yazar | SharedPtr\<IO::TextWriter\> | Kaydetmek istediğiniz TextWriter. |
...
XML belgesini belirtilen [XmlWriter](../../xmlwriter/) ile kaydeder.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| w | SharedPtr\<XmlWriter\> | Kaydetmek istediğiniz [XmlWriter](../../xmlwriter/). |
...
XML belgesini belirtilen dosyaya kaydeder. Belirtilen dosya mevcutsa, bu yöntem onu üzerine yazar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| filename | Dize | Belgeyi kaydetmek istediğiniz dosyanın konumu. |
