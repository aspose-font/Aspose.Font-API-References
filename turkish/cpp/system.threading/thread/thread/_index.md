---
title: "System::Threading::Thread::Thread yapıcı"
linktitle: "Thread"
second_title: "Aspose.Font için C++"
description: "System::Threading::Thread::Thread yapıcı. C++'da yapıcı."
type: docs
weight: 100
url: /tr/cpp/system.threading/thread/thread/
---
...
| --- | --- | --- |
| thread_function | ParameterizedThreadStart | İş parçacığı tarafından yürütülecek fonksiyon. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| t | Thread\& | [Thread](../) veri kopyalanacak. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| thread_function | ThreadStart | İş parçacığı tarafından yürütülecek fonksiyon. |
