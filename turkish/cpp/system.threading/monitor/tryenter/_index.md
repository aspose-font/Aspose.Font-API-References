---
title: "System::Threading::Monitor::TryEnter yöntemi"
linktitle: "TryEnter"
second_title: "Aspose.Font için C++"
description: "System::Threading::Monitor::TryEnter yöntemi. Belirtilen nesne üzerinde ayrıcalıklı bir kilit almaya çalışır C++'ta uygulanmamıştır."
type: docs
weight: 600
url: /tr/cpp/system.threading/monitor/tryenter/
---
## Monitor::TryEnter(const SharedPtr\<Object\>\&) method


Belirtilen nesne üzerinde münhasır kilit almaya çalışır. Uygulanmadı.
...
Belirtilen milisaniye sayısı kadar süreyle, belirtilen nesne üzerinde münhasır kilit almaya çalışır. Uygulanmadı.
...
Belirtilen süre boyunca, belirtilen nesne üzerinde münhasır kilit almaya çalışır. Uygulanmadı.
...
Belirtilen nesne üzerinde münhasır kilit almaya çalışır ve kilidin alınıp alınmadığını gösteren bir değeri atomik olarak ayarlar.
...
Belirtilen süre boyunca, belirtilen nesne üzerinde münhasır kilit almaya çalışır ve kilidin alınıp alınmadığını gösteren bir değeri atomik olarak ayarlar.
