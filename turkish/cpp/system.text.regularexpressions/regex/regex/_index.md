---
title: "System::Text::RegularExpressions::Regex::Regex yapıcı"
linktitle: "Regex"
second_title: "Aspose.Font için C++"
description: "System::Text::RegularExpressions::Regex::Regex yapıcı. C++'ta boş bir düzenli ifade oluşturur."
type: docs
weight: 100
url: /tr/cpp/system.text.regularexpressions/regex/regex/
---
## Regex::Regex() constructor


Boş bir düzenli ifade oluşturur.
...
| --- | --- | --- |
| desen | const String\& | C# sözdizimli desen. |
...
| --- | --- | --- |
| desen | const String\& | C# sözdizimli desen. |
| options | RegexOptions | [Regex](../) eşleştirme seçenekleri. |
...
| desen | const String\& | C# sözdizimli desen. |
| options | RegexOptions | [Regex](../) eşleştirme seçenekleri. |
| matchTimeout | TimeSpan | Eşleşmeyi kesmek için zaman aşımı. |
