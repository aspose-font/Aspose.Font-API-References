---
title: "System::Security::Cryptography::DSA::Create yöntemi"
linktitle: "Create"
second_title: "Aspose.Font için C++"
description: "System::Security::Cryptography::DSA::Create yöntemi. C++'ta varsayılan DSA algoritma uygulamasını oluşturur."
type: docs
weight: 900
url: /tr/cpp/system.security.cryptography/dsa/create/
---
## DSA::Create() method
...
| --- | --- | --- |
| parameters | const DSAParameters\& | [DSA](../) algoritması için parametreler. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| alg_name | const String\& | "System.Security.Cryptography.DSACryptoServiceProvider" olmalıdır. |
