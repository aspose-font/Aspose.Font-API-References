...
| [set_SurroundColors](./set_surroundcolors/)(const ArrayPtr\<Color\>\&) | Establece colores que corresponden a los puntos en la ruta que rellena este [PathGradientBrush](./). |
