...
| [Matrix](./matrix/)(const Rectangle\&, const ArrayPtr\<Point\>\&) | Construye una nueva instancia de la clase [Matrix](./) para la transformación geométrica definida por el rectángulo y la matriz de puntos especificados. |
| [Matrix](./matrix/)(const RectangleF\&, const ArrayPtr\<PointF\>\&) | Construye una nueva instancia de la clase [Matrix](./) para la transformación geométrica definida por el rectángulo y la matriz de puntos especificados. |
...
| [VectorTransformPoints](./vectortransformpoints/)(const ArrayPtr\<Point\>\&) | Multiplica cada vector en un arreglo por la matriz representada por el objeto actual. |
| [VectorTransformPoints](./vectortransformpoints/)(const System::Details::ArrayView\<Point\>\&) | Multiplica cada vector en un arreglo por la matriz representada por el objeto actual. |
