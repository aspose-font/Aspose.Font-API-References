...
description: "System::Drawing::Drawing2D::GraphicsPath::AddString method. Añade una cadena de texto a la ruta representada por el objeto actual en C++."
type: docs
weight: 1600
...
| --- | --- | --- |
| texto | const String\& | El texto a añadir |
...
| emSize | float | La altura de la caja cuadrada em que delimita cada carácter de la cadena |
| origin | Point | Especifica la ubicación donde comienza el texto |
