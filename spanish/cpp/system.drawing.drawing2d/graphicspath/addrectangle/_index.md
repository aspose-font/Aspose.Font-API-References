...
description: "System::Drawing::Drawing2D::GraphicsPath::AddRectangle method. Añade el rectángulo especificado a la ruta representada por el objeto actual en C++."
type: docs
weight: 1400
...
| --- | --- | --- |
| rect | const Rectangle\& | Un rectángulo para añadir |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| rect | const RectangleF\& | Un rectángulo para añadir |
