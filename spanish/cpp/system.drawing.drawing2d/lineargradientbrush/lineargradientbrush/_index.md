...
description: "System::Drawing::Drawing2D::LinearGradientBrush::LinearGradientBrush constructor. Construye una nueva instancia de LinearGradientBrush en C++."
type: docs
weight: 100
url: /es/cpp/system.drawing.drawing2d/lineargradientbrush/lineargradientbrush/
---
## LinearGradientBrush::LinearGradientBrush(const Point\&, const Point\&, const Color\&, const Color\&) constructor


Construye una nueva instancia de [LinearGradientBrush](../).
...
| --- | --- | --- |
| point1 | const Point\& | El punto de inicio del degradado |
| point2 | const Point\& | El punto final del degradado |
| color1 | const Color\& | El color de inicio del degradado |
| color2 | const Color\& | El color final del degradado |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| point1 | const PointF\& | El punto de inicio del degradado |
| point2 | const PointF\& | El punto final del degradado |
| color1 | const Color\& | El color de inicio del degradado |
| color2 | const Color\& | El color final del degradado |
## Observaciones
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| rect | const Rectangle\& | Un rectángulo delimitador del degradado |
| color1 | const Color\& | El color de inicio del degradado |
| color2 | const Color\& | El color final del degradado |
| ángulo | float | El ángulo de la línea de orientación del degradado; medido en grados en sentido horario desde el eje x |
| isAngleScaleable | bool | Especifica si el ángulo del degradado se ve afectado por la transformación asociada con el pincel |
...
| color1 | const Color\& | El color de inicio del degradado |
| color2 | const Color\& | El color final del degradado |
| linearGradientMode | LinearGradientMode | La dirección del degradado |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| rect | const RectangleF\& | Un rectángulo delimitador del degradado |
| color1 | const Color\& | El color de inicio del degradado |
| color2 | const Color\& | El color final del degradado |
| ángulo | float | El ángulo de la línea de orientación del degradado; medido en grados en sentido horario desde el eje x |
| isAngleScaleable | bool | Especifica si el ángulo del degradado se ve afectado por la transformación asociada con el pincel |
