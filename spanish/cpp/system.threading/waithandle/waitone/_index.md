...
description: "Método System::Threading::WaitHandle::WaitOne. Espera a que el manejador se active por un período ilimitado en C++."
type: docs
weight: 600
...
Espera a que el handle se active por un período ilimitado.
...
Espera a que el handle se active.
...
| --- | --- | --- |
| millisecondsTimeout | int | [Timeout](../../timeout/) para esperar, en milisegundos; -1 significa espera infinita, 0 significa comprobar y retornar, los valores positivos son tiempos de espera. |
