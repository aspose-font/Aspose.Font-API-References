...
description: "System::Threading::CancellationToken class. Propaga una notificación de que las operaciones deben cancelarse. Esta clase proporciona un mecanismo de cancelación cooperativa entre hilos, permitiendo que un hilo notifique a los demás que una operación debe cancelarse en C++."
type: docs
weight: 200
