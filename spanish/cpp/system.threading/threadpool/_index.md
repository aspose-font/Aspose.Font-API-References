---
title: "System::Threading::ThreadPool clase"
linktitle: "ThreadPool"
second_title: "Aspose.Font para C++"
description: "System::Threading::ThreadPool clase. API de pool de hilos que permite insertar trabajos en la cola para ser leídos por un conjunto de hilos de trabajo. Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio en C++."
type: docs
weight: 1300
...
| Método | Descripción |
| --- | --- |
| static [GetAvailableThreads](./getavailablethreads/)(int\&, int\&) | Obtiene el número de subprocesos disponibles. |
| static [GetInstance](./getinstance/)() | Información RTTI. |
| static [GetMaxThreads](./getmaxthreads/)(int\&, int\&) | Obtiene el número máximo de subprocesos concurrentes. |
| static [GetMinThreads](./getminthreads/)(int\&, int\&) | Obtiene el número mínimo de subprocesos creados por el grupo. |
| static [JoinAllThreads](./joinallthreads/)() | Une todos los subprocesos propios. Espera indefinidamente. |
| [operator=](./operator=/)(const ThreadPool\&) | Sin copia. |
| static [QueueUserWorkItem](./queueuserworkitem/)(WaitCallback) | Inserta el elemento de trabajo en la cola que está presente con una devolución de llamada sin parámetros. |
| static [QueueUserWorkItem](./queueuserworkitem/)(WaitCallback, const System::SharedPtr\<System::Object\>\&) | Inserta el elemento de trabajo en la cola que está presente con una devolución de llamada sin parámetros. |
| static [SetMaxThreads](./setmaxthreads/)(int, int) | Establece el número de subprocesos propios del grupo. |
| static [SetMinThreads](./setminthreads/)(int, int) | Establece el número mínimo de subprocesos propios del grupo. |
