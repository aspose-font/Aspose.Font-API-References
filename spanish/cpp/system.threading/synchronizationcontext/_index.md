---
title: "System::Threading::SynchronizationContext clase"
...
| Método | Descripción |
| --- | --- |
| static [get_Current](./get_current/)() | Obtiene el contexto de sincronización del hilo actual. |
...
Esta clase permite la propagación del contexto de sincronización entre hilos y se utiliza para marshalar devoluciones de llamada o invocaciones al hilo o contexto de sincronización apropiado.
