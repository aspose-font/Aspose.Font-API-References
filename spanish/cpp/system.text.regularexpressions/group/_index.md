...
| Método | Descripción |
| --- | --- |
| [AddCapture](./addcapture/)(const CapturePtr\&) | Agrega captura al grupo. |
| [get_Captures](./get_captures/)() | Obtiene las capturas disponibles. |
...
| [Group](./group/)() | Constructor de un grupo vacío. |
## Ver también
