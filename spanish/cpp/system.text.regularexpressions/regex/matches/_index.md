...
description: "Método System::Text::RegularExpressions::Regex::Matches. Obtiene todas las coincidencias de la expresión regular en la cadena dada al hacer coincidencias repetidamente en C++."
type: docs
weight: 700
...
| longitud | int | Número de caracteres a examinar (0 desactiva el límite). |

### ReturnValue

Todas las coincidencias encontradas al hacer coincidencias repetidamente.
