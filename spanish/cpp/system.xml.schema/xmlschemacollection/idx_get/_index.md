...
El [XmlSchema](../../xmlschema/) asociado con el URI de espacio de nombres; **nullptr** si no hay un esquema cargado asociado con el espacio de nombres proporcionado o si el espacio de nombres está asociado con un esquema XDR.
