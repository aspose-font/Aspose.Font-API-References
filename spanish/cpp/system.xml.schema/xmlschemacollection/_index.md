...
| Método | Descripción |
| --- | --- |
| [Add](./add/)(const String\&, const String\&) | Agrega el esquema ubicado en la URL proporcionada a la colección de esquemas. |
...
| [Add](./add/)(const String\&, const SharedPtr\<XmlReader\>\&, const SharedPtr\<System::Xml::XmlResolver\>\&) | Agrega el esquema contenido en el [XmlReader](../../system.xml/xmlreader/) a la colección de esquemas. El [XmlResolver](../../system.xml/xmlresolver/) especificado se utiliza para resolver cualquier recurso externo. |
| [Add](./add/)(const SharedPtr\<XmlSchema\>\&) | Agrega el [XmlSchema](../xmlschema/) a la colección. |
| [Add](./add/)(const SharedPtr\<XmlSchema\>\&, const SharedPtr\<System::Xml::XmlResolver\>\&) | Agrega el [XmlSchema](../xmlschema/) a la colección. El [XmlResolver](../../system.xml/xmlresolver/) especificado se utiliza para resolver cualquier referencia externa. |
...
| [CopyTo](./copyto/)(const ArrayPtr\<SharedPtr\<XmlSchema\>\>\&, int32_t) | Copia todos los objetos [XmlSchema](../xmlschema/) de esta colección en la matriz dada comenzando en el índice dado. |
...
| [idx_get](./idx_get/)(const String\&) | Devuelve el [XmlSchema](../xmlschema/) asociado con el URI de espacio de nombres dado. |
...
## Deprecated
La clase XmlSchemaCollection está obsoleta. Utilice XmlSchemaSet en su lugar.
