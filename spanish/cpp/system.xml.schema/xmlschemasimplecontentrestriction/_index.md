...
| [get_BaseTypeName](./get_basetypename/)() | Devuelve el nombre del tipo de datos incorporado o del tipo simple del cual se deriva este tipo. |
| [get_Facets](./get_facets/)() | Devuelve una faceta [Xml](../../system.xml/)[Schema](../). |
...
| [set_BaseTypeName](./set_basetypename/)(const SharedPtr\<XmlQualifiedName\>\&) | Establece el nombre del tipo de datos incorporado o del tipo simple del cual se deriva este tipo. |
