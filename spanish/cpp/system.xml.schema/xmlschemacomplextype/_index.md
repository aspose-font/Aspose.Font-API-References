...
| [get_BlockResolved](./get_blockresolved/)() | Devuelve el valor después de que el tipo haya sido compilado al conjunto de información de post-validación de esquema (infoset). Este valor indica cómo se aplica el tipo cuando se usa **xsi:type** en el documento de instancia. |
