...
| Método | Descripción |
| --- | --- |
| [get_BaseSchemaType](./get_baseschematype/)() | Devuelve el tipo de objeto posterior a la compilación o el tipo de datos incorporado del Lenguaje de Definición de XML [Schema](../) (XSD), elemento simpleType o elemento complexType. Este es un valor de conjunto de información posterior a la compilación del esquema. |
...
| [get_DerivedBy](./get_derivedby/)() | Devuelve la información posterior a la compilación sobre cómo se derivó este elemento de su tipo base. |
| [get_Final](./get_final/)() | Devuelve el atributo final de la derivación del tipo que indica si se permiten más derivaciones. |
| [get_FinalResolved](./get_finalresolved/)() | Devuelve la interpretación posterior a la compilación del valor de [XmlSchemaType::get_Final](./get_final/). |
