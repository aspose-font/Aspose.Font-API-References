---
title: "Método System::Xml::Schema::XmlSchema::Write"
linktitle: "Write"
second_title: "Aspose.Font para C++"
description: "Método System::Xml::Schema::XmlSchema::Write. Escribe el esquema XML en el flujo de datos suministrado en C++."
type: docs
weight: 2800
url: /es/cpp/system.xml.schema/xmlschema/write/
---
## XmlSchema::Write(const SharedPtr\<IO::Stream\>\&) method


Escribe el [Schema](../../) XML en el flujo de datos suministrado.
...
Escribe el [Schema](../../) XML en el flujo suministrado usando el [XmlNamespaceManager](../../../system.xml/xmlnamespacemanager/) especificado.
...
| --- | --- | --- |
| flujo | const SharedPtr\<IO::Stream\>\& | El flujo de datos suministrado. |
| namespaceManager | const SharedPtr\<XmlNamespaceManager\>\& | El [XmlNamespaceManager](../../../system.xml/xmlnamespacemanager/). |
...
Escribe el [Schema](../../) XML en el [IO::TextWriter](../../../system.io/textwriter/) suministrado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| writer | const SharedPtr\<IO::TextWriter\>\& | El [IO::TextWriter](../../../system.io/textwriter/) donde escribir. |
...
Escribe el [Schema](../../) XML en el TextWriter suministrado.
...
Escribe el [Schema](../../) XML en el [XmlWriter](../../../system.xml/xmlwriter/) suministrado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| writer | const SharedPtr\<XmlWriter\>\& | El [XmlWriter](../../../system.xml/xmlwriter/) para escribir. |
