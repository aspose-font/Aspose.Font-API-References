---
title: "Método System::Xml::Schema::XmlSchema::Compile"
linktitle: "Compile"
second_title: "Aspose.Font para C++"
description: "Método System::Xml::Schema::XmlSchema::Compile. Compila el Modelo de Objeto de Esquema XML (SOM) en información de esquema para validación. Se utiliza para comprobar la estructura sintáctica y semántica del SOM creado programáticamente. La comprobación de validación semántica se realiza durante la compilación en C++."
type: docs
weight: 200
...
Compila el [Schema](../../) [Object](../../../system/object/) Model (SOM) de XML en información de esquema para validación. Se utiliza para comprobar la estructura sintáctica y semántica del SOM creado programáticamente. La comprobación de validación semántica se realiza durante la compilación.
