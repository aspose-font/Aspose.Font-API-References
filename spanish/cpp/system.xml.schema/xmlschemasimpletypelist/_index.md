...
description: "Clase System::Xml::Schema::XmlSchemaSimpleTypeList. Representa el elemento list del XML Schema según lo especificado por el Consorcio de la World Wide Web (W3C). Esta clase puede usarse para definir un elemento simpleType como una lista de valores de un tipo de datos especificado en C++."
type: docs
weight: 6400
...
Representa el elemento **list** del XML [Schema](../) según lo especificado por el Consorcio de la World Wide [Web](../../system.web/) (W3C). Esta clase puede usarse para definir un elemento **simpleType** como una lista de valores de un tipo de datos especificado.
