...
Representa el elemento **restriction** para tipos simples del XML [Schema](../) según lo especificado por el World Wide [Web](../../system.web/) Consortium (WCC). Esta clase puede usarse restringiendo el elemento **simpleType**.
