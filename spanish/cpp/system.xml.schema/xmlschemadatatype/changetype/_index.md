...
description: "System::Xml::Schema::XmlSchemaDatatype::ChangeType method. Convierte el valor especificado, cuyo tipo es una de las representaciones válidas del tipo de esquema XML representado por el XmlSchemaDatatype, al tipo de tiempo de ejecución especificado en C++."
type: docs
weight: 100
...
Convierte el valor especificado, cuyo tipo es una de las representaciones válidas del tipo de esquema XML representado por el [XmlSchemaDatatype](../), al tipo de tiempo de ejecución especificado mediante el [IXmlNamespaceResolver](../../../system.xml/ixmlnamespaceresolver/) si el [XmlSchemaDatatype](../) representa el tipo **xs:QName** o un tipo derivado de él.
