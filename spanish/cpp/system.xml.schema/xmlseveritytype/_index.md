---
title: "System::Xml::Schema::XmlSeverityType enumeración"
...
| --- | --- | --- |
| Error | 0 | Indica que se produjo un error de validación al validar el documento de instancia. Esto se aplica a definiciones de tipo de documento (DTDs) y esquemas de lenguaje de definición XML [Schema](../) (XSD). Las restricciones de validez del Consorcio World Wide [Web](../../system.web/) (W3C) se consideran errores. Si no se ha creado un controlador de eventos de validación, los errores lanzan una excepción. |
