...
description: "Clase System::Xml::Schema::XmlSchemaGroupRef. Representa el elemento group con atributo ref del XML Schema según lo especificado por el World Wide Web Consortium (W3C). Esta clase se usa dentro de tipos complejos que hacen referencia a un group definido a nivel de schema en C++."
type: docs
weight: 3300
...
Representa el elemento **group** con atributo **ref** del XML [Schema](../) según lo especificado por el World Wide [Web](../../system.web/) Consortium (W3C). Esta clase se usa dentro de tipos complejos que hacen referencia a un **group** definido a nivel de **schema**.
