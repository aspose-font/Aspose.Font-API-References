---
title: "Método System::Xml::Schema::XmlSchemaSet::Schemas"
linktitle: "Esquemas"
second_title: "Aspose.Font para C++"
description: "Método System::Xml::Schema::XmlSchemaSet::Schemas. Devuelve una colección de todos los esquemas de definición de XML Schema (XSD) del XmlSchemaSet en C++."
type: docs
weight: 1600
...
Devuelve una colección de todos los esquemas de definición de XML [Schema](../../) (XSD) del [XmlSchemaSet](../).
...
Devuelve una colección de todos los esquemas de definición de XML [Schema](../../) (XSD) del [XmlSchemaSet](../) que pertenecen al espacio de nombres especificado.
