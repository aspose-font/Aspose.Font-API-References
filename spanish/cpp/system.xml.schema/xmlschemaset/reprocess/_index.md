...
description: "Método System::Xml::Schema::XmlSchemaSet::Reprocess. Reprocesa un esquema de definición de XML Schema (XSD) que ya existe en el XmlSchemaSet en C++."
type: docs
weight: 1500
...
Reprocesa un esquema de definición de XML [Schema](../../) (XSD) que ya existe en el [XmlSchemaSet](../).
...
| --- | --- | --- |
| esquema | SharedPtr\<XmlSchema\> | El esquema para reprocesar. |
