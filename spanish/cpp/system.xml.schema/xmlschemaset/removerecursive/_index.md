...
description: "System::Xml::Schema::XmlSchemaSet::RemoveRecursive método. Elimina el esquema del lenguaje de definición de XML Schema (XSD) especificado y todos los esquemas que importa del XmlSchemaSet en C++."
type: docs
weight: 1400
...
Elimina el esquema del lenguaje de definición de XML [Schema](../../) (XSD) especificado y todos los esquemas que importa del [XmlSchemaSet](../).
