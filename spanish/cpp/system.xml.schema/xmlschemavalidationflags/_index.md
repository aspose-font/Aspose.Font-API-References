...
description: "System::Xml::Schema::XmlSchemaValidationFlags enumeración. Especifica las opciones de validación de esquema utilizadas por las clases XmlSchemaValidator y XmlReader en C++."
type: docs
weight: 7900
...
| ProcessSchemaLocation | 2 | Procesar indicaciones de ubicación de esquema (**xsi:schemaLocation**, **xsi:noNamespaceSchemaLocation**) encontradas durante la validación. |
| ReportValidationWarnings | 4 | Informar advertencias de validación de esquema encontradas durante la validación. |
