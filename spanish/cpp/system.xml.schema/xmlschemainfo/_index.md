...
description: "Clase System::Xml::Schema::XmlSchemaInfo. Representa el conjunto de información posterior a la validación de esquema de un nodo XML validado en C++."
type: docs
weight: 3800
...
| [set_IsDefault](./set_isdefault/)(bool) | Establece un valor que indica si este nodo XML validado se estableció como resultado de la aplicación de un valor predeterminado durante la validación del esquema XML [Schema](../) Definition Language (XSD). |
