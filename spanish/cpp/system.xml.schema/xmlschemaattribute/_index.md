...
description: "Clase System::Xml::Schema::XmlSchemaAttribute. Representa el elemento attribute del XML Schema según lo especificado por el Consorcio World Wide Web (W3C). Los atributos proporcionan información adicional para otros elementos del documento. La etiqueta attribute se anida entre las etiquetas del elemento de un documento para el esquema. El documento XML muestra los atributos como elementos con nombre en la etiqueta de apertura de un elemento en C++."
type: docs
weight: 1100
...
| [get_Use](./get_use/)() | Devuelve información sobre cómo se utiliza el atributo. |
...
| [set_Use](./set_use/)(XmlSchemaUse) | Establece información sobre cómo se utiliza el atributo. |
