...
description: "System::Collections::Specialized::BitVector32 class. Proporciona un vector de bits ligero y simple con acceso fácil a enteros o Boolean a un almacenamiento de 32 bits en C++."
type: docs
weight: 100
...
Proporciona un vector de bits ligero y simple con acceso fácil a enteros o [Boolean](../../system/boolean/) a un almacenamiento de 32 bits.
