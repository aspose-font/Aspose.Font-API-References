...
description: "System::Collections::Specialized::NameValueCollection::Add method. Anula el método ICollection - no implementado en C++."
type: docs
weight: 200
url: /es/cpp/system.collections.specialized/namevaluecollection/add/
---
## NameValueCollection::Add(const String\&) method


Anula el método [ICollection](../../../system.collections/icollection/) - no implementado.
