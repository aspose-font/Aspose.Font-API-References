...
description: "System::Collections::Specialized::NameValueCollection class. Colección de claves String asociadas y valores String que pueden accederse tanto por la clave como por el índice en C++."
type: docs
weight: 200
...
| [Add](./add/)(const System::SharedPtr\<NameValueCollection\>\&) | Copia las entradas de la [NameValueCollection](./) especificada a la actual. |
