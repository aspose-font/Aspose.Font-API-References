...
| Método | Descripción |
| --- | --- |
| [CopyFrom](./copyfrom/)(const SharedPtr\<AsnEncodedData\>\&) override | Copia los datos de la extensión de otro objeto. |
