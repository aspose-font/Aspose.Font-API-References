...
| contraseña | const SecureStringPtr\& | Contraseña utilizada para acceder a los datos del certificado. |
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Secuencia de bytes que representa el certificado codificado. |
| contraseña | const String\& | Contraseña utilizada para acceder a los datos del certificado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| filename | const String\& | Archivo del cual cargar el certificado. |
