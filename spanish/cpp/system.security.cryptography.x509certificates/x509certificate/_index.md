...
| [get_Handle](./get_handle/)() const | Obtiene un manejador del contexto de certificado de la API criptográfica de Microsoft. |
...
| virtual [GetIssuerName](./getissuername/)() const | Obtiene el nombre de la autoridad de certificación que emitió el certificado actual. |
