...
Construye información de propiedad booleana a partir de la clase con un getter const.
...
Construye información de la propiedad booleana.
...
Construye información de propiedad int64_t a partir de la clase con un getter const.
...
Construye la información de la propiedad [Decimal](../../../system/decimal/) a partir de la clase con un getter const.
...
Construye información de la propiedad de cadena a partir de una clase con getter const.
