...
description: "System::Xml::Resolvers::XmlPreloadedResolver::GetEntity method. Mapea un URI a un objeto que contiene el recurso real en C++."
type: docs
weight: 400
...
| ofObjectToReturn | const TypeInfo\& | El tipo de objeto a devolver. El [XmlPreloadedResolver](../) admite objetos Stream y objetos TextReader para URIs que se añadieron como [String](../../../system/string/). Si el tipo solicitado no es compatible con el resolvedor, se lanzará una excepción. Utilice el método XmlPreloadedResolver::SupportsType(SharedPtr<Uri>,TypeInfo) para determinar si un determinado **Type** es compatible con este resolvedor. |
