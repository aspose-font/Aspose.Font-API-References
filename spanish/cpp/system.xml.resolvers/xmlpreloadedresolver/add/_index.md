...
description: "System::Xml::Resolvers::XmlPreloadedResolver::Add method. Añade una matriz de bytes al almacén XmlPreloadedResolver y lo asigna a un URI. Si el almacén ya contiene una asignación para el mismo URI, la asignación existente se sobrescribe en C++."
type: docs
weight: 200
...
Añade una matriz de bytes al almacén [XmlPreloadedResolver](../) y lo asigna a un URI. Si el almacén ya contiene una asignación para el mismo URI, la asignación existente se sobrescribe.
...
| --- | --- | --- |
| uri | const SharedPtr\<Uri\>\& | El URI de los datos que se están añadiendo al almacén [XmlPreloadedResolver](../). |
...
Añade un Stream al almacén [XmlPreloadedResolver](../) y lo asigna a un URI. Si el almacén ya contiene una asignación para el mismo URI, la asignación existente se sobrescribe.
...
Añade una cadena con datos precargados al almacén [XmlPreloadedResolver](../) y lo asigna a un URI. Si el almacén ya contiene una asignación para el mismo URI, la asignación existente se sobrescribe.
