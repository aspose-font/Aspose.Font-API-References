...
| --- | --- | --- |
| buffer | System::ArrayPtr\<uint8_t\> | Los datos a enviar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| búferes | System::SharedPtr\<Collections::Generic::IList\<ArraySegment\<uint8_t\>\>\> | Una colección de matrices de bytes de los cuales se deben enviar los datos. |
