...
description: "Clase System::Net::Sockets::Socket. La clase Socket implementa la interfaz Berkeley sockets en C++."
type: docs
weight: 400
...
La clase [Socket](./) implementa la interfaz Berkeley sockets.
...
| [Bind](./bind/)(System::SharedPtr\<EndPoint\>) | Asocia el socket al punto final local especificado. |
| [Close](./close/)() | Cierra la conexión del socket. |
| [Close](./close/)(int) | Cierra la conexión del socket con el tiempo de espera especificado para permitir que los datos en cola se envíen. |
