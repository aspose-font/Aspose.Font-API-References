...
| --- | --- | --- |
| socket | System::SharedPtr\<System::Net::Sockets::Socket\> | El socket que se utiliza para enviar y recibir datos. |
...
| --- | --- | --- |
| socket | System::SharedPtr\<System::Net::Sockets::Socket\> | El socket que se utiliza para enviar y recibir datos. |
| ownsSocket | bool | Un valor que indica si la instancia actual toma posesión del socket especificado cuando el valor es true. |
