...
| [EndAcceptSocket](./endacceptsocket/)(System::SharedPtr\<IAsyncResult\>) | Espera hasta que la operación asíncrona de aceptación especificada se complete. |
| [EndAcceptTcpClient](./endaccepttcpclient/)(System::SharedPtr\<IAsyncResult\>) | Espera hasta que la operación asíncrona de aceptación especificada se complete. |
...
| [Stop](./stop/)() | Deja de escuchar las conexiones entrantes. |
