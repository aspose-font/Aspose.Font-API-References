...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| puerto | int32_t | el número de puerto local desde el cual se pretende comunicar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre de host | Cadena | El nombre del host DNS remoto al que se pretende conectar. |
| puerto | int32_t | El número de puerto local desde el cual se pretende comunicar. |
...
Inicializa una nueva instancia de la clase [UdpClient](../). param local EP el punto final local al que se enlaza la conexión UDP.
