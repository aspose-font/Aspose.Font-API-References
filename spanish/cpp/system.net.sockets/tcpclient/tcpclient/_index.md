...
description: "Constructor de System::Net::Sockets::TcpClient::TcpClient. Construye una nueva instancia en C++."
type: docs
weight: 100
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre de host | Cadena | Un nombre de host remoto al que conectar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| localEP | System::SharedPtr\<IPEndPoint\> | El punto final al que está enlazado el socket. |
