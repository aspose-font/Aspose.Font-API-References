...
description: "Constructor de System::Net::Sockets::IPPacketInformation::IPPacketInformation. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net.sockets/ippacketinformation/ippacketinformation/
---
...
| --- | --- | --- |
| dirección | System::SharedPtr\<IPAddress\> | La dirección desde la que se recibe el paquete. |
| networkInterface | int32_t | La información de la interfaz de red. |
