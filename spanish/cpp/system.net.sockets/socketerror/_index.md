...
description: "System::Net::Sockets::SocketError enumeración. Enumera los tipos de error del socket en C++."
type: docs
weight: 1300
...
| InvalidArgument | 10022 | Se proporcionó un argumento inválido. |
...
| ProtocolType | 10041 | Este tipo de protocolo no es compatible con este socket. |
...
| ConnectionReset | 10054 | Una conexión es restablecida por un par remoto. |
...
| TimedOut | 10060 | Un intento de conexión expiró, o un host conectado no ha respondido. |
