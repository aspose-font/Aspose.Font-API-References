...
Define los nombres de opciones de socket para la clase [Socket](../socket/) class.
...
| --- | --- | --- |
| Depurar | 1 | Registrar información de depuración. |
...
| MaxConnections | 2147483647 | Esta opción no es compatible. Se utilizaba para especificar la longitud máxima de la cola para la escucha. |
...
| MulticastInterface | 9 | Establezca la interfaz para los paquetes multicast salientes. |
| MulticastTimeToLive | 10 | El tiempo de vida del multicast IP. |
| MulticastLoopback | 11 | El bucle de retorno del multicast IP. |
| AddMembership | 12 | Agregue una membresía de grupo IP. |
| DropMembership | 13 | Elimine una membresía de grupo IP. |
| DontFragment | 14 | No fragmentar los datagramas IP. |
| AddSourceMembership | 15 | Únase al grupo/fuente IP. |
| DropSourceMembership | 16 | Elimine el grupo/fuente IP. |
| BlockSource | 17 | Bloquee el grupo/fuente IP. |
...
| IPProtectionLevel | 23 | Permite restringir un socket IPv6 al ámbito especificado. |
| IPv6Only | 27 | El socket está restringido a enviar y recibir paquetes IPv6 solo. |
...
| ChecksumCoverage | 20 | Establece o obtiene la cobertura de suma de verificación UDP. |
