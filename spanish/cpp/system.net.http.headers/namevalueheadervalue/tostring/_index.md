...
description: "System::Net::Http::Headers::NameValueHeaderValue::ToString method. Análogo al método Object.ToString() de C#. Permite convertir objetos personalizados a cadena en C++."
type: docs
weight: 700
url: /es/cpp/system.net.http.headers/namevalueheadervalue/tostring/
---
...
| separador | char16_t | Un separador de cadena. |
| leadingSeparator | bool | El valor que indica si el separador de cadena debe añadirse antes del primer elemento de la colección. |
...
| separador | char16_t | Un separador de cadena. |
| leadingSeparator | bool | El valor que indica si el separador de cadena debe añadirse antes del primer elemento de la colección. |
| destination | System::SharedPtr\<Text::StringBuilder\> | Una instancia donde se asignará una representación en cadena. |
