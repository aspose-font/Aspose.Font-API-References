...
description: "System::Net::Http::Headers::ContentRangeHeaderValue::ContentRangeHeaderValue constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net.http.headers/contentrangeheadervalue/contentrangeheadervalue/
---
...
| --- | --- | --- |
| from | int64_t | Una posición en la que debe comenzar el envío de datos. |
| to | int64_t | Una posición en la que el envío de datos debe s |
...
| --- | --- | --- |
| from | int64_t | Una posición en la que debe comenzar el envío de datos. |
| to | int64_t | Una posición en la que el envío de datos debe detenerse. |
| longitud | int64_t | La longitud de un cuerpo de entidad. |
