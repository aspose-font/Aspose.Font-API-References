...
| static [Parse](./parse/)(String) | Convierte una cadena pasada en una instancia de la clase [WarningHeaderValue](./). |
...
| static [TryParse](./tryparse/)(String, System::SharedPtr\<WarningHeaderValue\>\&) | Intenta convertir una cadena pasada en una instancia de la clase [WarningHeaderValue](./). |
