...
description: "System::Net::Http::Headers::ViaHeaderValue::ViaHeaderValue constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net.http.headers/viaheadervalue/viaheadervalue/
---
...
| --- | --- | --- |
| protocolVersion | Cadena | La versión del protocolo. |
| receivedBy | Cadena | El host y el puerto por los que se recibió la solicitud o respuesta. |
...
| protocolVersion | Cadena | La versión del protocolo. |
| receivedBy | Cadena | El host y el puerto por los que se recibió la solicitud o respuesta. |
| protocolName | Cadena | El nombre del protocolo. |
...
| receivedBy | Cadena | El host y el puerto por los que se recibió la solicitud o respuesta. |
| protocolName | Cadena | El nombre del protocolo. |
| comentario | Cadena | El comentario. |
