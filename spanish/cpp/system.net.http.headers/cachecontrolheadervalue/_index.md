...
| [get_Extensions](./get_extensions/)() | Devuelve la colección de los tokens de cache-extension. |
...
| [get_ProxyRevalidate](./get_proxyrevalidate/)() | Obtiene el valor que determina si el servidor requiere revalidación de una entrada de caché cuando se vuelve obsoleta para las cachés de agentes de usuario compartidas. |
...
| [set_MaxStale](./set_maxstale/)(bool) | Establece el valor que determina si el cliente aceptará respuestas expiradas. |
| [set_MaxStaleLimit](./set_maxstalelimit/)(Nullable\<TimeSpan\>) | Establece el valor en segundos que determina el tiempo durante el cual el cliente aceptará respuestas expiradas. |
...
| [set_ProxyRevalidate](./set_proxyrevalidate/)(bool) | Establece el valor que determina si el servidor requiere revalidación de una entrada de caché cuando se vuelve obsoleta para las cachés de agentes de usuario compartidas. |
...
| [set_SharedMaxAge](./set_sharedmaxage/)(Nullable\<TimeSpan\>) | Establece el valor de edad máxima compartida en segundos que sobrescribe la directiva 'max-age' en el encabezado 'Cache-Control' o el encabezado 'Expires' para una caché compartida. |
