...
| Revalidate | 4 | Usando una copia local del recurso si la marca de tiempo del cliente es la misma que la marca de tiempo del recurso en el servidor. De lo contrario, el recurso se descarga de un servidor. |
| Reload | 5 | Un recurso siempre se descarga del servidor. |
| NoCacheNoStore | 6 | Nunca satisface una solicitud usando recursos del caché y no almacena recursos en caché. |
...
| Actualizar | 8 | Satisface una solicitud utilizando el servidor o una caché distinta de la caché local. |
