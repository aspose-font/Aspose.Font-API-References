...
description: "System::Net::Cache::HttpRequestCachePolicy::HttpRequestCachePolicy constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net.cache/httprequestcachepolicy/httprequestcachepolicy/
---
...
| --- | --- | --- |
| cacheSyncDate | DateTime | El tiempo en que los recursos almacenados en la caché deben volver a validarse. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| cacheAgeControl | HttpCacheAgeControl | Controla el comportamiento de caché de los recursos. |
| ageOrFreshOrStale | TimeSpan | Una cantidad de tiempo. |
...
| --- | --- | --- |
| cacheAgeControl | HttpCacheAgeControl | Controla el comportamiento de caché de los recursos. |
| maxAge | TimeSpan | La edad máxima permitida para los recursos. |
| freshOrStale | TimeSpan | Una cantidad de tiempo. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nivel | HttpRequestCacheLevel | El comportamiento de caché de los recursos. |
