...
Verifica si el tipo es una especialización de [System::Collections::Generic::List](../../system.collections.generic/list/). Si es así, el miembro value se establece en true; de lo contrario, se establece en false.
