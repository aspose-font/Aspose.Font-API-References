...
| nombre | System::String | El nombre del papel. |
| width | int32_t | El ancho del papel, en centésimas de pulgada. |
| height | int32_t | La altura del papel, en centésimas de pulgada. |
