---
title: "Método System::setter_decrement_wrap"
linktitle: "setter_decrement_wrap"
second_title: "Aspose.Font para C++"
description: "Método System::setter_decrement_wrap. El traductor traduce las expresiones de predecremento de C#''s que apuntan a la propiedad de instance''s que tiene setter y getter definidos, en una invocación de esta función (sobrecarga para const getter) en C++."
type: docs
weight: 37200
...
El traductor traduce las expresiones de predecremento de C#'s que apuntan a la propiedad de instance's que tiene setter y getter definidos, en una invocación de esta función (sobrecarga para const getter).
