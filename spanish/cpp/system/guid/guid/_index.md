...
description: "Constructor System::Guid::Guid. Construye un objeto que representa un GUID compuesto únicamente de ceros en C++."
type: docs
weight: 100
...
Construye una instancia de la clase [Guid](../) a partir de los componentes GUID especificados.
