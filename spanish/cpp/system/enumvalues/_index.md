...
Proporciona información meta sobre las constantes de enumeración del tipo de enumeración **E**.
...
| [GetNames](./getnames/)() const override | Devuelve un arreglo que contiene todos los nombres de la enumeración **E**. |
| static [GetNames](../enumvaluesbase/getnames/)(const TypeInfo\&) | Recupera un arreglo con los nombres de las constantes en una enumeración especificada. |
...
| [GetValues](./getvalues/)() const override | Devuelve un arreglo que contiene todos los valores de la enumeración **E**. |
| static [GetValues](../enumvaluesbase/getvalues/)(const TypeInfo\&) | Devuelve un arreglo que contiene todos los valores del tipo de enumeración especificado. |
