---
title: "Clase System::Int32"
linktitle: "Int32"
second_title: "Aspose.Font para C++"
description: "Clase System::Int32. Contiene métodos para trabajar con el entero de 32 bits en C++."
type: docs
weight: 4100
...
| static [Parse](./parse/)(const String\&, const SharedPtr\<IFormatProvider\>\&) | Convierte la cadena especificada que contiene la representación textual de un número al entero con signo de 32 bits equivalente utilizando la información de formato proporcionada. |
...
| static [Parse](./parse/)(const String\&, Globalization::NumberStyles, const SharedPtr\<IFormatProvider\>\&) | Convierte la cadena especificada que contiene la representación textual de un número al entero con signo de 32 bits equivalente utilizando la información de formato y el estilo numérico proporcionados. |
