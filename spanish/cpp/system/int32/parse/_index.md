...
Convierte la cadena especificada que contiene la representación textual de un número al entero con signo de 32 bits equivalente utilizando la información de formato proporcionada.
...
Convierte la cadena especificada que contiene la representación textual de un número al entero con signo de 32 bits equivalente utilizando la información de formato y el estilo numérico proporcionados.
