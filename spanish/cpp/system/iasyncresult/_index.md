...
| Método | Descripción |
| --- | --- |
| virtual [get_AsyncState](./get_asyncstate/)() | Devuelve un objeto que contiene la información sobre la operación asincrónica. |
| virtual [get_AsyncWaitHandle](./get_asyncwaithandle/)() | Devuelve una instancia de WaitHandle que puede usarse para esperar la finalización de la operación asincrónica. |
| virtual [get_CompletedSynchronously](./get_completedsynchronously/)() | Devuelve un valor que indica si la operación asincrónica se completó de forma sincrónica. |
| virtual [get_IsCompleted](./get_iscompleted/)() | Devuelve un valor que indica si la operación asincrónica ha finalizado. |
