...
description: "Método System::Buffer::GetByte. Interpreta la matriz tipada especificada como una matriz de bytes sin procesar y recupera el valor de byte en el desplazamiento de bytes especificado en C++."
type: docs
weight: 300
...
Interpreta la matriz tipada especificada como una matriz cruda de bytes y recupera el valor de byte en el desplazamiento de byte especificado.
