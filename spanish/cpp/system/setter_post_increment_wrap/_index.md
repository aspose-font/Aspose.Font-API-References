...
description: "System::setter_post_increment_wrap method. El traductor traduce las expresiones de post‑incremento de C#''s que apuntan a la propiedad de instance''s que tiene setter y getter definidos, en una invocación de esta función (sobrecarga para const getter) en C++."
type: docs
weight: 38000
...
El traductor traduce las expresiones de post‑incremento de C#'s que apuntan a la propiedad de instance's que tiene setter y getter definidos, en una invocación de esta función (sobrecarga para const getter).
...
El traductor traduce las expresiones de post‑incremento de C#'s que apuntan a la propiedad de instance's que tiene setter y getter definidos, en una invocación de esta función (sobrecarga para getter no const).
...
El traductor traduce las expresiones de post‑incremento de C# que apuntan a la propiedad de una clase que tiene setter y getter definidos, en una invocación de esta función.
