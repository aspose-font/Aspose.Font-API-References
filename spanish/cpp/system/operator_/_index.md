...
---
título: Método System::operator<
título del enlace: operator<
segundo_título: Aspose.Font para C++
description: 'System::operator< método. Determina si el valor especificado es menor que el valor representado por el objeto Nullable especificado al aplicar operator<() a estos valores en C++.'
tipo: documentos
peso: 28700
...
título del enlace: operator>
segundo_título: Aspose.Font para C++
description: 'System::operator> método. Determina si el valor especificado es mayor que el valor representado por el objeto Nullable especificado al aplicar operator>() a estos valores en C++.'
tipo: documentos
peso: 34200
url: /cpp/system/operator_/
---
