...
| --- | --- |
| To | El tipo al que se debe castear estáticamente los elementos del objeto enumerable |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| enumerable | const From\& | es heredero del objeto Enumerable con el método get_Count definido y que contiene los elementos para convertir |
