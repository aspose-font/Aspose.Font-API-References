...
| [Equals](./equals/)(SharedPtr\<Object\>) override | Determina si los URI representados por el objeto actual y el especificado son iguales. |
...
| [get_Authority](./get_authority/)() const | Devuelve el nombre de host y el número de puerto de un servidor. |
...
| [GetHashCode](./gethashcode/)() const override | Obtiene el código hash para el URI. |
| [GetLeftPart](./getleftpart/)(UriPartial) | Devuelve la porción especificada del URI representado por el objeto actual. |
| static [HexEscape](./hexescape/)(char16_t) | Devuelve el equivalente hexadecimal del carácter especificado. |
...
| [IsWellFormedOriginalString](./iswellformedoriginalstring/)() const | Indica si la cadena utilizada para construir este [Uri](./) estaba bien formada y no requiere ser escapada adicionalmente. |
...
| [MakeRelativeUri](./makerelativeuri/)(const SharedPtr\<Uri\>\&) | Determina la diferencia entre los URI representados por el objeto actual y el objeto [Uri](./) especificado. |
...
| static [TryCreate](./trycreate/)(const SharedPtr\<Uri\>\&, const String\&, SharedPtr\<Uri\>\&) | Construye un [Uri](./) abject a partir del objeto [Uri](./) especificado que representa el URI base y la representación en cadena del URI relativo. |
| static [TryCreate](./trycreate/)(const SharedPtr\<Uri\>\&, const SharedPtr\<Uri\>\&, SharedPtr\<Uri\>\&) | Construye un [Uri](./) abject a partir de los URI base y relativo especificados. |
...
| [Uri](./uri/)(const String\&, bool) | Construye un objeto [Uri](./) que representa el URI especificado; un argumento indica si el URI debe escaparse. |
| [Uri](./uri/)(const SharedPtr\<Uri\>\&, const String\&, bool) | Construye un [Uri](./) abject a partir del objeto [Uri](./) especificado que representa el URI base y la representación en cadena del URI relativo; un argumento indica si el URI debe escaparse. |
...
| [Uri](./uri/)(const SharedPtr\<Uri\>\&, const String\&) | Construye un [Uri](./) abject a partir de los URI base y relativo especificados. |
| [Uri](./uri/)(const SharedPtr\<Uri\>\&, const SharedPtr\<Uri\>\&) | Construye un [Uri](./) abject a partir de los URI base y relativo especificados. |
## Campos
...
| static [UriSchemeNetPipe](./urischemenetpipe/) | Especifica que el [Uri](./) se accede a través del esquema NetPipe usado por la Fundación de Comunicación de [Windows](../../system.windows/). |
| static [UriSchemeNetTcp](./urischemenettcp/) | Especifica que el [Uri](./) se accede a través del esquema NetTcp usado por la Fundación de Comunicación de [Windows](../../system.windows/). |
