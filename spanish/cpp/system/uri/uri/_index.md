...
description: "Constructor System::Uri::Uri. Construye un objeto Uri a partir de los URIs base y relativo especificados en C++."
type: docs
weight: 100
...
Construye un objeto [Uri](../) a partir del URI base y los URI relativos especificados.
...
Construye un [Uri](../) objeto a partir del [Uri](../) especificado que representa el URI base y la representación en cadena del URI relativo; un argumento especifica si el URI debe escaparse.
...
Construye un objeto [Uri](../) que representa el URI especificado; un argumento especifica si el URI debe escaparse.
