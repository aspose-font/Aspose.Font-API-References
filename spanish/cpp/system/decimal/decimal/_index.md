---
title: "Constructor System::Decimal::Decimal"
linktitle: "Decimal"
second_title: "Aspose.Font para C++"
description: "Constructor System::Decimal::Decimal. Construye una instancia que representa 0 en C++."
type: docs
weight: 100
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | const number_type\& | Una referencia constante al valor que será representado por el objeto que se está construyendo |
...
| medio | int32_t | Los 32 bits intermedios del valor |
| hola | int32_t | Los 32 bits superiores del valor |
| isNegative | bool | Especifica si el valor es negativo |
| escala | uint8_t | Una potencia de 10 que va de 0 a 28 |
