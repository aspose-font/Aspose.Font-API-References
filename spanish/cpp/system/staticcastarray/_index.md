...
description: "Método System::StaticCastArray. Realiza el casting de los elementos del arreglo especificado a un tipo diferente. Sobrescribe para los casos en que From es un objeto SmartPtr en C++."
type: docs
weight: 39900
...
Realiza el casting de los elementos del arreglo especificado a un tipo diferente. Sobrescribe para los casos en que From es un objeto [SmartPtr](../smartptr/).
...
Realiza el casting de los elementos del arreglo especificado a un tipo diferente. Sobrescribe para los casos en que From es Boxable y To es [Object](../object/)[].
