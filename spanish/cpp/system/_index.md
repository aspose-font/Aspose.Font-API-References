...
| [BoxedValueBase](./boxedvaluebase/) | Una clase base que define una interfaz e implementa algunos métodos fundamentales de una clase descendiente que representa un valor empaquetado. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](./makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](./smartptr/) y use este puntero para pasarla a funciones como argumento. |
| [Buffer](./buffer/) | Contiene métodos que manipulan matrices de bytes crudas. Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio. |
...
| [Console](./console/) | Proporciona métodos para la salida de datos al flujo de salida estándar. Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio. |
...
| [EnumValues](./enumvalues/) | Proporciona información meta sobre las constantes de enumeración del tipo de enumeración **E**. |
| [EnumValuesBase](./enumvaluesbase/) | Una clase base para una clase que representa información meta del tipo de enumeración. |
...
| [IFormattable](./iformattable/) | Define un método que formatea el valor del objeto actual usando la cadena de formato especificada y el proveedor de formato. |
...
| [MulticastDelegate< ReturnType(ArgumentTypes...)>](./multicastdelegate_returntype(argumenttypes...)_/) | Representa una colección de delegados. Este tipo debe ser asignado en la pila y pasado a funciones por valor o por referencia. Nunca use la clase [System::SmartPtr](./smartptr/) para gestionar objetos de este tipo. |
...
| [TypeInfo](./typeinfo/) | Representa un tipo concreto y proporciona información sobre él. |
...
| [UriParser](./uriparser/) | Se utiliza para analizar un nuevo esquema URI. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](./makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](./smartptr/) y use ese puntero para pasarlo a funciones como argumento. |
...
| [WeakReference](./weakreference/) | Representa una referencia débil, que referencia un objeto mientras aún permite que ese objeto sea eliminado. |
| [WeakReference< T >](./weakreference_t_/) | Representa una referencia débil, que referencia un objeto mientras aún permite que ese objeto sea eliminado. |
| [WeakReference<>](./weakreference__/) | Representa una referencia débil, que referencia un objeto mientras aún permite que ese objeto sea eliminado. |
## Enums
...
| [SmartPtrMode](./smartptrmode/) | Tipo de puntero [SmartPtr](./smartptr/): débil o compartido. Define si el puntero se cuenta al decidir si se elimina el objeto o no. |
...
| Typedef | Descripción |
| --- | --- |
| [Action](./action/) | Tipo de delegado que referencia métodos que no tienen valor de retorno. |
| [AggregateException](./aggregateexception/) |  |
| [ArrayPtr](./arrayptr/) | Alias para el tipo 'puntero a matriz'. |
| [AsyncCallback](./asynccallback/) | Un tipo de delegado que representa un método que se llamará cuando la operación asíncrona se complete. |
...
| [FunctionPtr](./functionptr/) | Un alias para el tipo de función con convención de llamada predeterminada. |
...
| ConversiónDinámica | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| ConversiónDinámica | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| ConversiónDinámica | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| ConversiónDinámica | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| ConversiónDinámica | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| ConversiónDinámica | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| ConversiónDinámica | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| ConversiónDinámica_noexcept | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| ConversiónDinámica_noexcept | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| ConversiónDinámica_noexcept | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| ConversiónDinámicaArray | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| EnumObtenerNombre | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| EnumObtenerNombre | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
...
| EstáEnumMetaInfoDefinido | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| EstáEnumMetaInfoDefinido | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
