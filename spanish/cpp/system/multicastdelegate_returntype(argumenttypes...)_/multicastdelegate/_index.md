...
| --- | --- | --- |
| inicial | Callback\&& | Un delegado para colocar en la colección de delegados |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| o | const MulticastDelegate\& | Una instancia de la clase MulticastDelegate de la cual copiar la colección de delegados. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| arg | std::function\<ReturnType(ArgumentTypes...)> | Un valor para colocar en la colección de delegados |
...
| --- | --- |
| T | Tipo del valor que se colocará en la colección de delegados de la instancia recién construida; el tipo debe ser convertible al tipo [Callback](../callback/). |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| arg | T | Un valor para colocar en la colección de delegados |
