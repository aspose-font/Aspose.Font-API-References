...
La función única que emula el comportamiento de la sentencia try[-catch]-finally de C#'s. Durante la traducción de la sentencia try[-catch]-finally de C#'s con la opción del traductor finally_statement_as_lambda establecida en true, la sentencia se traduce en la invocación de este método.
