...
description: "Método System::With. Clona el registro de referencia y le aplica un functor inicializador en C++."
type: docs
weight: 40200
...
Clona el registro de referencia y le aplica un functor inicializador.
...
| inicializador | const A\& | Funtor de inicialización aplicado al clon del registro. |
...
Copia el registro struct y le aplica el functor de inicializador.
...
| inicializador | const A\& | Funtor de inicialización aplicado a la copia del registro. |
