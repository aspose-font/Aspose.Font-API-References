---
title: "System::DynamicWeakPtr::operator= método"
linktitle: "operator="
second_title: "Aspose.Font para C++"
description: "System::DynamicWeakPtr::operator= método. Asigna por copia el puntero inteligente en C++."
type: docs
weight: 200
...
| --- | --- |
| Q | Tipo del punteado de origen. |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | const SmartPtr\<Q\>\& | Puntero al valor de asignación por copia. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | const SmartPtr_\& | Puntero al valor de asignación por copia. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | SmartPtr_\&& | Puntero al valor de asignación por movimiento. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| p | typename SmartPtr_::Pointee_ * | Valor de puntero. |
