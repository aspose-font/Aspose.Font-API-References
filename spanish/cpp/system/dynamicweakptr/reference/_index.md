...
description: "System::DynamicWeakPtr::Reference clase. Clase de referencia que garantiza que se llame a DynamicWeakPtr::Apply. Se usa si DynamicWeakPtr se pasa como parámetro de referencia SmartPtr a una función que pueda asignarle en C++."
type: docs
weight: 700
