...
description: "Método System::ObjectExt::Is. Implementa la traducción del operador ''is''. Especialización para literal de cadena en C++."
type: docs
weight: 1100
...
Verdadero si 'is' devuelve true, false en caso contrario.
...
Implementa la traducción del operador 'is'. Especialización para tipos enumerados.
...
Implementa la traducción del operador 'is'. Especialización para tipos empaquetables (de valor) que son exactamente eso.
...
Implementa la traducción del operador 'is'. Especialización para tipos enumerados frente a punteros débiles.
