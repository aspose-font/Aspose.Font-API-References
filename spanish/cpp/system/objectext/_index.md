...
description: "Clase System::ObjectExt. Proporciona métodos estáticos que emulan los métodos de Object de C# llamados para tipos C++ que no son Object (cadenas, números, etc.). Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio en C++."
type: docs
weight: 4900
...
Proporciona métodos estáticos que emulan los métodos de [Object](../object/) de C# llamados para tipos C++ que no son Object (cadenas, números, etc.). Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio.
...
| Método | Descripción |
| --- | --- |
| static [ArrayInitializerCast](./arrayinitializercast/)(From ...) | Convierte valores fundamentales de arreglos (que C# hace implícitamente pero C++ aparentemente no lo hace). |
...
| static [Is](./is/)(const T\&) | Implementa la traducción del operador 'is'. Especialización para tipos empaquetables (de valor) que son exactamente eso. |
...
| static [Is](./is/)(const SmartPtr\<U\>\&) | Implementa la traducción del operador 'is'. Especialización para tipos enumerados. |
| static [Is](./is/)(const WeakPtr\<U\>\&) | Implementa la traducción del operador 'is'. Especialización para tipos enumerados frente a punteros débiles. |
...
| static [ObjectToUnknown](./objecttounknown/)(SmartPtr\<Object\>) | Convierte [Object](../object/) a tipo desconocido, manejando tanto tipos de puntero inteligente como situaciones de valor bpxed. |
...
| static [ToString](./tostring/)(const T\&) | Sustitución del método ToString de C# para funcionar con cualquier tipo C++. |
| static [ToString](./tostring/)(T\&&) | Sustitución del método ToString de C# para funcionar con cualquier tipo C++. |
| static [Unbox](./unbox/)(const SmartPtr\<Object\>\&) | Desempaqueta tipos de valor después de convertir a [Object](../object/). Implementación para tipos enumerados. |
| static [Unbox](./unbox/)(const SmartPtr\<Object\>\&) | Desempaqueta tipos de valor después de convertir a [Object](../object/). Implementación para tipos que no son enumerados ni anulables. |
| static [Unbox](./unbox/)(const SmartPtr\<Object\>\&) | Desempaqueta tipos de valor después de convertir a [Object](../object/). Implementación para tipos que no son enumerados ni anulables. |
| static [Unbox](./unbox/)(E) | Desempaqueta tipos enumerados a entero. |
| static [Unbox](./unbox/)(E) | Convierte tipos enumerados. |
| static [Unbox](./unbox/)(const SmartPtr\<Object\>\&) | Desempaqueta valores de cadena. |
| static [UnboxStringSafe](./unboxstringsafe/)(const SmartPtr\<Object\>\&) | Desempaqueta cadena de valor empaquetado. |
