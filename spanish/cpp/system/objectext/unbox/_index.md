...
Desempaqueta tipos enumerados a entero.
...
| Parámetro | Descripción |
| --- | --- |
| T | Tipo de enumeración de destino. |
| E | Tipo enum de origen. |
...
Valor de enumeración convertido.
