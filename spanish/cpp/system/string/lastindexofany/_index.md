...
Busca cualquiera de los caracteres pasados en toda la cadena de forma inversa. Compara el último carácter de la cadena con todos los caracteres en anyOf, luego compara el anterior y así sucesivamente. Devuelve el índice de la primera coincidencia encontrada.
...
Busca cualquiera de los caracteres pasados en la subcadena de forma inversa. Compara el último carácter de la cadena con todos los caracteres en anyOf, luego compara el anterior y así sucesivamente. Devuelve el índice de la primera coincidencia encontrada.
