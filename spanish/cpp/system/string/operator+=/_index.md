...
description: "Método System::String::operator+=. Operador de asignación de concatenación en C++."
type: docs
weight: 2900
...
| --- | --- | --- |
| c | char_t | Carácter para añadir al final de la cadena actual. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| str | const String\& | [String](../) para añadir al final de la cadena actual. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | double | [Double](../../double/) para añadir al final de la cadena actual. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int16_t | Short para añadir al final de la cadena actual. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int32_t | Int para añadir al final de la cadena actual. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int64_t | Long para añadir al final de la cadena actual. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | T | [Boolean](../../boolean/) para añadir al final de la cadena actual. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | uint16_t | Unsigned short para añadir al final de la cadena actual. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | uint32_t | Unsigned int para añadir al final de la cadena actual. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | uint64_t | Unsigned long para añadir al final de la cadena actual. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | uint8_t | [Byte](../../byte/) para añadir al final de la cadena actual. |
