...
description: "Constructor System::String::String. Constructor predeterminado. Crea un objeto string que se considera nulo en C++."
type: docs
weight: 100
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| str | const std::wstring\& | Cadena ancha a convertir en [String](../). |
...
Construye una cadena a partir de un puntero a cadena de caracteres anchos. Trata la cadena apuntada como terminada en nulo y calcula la longitud de la cadena objetivo basándose en el carácter nulo. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas.
...
Constructor de relleno. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas.
