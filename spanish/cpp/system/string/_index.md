...
description: "Clase System::String. Clase de cadena utilizada en toda la biblioteca. Es un sustituto de C# System.String al traducir código. Por razones de optimización, no se considera una subclase de Object. Este tipo debe ser asignado en la pila y pasado a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 5800
...
| [begin](./begin/)() const | Devuelve un puntero al comienzo del búfer de cadena real. Nunca reasigna nada. No garantiza que el búfer esté terminado en nulo. |
| [Clone](./clone/)() const | Crea una copia de la cadena actual. |
| static [Compare](./compare/)(const String\&, int, const String\&, int, int, bool) | Less-equal-greater-compares dos subcadenas. |
| static [Compare](./compare/)(const String\&, int, const String\&, int, int, bool, const SharedPtr\<System::Globalization::CultureInfo\>\&) | Less-equal-greater-compares dos subcadenas. |
| static [Compare](./compare/)(const String\&, const String\&, System::StringComparison) | Less-equal-greater-compares dos cadenas. |
| static [Compare](./compare/)(const String\&, int, const String\&, int, int, System::StringComparison) | Less-equal-greater-compares dos cadenas. |
| static [Compare](./compare/)(const String\&, const String\&, bool) | Less-equal-greater-compares dos cadenas. |
| static [Compare](./compare/)(const String\&, const String\&, bool, const SharedPtr\<System::Globalization::CultureInfo\>\&) | Less-equal-greater-compares dos cadenas. |
| static [CompareOrdinal](./compareordinal/)(const String\&, const String\&) | Less-equal-greater-compares dos cadenas usando modo ordinal. |
| static [CompareOrdinal](./compareordinal/)(const String\&, int, const String\&, int, int) | Less-equal-greater-compares dos cadenas usando modo ordinal. |
...
| static [Equals](./equals/)(const String\&, const String\&) | Equal-compares dos cadenas usando el modo de comparación Ordial. |
| static [Equals](./equals/)(const String\&, const String\&, System::StringComparison) | Equal-compares dos cadenas. |
...
| static [FromWCS](./fromwcs/)(const std::wstring\&) | Crea [String](./) a partir de una cadena ancha. |
...
| static [Join](./join/)(const String\&, const ArrayPtr\<String\>\&, int, int) | Une el arreglo usando la cadena como separador. |
| static [Join](./join/)(const String\&, const System::Details::ArrayView\<String\>\&, int, int) | Une el arreglo usando la cadena como separador. |
| static [Join](./join/)(const String\&, const SharedPtr\<System::Collections::Generic::IEnumerable\<String\>\>\&) | Une el arreglo usando la cadena como separador. |
| static [Join](./join/)(const String\&, const ArrayPtr\<SharedPtr\<Object\>\>\&) | Une el arreglo usando la cadena como separador. |
...
| explicit [String](./string/)(T\&, typename std::enable_if\<IsStringLiteral\<T, wchar_t\>::value\>::type *) | Construye una cadena a partir de un literal de cadena ancha. Considera el literal como una cadena terminada en nulo y calcula la longitud de la cadena objetivo según el tamaño del literal. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas. |
| explicit [String](./string/)(const T\&, typename std::enable_if\<IsStringPointer\<T, wchar_t\>::value\>::type *) | Construye una cadena a partir de un puntero a cadena de caracteres anchos. Trata la cadena apuntada como terminada en nulo y calcula la longitud de la cadena objetivo basándose en el carácter nulo. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas. |
...
| explicit [String](./string/)(const wchar_t, int) | Constructor de relleno. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas. |
...
| [ToUtf8String](./toutf8string/)() const | Convierte la cadena a std::string. Usa codificación UTF-8. |
...
int main()
{
  ...
  // Recorta la cadena a continuación y la imprime.
