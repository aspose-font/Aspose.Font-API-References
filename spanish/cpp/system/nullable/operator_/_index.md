...
description: "System::Nullable::operator< método. Determina si el valor representado por el objeto actual es menor que el valor representado por el objeto Nullable especificado aplicando operator<() a estos valores en C++."
type: docs
weight: 1600
