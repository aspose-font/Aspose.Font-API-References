...
description: "System::Array::Array constructor. Construye un arreglo vacío en C++."
type: docs
weight: 100
...
Construye un objeto [Array](../) y lo llena con valores del arreglo especificado que contiene elementos del tipo **[UnderlyingType](../underlyingtype/)**.
...
| --- | --- |
| InitArraySize | Número de elementos del arreglo **init**. |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| init | const std::array\<UnderlyingType, InitArraySize\>\& | [Array](../) para copiar en el arreglo que se está construyendo. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| count | int | Tamaño inicial del arreglo |
| init | const T\& | El valor inicial usado para llenar el arreglo |
...
| --- | --- | --- |
| count | int | Tamaño inicial del arreglo |
| inits | const T | Valores con los que llenar el arreglo |
...
Construye un objeto [Array](../) y lo llena con valores de la lista de inicialización especificada que contiene elementos de tipo bool.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| init | std::initializer_list\<bool\> | Lista de inicialización que contiene elementos para llenar el array |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| init | std::initializer_list\<UnderlyingType\> | Lista de inicialización que contiene elementos para llenar el array |
...
| Parámetro | Descripción |
| --- | --- |
| Q | El tipo de los elementos del objeto std::vector del que se moverán los elementos |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| count | typename std::enable_if\<std::is_arithmetic\<T\>::value\&&std::is_arithmetic\<ValueType\>::value\&&std::is_convertible\<ValueType, T\>::value, int\>::type | Tamaño inicial del arreglo |
| init | ValueType | El valor inicial usado para llenar el arreglo |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | vector_t\&& | std::vector, cuyos elementos son adquiridos por el array |
