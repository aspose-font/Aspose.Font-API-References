---
title: "System::Char clase"
linktitle: "Char"
second_title: "Aspose.Font para C++"
description: "System::Char clase. Proporciona métodos para la manipulación de caracteres representados como unidades de código UTF-16. Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio en C++."
type: docs
weight: 1200
...
| static [ConvertToUtf32](./converttoutf32/)(const String\&, int) | Convierte el valor de un carácter codificado en UTF-16 o par sustituto en una posición especificada de una cadena en una unidad de código UTF-32. |
...
| static [IsLetterOrDigit](./isletterordigit/)(char_t) | Determina si el carácter especificado está clasificado como una letra Unicode o un dígito decimal. |
