...
description: "Método System::Char::IsSurrogatePair. Determina si los dos caracteres especificados forman un par de surrogados UTF-16 en C++."
type: docs
weight: 1700
...
| --- | --- | --- |
| highSurrogate | char_t | Un carácter que se prueba para ser un surrogado alto |
| lowSurrogate | char_t | Un carácter que se prueba para ser un surrogado bajo |
...
Verdadero si los caracteres especificados son un par sustituto, de lo contrario - falso
