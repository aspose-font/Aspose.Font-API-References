...
description: "System::DateTimeOffset::Parse method. Convierte la cadena especificada al equivalente DateTimeOffset en C++."
type: docs
weight: 5500
...
Convierte la cadena especificada al equivalente [DateTimeOffset](../).
...
Convierte la cadena especificada al objeto [DateTimeOffset](../) usando el proveedor de formato y el estilo de formato especificados.
