...
Devuelve una nueva instancia de la clase [DateTimeOffset](../) que representa el valor de fecha y hora que resulta de la resta del intervalo de tiempo especificado del valor representado por el objeto actual.
...
Una nueva instancia de la clase [DateTimeOffset](../) que representa el valor de fecha y hora que resulta de la resta de **value** del valor representado por el objeto actual.
