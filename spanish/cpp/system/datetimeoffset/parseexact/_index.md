...
description: "System::DateTimeOffset::ParseExact método. Convierte la cadena especificada en un objeto DateTimeOffset usando los formatos especificados, el proveedor de formato y el estilo de formato en C++."
type: docs
weight: 5600
...
Convierte la cadena especificada en un objeto [DateTimeOffset](../) usando los formatos especificados, el proveedor de formato y el estilo de formato.
...
Convierte la cadena especificada en un objeto [DateTimeOffset](../) usando el formato especificado, el proveedor de formato y el estilo de formato.
