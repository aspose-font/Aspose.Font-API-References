...
| [get_Day](./get_day/)() const | Devuelve el número ordinal del día de la semana en que ocurre el cambio de hora. |
| [get_DayOfWeek](./get_dayofweek/)() const | Devuelve el valor que representa el día de la semana en que ocurre el cambio de hora. |
...
| [get_Month](./get_month/)() const | Devuelve el número ordinal del mes del año en que ocurre el cambio de hora. |
| [get_TimeOfDay](./get_timeofday/)() const | Devuelve un objeto [DateTime](../../datetime/) que representa la hora específica en que ocurre el cambio de hora. |
| [get_Week](./get_week/)() const | Devuelve el número ordinal de la semana del mes en que ocurre el cambio de hora. |
