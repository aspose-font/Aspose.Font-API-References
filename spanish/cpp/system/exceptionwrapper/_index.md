...
Plantilla que representa un contenedor de excepciones que se derivan de la clase [Exception](../exception/).
...
| explicit [ExceptionWrapper](./exceptionwrapper/)(Args\&&...) | Constructor que reenvía parámetros a los constructores de la clase [Exception](../exception/) y crea un puntero inteligente que contiene una nueva instancia de la clase [Exception](../exception/). |
...
| static [Type](./type/)() | Atajo para obtener el objeto [System::TypeInfo](../typeinfo/) para el tipo [Exception](../exception/). |
## Typedefs
