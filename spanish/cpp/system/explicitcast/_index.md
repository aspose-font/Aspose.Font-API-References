...
Convierte el tipo de origen al tipo de resultado usando una conversión explícita. Se usa cuando se necesita una conversión simple tipo constructor.
...
Convierte el tipo de origen al tipo de resultado usando una conversión explícita. Se usa cuando el origen y el resultado son punteros inteligentes (sin la explícita [SmartPtr<...>](../smartptr/) en el tipo de resultado).
...
Convierte el tipo de origen al tipo de resultado usando una conversión explícita. Se usa cuando el origen y el resultado son punteros inteligentes (con la explícita [SmartPtr<...>](../smartptr/) en el tipo de resultado).
...
Convierte el tipo de origen al tipo de resultado usando una conversión explícita. Se usa para empaquetar enums.
...
Convierte el tipo de origen al tipo de resultado usando una conversión explícita. Se usa para convertir entre arreglos.
