...
description: "Clase System::DateTime. Representa un valor de fecha y hora específico en el continuo temporal. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 1600
...
Representa un valor de fecha y hora específico en el continuo temporal. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca use la clase [System::SmartPtr](../smartptr/) para gestionar objetos de este tipo.
...
| [DateTime](./datetime/)(int, int, int) | Construye una instancia que representa un valor de fecha y hora especificado como un año, mes y día determinados. |
| [DateTime](./datetime/)(int, int, int, const SharedPtr\<Globalization::Calendar\>\&) | Construye una instancia que representa un valor de fecha y hora especificado como un año, mes y día determinados en el calendario especificado. |
...
| [DateTime](./datetime/)(int64_t, DateTimeKind, bool) | Construye una instancia que representa un valor de fecha y hora especificado como un número de ticks. SOLO USO INTERNO. |
| [DateTime](./datetime/)(const DateTime\&) | Copia-constuye una instancia. |
...
| static [FromBinary](./frombinary/)(int64_t) | Deserializa el valor de fecha y hora desde el entero sin signo de 64 bits especificado y asigna ese valor a la nueva instancia de la clase [DateTime](./). |
...
| static [FromOADate](./fromoadate/)(double) | Devuelve una instancia de la clase [DateTime](./) que representa el valor de fecha y hora equivalente a la fecha de automatización OLE especificada. |
| static [FromUnixTime](./fromunixtime/)(time_t) | Convierte el valor de tiempo Unix especificado a una instancia de la clase [DateTime](./). SOLO USO INTERNO. |
| [get_Date](./get_date/)() const | Devuelve una nueva instancia de la clase [DateTime](./) que representa la parte de fecha del valor de fecha y hora representado por el objeto actual, con cada componente de la parte de tiempo establecido a 0. |
| [get_Day](./get_day/)() const | Devuelve el número ordinal del día en el mes representado por el objeto actual. |
| [get_DayOfWeek](./get_dayofweek/)() const | Devuelve un valor que representa el día de la semana que representa el objeto actual. |
| [get_DayOfYear](./get_dayofyear/)() const | Devuelve el número ordinal del día en el año representado por el objeto actual. |
...
| [get_Month](./get_month/)() const | Devuelve el número ordinal del mes en el año representado por el objeto actual. |
...
| [get_Ticks](./get_ticks/)() const | Devuelve un número de intervalos de 100 nanosegundos transcurridos desde 0:00:00 UTC, 1 de enero de 0001, en el calendario gregoriano hasta la fecha y hora representadas por el objeto actual. |
...
| static [Parse](./parse/)(const String\&, const SharedPtr\<IFormatProvider\>\&, Globalization::DateTimeStyles) | Convierte la representación en cadena especificada de un valor de fecha y hora al objeto [DateTime](./) equivalente usando información de formato específica de la cultura. |
...
| [ToLongDateString](./tolongdatestring/)() const | Devuelve una cadena que contiene la representación de fecha larga del objeto actual. |
| [ToLongTimeString](./tolongtimestring/)() const | Devuelve una cadena que contiene la representación de hora larga del objeto actual. |
...
| [ToUnixTime](./tounixtime/)() const | Devuelve un valor que representa el valor de fecha y hora representado por el objeto actual como tiempo Unix. PARA USO INTERNO. |
...
| Campo | Descripción |
| --- | --- |
| static constexpr [MaxTicks](./maxticks/) | El número de 100-nanosegundos en el intervalo de tiempo entre el valor mínimo posible y el máximo posible de [DateTime](./). |
...
int main()
{
  ...
  // Crear la instancia de la clase 'DateTime'.
  DateTime dateTime{1990, 10, 30};

  // Imprimir la instancia en varios formatos.
