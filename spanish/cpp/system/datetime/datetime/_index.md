...
| minuto | int | El minuto del **hour** que será representado por la instancia que se está construyendo. |
...
Construye una instancia que representa un valor de fecha y hora especificado como un número de ticks. SOLO USO INTERNO.
