...
description: "Método System::SmartPtr::operator=. Asigna por copia un objeto SmartPtr. Realiza las conversiones de tipo necesarias en C++."
type: docs
weight: 2800
...
Asigna por copia un objeto [SmartPtr](../). Realiza las conversiones de tipo necesarias.
...
Asigna por copia un objeto [SmartPtr](../).
...
Asigna un puntero crudo a un objeto [SmartPtr](../).
...
Asigna por movimiento un objeto [SmartPtr](../). x queda inutilizable.
