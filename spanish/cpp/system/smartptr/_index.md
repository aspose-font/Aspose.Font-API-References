...
| Método | Descripción |
| --- | --- |
| [begin](./begin/)() | Accesor para el método [begin()](./begin/) de una colección subyacente. Solo compila si [SmartPtr_](./smartptr_/) es un tipo de especialización con el método [begin()](./begin/). |
| [begin](./begin/)() const | Accesor para el método [begin()](./begin/) de una colección subyacente. Solo compila si [SmartPtr_](./smartptr_/) es un tipo de especialización con el método [begin()](./begin/). |
...
| [Cast](./cast/)() const | Convierte el puntero al tipo derivado usando dynamic_cast. |
| [cbegin](./cbegin/)() const | Accesor para el método [cbegin()](./cbegin/) de una colección subyacente. Solo compila si [SmartPtr_](./smartptr_/) es un tipo de especialización con el método [cbegin()](./cbegin/). |
| [cend](./cend/)() const | Accesor para el método [cend()](./cend/) de una colección subyacente. Solo compila si [SmartPtr_](./smartptr_/) es un tipo de especialización con el método [cend()](./cend/). |
...
| [end](./end/)() | Accesor para el método [end()](./end/) de una colección subyacente. Solo compila si [SmartPtr_](./smartptr_/) es un tipo de especialización con el método [end()](./end/). |
| [end](./end/)() const | Accesor para el método [end()](./end/) de una colección subyacente. Solo compila si [SmartPtr_](./smartptr_/) es un tipo de especialización con el método [end()](./end/). |
...
| [operator=](./operator=/)(const SmartPtr\<Q\>\&) | Asigna por copia el objeto [SmartPtr](./). Realiza las conversiones de tipo requeridas. |
...
| [SmartPtr](./smartptr/)(const SmartPtr\<Q\>\&, SmartPtrMode) | Construye por copia un objeto [SmartPtr](./). Ambos punteros apuntan al mismo objeto después. Realiza conversión de tipo si está permitida. |
| [SmartPtr](./smartptr/)(SmartPtr_\&&, SmartPtrMode) | Construye por movimiento un objeto [SmartPtr](./). Efectivamente, intercambia dos punteros, si ambos están en el mismo modo. x puede quedar inutilizable después de la llamada. |
...
| explicit [SmartPtr](./smartptr/)(const Y\&) | Inicializa un arreglo vacío. Se usa para traducir algunas construcciones de código C#. |
