...
description: "System::TimeSpan class. Representa un intervalo de tiempo. Este tipo debe ser asignado en la pila y pasado a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 6100
...
| [IsNull](./isnull/)() const |  |
| [Negate](./negate/)() const | Devuelve una nueva instancia del objeto [TimeSpan](./) que representa el valor negado representado por el objeto [TimeSpan](./) actual. |
...
| [operator+](./operator+/)() const | Devuelve self. |
| [operator+=](./operator+=/)(TimeSpan) | Asigna al objeto actual el intervalo de tiempo que es la suma del intervalo de tiempo representado por el objeto actual y los objetos especificados. |
| [operator-](./operator-/)(TimeSpan) const | Devuelve una nueva instancia de la clase [TimeSpan](./) que representa un intervalo de tiempo que es el resultado de la sustracción del intervalo de tiempo representado por el objeto especificado del intervalo de tiempo representado por el objeto actual. |
| [operator-](./operator-/)() const | Devuelve una nueva instancia del objeto [TimeSpan](./) que representa el valor negado representado por el objeto [TimeSpan](./) actual. |
| [operator-=](./operator-=/)(TimeSpan) | Asigna al objeto actual el intervalo de tiempo que es el resultado de la sustracción del intervalo de tiempo representado por el objeto especificado del intervalo de tiempo representado por el objeto actual. |
...
| [operator<=](./operator_=/)(TimeSpan) const | Determina si el intervalo de tiempo representado por el objeto actual es más corto que o igual al intervalo de tiempo representado por el objeto especificado. |
| [operator<=](./operator_=/)(std::nullptr_t) const |  |
...
| [Subtract](./subtract/)(TimeSpan) const | Devuelve una nueva instancia de la clase [TimeSpan](./) que representa un intervalo de tiempo que es el resultado de la sustracción del intervalo de tiempo representado por el objeto especificado del intervalo de tiempo representado por el objeto actual. |
