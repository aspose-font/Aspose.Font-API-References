...
description: "Clase System::ArraySegment. Representa un segmento del arreglo unidimensional. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 300
...
Representa un segmento del arreglo unidimensional. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca use la clase [System::SmartPtr](../smartptr/) para gestionar objetos de este tipo.
...
int main()
{
  ...
  // Crear el segmento de arreglo que contiene todo el arreglo.
  auto fullArray = MakeObject<ArraySegment<String>>(array);

  // Imprimir los elementos del segmento de arreglo.
  Print(fullArray);

  // Crear el segmento de arreglo.
