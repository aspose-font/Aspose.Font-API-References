...
| virtual [ContainsKey](./containskey/)(System::String) const | Comprueba si el control con un nombre específico está presente en la colección. |
| [ControlCollection](./controlcollection/)(const System::SharedPtr\<Control\>\&) | Constructor. |
| [CopyTo](./copyto/)(System::ArrayPtr\<System::SharedPtr\<Control\>\>, int) override | Copia el contenido de la colección en los elementos existentes del arreglo. |
