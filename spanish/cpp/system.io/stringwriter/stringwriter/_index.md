...
| --- | --- | --- |
| formatProvider | const IFormatProviderPtr\& | Un objeto [IFormatProvider](../../../system/iformatprovider/) para ser usado por el objeto que se está construyendo |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| sb | const System::SharedPtr\<Text::StringBuilder\>\& | El objeto StringBuilder para ser usado por el [StringWriter](../) que se está construyendo |
