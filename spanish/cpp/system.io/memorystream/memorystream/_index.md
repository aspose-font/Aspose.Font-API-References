...
description: "System::IO::MemoryStream::MemoryStream constructor. Construye una nueva instancia de la clase MemoryStream con una capacidad inicial igual a 0 en C++."
type: docs
weight: 100
...
| --- | --- | --- |
| contenido | const ArrayPtr\<uint8_t\>\& | Una matriz de bytes que se usará como búfer de memoria en el que se basará el flujo representado por el objeto que se está creando. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| contenido | const ArrayPtr\<uint8_t\>\& | Una matriz de bytes cuyo segmento se usará como búfer de memoria en el que se basará el flujo representado por el objeto que se está creando. |
| índice | int | Un índice basado en 0 del elemento en **content** en el que comienza el segmento |
