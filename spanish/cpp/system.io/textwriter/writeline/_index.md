...
description: "System::IO::TextWriter::WriteLine método. Escribe los caracteres terminadores de línea en el flujo en C++."
type: docs
weight: 1000
...
Escribe caracteres de terminación de línea al flujo.
...
Escribe la representación en cadena del valor booleano especificado seguido de los caracteres de terminación de línea al flujo.
...
Escribe los valores especificados formateados según el formato especificado, seguidos de los caracteres en el flujo.
...
Escribe la representación en cadena del objeto [TypeInfo](../../../system/typeinfo/) especificado, seguida de los caracteres terminadores de línea en el flujo.
...
Escribe la representación en cadena del objeto [Decimal](../../../system/decimal/) especificado, seguida de los caracteres de terminación de línea, en el flujo.
