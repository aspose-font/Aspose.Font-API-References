...
description: "System::IO::TextWriter::Write método. Escribe la representación en cadena del valor booleano especificado en el flujo en C++."
type: docs
weight: 900
...
Escribe la representación en cadena del valor booleano especificado al flujo.
...
Escribe el carácter especificado al flujo.
...
Escribe la cadena C especificada al flujo.
...
Escribe la representación en cadena del objeto especificado al flujo.
...
Escribe los valores especificados formateados según el formato especificado al flujo.
...
Escribe la cadena especificada al flujo.
...
Escribe la representación en cadena del objeto [TypeInfo](../../../system/typeinfo/) especificado en el flujo.
...
Escribe la representación en cadena del objeto [Decimal](../../../system/decimal/) especificado en el flujo.
...
Escribe la representación en cadena del valor de punto flotante de doble precisión especificado al flujo.
...
Escribe la representación en cadena del valor de punto flotante de precisión simple especificado al flujo.
...
Escribe la representación en cadena del valor entero de 32 bits especificado al flujo.
...
Escribe la representación en cadena del valor entero de 64 bits especificado al flujo.
...
Escribe la representación en cadena del valor entero sin signo de 32 bits especificado al flujo.
...
Escribe la representación en cadena del valor entero sin signo de 64 bits especificado al flujo.
