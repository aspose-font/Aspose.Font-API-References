...
description: "Clase System::IO::BasicSystemIOStreamWrapper. Representa un contenedor similar a std::iostream que usa BasicSystemIOStreamBuf como búfer interno en C++."
type: docs
weight: 500
...
Representa un contenedor similar a std::iostream que usa [BasicSystemIOStreamBuf](../basicsystemiostreambuf/) como búfer interno.
...
| [swap](./swap/)(BasicSystemIOStreamWrapper\&) | Llamada a swap *this y **right**, si no son iguales. |
## Typedefs
