...
| [Read](./read/)(ArrayPtr\<char_t\>, int, int) override | Lee el número especificado de caracteres del flujo al arreglo de caracteres especificado comenzando en la posición especificada. |
