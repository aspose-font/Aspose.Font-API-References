...
description: "Clase System::IO::BasicSystemOStreamWrapper. Representa un envoltorio similar a std::ostream que usa BasicSystemIOStreamBuf como búfer interno en C++."
type: docs
weight: 700
...
Representa un envoltorio similar a std::ostream que usa [BasicSystemIOStreamBuf](../basicsystemiostreambuf/) como búfer interno.
...
| [BasicSystemOStreamWrapper](./basicsystemostreamwrapper/)(SharedPtr\<Stream\>, SystemIOStreamWrappingMode) | Construye una nueva instancia del [BasicSystemOStreamWrapper](./). |
...
| [swap](./swap/)(BasicSystemOStreamWrapper\&) | Llamada a swap *this y **right**, si no son iguales. |
## Typedefs
