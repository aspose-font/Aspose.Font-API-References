...
| [Flush](./flush/)() | Vacia el flujo de salida. |
...
| virtual [Write](./write/)(bool) | Escribe un solo byte con un valor de 0 si **value** es 'true' y 1 si **value** es 'false' en el flujo de salida. |
...
| virtual [Write](./write/)(double) | Escribe el valor de punto flotante de precisión doble especificado en el flujo de salida. |
