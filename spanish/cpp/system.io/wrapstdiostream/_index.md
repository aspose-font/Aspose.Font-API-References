...
Función contenedora para flujos similares a std::basic_istream.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| flujo | std::basic_istream\<char_type, traits_type\>\& | Flujo similar a std::basic_istream |
| mode | STDIOStreamWrappingMode | Modo de envoltura |
...
Función contenedora para flujos similares a std::basic_ostream.
