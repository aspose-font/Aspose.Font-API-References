...
description: "System::IO::File::ReadAllLines method. Lee el contenido del archivo de texto especificado línea por línea a una matriz de cadenas usando la codificación de caracteres especificada en C++."
type: docs
weight: 2400
...
Una matriz de cadenas donde cada elemento representa una sola línea del archivo especificado
