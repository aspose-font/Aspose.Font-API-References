...
description: "System::IO::File::Create método. Crea un nuevo archivo (o sobrescribe el existente) y lo abre para acceso de lectura y escritura utilizando el tamaño de búfer y las opciones especificadas en C++."
type: docs
weight: 500
