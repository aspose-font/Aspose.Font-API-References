...
description: "System::IO::Directory::GetDirectories método. Busca los directorios que cumplen con los criterios de búsqueda especificados ya sea en el directorio especificado o en todo el árbol de directorios que tiene como raíz el directorio especificado en C++."
type: docs
weight: 1000
...
Busca los directorios que cumplen con los criterios de búsqueda especificados, ya sea en el directorio indicado o en todo el árbol de directorios raíz del directorio especificado.
