...
| --- | --- | --- |
| buffer | ArrayPtr\<char_t\> | La matriz de caracteres UTF-16 donde escribir los caracteres leídos del flujo de entrada |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| buffer | ArrayPtr\<uint8_t\> | El arreglo de bytes donde escribir los bytes leídos |
| índice | int | Una posición basada en cero en **buffer** para comenzar a escribir |
