...
description: "System::IO::BasicSystemIOStreamBuf class. Representa un búfer que envuelve flujos similares a System::IO::Stream y permite que se usen como un búfer interno similar a std::iostream en C++."
type: docs
weight: 400
...
Representa un búfer que envuelve flujos [System::IO::Stream](../stream/)-like y permite que se usen como un búfer interno similar a std::iostream.
