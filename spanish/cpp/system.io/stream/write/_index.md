---
title: "System::IO::Stream::Write método"
linktitle: "Write"
second_title: "Aspose.Font para C++"
description: "System::IO::Stream::Write método. Escribe el subrango especificado de bytes del arreglo de bytes especificado al flujo en C++."
type: docs
weight: 2600
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| buffer | const System::Details::StackArray\<uint8_t, N\>\& | El arreglo de pila que contiene los bytes a escribir |
| desplazamiento | int32_t | Un índice basado en cero del elemento en **buffer** en el que comienza el subrango a escribir |
| count | int32_t | El número de elementos en el subrango a escribir |
