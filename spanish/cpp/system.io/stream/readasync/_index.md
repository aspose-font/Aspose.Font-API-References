---
title: "System::IO::Stream::ReadAsync método"
linktitle: "ReadAsync"
second_title: "Aspose.Font para C++"
description: "System::IO::Stream::ReadAsync método. Lee de forma asíncrona una secuencia de bytes del flujo actual, avanza la posición dentro del flujo por la cantidad de bytes leídos y supervisa las solicitudes de cancelación en C++."
type: docs
weight: 1900
...
| --- | --- | --- |
| buffer | const ArrayPtr\<uint8_t\>\& | La matriz de bytes donde escribir los bytes leídos. |
