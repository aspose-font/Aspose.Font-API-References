...
description: "System::Security::Cryptography::CryptoStream::Read method. Lee datos del flujo en C++."
type: docs
weight: 1000
url: /es/cpp/system.security.cryptography/cryptostream/read/
---
...
| --- | --- | --- |
| buffer | const ArrayPtr\<uint8_t\>\& | Buffer de datos de destino. |
| desplazamiento | int32_t | Desplazamiento en el búfer de destino. |
| count | int32_t | Número de bytes a leer. |

### ReturnValue

Número real de bytes que se están leyendo.
