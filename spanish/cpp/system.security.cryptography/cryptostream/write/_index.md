...
description: "System::Security::Cryptography::CryptoStream::Write method. Escribe datos en el flujo en C++."
type: docs
weight: 1400
url: /es/cpp/system.security.cryptography/cryptostream/write/
---
...
| --- | --- | --- |
| buffer | const ArrayPtr\<uint8_t\>\& | Buffer de datos de origen. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| buffer | const System::Details::ArrayView\<uint8_t\>\& | Buffer de datos de origen. |
| desplazamiento | int32_t | Desplazamiento en el buffer de origen. |
| count | int32_t | Número de bytes a escribir. |
