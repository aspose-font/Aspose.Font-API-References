...
| [HashData](./hashdata/)(ByteArrayPtr, int32_t, int32_t, HashAlgorithmName) override | Calcula el valor hash de la matriz de datos especificada usando el algoritmo de hash especificado. |
...
| [SignData](./signdata/)(const ByteArrayPtr\&) | Calcula el valor hash de la matriz de datos especificada y firma el resultado. |
| [SignData](./signdata/)(const ByteArrayPtr\&, int32_t, int32_t) | Calcula el valor hash de la matriz de datos especificada y firma el resultado. |
