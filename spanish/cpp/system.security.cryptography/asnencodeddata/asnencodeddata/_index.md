...
description: "System::Security::Cryptography::AsnEncodedData::AsnEncodedData constructor. Constructor en C++."
type: docs
weight: 100
url: /es/cpp/system.security.cryptography/asnencodeddata/asnencodeddata/
---
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Datos codificados en formato de bytes crudos. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| oid | const SharedPtr\<Oid\>\& | [Object](../../../system/object/) identificador de datos codificados. |
| raw_data | const ByteArrayPtr\& | Datos codificados en formato de bytes crudos. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| oid | const String\& | [Object](../../../system/object/) identificador de datos codificados. |
| raw_data | const ByteArrayPtr\& | Datos codificados en formato de bytes crudos. |
