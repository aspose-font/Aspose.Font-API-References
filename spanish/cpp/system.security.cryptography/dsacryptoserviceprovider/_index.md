...
description: "Clase System::Security::Cryptography::DSACryptoServiceProvider. Algoritmo DSA en forma CSP. Los objetos de esta clase solo deben asignarse usando la función System::MakeObject() function. Nunca cree una instancia de este tipo en la pila ni usando el operador new, ya que provocará errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use este puntero para pasarlo a funciones como argumento en C++."
type: docs
weight: 1000
...
| Método | Descripción |
| --- | --- |
| [CreateSignature](./createsignature/)(ByteArrayPtr) override | Cree una firma [DSA](../dsa/) para los datos especificados. |
| [Dispose](./dispose/)() override | Libera los datos asociados con el objeto. |
...
| [ExportCspBlob](./exportcspblob/)(bool) override | Exporta un blob con información sobre la clave. No implementado. |
...
| [get_KeyExchangeAlgorithm](./get_keyexchangealgorithm/)() override | Comprueba el algoritmo de intercambio de claves asociado con el objeto. |
...
| [VerifySignature](./verifysignature/)(ByteArrayPtr, ByteArrayPtr) override | Verifique la firma [DSA](../dsa/) para los datos especificados. |
## Ver también
