...
| Método | Descripción |
| --- | --- |
| static [FromFriendlyName](./fromfriendlyname/)(const String\&, OidGroup) | Cree un objeto OID a partir del nombre amigable OID especificado. |
| static [FromOidValue](./fromoidvalue/)(const String\&, OidGroup) | Cree un objeto OID a partir del valor OID especificado. |
