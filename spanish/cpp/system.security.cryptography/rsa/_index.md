...
| [SignData](./signdata/)(const ByteArrayPtr\&, const HashAlgorithmName\&, const SharedPtr\<RSASignaturePadding\>\&) | Calcula el valor hash del arreglo de datos especificado usando el algoritmo hash y el modo de relleno especificados, y firma el resultado. |
| [SignData](./signdata/)(const ByteArrayPtr\&, int32_t, int32_t, const HashAlgorithmName\&, const SharedPtr\<RSASignaturePadding\>\&) | Calcula el valor hash del arreglo de datos especificado usando el algoritmo hash y el modo de relleno especificados, y firma el resultado. |
