...
description: "Clase System::Threading::Tasks::Task. Representa una operación asíncrona que puede esperarse y combinarse con otras tareas en C++."
type: docs
weight: 600
...
Representa una operación asincrónica que puede esperarse y combinarse con otras tareas.
...
| Método | Descripción |
| --- | --- |
| [Activate](./activate/)(const SharedPtr\<TaskScheduler\>\&) | Activa la tarea para su ejecución en un programador. |
...
| [Dispose](./dispose/)() override | Libera los recursos asociados a la tarea. |
...
| [get_IsCompleted](./get_iscompleted/)() const | Obtiene si la tarea ha finalizado. |
...
| [Task](./task/)(const Action\<SharedPtr\<Object\>\>\&, const SharedPtr\<Object\>\&, const CancellationToken\&) | Construye un [Task](./) con una acción con estado, un objeto de estado y un token de cancelación. |
