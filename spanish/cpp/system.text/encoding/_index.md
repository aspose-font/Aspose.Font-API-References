...
| [get_EncoderFallback](./get_encoderfallback/)() const | Obtiene el fallback del codificador. |
...
| virtual [get_IsBrowserDisplay](./get_isbrowserdisplay/)() | Comprueba si la codificación se puede usar en el navegador para mostrar contenido. |
| virtual [get_IsBrowserSave](./get_isbrowsersave/)() | Comprueba si la codificación se puede usar en el navegador para guardar contenido. |
| virtual [get_IsMailNewsDisplay](./get_ismailnewsdisplay/)() | Comprueba si la codificación se puede usar en el cliente de correo para mostrar contenido. |
| virtual [get_IsMailNewsSave](./get_ismailnewssave/)() | Comprueba si la codificación se puede usar en el cliente de correo para guardar contenido. |
...
| [set_DecoderFallback](./set_decoderfallback/)(const DecoderFallbackPtr\&) | Establece el fallback del decodificador. |
| [set_EncoderFallback](./set_encoderfallback/)(const EncoderFallbackPtr\&) | Establece el fallback del codificador. |
## Campos
