...
| [set_EnableRaisingEvents](./set_enableraisingevents/)(bool) | Establece si el evento Exited debe generarse cuando el proceso termina. |
...
| [WaitForExit](./waitforexit/)(int) | Espera a que el proceso finalice. No implementado. |
| [WaitForExit](./waitforexit/)() | Espera a que el proceso finalice, no devuelve el control hasta que termine. |
