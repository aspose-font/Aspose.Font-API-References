...
description: "System::Diagnostics::StackFrame::StackFrame constructor. No hay copia en C++."
type: docs
weight: 100
url: /es/cpp/system.diagnostics/stackframe/stackframe/
---
...
Crea un marco de pila en el desplazamiento de pila actual.
...
| --- | --- | --- |
| skip_frames | int | Cuántos fotogramas omitir. |
