...
| [get_UserState](./get_userstate/)() const | Obtiene el identificador único de la tarea asíncrona. Una referencia de objeto que identifica de forma única la tarea asíncrona; de lo contrario, null si no se ha establecido ningún valor. |
## Campos
