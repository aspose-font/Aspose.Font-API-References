...
| --- | --- | --- |
| error | const System::Exception\& | Cualquier error que ocurrió durante la operación asincrónica. |
| cancelado | bool | Un valor que indica si la operación asincrónica fue cancelada. |
| userState | const System::SharedPtr\<System::Object\>\& | El objeto de estado opcional suministrado por el usuario pasado al método [System.ComponentModel.BackgroundWorker.RunWorkerAsync](../../backgroundworker/runworkerasync/)([System.Object](../../../system/object/)). |
