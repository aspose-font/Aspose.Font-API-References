---
title: "Clase System::Timers::Timer"
linktitle: "Timer"
second_title: "Aspose.Font para C++"
description: "Clase System::Timers::Timer. Temporizador que llama al delegado en un bucle en C++."
type: docs
weight: 200
...
| [set_Enabled](./set_enabled/)(bool) | Inicia o detiene el temporizador. Iniciar el temporizador no reinicia la cuenta del tiempo si el temporizador ya se está ejecutando. |
| [set_Interval](./set_interval/)(double) | Establece el intervalo del temporizador. |
| [Start](./start/)() | Inicia el temporizador. No reinicia la cuenta del tiempo si el temporizador ya se está ejecutando. |
