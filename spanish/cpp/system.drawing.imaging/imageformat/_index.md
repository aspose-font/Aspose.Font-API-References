...
| static [get_Emf](./get_emf/)() | Devuelve un puntero compartido a un objeto [ImageFormat](./) que representa el formato de metarchivo mejorado. |
...
| static [get_Wmf](./get_wmf/)() | Devuelve un puntero compartido a un objeto [ImageFormat](./) que representa el formato de imagen de metarchivo [Windows](../../system.windows/) (WMF). |
