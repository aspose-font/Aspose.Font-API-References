...
| [get_Stride](./get_stride/)() const | Devuelve el ancho de paso (stride) de la imagen en bytes. |
...
| [set_Stride](./set_stride/)(int) | Establece el ancho de paso (stride) de la imagen en bytes. |
