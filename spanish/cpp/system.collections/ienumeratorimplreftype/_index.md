---
title: "Clase System::Collections::IEnumeratorImplRefType"
linktitle: "IEnumeratorImplRefType"
second_title: "Aspose.Font para C++"
description: "Clase System::Collections::IEnumeratorImplRefType. Wrapper que crea una implementación de IEnumerator no genérica sobre el iterador genérico IEnumeratorImplRefType: wrapper para los tipos de referencia en C++."
type: docs
weight: 700
...
Wrapper que crea una implementación no genérica de [IEnumerator](../ienumerator/) sobre el iterador genérico [IEnumeratorImplRefType](./) - envoltorio para los tipos de referencia.
