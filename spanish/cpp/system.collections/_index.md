...
| [BitArrayPtr](./bitarrayptr/) | Puntero a [BitArray](./bitarray/). Este tipo es un puntero para gestionar la eliminación de otros objetos. Debe ser asignado en la pila y pasado a funciones ya sea por valor o por referencia constante. |
