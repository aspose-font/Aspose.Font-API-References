...
description: "System::Xml::XPath::XPathNavigator::InsertElementBefore método. Crea un nuevo elemento hermano antes del nodo actual usando el prefijo de espacio de nombres, el nombre local y el URI del espacio de nombres especificados, con el valor especificado en C++."
type: docs
weight: 4400
