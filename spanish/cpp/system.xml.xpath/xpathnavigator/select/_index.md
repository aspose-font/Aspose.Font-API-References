...
Selecciona un conjunto de nodos usando la expresión [XPath](../../) especificada con el objeto [IXmlNamespaceResolver](../../../system.xml/ixmlnamespaceresolver/) indicado para resolver los prefijos de espacios de nombres.
