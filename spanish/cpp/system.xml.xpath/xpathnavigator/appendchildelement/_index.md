...
description: "System::Xml::XPath::XPathNavigator::AppendChildElement método. Crea un nuevo nodo de elemento hijo al final de la lista de nodos hijos del nodo actual usando el prefijo de espacio de nombres, el nombre local y el URI de espacio de nombres especificados con el valor indicado en C++."
type: docs
weight: 200
...
| --- | --- | --- |
| prefijo | Cadena | El prefijo de espacio de nombres del nuevo nodo de elemento hijo (si lo hay). |
| localName | Cadena | El nombre local del nuevo nodo de elemento hijo (si lo hay). |
