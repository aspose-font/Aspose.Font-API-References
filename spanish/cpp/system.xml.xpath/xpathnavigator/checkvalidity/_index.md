...
description: "System::Xml::XPath::XPathNavigator::CheckValidity método. Verifica que los datos XML en el XPathNavigator se ajusten al esquema del lenguaje de definición de XML Schema (XSD) proporcionado en C++."
type: docs
weight: 300
...
Verifica que los datos XML en el [XPathNavigator](../) se ajusten al esquema del lenguaje de definición de XML [Schema](../../../system.xml.schema/) (XSD) proporcionado.
