---
title: "Método System::Xml::XPath::XPathNavigator::MoveToChild"
linktitle: "MoveToChild"
second_title: "Aspose.Font para C++"
description: "Método System::Xml::XPath::XPathNavigator::MoveToChild. Mueve el XPathNavigator al nodo hijo con el nombre local y el URI del espacio de nombres especificados en C++."
type: docs
weight: 5200
...
| --- | --- | --- |
| localName | Cadena | El nombre local del nodo hijo al que mover. |
| namespaceURI | Cadena | El URI del espacio de nombres del nodo hijo al que mover. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| type | XPathNodeType | El [XPathNodeType](../../xpathnodetype/) del nodo hijo al que mover. |
