...
| localName | Cadena | El nombre local del elemento. |
| namespaceURI | Cadena | El URI del espacio de nombres del elemento. |
| end | SharedPtr\<XPathNavigator\> | El objeto [XPathNavigator](../) posicionado en el límite del elemento que el [XPathNavigator](../) actual no pasará mientras busca el elemento siguiente. |
...
Mueve el [XPathNavigator](../) al elemento siguiente del [XPathNodeType](../../xpathnodetype/) especificado en orden de documento.
...
Mueve el [XPathNavigator](../) al elemento siguiente del [XPathNodeType](../../xpathnodetype/) especificado, hasta el límite especificado, en orden de documento.
