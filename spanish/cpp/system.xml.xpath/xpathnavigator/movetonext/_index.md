...
description: "Método System::Xml::XPath::XPathNavigator::MoveToNext. Cuando se sobrescribe en una clase derivada, mueve el XPathNavigator al siguiente nodo hermano del nodo actual en C++."
type: docs
weight: 6000
...
Cuando se sobrescribe en una clase derivada, mueve el [XPathNavigator](../) al siguiente nodo hermano del nodo actual.
...
Mueve el [XPathNavigator](../) al siguiente nodo hermano con el nombre local y el URI del espacio de nombres especificados.
...
| --- | --- | --- |
| localName | Cadena | El nombre local del siguiente nodo hermano al que se moverá. |
| namespaceURI | Cadena | El URI del espacio de nombres del siguiente nodo hermano al que se moverá. |
...
Mueve el [XPathNavigator](../) al siguiente nodo hermano del nodo actual que coincida con el [XPathNodeType](../../xpathnodetype/) especificado.
