---
title: "System::Xml::XPath::XPathNavigator::SelectDescendants método"
linktitle: "SelectDescendants"
second_title: "Aspose.Font para C++"
description: "System::Xml::XPath::XPathNavigator::SelectDescendants method. Selecciona todos los nodos descendientes del nodo actual con el nombre local y el URI del espacio de nombres especificados en C++."
type: docs
weight: 7400
...
| --- | --- | --- |
| nombre | Cadena | El nombre local de los nodos descendientes. |
| namespaceURI | Cadena | El URI del espacio de nombres de los nodos descendientes. |
