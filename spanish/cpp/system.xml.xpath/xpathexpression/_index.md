...
| virtual [AddSort](./addsort/)(SharedPtr\<Object\>, XmlSortOrder, XmlCaseOrder, String, XmlDataType) | Cuando se sobrescribe en una clase derivada, ordena los nodos seleccionados por la expresión [XPath](../) según los parámetros proporcionados. |
| virtual [Clone](./clone/)() | Cuando se sobrescribe en una clase derivada, devuelve un clon de este [XPathExpression](./). |
