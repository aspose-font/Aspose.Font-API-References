...
| Método | Descripción |
| --- | --- |
| [_ValueList](./_valuelist/)(const typename Dict::Ptr\&) | Inicializa la colección referenciando el diccionario especificado. |
