...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| src | const SharedPtr\<IDictionary\<TKey, TValue\>\>\& | [Dictionary](../) del cual copiar datos. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| capacidad | int | Capacidad a asignar; ignorado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| capacity | int | [Dictionary](../) capacidad después de la creación; ignorado. |
| comparer | const SharedPtr\<IEqualityComparer\<TKey\>\>\& | [Comparer](../../comparer/) para usar. |
