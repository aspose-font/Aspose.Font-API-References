---
title: "Clase System::Collections::Generic::List"
linktitle: "Lista"
second_title: "Aspose.Font para C++"
description: "Clase System::Collections::Generic::List. Declaración adelantada de List en C++."
type: docs
weight: 3300
...
| [AddInitializer](./addinitializer/)(int, const T *) | Agrega elementos a la lista; se usa al traducir inicializadores. |
...
| [cend](./cend/)() const | Obtiene un iterador para un elemento calificado como const inexistente detrás del final de la colección. |
...
| [CopyTo](./copyto/)(System::ArrayPtr\<T\>, int) override | Copia los elementos de la lista en elementos existentes del arreglo. |
| [CopyTo](./copyto/)(const System::ArrayPtr\<T\>\&) | Copia todos los elementos en elementos existentes del arreglo. |
| [CopyTo](./copyto/)(int, const System::ArrayPtr\<T\>\&, int, int) | Copia los elementos a partir del índice especificado en elementos existentes del arreglo. |
...
| [end](./end/)() | Obtiene un iterador para un elemento inexistente detrás del final de la colección. |
| [end](./end/)() const | Obtiene un iterador para un elemento inexistente detrás del final de la colección calificada como const. |
...
| [IndexOf](./indexof/)(const T\&) const override | Obtiene el primer índice de un elemento específico. |
...
| [rend](./rend/)() | Obtiene un iterador inverso para un elemento que no existe antes del inicio de la colección. |
| [rend](./rend/)() const | Obtiene un iterador inverso para un elemento que no existe antes del inicio de la colección calificada como const. |
...
| [Sort](./sort/)(const SharedPtr\<System::Collections::Generic::IComparer\<T\>\>\&) | Ordena los elementos de la lista. |
| [Sort](./sort/)() | Ordena los elementos de la lista usando el comparador predeterminado. |
| [Sort](./sort/)(int, int, SharedPtr\<System::Collections::Generic::IComparer\<T\>\>) | Ordena los elementos de la porción de la lista. |
| [Sort](./sort/)(Comparison\<T\>, bool) | Ordena los elementos de la lista. |
| [ToArray](./toarray/)() const | Convierte la lista a una matriz. |
| [TrimExcess](./trimexcess/)() | Ajusta la capacidad de la lista para que coincida con su tamaño. |
| [TrueForAll](./trueforall/)(System::Predicate\<T\>) | Determina si todos los elementos de la colección cumplen las condiciones definidas por el predicado especificado. |
...
int main()
{
  ...
  // Insertar el elemento en el índice 1.
  ...
  // Agregar elementos de la segunda lista a la primera.
  list1->AddRange(list2);

  // Imprimir los elementos de la primera lista.
