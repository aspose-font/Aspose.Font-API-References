...
| [Add](./add/)(const T\&) override | Añade un elemento al conjunto. |
...
| [data](./data/)() | Accesor del tipo de datos subyacente. |
| [data](./data/)() const | Accesor del tipo de datos subyacente. |
...
| [TryAdd](./tryadd/)(const T\&) | Añade un elemento al conjunto. |
