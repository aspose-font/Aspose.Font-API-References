...
| [AddFirst](./addfirst/)(const T\&) | Agrega **element** al comienzo de la lista. |
| [AddFirst](./addfirst/)(const SharedPtr\<LinkedListNode\<T\>\>\&) | Agrega **newNode** al comienzo de la lista. |
...
int main()
{
  ...
  // Imprima los elementos de la lista enlazada.
