...
| virtual [GetValueOrDefault](./getvalueordefault/)(const TKey\&) const | Devuelve el valor si se encuentra; o **Value()** en caso contrario. |
| virtual [GetValueOrDefault](./getvalueordefault/)(const TKey\&, const TValue\&) const | Devuelve el valor si se encuentra; o **defaultValue** en caso contrario. |
| virtual [GetValueOrNull](./getvalueornull/)(const TKey\&) const | Devuelve el valor si se encuentra; o **null** en caso contrario, tiene sentido solo para tipos de referencia. |
