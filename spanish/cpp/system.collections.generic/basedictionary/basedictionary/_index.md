...
description: "System::Collections::Generic::BaseDictionary::BaseDictionary constructor. Crea una estructura de datos vacía en C++."
type: docs
weight: 100
url: /es/cpp/system.collections.generic/basedictionary/basedictionary/
---
...
| --- | --- | --- |
| src | BaseType * | [Object](../../../system/object/) para copiar datos de. |
...
| --- | --- |
| Argumentos | Tipos de argumentos del constructor del mapa. |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| src | BaseType * | [Object](../../../system/object/) para copiar datos de. |
| args | const Args\&... | Argumentos a pasar al constructor del mapa subyacente. |
...
| Parámetro | Descripción |
| --- | --- |
| Argumentos | Tipos de argumentos a pasar al mapa. |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| args | int | Argumentos a pasar al mapa subyacente. |
