...
description: "Clase System::Collections::Generic::BaseDictionary. Implementa código común para varias estructuras de datos similares a diccionarios (p. ej. Dictionary, SortedDictionary). No debería usarse directamente, excepto mediante herencia al definir contenedores. Los objetos de esta clase solo deben asignarse usando la función System::MakeObject() function. Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a funciones como argumento en C++."
type: docs
weight: 500
...
| [ContainsValue](./containsvalue/)(const mapped_t\&) | Comprueba si el valor está presente en el diccionario. Usa el operador == para comparar valores. |
...
| [GetValueOrDefault](./getvalueordefault/)(const key_t\&) const override | Devuelve el valor si se encuentra; o **Value()** en caso contrario. |
| [GetValueOrDefault](./getvalueordefault/)(const key_t\&, const mapped_t\&) const override | Devuelve el valor si se encuentra; o **defaultValue** en caso contrario. |
...
| [Remove](./remove/)(const key_t\&) override | Elimina una clave específica del diccionario. |
