...
description: "System::Collections::Generic::_net_binnary_search método. Implementa búsqueda binaria en contenedor de acceso aleatorio. Especialización para punteros inteligentes. Utiliza el método System::Object::CompareTo en C++."
type: docs
weight: 4900
...
Implementa búsqueda binaria en contenedor de acceso aleatorio. Especialización para punteros inteligentes. Utiliza el método System::Object::CompareTo.
...
Si se encuentra, índice del siguiente elemento; de lo contrario, complemento del índice donde se detuvo la búsqueda.
...
Implementa búsqueda binaria en contenedor de acceso aleatorio. Especialización para tipos de valor. Utiliza el método CompareTo.
...
Implementa búsqueda binaria en contenedor de acceso aleatorio. Especialización para tipos escalares. Compara los elementos usando los operadores mayor y menor.
...
Implementa búsqueda binaria en contenedor de acceso aleatorio.
...
| count | int | Longitud del rango de búsqueda. |
| valor | T | Valor a buscar. |
| comparer | const SharedPtr\<System::Collections::Generic::IComparer\<T\>\>\& | Objeto [Comparer](../comparer/). |
