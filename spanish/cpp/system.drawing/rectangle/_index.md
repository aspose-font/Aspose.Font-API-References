...
| [Contains](./contains/)(const Rectangle\&) const | Determina si el rectángulo especificado está ubicado dentro del rectángulo representado por el objeto actual. |
...
| [Offset](./offset/)(const Point\&) | Desplaza la posición del rectángulo representado por el objeto actual por las cantidades especificadas. |
| [Offset](./offset/)(int, int) | Desplaza la posición del rectángulo representado por el objeto actual por las cantidades especificadas. |
