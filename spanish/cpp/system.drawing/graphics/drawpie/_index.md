---
title: "Método System::Drawing::Graphics::DrawPie"
linktitle: "DrawPie"
second_title: "Aspose.Font para C++"
description: "Método System::Drawing::Graphics::DrawPie. Dibuja el pastel especificado usando la pluma especificada en la superficie representada por el objeto actual en C++."
type: docs
weight: 2400
url: /es/cpp/system.drawing/graphics/drawpie/
---
...
| --- | --- | --- |
| pluma | const SharedPtr\<Pen\>\& | Una pluma para usar al dibujar el pastel |
...
| height | float | El alto del rectángulo que define la elipse |
| startAngle | float | Ángulo en grados medido en sentido horario desde el eje X hasta el punto de inicio del pie |
| sweepAngle | float | Ángulo en grados medido en sentido horario desde el **startAngle** hasta el punto final del pie |
...
| height | int32_t | El alto del rectángulo que define la elipse |
| startAngle | int32_t | Ángulo en grados medido en sentido horario desde el eje X hasta el punto de inicio del pie |
| sweepAngle | int32_t | Ángulo en grados medido en sentido horario desde el **startAngle** hasta el punto final del pie |
