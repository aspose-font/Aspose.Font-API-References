...
Establece la región de recorte de la superficie de dibujo representada por el objeto [Gráficos](../) actual al resultado de la operación especificada que combina la región de recorte actual y la región especificada por una ruta gráfica.
