---
title: "System::Drawing::Graphics::DrawImage método"
linktitle: "DrawImage"
...
| srcRect | Rectángulo | Un rectángulo que define la región de la imagen especificada que se dibujará |
...
| srcRect | const RectangleF\& | Un rectángulo que define la región de la imagen especificada que se dibujará |
| srcUnit | GraphicsUnit | Las unidades de medida utilizadas por el parámetro **srcRect** |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| destPoints | const System::Details::ArrayView\<PointF\>\& | Una vista de matriz que contiene tres puntos que definen un paralelogramo en la superficie de dibujo donde se dibujará la imagen |
| srcRect | const RectangleF\& | Un rectángulo que define la región de la imagen especificada que se dibujará |
| srcUnit | GraphicsUnit | Las unidades de medida utilizadas por el parámetro **srcRect** |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Especifica la información de color y gamma para la imagen |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| destPoints | const System::Details::StackArray\<PointF, N\>\& | Una matriz de pila que contiene tres puntos que definen un paralelogramo en la superficie de dibujo donde se dibujará la imagen |
| srcRect | const RectangleF\& | Un rectángulo que define la región de la imagen especificada que se dibujará |
| srcUnit | GraphicsUnit | Las unidades de medida utilizadas por el parámetro **srcRect** |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Especifica la información de color y gamma para la imagen |
...
| width | float | El ancho de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| height | float | La altura de la esquina superior izquierda del rectángulo donde dibujar la imagen |
...
| x | float | La coordenada X de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| y | float | La coordenada Y de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| srcRect | RectangleF | Un rectángulo que define la región de la imagen especificada que se dibujará |
| srcUnit | GraphicsUnit | Las unidades de medida utilizadas por el parámetro **srcRect** |
...
| width | int | El ancho de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| height | int | La altura de la esquina superior izquierda del rectángulo donde dibujar la imagen |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| pt | Point | La ubicación de la esquina superior izquierda de la imagen dibujada |
