...
| [Contains](./contains/)(const RectangleF\&) | Determina si el rectángulo especificado está ubicado dentro del rectángulo representado por el objeto actual. |
...
| [Offset](./offset/)(const PointF\&) | Desplaza la posición del rectángulo representado por el objeto actual por las cantidades especificadas. |
| [Offset](./offset/)(float, float) | Desplaza la posición del rectángulo representado por el objeto actual por las cantidades especificadas. |
...
| [RectangleF](./rectanglef/)(const PointF\&, const SizeF\&) | Construye una nueva instancia del objeto [RectangleF](./) que representa un rectángulo con las coordenadas de su esquina superior izquierda especificadas como una instancia de la clase [PointF](../pointf/) y su ancho y altura como una instancia de la clase [SizeF](../sizef/). |
...
| Campo | Descripción |
| --- | --- |
| static [Empty](./empty/) | Un rectángulo vacío, es decir, un rectángulo cuyas coordenadas de ubicación y valores de tamaño son cero. |
## Ver también
