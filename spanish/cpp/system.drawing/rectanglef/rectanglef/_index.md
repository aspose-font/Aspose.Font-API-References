...
description: "System::Drawing::RectangleF::RectangleF constructor. Construye una nueva instancia del objeto RectangleF que representa un rectángulo con coordenadas X e Y y valores de ancho y alto establecidos en 0 en C++."
type: docs
weight: 100
url: /es/cpp/system.drawing/rectanglef/rectanglef/
---
## RectangleF::RectangleF() constructor


Construye una nueva instancia del objeto [RectangleF](../) que representa un rectángulo con coordenadas X y Y y valores de ancho y altura establecidos en 0.
...
| --- | --- | --- |
| location | const PointF\& | Especifica la ubicación de la esquina superior izquierda del rectángulo |
| size | const SizeF\& | Especifica el ancho y la altura del rectángulo |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| rect | const Rectangle\& | Una instancia de la clase [Rectangle](../../rectangle/) que especifica la posición y el tamaño del rectángulo que será representado por el objeto que se está construyendo |
