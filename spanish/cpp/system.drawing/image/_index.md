...
| [Save](./save/)(const String\&, const Imaging::ImageCodecInfoPtr\&, const Imaging::EncoderParametersPtr\&) | Guarda la imagen representada por el objeto actual en el archivo especificado usando el codificador y los parámetros del codificador especificados. |
| [Save](./save/)(const SharedPtr\<System::IO::Stream\>\&, const Imaging::ImageCodecInfoPtr\&, const Imaging::EncoderParametersPtr\&) | Guarda la imagen representada por el objeto actual en el flujo especificado usando el codificador y los parámetros del codificador especificados. |
| [SaveAdd](./saveadd/)(const Imaging::EncoderParametersPtr\&) | Agrega un fotograma al archivo o flujo especificado en una llamada anterior al método [Save()](./save/). |
| [SaveAdd](./saveadd/)(const SharedPtr\<Image\>\&, const Imaging::EncoderParametersPtr\&) | Agrega un fotograma al archivo o flujo especificado en una llamada anterior al método [Save()](./save/). |
