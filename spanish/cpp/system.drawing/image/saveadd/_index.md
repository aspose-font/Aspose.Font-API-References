---
title: "Método System::Drawing::Image::SaveAdd"
linktitle: "SaveAdd"
second_title: "Aspose.Font para C++"
description: "Método System::Drawing::Image::SaveAdd. Añade un fotograma al archivo o flujo especificado en una llamada previa al método [Save()](../save/) en C++."
type: docs
weight: 2300
url: /es/cpp/system.drawing/image/saveadd/
---
## Image::SaveAdd(const Imaging::EncoderParametersPtr\&) method


Añade un fotograma al archivo o flujo especificado en una llamada previa al método [Save()](../save/).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| image | const SharedPtr\<Image\>\& | Un objeto [Image](../) que contiene el fotograma a añadir |
| encoder_params | const Imaging::EncoderParametersPtr\& | Los parámetros del codificador a usar |
