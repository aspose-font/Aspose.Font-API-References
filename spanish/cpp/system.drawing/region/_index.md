...
| [GetRegionScans](./getregionscans/)(const SharedPtr\<Drawing2D::Matrix\>\&) const | Devuelve una matriz de estructuras [RectangleF](../rectanglef/) que aproximan este [Region](./) después de aplicar la transformación matricial especificada. |
