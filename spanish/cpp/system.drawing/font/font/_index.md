...
| --- | --- | --- |
| prototype | const SharedPtr\<Font\>\& | La fuente existente a partir de la cual crear la nueva. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| familia | const SharedPtr\<FontFamily\>\& | La familia tipográfica de la nueva fuente |
