...
description: "Clase System::Drawing::SizeF. Representa un par de valores de punto flotante de precisión simple que representan el ancho y alto de una imagen. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 2300
