...
| [GetCellAscent](./getcellascent/)(FontStyle) | Devuelve el ascenso de celda de la familia tipográfica representada por el objeto actual para el estilo de fuente especificado. |
| [GetCellDescent](./getcelldescent/)(FontStyle) | Devuelve el descenso de celda de la familia tipográfica representada por el objeto actual para el estilo de fuente especificado. |
