...
description: "System::Drawing::Point::Add method. Añade los valores de ancho y alto del objeto Size especificado a los valores de las coordenadas X y Y del objeto Point especificado correspondientemente en C++."
type: docs
weight: 1500
...
Añade los valores de ancho y alto del objeto [Size](../../size/) especificado a los valores de las coordenadas X y Y del objeto [Point](../) especificado correspondientemente.
