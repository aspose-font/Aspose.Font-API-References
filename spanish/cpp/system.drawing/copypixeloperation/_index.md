...
| Blackness | 66 | La región de destino se llena usando el color con índice 0 en la paleta física. |
...
| PatInvert | 5898313 | Los colores del pincel actualmente seleccionado en el contexto de dispositivo de destino se combinan mediante XOR con los colores del destino. |
...
| MergeCopy | 12583114 | Los colores de la región de origen se combinan mediante AND con los colores del pincel seleccionado del contexto de dispositivo de destino. |
...
| PatPaint | 16452105 | Los colores del pincel actualmente seleccionado en el contexto de dispositivo de destino se combinan con OR con los colores de la región fuente invertida. El resultado de esta operación se combina con OR con los colores de la región de destino. |
