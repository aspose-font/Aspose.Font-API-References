...
| virtual [get_IsMutuallyAuthenticated](./get_ismutuallyauthenticated/)() const | Devuelve un valor que indica si el servidor y el cliente están autenticados. |
