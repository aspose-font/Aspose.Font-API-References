...
description: "System::Net::Security::SslStream::AuthenticateAsClient method. Autentica el lado cliente de la conexión en C++."
type: docs
weight: 200
...
| --- | --- | --- |
| targetHost | Cadena | El nombre del servidor que comparte la instancia actual. |
