...
| Método | Descripción |
| --- | --- |
| [Add](./add/)(const TKey\&, const TValue\&) override | Añade un valor al diccionario. |
...
| [Remove](./remove/)(const TKey\&) override | Elimina un elemento del contenedor. |
| [TryAdd](./tryadd/)(const TKey\&, const TValue\&) | Intenta añadir un par clave/valor al diccionario. |
## Typedefs
