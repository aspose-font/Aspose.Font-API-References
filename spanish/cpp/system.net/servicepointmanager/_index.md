...
| static [get_SecurityProtocol](./get_securityprotocol/)() | Obtiene el tipo de protocolo de seguridad utilizado por las instancias de la clase ServicePoint que son gestionadas por la instancia actual. |
| static [get_ServerCertificateValidationCallback](./get_servercertificatevalidationcallback/)() | Obtiene la función de devolución de llamada que se usa para validar un certificado de servidor. |
| static [get_UseNagleAlgorithm](./get_usenaglealgorithm/)() | Obtiene un valor que indica si las instancias de la clase ServicePoint usan el algoritmo de Nagle. |
...
| static [set_DefaultConnectionLimit](./set_defaultconnectionlimit/)(int32_t) | Establece el número máximo de conexiones concurrentes que se permiten en las instancias de ServicePoint-class. |
...
| static [set_MaxServicePointIdleTime](./set_maxservicepointidletime/)(int32_t) | Establece el tiempo máximo de inactividad de las instancias de ServicePoint-class. |
...
| static [set_UseNagleAlgorithm](./set_usenaglealgorithm/)(bool) | Establece un valor que indica si las instancias de ServicePoint-class usan el algoritmo de Nagle. |
