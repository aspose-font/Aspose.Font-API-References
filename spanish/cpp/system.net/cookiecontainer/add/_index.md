---
title: "System::Net::CookieContainer::Add método"
linktitle: "Add"
second_title: "Aspose.Font para C++"
description: "System::Net::CookieContainer::Add método. Agrega una cookie a la colección en C++."
type: docs
weight: 200
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| cookies | System::SharedPtr\<CookieCollection\> | La colección de la que se copiarán las cookies. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| uri | System::SharedPtr\<Uri\> | Una URI de la cookie. |
| cookie | System::SharedPtr\<Cookie\> | La cookie a agregar. |
...
| --- | --- | --- |
| uri | System::SharedPtr\<Uri\> | Una URI de la cookie. |
| cookies | System::SharedPtr\<CookieCollection\> | Una colección de cookies de la que se deben copiar las cookies. |
