...
| ReceiveFailure | 3 | No se recibe una respuesta completa del servidor remoto. |
...
| Timeout | 14 | No se recibió respuesta durante el período de tiempo de espera para una solicitud. |
