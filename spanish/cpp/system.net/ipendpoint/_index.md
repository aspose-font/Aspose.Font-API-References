...
| [get_Address](./get_address/)() | Obtiene la dirección del punto de conexión. |
...
| [set_Address](./set_address/)(System::SharedPtr\<IPAddress\>) | Establece la dirección del punto de conexión. |
...
| Campo | Descripción |
| --- | --- |
| static [Any](./any/) | El punto de conexión para cualquier dirección IPv4 y cualquier puerto. |
| static [AnyPort](./anyport/) | Un valor que indica si se puede usar cualquier puerto. |
| static [IPv6Any](./ipv6any/) | El punto de conexión para cualquier dirección IPv6 y cualquier puerto. |
