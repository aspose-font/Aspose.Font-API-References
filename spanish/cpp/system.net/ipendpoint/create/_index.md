...
description: "System::Net::IPEndPoint::Create método. Cree una nueva instancia de la clase EndPoint usando la dirección de socket especificada en C++."
type: docs
weight: 200
...
Cree una nueva instancia de la clase [EndPoint](../../endpoint/) usando la dirección de socket especificada.
