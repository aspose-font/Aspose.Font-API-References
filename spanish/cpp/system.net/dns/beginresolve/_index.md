...
description: "Método System::Net::Dns::BeginResolve. Inicia una operación asíncrona para crear una nueva instancia de la clase IPHostEntry usando el nombre de host especificado en C++."
type: docs
weight: 400
...
Inicia una operación asíncrona para crear una nueva instancia de la clase IPHostEntry-class usando el nombre de host especificado.
...
| --- | --- | --- |
| hostName | String | Un nombre de host que se usa para crear una nueva instancia de la clase [IPHostEntry](../../iphostentry/). |
