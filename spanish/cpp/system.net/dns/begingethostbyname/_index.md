...
description: "Método System::Net::Dns::BeginGetHostByName. Inicia una operación asincrónica para crear una nueva instancia de IPHostEntry-class usando el nombre de host especificado en C++."
type: docs
weight: 200
...
| --- | --- | --- |
| hostName | Cadena | Un nombre de host. |
