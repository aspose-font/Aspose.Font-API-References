---
title: "Método System::Net::Dns::BeginGetHostEntry"
linktitle: "BeginGetHostEntry"
second_title: "Aspose.Font para C++"
description: "Método System::Net::Dns::BeginGetHostEntry. Inicia una operación asíncrona para crear una nueva instancia de la clase IPHostEntry usando la cadena especificada que contiene un nombre de host o una dirección IP en C++."
type: docs
weight: 300
...
Inicia una operación asíncrona para crear una nueva instancia de la clase IPHostEntry-class usando la cadena especificada que contiene un nombre de host o una dirección IP.
...
| --- | --- | --- |
| hostNameOrAddress | Cadena | La cadena que contiene un nombre de host o una dirección IP. |
...
Inicia una operación asíncrona para crear una nueva instancia de la clase IPHostEntry-class usando la dirección IP especificada.
