...
description: "System::Net::CookieCollection::idx_get method. Devuelve una cookie de la colección de cookies en el índice especificado en C++."
type: docs
weight: 800
url: /es/cpp/system.net/cookiecollection/idx_get/
---
...
| --- | --- | --- |
| índice | int32_t | El índice de una cookie que debe ser devuelta. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre | Cadena | El nombre de una cookie que debe ser devuelta. |
