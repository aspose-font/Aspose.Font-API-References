...
description: "System::Net::SocketAddress::SocketAddress constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net/socketaddress/socketaddress/
---
...
| --- | --- | --- |
| familia | Sockets::AddressFamily | La familia de direcciones. |
...
| --- | --- | --- |
| familia | Sockets::AddressFamily | La familia de direcciones. |
| size | int32_t | El tamaño del búfer subyacente. |
