...
| [get_Count](./get_count/)() const | Devuelve el número de elementos en la colección. |
...
| static [IsRestricted](./isrestricted/)(const String\&) | Comprueba si el encabezado HTTP especificado puede establecerse para la solicitud. |
| [Remove](./remove/)(String) | Elimina el encabezado mediante el nombre de encabezado especificado. |
