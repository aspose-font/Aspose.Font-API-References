...
| --- | --- | --- |
| usar | Description::SoapBindingUse | El formato de los parámetros. |
...
| --- | --- | --- |
| usar | Description::SoapBindingUse | El formato de los parámetros. |
| paramStyle | SoapParameterStyle | Un valor que indica si los parámetros están encapsulados dentro de un solo elemento XML bajo el elemento 'Body'. |
