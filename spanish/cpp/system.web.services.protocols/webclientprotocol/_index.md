...
Esta clase base se utiliza en todos los proxies de cliente de servicio XML [Web](../../system.web/). Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento.
...
| [get_Timeout](./get_timeout/)() | Obtiene el intervalo de tiempo de espera antes de que la solicitud expire. |
...
| [set_Timeout](./set_timeout/)(int32_t) | Establece el intervalo de tiempo de espera antes de que la solicitud expire. |
