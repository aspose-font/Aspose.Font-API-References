...
| [GetMonthGenitiveName](./getmonthgenitivename/)(int) const | Obtiene el nombre genitivo del mes. |
...
| [set_LongDatePattern](./set_longdatepattern/)(const String\&) | Establece el patrón largo de fecha. |
| [set_LongTimePattern](./set_longtimepattern/)(const String\&) | Establece el patrón largo de hora. |
...
| [set_ShortDatePattern](./set_shortdatepattern/)(const String\&) | Establece el patrón corto de fecha. |
| [set_ShortestDayNames](./set_shortestdaynames/)(const ArrayPtr\<String\>\&) | Establece los nombres de día más cortos posibles. |
| [set_ShortTimePattern](./set_shorttimepattern/)(const String\&) | Establece el patrón corto de hora. |
