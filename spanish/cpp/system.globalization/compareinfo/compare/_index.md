...
description: "System::Globalization::CompareInfo::Compare método. Compara cadenas. Solo se admiten los modos Ordinal y OrdinalIgnoreCase en C++."
type: docs
weight: 200
...
| options | CompareOptions | [String](../../../system/string/) tipo de comparación. |

### ReturnValue

Valor negativo si la cadena LHS precede a la RHS, cero si coinciden, valor positivo en caso contrario.
...
| offset2 | int | Índice inicial de caracteres en **string2**. |

### ReturnValue

Valor negativo si la primera sección de la cadena precede a la segunda sección, cero si coinciden, valor positivo en caso contrario.
...
| string2 | const String\& | Segunda cadena. |
| offset2 | int | Índice inicial de caracteres en **string2**. |
| options | CompareOptions | Opciones de comparación de [String](../../../system/string/). |
