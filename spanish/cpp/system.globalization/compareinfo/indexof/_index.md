...
Índice del valor de búsqueda en la cadena origen o -1 si no se encuentra.
...
| origen | const String\& | Cadena de origen. |
| valor | char16_t | Carácter. |
| start_index | int | Índice de inicio de búsqueda en la cadena origen. |
...
| valor | char16_t | Carácter. |
| start_index | int | Índice de inicio de búsqueda en la cadena origen. |
| count | int | Número de caracteres en la cadena origen. |
