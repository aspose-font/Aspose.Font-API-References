---
title: "Método System::Globalization::CultureInfo::GetCultureInfo"
linktitle: "GetCultureInfo"
second_title: "Aspose.Font para C++"
description: "System::Globalization::CultureInfo::GetCultureInfo method. Obtiene la cultura por su nombre. Igual que CreateSpecificCulture en C++."
type: docs
weight: 4200
url: /es/cpp/system.globalization/cultureinfo/getcultureinfo/
---
...
| --- | --- | --- |
| nombre | const String\& | Nombre de cultura predefinido o nombre del objeto de cultura existente. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre | const String\& | Nombre de la cultura. |
| text_and_compare_culture_name | const String\& | Nombre de cultura usado para los objetos [TextInfo](../../textinfo/) y [CompareInfo](../../compareinfo/). |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| cultura | int32_t | Identificador de cultura. |
