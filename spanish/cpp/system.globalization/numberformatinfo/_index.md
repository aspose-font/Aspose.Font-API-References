...
| static [get_CurrentInfo](./get_currentinfo/)() | Obtiene la información de formato numérico definida por la cultura del hilo actual. |
...
| [get_NaNSymbol](./get_nansymbol/)() const | Obtiene el símbolo Not-a-Number. |
...
| [get_NumberGroupSeparator](./get_numbergroupseparator/)() const | Obtiene el separador de grupos numéricos. |
...
| [get_PercentDecimalDigits](./get_percentdecimaldigits/)() const | Obtiene el número de decimales en valores de porcentaje. |
...
| [get_PercentGroupSizes](./get_percentgroupsizes/)() const | Obtiene la cantidad de dígitos por grupo de valor de porcentaje. |
...
| [set_PercentDecimalDigits](./set_percentdecimaldigits/)(int) | Establece el número de lugares decimales en valores de porcentaje. |
| [set_PercentDecimalSeparator](./set_percentdecimalseparator/)(const String\&) | Establece el separador decimal en valores de porcentaje. |
| [set_PercentGroupSeparator](./set_percentgroupseparator/)(const String\&) | Establece el separador de grupo en valores de porcentaje. |
