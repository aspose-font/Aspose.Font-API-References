...
| virtual [ToLower](./tolower/)(char_t) const | Convierte un carácter a minúsculas. |
| virtual [ToLower](./tolower/)(String) const | Convierte una cadena a minúsculas. |
...
| [ToTitleCase](./totitlecase/)(String) const | Convierte una cadena a mayúsculas tipo título (excepto para acrónimos que ya están en mayúsculas). |
| virtual [ToUpper](./toupper/)(char_t) const | Convierte un carácter a mayúsculas. |
| virtual [ToUpper](./toupper/)(String) const | Convierte una cadena a mayúsculas. |
## Ver también
