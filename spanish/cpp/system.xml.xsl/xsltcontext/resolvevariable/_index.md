...
description: "System::Xml::Xsl::XsltContext::ResolveVariable método. Cuando se sobrescribe en una clase derivada, resuelve una referencia de variable y devuelve un IXsltContextVariable que representa la variable en C++."
type: docs
weight: 500
...
| nombre | Cadena | El nombre de la variable. |

### ReturnValue

Una [IXsltContextVariable](../../ixsltcontextvariable/) que representa la variable en tiempo de ejecución.
