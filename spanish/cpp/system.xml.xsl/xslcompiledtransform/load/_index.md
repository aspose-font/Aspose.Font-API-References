...
| --- | --- | --- |
| stylesheet | const SharedPtr\<System::Xml::XPath::IXPathNavigable\>\& | Un objeto que implementa la interfaz IXPathNavigable. Puede ser un [XmlNode](../../../system.xml/xmlnode/) (normalmente un [XmlDocument](../../../system.xml/xmldocument/)), o un XPathDocument que contiene la hoja de estilo. |
| settings | SharedPtr\<XsltSettings\> | El [XsltSettings](../../xsltsettings/) a aplicar a la hoja de estilo. Si esto es **nullptr**, se aplica la configuración [XsltSettings::get_Default](../../xsltsettings/get_default/). |
...
| settings | const SharedPtr\<XsltSettings\>\& | El [XsltSettings](../../xsltsettings/) a aplicar a la hoja de estilo. Si esto es **nullptr**, se aplica la configuración [XsltSettings::get_Default](../../xsltsettings/get_default/). |
