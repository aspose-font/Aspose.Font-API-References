...
description: "Método System::Xml::Xsl::XslTransform::Transform. Transforma los datos XML en el IXPathNavigable usando los args especificados y devuelve el resultado a un XmlReader en C++."
type: docs
weight: 400
...
Transforma los datos XML en el IXPathNavigable usando los **args** especificados y devuelve el resultado a un [XmlWriter](../../../system.xml/xmlwriter/).
...
Transforma los datos XML en el XPathNavigator usando los **args** especificados y devuelve el resultado a un [XmlReader](../../../system.xml/xmlreader/).
...
Transforma los datos XML en el XPathNavigator usando los args especificados y devuelve el resultado a un [XmlWriter](../../../system.xml/xmlwriter/).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| inputfile | const String\& | La URL del documento fuente a transformar. |
