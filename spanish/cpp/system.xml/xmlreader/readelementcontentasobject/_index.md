...
Un objeto empaquetado del tipo más apropiado. El valor de [XmlReader::get_ValueType](../get_valuetype/) determina el tipo adecuado. Si el contenido está tipado como una lista, este método devuelve una matriz de objetos empaquetados del tipo apropiado.
