...
Comprueba que los valores [XmlReader::get_LocalName](../get_localname/) y [XmlReader::get_NamespaceURI](../get_namespaceuri/) del elemento encontrado coinciden con las cadenas proporcionadas antes de leer un elemento solo de texto. Sin embargo, se recomienda usar el método [XmlReader::ReadElementContentAsString](../readelementcontentasstring/) en su lugar, porque proporciona una forma más directa de manejar esta operación.
...
| --- | --- | --- |
| nombre local | Cadena | El nombre local a comprobar. |
| ns | Cadena | El URI del espacio de nombres a comprobar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre | Cadena | El nombre a comprobar. |
