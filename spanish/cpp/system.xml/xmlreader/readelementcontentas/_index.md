...
Comprueba que el nombre local y el URI del espacio de nombres especificados coincidan con los del elemento actual, luego lee el contenido del elemento como el tipo solicitado.
