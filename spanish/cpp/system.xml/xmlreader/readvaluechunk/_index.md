...
description: "System::Xml::XmlReader::ReadValueChunk método. Lee flujos grandes de texto incrustados en un documento XML en C++."
type: docs
weight: 7400
...
| --- | --- | --- |
| buffer | ArrayPtr\<char16_t\> | La matriz de caracteres que sirve como búfer al que se escribe el contenido de texto. Este valor no puede ser **nullptr**. |
