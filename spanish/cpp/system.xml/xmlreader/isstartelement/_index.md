...
| --- | --- | --- |
| nombre local | Cadena | La cadena a comparar con el valor **LocalName** del elemento encontrado. |
| ns | Cadena | La cadena a comparar con el valor **NamespaceURI** del elemento encontrado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre | Cadena | La cadena coincidió con el valor **Name** del elemento encontrado. |
