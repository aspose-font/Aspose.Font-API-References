...
| --- | --- | --- |
| localName | Cadena | El nombre local del elemento al que desea moverse. |
| namespaceURI | Cadena | El URI del espacio de nombres del elemento al que desea moverse. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre | Cadena | El nombre calificado del elemento al que desea moverse. |
