---
title: "System::Xml::XmlWriter::WriteAttributeString método"
linktitle: "WriteAttributeString"
second_title: "Aspose.Font para C++"
description: "System::Xml::XmlWriter::WriteAttributeString método. Cuando se sobrescribe en una clase derivada, escribe un atributo con el nombre local especificado, el URI del espacio de nombres y el valor en C++."
type: docs
weight: 1000
url: /es/cpp/system.xml/xmlwriter/writeattributestring/
---
...
| ns | const String\& | El URI del espacio de nombres que se asociará con el atributo. |
| valor | const String\& | El valor del atributo. |
