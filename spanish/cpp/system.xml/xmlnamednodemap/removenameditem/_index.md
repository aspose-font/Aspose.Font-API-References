---
title: "Método System::Xml::XmlNamedNodeMap::RemoveNamedItem"
...
| --- | --- | --- |
| localName | Cadena | El nombre local del nodo a eliminar. |
| namespaceURI | Cadena | El URI del espacio de nombres del nodo a eliminar. |
