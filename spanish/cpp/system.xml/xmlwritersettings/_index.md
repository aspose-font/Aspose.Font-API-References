...
| [get_CheckCharacters](./get_checkcharacters/)() | Devuelve un valor que indica si el escritor XML debe verificar que todos los caracteres del documento cumplan con la sección "2.2 Characters" de la [Recomendación XML 1.0](https://www.w3.org/TR/REC-xml/#charsets) del W3C. |
...
| [set_CheckCharacters](./set_checkcharacters/)(bool) | Establece un valor que indica si el escritor XML debe comprobar que todos los caracteres del documento cumplen con la sección "2.2 Characters" de la recomendación W3C [XML 1.0 Recommendation](https://www.w3.org/TR/REC-xml/#charsets). |
| [set_CloseOutput](./set_closeoutput/)(bool) | Establece un valor que indica si el [XmlWriter](../xmlwriter/) también debe cerrar el flujo subyacente o el TextWriter cuando se llame al método [XmlWriter::Close](../xmlwriter/close/). |
