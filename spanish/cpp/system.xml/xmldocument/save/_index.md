---
title: "System::Xml::XmlDocument::Save método"
linktitle: "Save"
second_title: "Aspose.Font para C++"
description: "System::Xml::XmlDocument::Save método. Guarda el documento XML en el flujo especificado en C++."
type: docs
weight: 3700
...
| --- | --- | --- |
| outStream | SharedPtr\<IO::Stream\> | El flujo al que desea guardar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| escritor | SharedPtr\<IO::TextWriter\> | El TextWriter al que deseas guardar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| w | SharedPtr\<XmlWriter\> | El [XmlWriter](../../xmlwriter/) en el que desea guardar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| filename | Cadena | La ubicación del archivo donde deseas guardar el documento. |
