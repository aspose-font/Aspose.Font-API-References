...
| documento | Documento |
| fragmento de documento | FragmentoDeDocumento |
| tipo de documento | TipoDeDocumento |
| elemento | Elemento |
| referencia de entidad | EntityReference |
| instrucción de procesamiento | InstrucciónDeProcesamiento |
| espacio en blanco significativo | EspacioEnBlancoSignificativo |
| texto | Text |
| espacio en blanco | EspacioEnBlanco |
...
| nombre | const String\& | El nombre local del nuevo nodo. |
| namespaceURI | const String\& | El URI del espacio de nombres del nuevo nodo. |
