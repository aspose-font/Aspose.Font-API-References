...
| --- | --- | --- |
| localName | Cadena | El LocalName a coincidir. El valor especial **\"*\"** coincide con todas las etiquetas. |
| namespaceURI | Cadena | NamespaceURI a coincidir. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre | Cadena | El nombre calificado para coincidir. Se compara con el valor **get_Name** del nodo coincidente. El valor especial **\"*\"** coincide con todas las etiquetas. |

### ReturnValue

Una [XmlNodeList](../../xmlnodelist/) que contiene una lista de todos los nodos coincidentes. Si ningún nodo coincide con **name**, la colección devuelta estará vacía.
