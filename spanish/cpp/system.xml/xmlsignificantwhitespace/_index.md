...
description: "Clase System::Xml::XmlSignificantWhitespace. Representa espacio en blanco entre marcas en un nodo de contenido mixto o espacio en blanco dentro de un ámbito xml:space=''preserve''. También se le conoce como espacio en blanco significativo en C++."
type: docs
weight: 3700
...
Representa espacio en blanco entre marcas en un nodo de contenido mixto o espacio en blanco dentro de un ámbito **xml:space='preserve'**. Esto también se conoce como espacio en blanco significativo.
