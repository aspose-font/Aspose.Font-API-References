...
description: "System::Xml::XmlSecureResolver::GetEntity método. Asigna un URI a un objeto que contiene el recurso real en C++."
type: docs
weight: 200
...
El flujo devuelto al llamar a **GetEntity** en el [XmlResolver](../../xmlresolver/) subyacente. Si se especifica un tipo distinto de Stream, el método devuelve **nullptr**.
