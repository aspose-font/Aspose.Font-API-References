...
| --- | --- | --- |
| Prohibit | 0 | Especifica que cuando se encuentra un DTD, se lanza una [XmlException](../xmlexception/) con un mensaje que indica que los DTDs están prohibidos. Este es el comportamiento predeterminado. |
