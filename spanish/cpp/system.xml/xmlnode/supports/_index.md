...
| --- | --- | --- |
| característica | Cadena | El nombre del paquete de la característica a probar. Este nombre no distingue entre mayúsculas y minúsculas. |
| versión | Cadena | El número de versión del nombre del paquete a probar. Si la versión no se especifica (null), admitir cualquier versión de la característica hace que el método devuelva true. |
