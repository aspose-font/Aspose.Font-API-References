...
| virtual [get_PreviousSibling](./get_previoussibling/)() | Devuelve el nodo inmediatamente anterior a este nodo. |
...
| virtual [GetPrefixOfNamespace](./getprefixofnamespace/)(String) | Busca la declaración **xmlns** más cercana para el URI del espacio de nombres dado que está en alcance del nodo actual y devuelve el prefijo definido en esa declaración. |
| virtual [idx_get](./idx_get/)(String) | Devuelve el primer elemento hijo con el nombre especificado [XmlNode::get_Name](./get_name/). |
...
| virtual [PrependChild](./prependchild/)(SharedPtr\<XmlNode\>) | Añade el nodo especificado al principio de la lista de nodos hijos de este nodo. |
...
| virtual [set_InnerText](./set_innertext/)(String) | Establece los valores concatenados del nodo y todos sus nodos hijos. |
| virtual [set_InnerXml](./set_innerxml/)(String) | Establece el marcado que representa solo los nodos hijos de este nodo. |
| virtual [set_Prefix](./set_prefix/)(String) | Establece el prefijo del espacio de nombres de este nodo. |
