...
description: "Clase System::Xml::XmlNodeReader. Representa un lector que proporciona acceso rápido, sin caché y solo hacia adelante a datos XML en un XmlNode en C++."
type: docs
weight: 2800
...
Representa un lector que proporciona acceso rápido, sin caché y solo hacia adelante a datos XML en un [XmlNode](../xmlnode/).
