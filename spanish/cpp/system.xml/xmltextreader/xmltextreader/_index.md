...
| context | const SharedPtr\<XmlParserContext\>\& | El [XmlParserContext](../../xmlparsercontext/) en el que se analizará el **xmlFragment**. Esto incluye el [XmlNameTable](../../xmlnametable/) a usar, la codificación, el ámbito de espacio de nombres, el **xml:lang** actual y el ámbito **xml:space**. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| entrada | const SharedPtr\<IO::TextReader\>\& | El TextReader que contiene los datos XML para leer. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| url | const String\& | La URL del archivo que contiene los datos XML para leer. |
| nt | const SharedPtr\<XmlNameTable\>\& | El [XmlNameTable](../../xmlnametable/) a usar. |
...
Inicializa una nueva instancia de la clase [XmlTextReader](../) con la cadena especificada, [XmlNodeType](../../xmlnodetype/) y [XmlParserContext](../../xmlparsercontext/).
