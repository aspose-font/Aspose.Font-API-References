...
| [get_IsDefault](./get_isdefault/)() override | Devuelve un valor que indica si el nodo actual es un atributo generado a partir del valor predeterminado definido en el DTD o el esquema. |
...
| [get_NamespaceURI](./get_namespaceuri/)() override | Devuelve la URI del espacio de nombres (según lo definido en la especificación de espacios de nombres de W3C) del nodo en el que está posicionado el lector. |
...
| [get_Normalization](./get_normalization/)() | Devuelve un valor que indica si se debe normalizar el espacio en blanco y los valores de los atributos. |
...
| [MoveToAttribute](./movetoattribute/)(String, String) override | Se desplaza al atributo con el nombre local y el URI del espacio de nombres especificados. |
...
| [ReadContentAsBase64](./readcontentasbase64/)(ArrayPtr\<uint8_t\>, int32_t, int32_t) override | Lee el contenido y devuelve los bytes binarios decodificados **Base64**. |
| [ReadContentAsBinHex](./readcontentasbinhex/)(ArrayPtr\<uint8_t\>, int32_t, int32_t) override | Lee el contenido y devuelve los bytes binarios decodificados **BinHex**. |
...
| [XmlTextReader](./xmltextreader/)(const String\&, const SharedPtr\<IO::TextReader\>\&, const SharedPtr\<XmlNameTable\>\&) | Inicializa una nueva instancia de la clase [XmlTextReader](./) con la URL, el TextReader y [XmlNameTable](../xmlnametable/) especificados. |
