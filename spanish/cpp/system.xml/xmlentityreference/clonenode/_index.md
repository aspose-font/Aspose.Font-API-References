...
| --- | --- | --- |
| deep | bool | **true** para clonar recursivamente el subárbol bajo el nodo especificado; **false** para clonar solo el nodo mismo. Para los nodos [XmlEntityReference](../), este método siempre devuelve un nodo de referencia de entidad sin hijos. El texto de reemplazo se establece cuando el nodo se inserta en un padre. |
