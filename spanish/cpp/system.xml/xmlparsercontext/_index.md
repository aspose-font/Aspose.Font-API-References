...
| [get_InternalSubset](./get_internalsubset/)() | Devuelve el subconjunto interno DTD. |
| [get_NamespaceManager](./get_namespacemanager/)() | Devuelve el [XmlNamespaceManager](../xmlnamespacemanager/). |
| [get_NameTable](./get_nametable/)() | Devuelve la [XmlNameTable](../xmlnametable/) usada para atomizar cadenas. Para más información sobre cadenas atomizadas, vea [XmlNameTable](../xmlnametable/). |
...
| [set_NameTable](./set_nametable/)(const SharedPtr\<XmlNameTable\>\&) | Establece la [XmlNameTable](../xmlnametable/) utilizada para atomizar cadenas. Para obtener más información sobre las cadenas atomizadas, consulte la [XmlNameTable](../xmlnametable/). |
...
| [XmlParserContext](./xmlparsercontext/)(const SharedPtr\<XmlNameTable\>\&, const SharedPtr\<XmlNamespaceManager\>\&, const String\&, System::Xml::XmlSpace) | Inicializa una nueva instancia de la clase [XmlParserContext](./) con la [XmlNameTable](../xmlnametable/), [XmlNamespaceManager](../xmlnamespacemanager/) especificadas, **xml:lang**, y **xml:space**. |
| [XmlParserContext](./xmlparsercontext/)(const SharedPtr\<XmlNameTable\>\&, const SharedPtr\<XmlNamespaceManager\>\&, const String\&, System::Xml::XmlSpace, const SharedPtr\<System::Text::Encoding\>\&) | Inicializa una nueva instancia de la clase [XmlParserContext](./) con la [XmlNameTable](../xmlnametable/), [XmlNamespaceManager](../xmlnamespacemanager/) especificadas, **xml:lang**, **xml:space**, y la codificación. |
| [XmlParserContext](./xmlparsercontext/)(const SharedPtr\<XmlNameTable\>\&, const SharedPtr\<XmlNamespaceManager\>\&, const String\&, const String\&, const String\&, const String\&, const String\&, const String\&, System::Xml::XmlSpace) | Inicializa una nueva instancia de la clase [XmlParserContext](./) con la [XmlNameTable](../xmlnametable/), [XmlNamespaceManager](../xmlnamespacemanager/) especificadas, la URI base, **xml:lang**, **xml:space**, y los valores del tipo de documento. |
| [XmlParserContext](./xmlparsercontext/)(const SharedPtr\<XmlNameTable\>\&, const SharedPtr\<XmlNamespaceManager\>\&, const String\&, const String\&, const String\&, const String\&, const String\&, const String\&, System::Xml::XmlSpace, const SharedPtr\<System::Text::Encoding\>\&) | Inicializa una nueva instancia de la clase [XmlParserContext](./) con la [XmlNameTable](../xmlnametable/), [XmlNamespaceManager](../xmlnamespacemanager/) especificadas, la URI base, **xml:lang**, **xml:space**, la codificación y los valores del tipo de documento. |
## Typedefs
