...
| --- | --- | --- |
| nombre | Cadena | Nombre de la instrucción de procesamiento. |
| text | String | [Text](../../../system.text/) para incluir en la instrucción de procesamiento. |
## Observaciones



Este método se utiliza para crear una declaración XML después de que se haya llamado a [XmlTextWriter::WriteStartDocument](../writestartdocument/).
## Ver también
