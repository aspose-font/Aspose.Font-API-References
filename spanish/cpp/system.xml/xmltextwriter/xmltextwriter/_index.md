...
description: "System::Xml::XmlTextWriter::XmlTextWriter constructor. Crea una instancia de la clase XmlTextWriter usando el flujo y la codificación especificados en C++."
type: docs
weight: 100
...
| --- | --- | --- |
| w | const SharedPtr\<IO::Stream\>\& | El flujo al que deseas escribir. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| filename | const String\& | El nombre de archivo al que escribir. Si el archivo existe, lo trunca y sobrescribe con el nuevo contenido. |
