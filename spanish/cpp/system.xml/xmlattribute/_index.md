...
| [PrependChild](./prependchild/)(SharedPtr\<XmlNode\>) override | Añade el nodo especificado al principio de la lista de nodos hijos de este nodo. |
...
| [set_Prefix](./set_prefix/)(String) override | Establece el prefijo del espacio de nombres de este nodo. |
