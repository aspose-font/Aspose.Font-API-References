...
| [get_Schemas](./get_schemas/)() | Devuelve el XmlSchemaSet que se usará al realizar la validación de esquemas. |
...
| [set_MaxCharactersFromEntities](./set_maxcharactersfromentities/)(int64_t) | Establece un valor que indica el número máximo permitido de caracteres en un documento que resultan de expandir entidades. |
...
| [set_Schemas](./set_schemas/)(const SharedPtr\<Schema::XmlSchemaSet\>\&) | Establece el XmlSchemaSet que se usará al realizar la validación de esquemas. |
