...
| Método | Descripción |
| --- | --- |
| virtual [AddNamespace](./addnamespace/)(String, String) | Agrega el espacio de nombres dado a la colección. |
...
| virtual [PopScope](./popscope/)() | Elimina un alcance de espacio de nombres de la pila. |
| virtual [PushScope](./pushscope/)() | Agrega un alcance de espacio de nombres a la pila. |
| virtual [RemoveNamespace](./removenamespace/)(String, String) | Elimina el espacio de nombres dado para el prefijo dado. |
