...
description: "System::Array::LastIndexOf method. Determina l'indice dell'ultima occorrenza dell'elemento specificato in un intervallo di elementi dell'array specificato dall'indice di partenza e dal numero di elementi nell'intervallo in C++."
type: docs
weight: 5500
url: /it/cpp/system/array/lastindexof/
---
...
Indice dell'ultima occorrenza dell'elemento specificato se trovato, altrimenti -1
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| items | const ArrayPtr\<ArrayType\>\& | [Array](../) in cui cercare l'elemento specificato |
| valore | const ValueType\& | Indice dell'elemento di cui determinare |
