---
title: "System::TimeZoneInfo::ConvertTime metodo"
linktitle: "ConvertTime"
second_title: "Aspose.Font per C++"
description: "System::TimeZoneInfo::ConvertTime metodo. Converte l'ora nell'ora di un fuso orario specificato in C++."
type: docs
weight: 200
url: /it/cpp/system/timezoneinfo/converttime/
---
...
| destination_time_zone | const TimeZoneInfoPtr\& | Fuso orario di destinazione. |
...
| --- | --- | --- |
| date_time | DateTime | Data e ora da convertire. |
| source_time_zone | const TimeZoneInfoPtr\& | Fuso orario di origine. |
| destination_time_zone | const TimeZoneInfoPtr\& | Fuso orario di destinazione. |
