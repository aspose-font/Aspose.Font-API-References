...
description: "System::MulticastDelegate< ReturnType(ArgumentTypes...)>::MulticastDelegate method. Costruisce una collezione vuota in C++."
type: docs
weight: 100
url: /it/cpp/system/multicastdelegate_returntype(argumenttypes...)_/multicastdelegate/
---
...
Crea un'istanza e inserisce il delegato specificato nella collezione dei delegati.
...
| --- | --- | --- |
| iniziale | Callback\&& | Un delegato da inserire nella collezione di delegati |
...
Esegue una copia superficiale della collezione di delegati.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| o | const MulticastDelegate\& | Un'istanza della classe MulticastDelegate da cui copiare la collezione di delegati. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| o | MulticastDelegate\&& | Un'istanza della classe MulticastDelegate da cui spostare la collezione di delegati. |
...
Crea un'istanza e inserisce il valore specificato nella collezione dei delegati.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| arg | std::function\<ReturnType(ArgumentTypes...)> | Un valore da inserire nella collezione di delegati |
...
| --- | --- |
| T | Tipo del valore da inserire nella collezione di delegati della nuova istanza costruita; il tipo deve essere convertibile al tipo [Callback](../callback/). |

| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| arg | T | Un valore da inserire nella collezione di delegati |
