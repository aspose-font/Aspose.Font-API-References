---
title: "Costruttore System::DateTimeOffset::DateTimeOffset"
linktitle: "DateTimeOffset"
second_title: "Aspose.Font per C++"
description: "Costruttore System::DateTimeOffset::DateTimeOffset. Costruttore predefinito in C++."
type: docs
weight: 100
url: /it/cpp/system/datetimeoffset/datetimeoffset/
---
...
| --- | --- | --- |
| date_time | DateTime | Data e ora. |
| offset | TimeSpan | Scostamento temporale da UTC. |
...
| --- | --- | --- |
| anno | int | Anno. |
| mese | int | Mese (da 1 a 12). |
| giorno | int | Giorno (da 1 al numero di giorni del mese). |
| ora | int | Ora (da 0 a 23). |
| minuto | int | Minuto (da 0 a 59). |
| secondo | int | Secondo (da 0 a 59). |
| millisecondo | int | Millisecondo (da 0 a 999). |
| calendario | const SharedPtr\<Globalization::Calendar\>\& | Calendario usato per interpretare anno, mese e giorno. |
| offset | TimeSpan | Scostamento temporale da UTC. |
