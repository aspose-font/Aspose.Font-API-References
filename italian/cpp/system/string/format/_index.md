---
title: "Metodo System::String::Format"
linktitle: "Formato"
second_title: "Aspose.Font per C++"
description: "Metodo System::String::Format. Formatta la stringa in stile C# in C++."
type: docs
weight: 6600
url: /it/cpp/system/string/format/
---
...
| --- | --- |
| Argomenti | Argomenti per la stringa di formato. |

| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| fp | const SharedPtr\<IFormatProvider\>\& | Provider di formato da utilizzare per convertire gli argomenti in stringhe. |
| formato | const String\& | Stringa di formato. |
| argomenti | const Args\&... | Argomenti per la stringa di formato. |
...
| Parametro | Descrizione |
| --- | --- |
| T | Argomenti per la stringa di formato. |

| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| formato | const String\& | Stringa di formato. |
| argomenti | const System::ArrayPtr\<T\>\& | Argomenti per la stringa di formato. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| formato | std::nullptr_t | Stringa di formato. |
| argomenti | const char16_t(&) | Argomenti per la stringa di formato. |
...
| --- | --- | --- |
| formato | std::nullptr_t | Stringa di formato. |
| argomenti | const String\& | Argomenti per la stringa di formato. |
