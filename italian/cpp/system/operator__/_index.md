...
description: "System::operator<< metodo. Scrive una stringa sullo stream di output usando la codifica UTF-8 in C++."
type: docs
weight: 29200
url: /it/cpp/system/operator__/
---
...
| decimal | const Decimal\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| exception | const Exception\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| guid | const Guid\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| value | const Nullable\<T\>\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| os | const OperatingSystem\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| object_ptr | const SharedPtr\<T\>\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| object | const System::Object\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| type_info | const TypeInfo\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| version | const Version\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| object_ptr | const WeakPtr\<T\>\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| date_time | DateTime | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| value | DateTimeOffset | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| time_span | TimeSpan | [Data](../../system.data/) da inserire. |
...
description: 'System::operator>> metodo. Ottiene una stringa dallo stream di input usando la codifica UTF-8 in C++.'
type: docs
peso: 35200
