---
title: "System::Int32::Parse metodo"
linktitle: "Analizza"
second_title: "Aspose.Font per C++"
description: "Come utilizzare il metodo Parse della classe System::Int32 in C++."
type: docs
weight: 100
url: /it/cpp/system/int32/parse/
---
...
Converte la stringa specificata contenente la rappresentazione testuale di un numero nell'intero con segno a 32 bit equivalente utilizzando le informazioni di formattazione fornite.
...
| --- | --- | --- |
| valore | const String\& | La stringa da convertire. |
| provider | const SharedPtr\<IFormatProvider\>\& | Un puntatore a un oggetto che contiene le informazioni sul formato della stringa. |
