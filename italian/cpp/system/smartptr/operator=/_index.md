---
title: "System::SmartPtr::operator= metodo"
linktitle: "operator="
second_title: "Aspose.Font per C++"
description: "System::SmartPtr::operator= metodo. Assegna per copia l'oggetto SmartPtr. Esegue le conversioni di tipo necessarie in C++."
type: docs
weight: 2800
...
Assegna per copia l'oggetto [SmartPtr](../). Esegue le conversioni di tipo necessarie.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| x | const SmartPtr_\\& | Puntatore da assegnare per copia. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| p | Pointee_ * | Valore del puntatore da assegnare. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| x | SmartPtr_\&& | Puntatore da assegnare per spostamento. |
