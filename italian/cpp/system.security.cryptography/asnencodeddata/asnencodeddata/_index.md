---
title: "System::Security::Cryptography::AsnEncodedData::AsnEncodedData costruttore"
linktitle: "AsnEncodedData"
second_title: "Aspose.Font per C++"
description: "System::Security::Cryptography::AsnEncodedData::AsnEncodedData costruttore. Costruttore in C++."
type: docs
weight: 100
url: /it/cpp/system.security.cryptography/asnencodeddata/asnencodeddata/
---
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Dati codificati in formato byte grezzo. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| asn_encoded_data | const SharedPtr\<AsnEncodedData\>\& | [Object](../../../system/object/) da cui copiare i dati. |
## Osservazioni
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| oid | const SharedPtr\<Oid\>\& | [Object](../../../system/object/) identificatore dei dati codificati. |
| raw_data | const ByteArrayPtr\& | Dati codificati in formato byte grezzo. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| oid | const String\& | [Object](../../../system/object/) identificatore dei dati codificati. |
| raw_data | const ByteArrayPtr\& | Dati codificati in formato byte grezzo. |
