---
title: "Costruttore System::Security::Cryptography::CspParameters::CspParameters"
linktitle: "CspParameters"
second_title: "Aspose.Font per C++"
description: "Costruttore System::Security::Cryptography::CspParameters::CspParameters. Costruttore in C++."
type: docs
weight: 100
url: /it/cpp/system.security.cryptography/cspparameters/cspparameters/
---
...
| --- | --- | --- |
| dwTypeIn | int | Codice del tipo di provider; ignorato. |
...
| --- | --- | --- |
| dwTypeIn | int | Codice del tipo di provider; ignorato. |
| strProviderNameIn | const System::String\& | Nome del provider; ignorato. |
...
| dwTypeIn | int | Codice del tipo di provider; ignorato. |
| strProviderNameIn | const System::String\& | Nome del provider; ignorato. |
| strContainerNameIn | const System::String\& | Nome del contenitore; ignorato. |
