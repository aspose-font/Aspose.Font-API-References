---
title: "System::Security::Cryptography::CryptoStream::Write metodo"
linktitle: "Write"
second_title: "Aspose.Font per C++"
description: "System::Security::Cryptography::CryptoStream::Write metodo. Scrive i dati nel flusso in C++."
type: docs
weight: 1400
url: /it/cpp/system.security.cryptography/cryptostream/write/
---
...
| --- | --- | --- |
| buffer | const ArrayPtr\<uint8_t\>\& | Buffer dei dati di origine. |
| offset | int32_t | Offset nel buffer di origine. |
| count | int32_t | Numero di byte da scrivere. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| buffer | const System::Details::ArrayView\<uint8_t\>\& | Buffer dei dati di origine. |
| offset | int32_t | Offset nel buffer di origine. |
| count | int32_t | Numero di byte da scrivere. |
