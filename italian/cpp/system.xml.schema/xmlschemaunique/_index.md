...
description: "System::Xml::Schema::XmlSchemaUnique class. Rappresenta l'elemento unique dallo XML Schema come specificato dal World Wide Web Consortium (W3C). Questa classe può essere utilizzata per identificare un vincolo unico tra un insieme di elementi in C++."
type: docs
weight: 6900
...
Rappresenta l'elemento **unique** dallo XML [Schema](../) come specificato dal World Wide [Web](../../system.web/) Consortium (W3C). Questa classe può essere utilizzata per identificare un vincolo unico tra un insieme di elementi.
