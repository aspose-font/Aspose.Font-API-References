...
description: "System::Xml::Schema::XmlSchemaWhiteSpaceFacet class. Rappresenta il facet whiteSpace del World Wide Web Consortium (W3C) in C++."
type: docs
weight: 7100
url: /it/cpp/system.xml.schema/xmlschemawhitespacefacet/
---
## XmlSchemaWhiteSpaceFacet class


Rappresenta il facet **whiteSpace** del World Wide [Web](../../system.web/) Consortium (W3C).
