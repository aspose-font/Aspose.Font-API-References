---
title: "Costruttore System::Collections::Generic::DictionaryIterator::DictionaryIterator"
linktitle: "DictionaryIterator"
second_title: "Aspose.Font per C++"
description: "Costruttore System::Collections::Generic::DictionaryIterator::DictionaryIterator. Costruttore in C++."
type: docs
weight: 100
url: /it/cpp/system.collections.generic/dictionaryiterator/dictionaryiterator/
---
...
| --- | --- | --- |
| iteratore | const typename Dict::map_t::const_iterator\\& | Iteratore da tenere. |
| end | const typename Dict::map_t::const_iterator\\& | Iteratore alla fine del contenitore. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| altro | DictionaryIterator\&& | Iteratore da cui spostare i dati. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| iteratore | typename Dict::map_t::const_iterator\\&& | Iteratore da tenere. |
| end | typename Dict::map_t::const_iterator\\&& | Iteratore alla fine del contenitore. |
