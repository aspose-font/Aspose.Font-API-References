---
title: "System::Collections::Generic::BaseDictionary::end metodo"
linktitle: "end"
second_title: "Aspose.Font per C++"
description: "System::Collections::Generic::BaseDictionary::end metodo. Restituisce un iteratore al wrapper KVPair per l'elemento chiave-valore che segue l'ultimo elemento del contenitore. Implementato in stile C# - l'iteratore dovrebbe restituire l'oggetto KVPair con l'interfaccia get_Key() e get_Value(). Questo elemento funge da segnaposto; tentare di accedervi provoca un comportamento indefinito in C++."
type: docs
weight: 1100
url: /it/cpp/system.collections.generic/basedictionary/end/
---
