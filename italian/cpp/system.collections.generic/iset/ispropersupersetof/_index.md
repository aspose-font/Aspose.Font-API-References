...
description: "System::Collections::Generic::ISet::IsProperSupersetOf method. Verifica se il set corrente è un superset rigoroso di un altro contenitore in C++."
type: docs
weight: 500
url: /it/cpp/system.collections.generic/iset/ispropersupersetof/
---
...
| --- | --- | --- |
| altro | IEnumerablePtr | Sottoinsieme da verificare. |
