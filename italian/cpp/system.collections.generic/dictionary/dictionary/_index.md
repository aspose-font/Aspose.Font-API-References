---
title: "System::Collections::Generic::Dictionary::Dictionary costruttore"
linktitle: "Dictionary"
second_title: "Aspose.Font per C++"
description: "System::Collections::Generic::Dictionary::Dictionary costruttore. Crea un dizionario vuoto in C++."
type: docs
weight: 100
url: /it/cpp/system.collections.generic/dictionary/dictionary/
---
...
| --- | --- | --- |
| mappa | const map_t\& | Mappa da cui copiare i dati. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| src | const SharedPtr\<IDictionary\<TKey, TValue\>\>\& | Dizionario sorgente. |
| comparer | const SharedPtr\<IEqualityComparer\<TKey\>\>\& | [Comparer](../../comparer/) oggetto da utilizzare. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| comparer | const SharedPtr\<IEqualityComparer\<TKey\>\>\& | [Comparer](../../comparer/) da usare. |
...
Sovraccarico che corrisponde alla creazione di un dizionario pre-allocato; in realtà non effettua alcuna allocazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| capacità | int | Capacità da allocare; ignorata. |
