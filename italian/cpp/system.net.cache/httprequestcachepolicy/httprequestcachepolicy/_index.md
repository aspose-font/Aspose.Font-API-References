---
title: "System::Net::Cache::HttpRequestCachePolicy::HttpRequestCachePolicy costruttore"
linktitle: "HttpRequestCachePolicy"
second_title: "Aspose.Font per C++"
description: "System::Net::Cache::HttpRequestCachePolicy::HttpRequestCachePolicy costruttore. Crea una nuova istanza in C++."
type: docs
weight: 100
url: /it/cpp/system.net.cache/httprequestcachepolicy/httprequestcachepolicy/
---
...
| --- | --- | --- |
| cacheSyncDate | DateTime | Il tempo in cui le risorse memorizzate nella cache devono essere rivalutate. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| cacheAgeControl | HttpCacheAgeControl | Controlla il comportamento di caching per le risorse. |
| ageOrFreshOrStale | TimeSpan | Una quantità di tempo. |
...
| --- | --- | --- |
| cacheAgeControl | HttpCacheAgeControl | Controlla il comportamento di caching per le risorse. |
| maxAge | TimeSpan | L'età massima consentita per le risorse. |
| freshOrStale | TimeSpan | Una quantità di tempo. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| livello | HttpRequestCacheLevel | Il comportamento di caching per le risorse. |
