---
title: "System::Drawing::Font::Font costruttore"
linktitle: "Font"
second_title: "Aspose.Font per C++"
description: "System::Drawing::Font::Font costruttore. Crea una nuova istanza della classe Font che rappresenta il font esistente specificato con lo stile di font specificato in C++."
type: docs
weight: 100
url: /it/cpp/system.drawing/font/font/
---
## Font::Font(const SharedPtr\<Font\>\&, FontStyle) constructor


Crea una nuova istanza della classe [Font](../) che rappresenta il font esistente specificato con lo stile di font specificato.
...
| --- | --- | --- |
| prototipo | const SharedPtr\<Font\>\& | Il font esistente da cui creare il nuovo |
| new_style | FontStyle | Uno stile di font da applicare al nuovo font |
...
Crea una nuova istanza della classe [Font](../).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| famiglia | const SharedPtr\<FontFamily\>\& | La famiglia di caratteri del nuovo font |
| em_size | float | La dimensione em del nuovo font nelle unità specificate dal parametro **unit** |
| stile | FontStyle | Lo stile del nuovo font |
| unit | GraphicsUnit | Le unità di misura del nuovo font |
| gdi_charset | uint8_t | Un set di caratteri GDI da utilizzare per il nuovo font |
| gdi_vertical_font | bool | Vero se il nuovo font è derivato da un font verticale GDI |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| family_name | const String\& | Il nome della famiglia di caratteri del nuovo font |
| em_size | float | La dimensione em del nuovo font nelle unità specificate dal parametro **unit** |
| stile | FontStyle | Lo stile del nuovo font |
| unit | GraphicsUnit | Le unità di misura del nuovo font |
| gdi_charset | uint8_t | Un set di caratteri GDI da utilizzare per il nuovo font |
