...
| [ToSize](./tosize/)() const | Crea un oggetto [Size](../size/) dall'oggetto [SizeF](./) corrente troncando i valori di larghezza e altezza dell'oggetto [SizeF](./) al più vicino intero inferiore. |
