---
title: "System::Drawing::TextureBrush::TextureBrush costruttore"
linktitle: "TextureBrush"
second_title: "Aspose.Font per C++"
description: "System::Drawing::TextureBrush::TextureBrush costruttore. Crea una nuova istanza della classe TextureBrush che utilizza l'immagine specificata in C++."
type: docs
weight: 100
url: /it/cpp/system.drawing/texturebrush/texturebrush/
---
...
| --- | --- | --- |
| immagine | const SharedPtr\<Image\>\& | Un'immagine usata dal pennello per riempire l'interno di una forma |
| wrap_mode | Drawing2D::WrapMode | Specifica come l'oggetto pennello è ripetuto |
| dst_rect | Rectangle | Specifica il rettangolo di delimitazione per il pennello |
...
| immagine | const SharedPtr\<Image\>\& | Un'immagine usata dal pennello per riempire l'interno di una forma |
| wrap_mode | Drawing2D::WrapMode | Specifica come l'oggetto pennello è ripetuto |
| dst_rect | RectangleF | Specifica il rettangolo di delimitazione per il pennello |
...
| immagine | const SharedPtr\<Image\>\& | Un'immagine usata dal pennello per riempire l'interno di una forma |
| dst_rect | Rectangle | Specifica il rettangolo di delimitazione per il pennello |
| image_attrs | const SharedPtr\<Imaging::ImageAttributes\>\& | Gli attributi dell'immagine |
