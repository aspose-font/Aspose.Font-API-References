...
Vero se l'interno della regione specificata è identico all'interno della regione rappresentata dall'oggetto corrente quando viene applicata la trasformazione associata al parametro **g**; altrimenti - falso
