...
description: "classe System::Drawing::Color. Rappresenta un colore. Questo tipo dovrebbe essere allocato sullo stack e passato alle funzioni per valore o per riferimento. Non utilizzare mai la classe System::SmartPtr per gestire oggetti di questo tipo in C++."
type: docs
weight: 500
...
| Metodo | Descrizione |
| --- | --- |
| [Color](./color/)() | Costruisce un'istanza "vuota" della classe [Color](./) che non rappresenta alcun colore. |
...
| static [FromArgb](./fromargb/)(int) | Costruisce un'istanza della classe [Color](./) che rappresenta il colore specificato. |
| static [FromArgb](./fromargb/)(int, int, int, int) | Costruisce un'istanza della classe [Color](./) che rappresenta il colore specificato. |
| static [FromArgb](./fromargb/)(int, int, int) | Costruisce un'istanza della classe [Color](./) che rappresenta il colore specificato con il componente alfa impostato a 0xFF. |
| static [FromArgb](./fromargb/)(int, Color) | Costruisce un'istanza della classe [Color](./) che rappresenta il colore specificato. |
| static [FromKnownColor](./fromknowncolor/)(KnownColor) | Costruisce un'istanza della classe [Color](./) che rappresenta il colore noto specificato. |
| static [FromName](./fromname/)(const String\&) | Costruisce un'istanza della classe [Color](./) che rappresenta un colore con il nome specificato. |
...
| [get_IsEmpty](./get_isempty/)() const | Restituisce un valore che indica se l'oggetto corrente è "vuoto" cioè non rappresenta alcun colore. |
...
| [GetBrightness](./getbrightness/)() | Restituisce la componente di luminosità del colore rappresentato dall'oggetto corrente. |
...
| [operator!=](./operator!=/)(const Color\&) const | Determina se l'oggetto corrente e quello specificato [Color](./) rappresentano colori distinti. |
...
| Campo | Descrizione |
| --- | --- |
| static [Empty](./empty/) | Una istanza "vuota" della classe [Color](./), cioè un'istanza che non rappresenta alcun colore. |
## Vedi anche
