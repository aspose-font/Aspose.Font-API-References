---
title: "Metodo System::Drawing::operator<<"
linktitle: "operator<<"
second_title: "Aspose.Font per C++"
description: "Metodo System::Drawing::operator<<. Inserisci dati nello stream usando la codifica UTF-8 in C++."
type: docs
weight: 3900
url: /it/cpp/system.drawing/operator__/
---
...
| color | Color | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| point | const Point\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| point | const PointF\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| rectangle | const Rectangle\& | [Data](../../system.data/) da inserire. |
...
| --- | --- | --- |
| stream | std::ostream\& | Stream di output in cui inserire i dati. |
| rectangle | const RectangleF\& | [Data](../../system.data/) da inserire. |
