...
| [Flush](./flush/)() override | Cancella i buffer di questo stream e scrive tutti i dati bufferizzati nello storage sottostante. Non supportato! |
...
| [WriteByte](./writebyte/)(uint8_t) override | Se la modalità di wrapping è binaria, scrive sullo stream il valore intero senza segno a 8 bit specificato, altrimenti lo converte al tipo [char_type](./char_type/) e poi scrive il risultato sullo stream. Non supportato! |
## Campi
