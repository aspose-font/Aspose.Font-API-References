---
title: "System::IO::TextWriter::Write metodo"
linktitle: "Write"
second_title: "Aspose.Font per C++"
description: "System::IO::TextWriter::Write metodo. Scrive la rappresentazione stringa del valore booleano specificato sullo stream in C++."
type: docs
weight: 900
url: /it/cpp/system.io/textwriter/write/
---
## TextWriter::Write(bool) method


Scrive la rappresentazione stringa del valore booleano specificato nello stream.
...
Scrive tutti i caratteri dell'array specificato nel flusso.
...
Scrive l'intervallo specificato di caratteri UTF-16 dall'array di caratteri specificato nel flusso.
...
Scrive la c-string specificata nel flusso.
...
Scrive la rappresentazione stringa dell'oggetto specificato nello stream.
...
Scrive i valori specificati formattati secondo il formato specificato nel flusso.
...
Scrive la stringa specificata nel flusso.
...
Scrive la rappresentazione stringa del valore a virgola mobile a doppia precisione specificato nel flusso.
...
Scrive la rappresentazione stringa del valore a virgola mobile a precisione singola specificato nel flusso.
...
Scrive la rappresentazione stringa del valore intero a 32 bit specificato nel flusso.
...
Scrive la rappresentazione stringa del valore intero a 64 bit specificato nel flusso.
...
Scrive la rappresentazione stringa del valore intero senza segno a 32 bit specificato nel flusso.
...
Scrive la rappresentazione stringa del valore intero senza segno a 64 bit specificato nel flusso.
