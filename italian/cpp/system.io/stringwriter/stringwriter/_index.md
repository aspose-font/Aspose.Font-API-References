---
title: "System::IO::StringWriter::StringWriter costruttore"
linktitle: "StringWriter"
second_title: "Aspose.Font per C++"
description: "System::IO::StringWriter::StringWriter costruttore. Crea una nuova istanza di StringWriter utilizzando IFormatProvider dalla cultura corrente in C++."
type: docs
weight: 100
url: /it/cpp/system.io/stringwriter/stringwriter/
---
...
| --- | --- | --- |
| formatProvider | const IFormatProviderPtr\& | Un oggetto [IFormatProvider](../../../system/iformatprovider/) da utilizzare dall'oggetto in fase di costruzione |
...
Crea una nuova istanza di [StringWriter](../) utilizzando il StringBuilder specificato e [IFormatProvider](../../../system/iformatprovider/) dalla cultura corrente.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| sb | const System::SharedPtr\<Text::StringBuilder\>\& | L'oggetto StringBuilder da utilizzare dal [StringWriter](../) in fase di costruzione. |
...
Crea una nuova istanza di [StringWriter](../) utilizzando il StringBuilder specificato e [IFormatProvider](../../../system/iformatprovider/).
