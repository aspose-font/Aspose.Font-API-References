---
title: "Costruttore System::IO::BasicSTDIOStreamWrapper::BasicSTDIOStreamWrapper"
linktitle: "BasicSTDIOStreamWrapper"
second_title: "Aspose.Font per C++"
description: "Costruttore System::IO::BasicSTDIOStreamWrapper::BasicSTDIOStreamWrapper. Costruttore di copia. Eliminato in C++."
type: docs
weight: 100
url: /it/cpp/system.io/basicstdiostreamwrapper/basicstdiostreamwrapper/
---
...
Crea una nuova istanza di [BasicSTDIOStreamWrapper](../).
...
| --- | --- | --- |
| str | std::basic_iostream\<char_type, traits_type\>\& | Il riferimento al flusso |
