...
description: "System::IO::TextReader::ReadBlock metodo. Legge il numero massimo specificato di caratteri dal lettore di testo corrente e scrive i dati in un buffer, a partire dall'indice specificato in C++."
type: docs
weight: 500
...
| indice | int | Un indice a base zero in **buffer** da cui iniziare a scrivere |
