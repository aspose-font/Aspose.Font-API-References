...
description: "System::Collections::Specialized::NameValueCollection::NameValueCollection constructor. Inizializza una nuova istanza della classe NameValueCollection che è vuota in C++."
type: docs
weight: 100
url: /it/cpp/system.collections.specialized/namevaluecollection/namevaluecollection/
---
## NameValueCollection::NameValueCollection() constructor


Inizializza una nuova istanza della classe [NameValueCollection](../) che è vuota.
...
Copia le voci dal [NameValueCollection](../) specificato a un nuovo [NameValueCollection](../).
