...
description: "System::Globalization::CompareInfo::GetCompareInfo method. Ottiene il CompareInfo associato alla cultura specificata in C++."
type: docs
weight: 1500
url: /it/cpp/system.globalization/compareinfo/getcompareinfo/
---
...
| --- | --- | --- |
| nome | const String\& | Nome della cultura. |
| assembly | const SharedPtr\<Reflection::Assembly\>\& | Assembly che contiene i metodi di confronto delle stringhe. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| cultura | int | Identificatore di cultura (LCID). |
