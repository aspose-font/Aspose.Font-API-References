...
description: "classe System::Collections::IList. IList rappresenta una collezione non generica di oggetti che possono essere acceduti individualmente per indice in C++."
type: docs
weight: 1000
...
| Metodo | Descrizione |
| --- | --- |
| virtual [Add](./add/)(SharedPtr\<System::Object\>) | Aggiunge un elemento alla fine della lista. |
...
| virtual [Remove](./remove/)(SharedPtr\<System::Object\>) | Rimuove la prima occorrenza dell'elemento specificato dalla lista. |
