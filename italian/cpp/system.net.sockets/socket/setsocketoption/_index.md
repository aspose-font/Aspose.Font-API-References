...
description: "System::Net::Sockets::Socket::SetSocketOption method. Imposta l'opzione del socket specificata al valore specificato in C++."
type: docs
weight: 6200
url: /it/cpp/system.net.sockets/socket/setsocketoption/
---
## Socket::SetSocketOption(SocketOptionLevel, SocketOptionName, bool) method


Imposta l'opzione socket specificata al valore specificato.
...
| optionName | SocketOptionName | Il nome dell'opzione che deve essere aggiornato. |
| optionValue | bool | Il valore che deve essere impostato sull'opzione specificata. |
...
| optionLevel | SocketOptionLevel | Il livello dell'opzione del socket. |
| optionName | SocketOptionName | Il nome dell'opzione che deve essere aggiornato. |
| optionValue | int32_t | Il valore che deve essere impostato sull'opzione specificata. |
...
| optionLevel | SocketOptionLevel | Il livello dell'opzione del socket. |
| optionName | SocketOptionName | Il nome dell'opzione che deve essere aggiornato. |
| optionValue | System::ArrayPtr\<uint8_t\> | Il valore che deve essere impostato sull'opzione specificata. |
...
| optionLevel | SocketOptionLevel | Il livello dell'opzione del socket. |
| optionName | SocketOptionName | Il nome dell'opzione che deve essere aggiornato. |
| optionValue | System::SharedPtr\<Object\> | Il valore che deve essere impostato sull'opzione specificata. |
