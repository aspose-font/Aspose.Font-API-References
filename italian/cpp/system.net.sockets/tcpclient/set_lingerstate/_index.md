...
description: "System::Net::Sockets::TcpClient::set_LingerState method. Imposta un valore che indica se il socket ritarderà la chiusura nel tentativo di inviare tutti i dati in sospeso in C++."
type: docs
weight: 2000
url: /it/cpp/system.net.sockets/tcpclient/set_lingerstate/
---
...
| --- | --- | --- |
| valore | System::SharedPtr\<LingerOption\> | Il valore che deve essere impostato. |
