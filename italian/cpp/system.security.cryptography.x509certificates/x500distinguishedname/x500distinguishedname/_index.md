---
title: "System::Security::Cryptography::X509Certificates::X500DistinguishedName::X500DistinguishedName costruttore"
linktitle: "X500DistinguishedName"
second_title: "Aspose.Font per C++"
description: "System::Security::Cryptography::X509Certificates::X500DistinguishedName::X500DistinguishedName costruttore. Costruttore in C++."
type: docs
weight: 100
url: /it/cpp/system.security.cryptography.x509certificates/x500distinguishedname/x500distinguishedname/
---
...
| --- | --- | --- |
| encoded_distinguished_name | const ByteArrayPtr\& | Nome distinto codificato. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| encoded_distinguished_name | const SharedPtr\<AsnEncodedData\>\& | [Object](../../../system/object/) che rappresenta il nome distinto. |
## Osservazioni
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| distinguishedName | const SharedPtr\<X500DistinguishedName\>\& | Nome distinto da cui copiare i dati. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| distinguished_name | const String\& | Nome distinto. |
...
| --- | --- | --- |
| distinguished_name | const String\& | Nome distinto. |
| flag | X500DistinguishedNameFlags | Flag combinati bitwise che specificano le proprietà di costruzione del nome. |
