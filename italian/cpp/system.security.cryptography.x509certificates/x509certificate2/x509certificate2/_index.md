...
description: "System::Security::Cryptography::X509Certificates::X509Certificate2::X509Certificate2 constructor. Crea un X509Certificate2 vuoto in C++."
type: docs
weight: 100
url: /it/cpp/system.security.cryptography.x509certificates/x509certificate2/x509certificate2/
---
## X509Certificate2::X509Certificate2() constructor


Crea un [X509Certificate2](../) vuoto.
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Sequenza di byte che rappresenta il certificato codificato. |
| password | const SecureStringPtr\& | Password del certificato. |
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Sequenza di byte che rappresenta il certificato codificato. |
| password | const String\& | Password del certificato. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| cert | const SharedPtr\<X509Certificate\>\& | Un oggetto [X509Certificate](../../x509certificate/). |
