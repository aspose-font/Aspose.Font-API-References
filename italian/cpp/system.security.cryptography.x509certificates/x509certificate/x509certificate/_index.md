---
title: "Costruttore System::Security::Cryptography::X509Certificates::X509Certificate::X509Certificate"
linktitle: "X509Certificate"
second_title: "Aspose.Font per C++"
description: "Costruttore System::Security::Cryptography::X509Certificates::X509Certificate::X509Certificate. Costruttore in C++."
type: docs
weight: 100
url: /it/cpp/system.security.cryptography.x509certificates/x509certificate/x509certificate/
---
...
| --- | --- | --- |
| dati | const ByteArrayPtr\& | Sequenza di byte che rappresenta il certificato codificato. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Sequenza di byte che rappresenta il certificato codificato (parte pubblica). |
| private_key | const ByteArrayPtr\& | Sequenza di byte che rappresenta la chiave privata. |
| key_storage_flags | X509KeyStorageFlags | Flag che indicano come memorizzare la chiave. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Sequenza di byte che rappresenta il certificato codificato. |
| password | const SecureStringPtr\& | Password utilizzata per accedere ai dati del certificato. |
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Sequenza di byte che rappresenta il certificato codificato. |
| password | const String\& | Password utilizzata per accedere ai dati del certificato. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| cert | const SharedPtr\<X509Certificate\>\& | Un certificato usato per inizializzare questo oggetto. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| filename | const String\& | File da cui caricare il certificato. |
