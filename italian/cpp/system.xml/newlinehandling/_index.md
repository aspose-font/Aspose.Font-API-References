...
| Entitize | 1 | I caratteri di nuova riga vengono convertiti in entità. Questa impostazione preserva tutti i caratteri quando l'output viene letto da un [XmlReader](../xmlreader/) normalizzante. |
