---
title: "System::Drawing::Drawing2D::LinearGradientBrush::LinearGradientBrush costruttore"
linktitle: "LinearGradientBrush"
second_title: "Aspose.Font per C++"
description: "System::Drawing::Drawing2D::LinearGradientBrush::LinearGradientBrush costruttore. Costruisce una nuova istanza di LinearGradientBrush in C++."
type: docs
weight: 100
url: /it/cpp/system.drawing.drawing2d/lineargradientbrush/lineargradientbrush/
---
## LinearGradientBrush::LinearGradientBrush(const Point\&, const Point\&, const Color\&, const Color\&) constructor


Costruisce una nuova istanza di [LinearGradientBrush](../).
...
| --- | --- | --- |
| point1 | const Point\& | Il punto iniziale del gradiente |
| point2 | const Point\& | Il punto finale del gradiente |
| color1 | const Color\& | Il colore iniziale del gradiente |
| color2 | const Color\& | Il colore finale del gradiente |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| point1 | const PointF\& | Il punto iniziale del gradiente |
| point2 | const PointF\& | Il punto finale del gradiente |
| color1 | const Color\& | Il colore iniziale del gradiente |
| color2 | const Color\& | Il colore finale del gradiente |
## Osservazioni
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| rect | const Rectangle\& | Un rettangolo di delimitazione del gradiente |
| color1 | const Color\& | Il colore iniziale del gradiente |
| color2 | const Color\& | Il colore finale del gradiente |
| angolo | float | L'angolo della linea di orientamento del gradiente; misurato in gradi in senso orario dall'asse x |
| isAngleScaleable | bool | Specifica se l'angolo del gradiente è influenzato dalla trasformazione associata al pennello |
...
| color1 | const Color\& | Il colore iniziale del gradiente |
| color2 | const Color\& | Il colore finale del gradiente |
| linearGradientMode | LinearGradientMode | La direzione del gradiente |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| rect | const RectangleF\& | Un rettangolo di delimitazione del gradiente |
| color1 | const Color\& | Il colore iniziale del gradiente |
| color2 | const Color\& | Il colore finale del gradiente |
| angolo | float | L'angolo della linea di orientamento del gradiente; misurato in gradi in senso orario dall'asse x |
| isAngleScaleable | bool | Specifica se l'angolo del gradiente è influenzato dalla trasformazione associata al pennello |
