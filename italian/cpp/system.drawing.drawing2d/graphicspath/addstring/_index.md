---
title: "System::Drawing::Drawing2D::GraphicsPath::AddString metodo"
linktitle: "AddString"
second_title: "Aspose.Font per C++"
description: "System::Drawing::Drawing2D::GraphicsPath::AddString metodo. Aggiunge una stringa di testo al percorso rappresentato dall'oggetto corrente in C++."
type: docs
weight: 1600
url: /it/cpp/system.drawing.drawing2d/graphicspath/addstring/
---
## GraphicsPath::AddString(const String\&, const SharedPtr\<FontFamily\>\&, int, float, Point, const SharedPtr\<StringFormat\>\&) method


Aggiunge una stringa di testo al percorso rappresentato dall'oggetto corrente.
...
| --- | --- | --- |
| testo | const String\& | Il testo da aggiungere |
| famiglia | const SharedPtr\<FontFamily\>\& | La famiglia di caratteri utilizzata per disegnare il testo |
| style | int | Un valore di enumerazione [FontStyle](../../../system.drawing/fontstyle/) che specifica lo stile del carattere da utilizzare |
| emSize | float | L'altezza della casella quadrata em che delimita ogni carattere della stringa |
| origin | Punto | Specifica la posizione in cui inizia il testo |
| stringFormat | const SharedPtr\<StringFormat\>\& | Il formato della stringa |
...
| style | int | Un valore di enumerazione [FontStyle](../../../system.drawing/fontstyle/) che specifica lo stile del carattere da utilizzare |
| emSize | float | L'altezza della casella quadrata em che delimita ogni carattere della stringa |
| origin | PointF | Specifica la posizione in cui inizia il testo |
| stringFormat | const SharedPtr\<StringFormat\>\& | Il formato della stringa |
...
| style | int | Un valore di enumerazione [FontStyle](../../../system.drawing/fontstyle/) che specifica lo stile del carattere da utilizzare |
| emSize | float | L'altezza della casella quadrata em che delimita ogni carattere della stringa |
| layoutRect | Rectangle | Un rettangolo che delimita il testo |
| stringFormat | const SharedPtr\<StringFormat\>\& | Il formato della stringa |
...
| style | int | Un valore di enumerazione [FontStyle](../../../system.drawing/fontstyle/) che specifica lo stile del carattere da utilizzare |
| emSize | float | L'altezza della casella quadrata em che delimita ogni carattere della stringa |
| layoutRect | RectangleF | Un rettangolo che delimita il testo |
| stringFormat | const SharedPtr\<StringFormat\>\& | Il formato della stringa |
