...
description: "System::Net::Http::Headers::NameValueHeaderValue::ToString method. Analogo al metodo C# Object.ToString(). Consente di convertire oggetti personalizzati in stringa in C++."
type: docs
weight: 700
url: /it/cpp/system.net.http.headers/namevalueheadervalue/tostring/
---
...
Restituisce una rappresentazione stringa della raccolta delle istanze della classe NameValueHeaderValue.
...
| separatore | char16_t | Un separatore di stringa. |
...
| separatore | char16_t | Un separatore di stringa. |
| leadingSeparator | bool | Il valore che indica se il separatore di stringa deve essere aggiunto prima del primo elemento della collezione. |
| destination | System::SharedPtr\<Text::StringBuilder\> | Un'istanza a cui verrà assegnata una rappresentazione stringa. |
