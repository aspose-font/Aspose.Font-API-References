...
description: "Metodo System::Net::Http::Headers::StringWithQualityHeaderValue::GetStringWithQualityLength. Converte una stringa fornita dall'indice specificato in un'istanza della classe StringWithQualityHeaderValue in C++."
type: docs
weight: 700
url: /it/cpp/system.net.http.headers/stringwithqualityheadervalue/getstringwithqualitylength/
---
## StringWithQualityHeaderValue::GetStringWithQualityLength method


Converte una stringa fornita dall'indice specificato in un'istanza della classe [StringWithQualityHeaderValue](../).
