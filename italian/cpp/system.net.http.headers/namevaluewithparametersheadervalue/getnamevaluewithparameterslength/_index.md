...
description: "System::Net::Http::Headers::NameValueWithParametersHeaderValue::GetNameValueWithParametersLength method. Converte una stringa fornita dall'indice specificato in un'istanza della classe NameValueWithParametersHeaderValue in C++."
type: docs
weight: 600
url: /it/cpp/system.net.http.headers/namevaluewithparametersheadervalue/getnamevaluewithparameterslength/
---
## NameValueWithParametersHeaderValue::GetNameValueWithParametersLength method


Converte una stringa fornita dall'indice specificato in un'istanza della classe [NameValueWithParametersHeaderValue](../).
