...
description: "System::Net::Http::Headers::HttpRequestHeaders::get_UserAgent method. Restituisce un valore dell'intestazione ''User-Agent'' in C++."
type: docs
weight: 3100
url: /it/cpp/system.net.http.headers/httprequestheaders/get_useragent/
---
## HttpRequestHeaders::get_UserAgent method


Restituisce un valore dell'intestazione 'User-Agent'.
