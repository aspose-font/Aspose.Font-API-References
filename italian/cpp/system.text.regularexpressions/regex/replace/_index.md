...
description: "System::Text::RegularExpressions::Regex::Replace method. Sostituisce tutte le corrispondenze dell'espressione regolare nella stringa con la stringa di sostituzione in C++."
type: docs
weight: 800
url: /it/cpp/system.text.regularexpressions/regex/replace/
---
## Regex::Replace(const String\&, const char_t *) method


Sostituisce tutte le corrispondenze della regex nella stringa con la stringa di sostituzione.
...
| sostituzione | const char_t * | Stringa di sostituzione. |
...
| --- | --- | --- |
| input | const String\& | Stringa di input. |
| valutatore | const MatchEvaluator\& | Delegato per generare stringhe di sostituzione basate sulle corrispondenze. |
...
| input | const String\& | Stringa di input. |
| valutatore | const MatchEvaluator\& | Delegato per generare stringhe di sostituzione basate sulle corrispondenze. |
| count | int | Limite del numero di sostituzioni. |
...
| valutatore | const MatchEvaluator\& | Delegato per generare stringhe di sostituzione basate sulle corrispondenze. |
| count | int | Limite del numero di sostituzioni. |
| startat | int | Indice nella stringa di input da cui iniziare la sostituzione. |
...
| --- | --- | --- |
| input | const String\& | Stringa di input. |
| sostituzione | const String\& | Stringa di sostituzione. |
...
Sostituisce le sottostringhe nella stringa. Non implementato.
...
| --- | --- | --- |
| input | const String\& | Stringa di input. |
| pattern | const String\& | [Regex](../) modello. |
| sostituzione | const char_t * | Stringa di sostituzione. |
...
| valutatore | const MatchEvaluator\& | Delegato per generare la stringa di sostituzione per ogni corrispondenza. |
...
| pattern | const String\& | [Regex](../) modello. |
| valutatore | const MatchEvaluator\& | Delegato per generare stringhe di sostituzione basate sulle corrispondenze. |
| options | RegexOptions | [Regex](../) opzioni. |
