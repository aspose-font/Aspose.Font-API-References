---
title: "Metodo System::Net::WebHeaderCollection::Add"
linktitle: "Add"
second_title: "Aspose.Font per C++"
description: "Metodo System::Net::WebHeaderCollection::Add. Aggiunge la coppia specificata di intestazione e valore dell'intestazione alla collezione in C++."
type: docs
weight: 200
url: /it/cpp/system.net/webheadercollection/add/
---
## WebHeaderCollection::Add(HttpRequestHeader, String) method


Aggiunge la coppia specificata dell'intestazione e del valore dell'intestazione alla raccolta.
...
Aggiunge la coppia specificata del nome dell'intestazione e del valore dell'intestazione alla raccolta.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| intestazione | Stringa | Il nome dell'intestazione. |
| valore | Stringa | Il valore dell'intestazione. |
