...
description: "System::Xml::Schema::XmlSchemaSimpleContentExtension::set_AnyAttribute method. يضبط XmlSchemaAnyAttribute لاستخدامه في قيمة السمة في C++."
type: docs
weight: 500
url: /ar/cpp/system.xml.schema/xmlschemasimplecontentextension/set_anyattribute/
---
## XmlSchemaSimpleContentExtension::set_AnyAttribute method


يضبط [XmlSchemaAnyAttribute](../../xmlschemaanyattribute/) لاستخدامه في قيمة السمة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | const SharedPtr\<XmlSchemaAnyAttribute\>\& | القيمة التي سيتم تعيينها. |
