---
title: "System::Net::Sockets::Socket::SetSocketOption طريقة"
linktitle: "SetSocketOption"
second_title: "Aspose.Font لـ C++"
description: "System::Net::Sockets::Socket::SetSocketOption طريقة. يضبط خيار المقبس المحدد إلى القيمة المحددة في C++."
type: docs
weight: 6200
url: /ar/cpp/system.net.sockets/socket/setsocketoption/
---
## Socket::SetSocketOption(SocketOptionLevel, SocketOptionName, bool) method


يضبط خيار المقبس المحدد إلى القيمة المحددة.
...
| optionName | SocketOptionName | اسم الخيار الذي يجب تحديثه. |
| optionValue | bool | القيمة التي يجب تعيينها للخيار المحدد. |
...
| optionLevel | SocketOptionLevel | مستوى خيار المقبس. |
| optionName | SocketOptionName | اسم الخيار الذي يجب تحديثه. |
| optionValue | int32_t | القيمة التي يجب تعيينها للخيار المحدد. |
...
| optionLevel | SocketOptionLevel | مستوى خيار المقبس. |
| optionName | SocketOptionName | اسم الخيار الذي يجب تحديثه. |
| optionValue | System::ArrayPtr\<uint8_t\> | القيمة التي يجب تعيينها للخيار المحدد. |
...
| optionLevel | SocketOptionLevel | مستوى خيار المقبس. |
| optionName | SocketOptionName | اسم الخيار الذي يجب تحديثه. |
| optionValue | System::SharedPtr\<Object\> | القيمة التي يجب تعيينها للخيار المحدد. |
