---
title: "System::Security::Cryptography::X509Certificates::X509Certificate2::Import طريقة"
linktitle: "Import"
second_title: "Aspose.Font لـ C++"
description: "System::Security::Cryptography::X509Certificates::X509Certificate2::Import طريقة. يستورد المعلومات من بيانات الشهادة المحددة في C++."
type: docs
weight: 2400
url: /ar/cpp/system.security.cryptography.x509certificates/x509certificate2/import/
---
## X509Certificate2::Import(const ByteArrayPtr\&) method


يستورد المعلومات من بيانات الشهادة المحددة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| البيانات | const ByteArrayPtr\& | اسم ملف الشهادة. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| البيانات | const ByteArrayPtr\& | بيانات شهادة X.509. |
...
يستورد المعلومات من ملف الشهادة المحدد.
