...
خطأ إذا كان تمثيل الكائن كسلسلة يساوي السلسلة، صحيح خلاف ذلك.
...
يحدد ما إذا كانت عناوين URI الممثلة بواسطة الكائن الحالي والكائن المحدد غير متساوية.
...
مقارنة عدم المساواة بين مؤشرين ذكيين.
...
يحدد ما إذا كانت القيمة المحددة غير مساوية للقيمة الممثلة بواسطة الكائن [Nullable](../nullable/) المحدد عن طريق تطبيق [operator!=()](./) على هاتين القيمتين.
...
يتحقق مما إذا كان المؤشر الذكي غير null.
...
يحدد ما إذا كان كائن [Nullable](../nullable/) المحدد يمثل قيمة غير مساوية لـ null.
...
صحيح إذا كان الكائن المحدد يمثل قيمة غير null، خطأ خلاف ذلك
...
خطأ إذا كانت السلسلة null، صحيح خلاف ذلك.
