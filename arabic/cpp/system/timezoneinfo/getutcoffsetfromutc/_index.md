---
title: "System::TimeZoneInfo::GetUtcOffsetFromUtc طريقة"
linktitle: "GetUtcOffsetFromUtc"
second_title: "Aspose.Font لـ C++"
description: "طريقة System::TimeZoneInfo::GetUtcOffsetFromUtc. دالة مساعدة داخلية تُرجع إزاحة UTC لتاريخ‑وقت UTC في منطقة زمنية محددة. للاستخدام الداخلي في C++."
type: docs
weight: 1200
url: /ar/cpp/system/timezoneinfo/getutcoffsetfromutc/
---
## TimeZoneInfo::GetUtcOffsetFromUtc(DateTime, const TimeZoneInfoPtr\&) method


دالة مساعدة داخلية تُعيد إزاحة UTC لتاريخ‑وقت UTC في منطقة زمنية محددة. للاستخدام الداخلي فقط.
