...
description: "System::TimeZoneInfo::ConvertTimeToUtc method. يحول الوقت إلى توقيت UTC في C++."
type: docs
weight: 500
url: /ar/cpp/system/timezoneinfo/converttimetoutc/
---
## TimeZoneInfo::ConvertTimeToUtc(DateTime) method


يحوّل الوقت إلى توقيت UTC.
...
| --- | --- | --- |
| date_time | DateTime | التاريخ والوقت للتحويل. |
| source_time_zone | const TimeZoneInfoPtr\& | منطقة المصدر الزمنية. |
