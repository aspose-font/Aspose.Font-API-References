---
title: "فئة System::Int32"
linktitle: "Int32"
second_title: "Aspose.Font لـ C++"
description: "فئة System::Int32. تحتوي على طرق للعمل مع عدد صحيح 32‑بت في C++."
type: docs
weight: 4100
url: /ar/cpp/system/int32/
---
## Int32 class
...
| طريقة | الوصف |
| --- | --- |
| static [Parse](./parse/)(const String\&) | يحوّل السلسلة المحددة التي تحتوي على تمثيل عدد إلى عدد صحيح موقع 32‑بت مكافئ. |
| static [Parse](./parse/)(const String\&, const SharedPtr\<IFormatProvider\>\&) | يحوّل السلسلة المحددة التي تحتوي على تمثيل عدد إلى عدد صحيح موقع 32‑بت مكافئ باستخدام معلومات التنسيق المقدمة. |
...
| static [Parse](./parse/)(const String\&, Globalization::NumberStyles, const SharedPtr\<IFormatProvider\>\&) | يحوّل السلسلة المحددة التي تحتوي على تمثيل عدد إلى عدد صحيح موقع 32‑بت مكافئ باستخدام معلومات التنسيق المقدمة ونمط الرقم. |
...
| static [TryParse](./tryparse/)(const String\&, int32_t\&) | يحوّل السلسلة المحددة التي تحتوي على تمثيل عدد إلى عدد صحيح موقع 32‑بت مكافئ. |
| static [TryParse](./tryparse/)(const String\&, Globalization::NumberStyles, const SharedPtr\<IFormatProvider\>\&, int32_t\&) | يحوّل السلسلة المحددة التي تحتوي على تمثيل عدد إلى عدد صحيح موقع 32‑بت مكافئ باستخدام معلومات التنسيق المقدمة ونمط الرقم. |
