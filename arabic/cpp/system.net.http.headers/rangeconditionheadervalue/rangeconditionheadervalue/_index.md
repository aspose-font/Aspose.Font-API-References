---
title: "System::Net::Http::Headers::RangeConditionHeaderValue::RangeConditionHeaderValue منشئ"
linktitle: "RangeConditionHeaderValue"
second_title: "Aspose.Font لـ C++"
description: "System::Net::Http::Headers::RangeConditionHeaderValue::RangeConditionHeaderValue منشئ. ينشئ نسخة جديدة في C++."
type: docs
weight: 100
url: /ar/cpp/system.net.http.headers/rangeconditionheadervalue/rangeconditionheadervalue/
---
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| التاريخ | DateTimeOffset | قيمة التاريخ. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| entityTag | String | التمثيل النصي لقيمة رأس 'ETag'. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| entityTag | System::SharedPtr\<EntityTagHeaderValue\> | قيمة رأس 'ETag'. |
