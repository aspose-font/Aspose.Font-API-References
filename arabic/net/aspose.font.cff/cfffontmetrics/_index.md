---
title: "الفئة CffFontMetrics"
second_title: "مرجع API لـ Aspose.Font لـ .NET"
description: "الفئة Aspose.Font.Cff.CffFontMetrics. تمثل مقاييس خط CFF"
type: docs
weight: 40
...
| الاسم | الوصف |
| --- | --- |
| override [Ascender](../../aspose.font.cff/cfffontmetrics/ascender/) { get; } | يحصل على قيمة Ascender. |
| override [Descender](../../aspose.font.cff/cfffontmetrics/descender/) { get; } | يحصل على قيمة Descender. |
| override [FontBBox](../../aspose.font.cff/cfffontmetrics/fontbbox/) { get; } | يحصل على قيمة FontBBox. |
...
| override [UnitsPerEM](../../aspose.font.cff/cfffontmetrics/unitsperem/) { get; } | يحصل على قيمة UnitsPerEM. |
...
| [GetFontMatrixForGlyph](../../aspose.font.cff/cfffontmetrics/getfontmatrixforglyph/)(GlyphId) | يحسب مصفوفة التحويل للـ glyph المحدد بالمعرف. |
...
| override [GetGlyphWidth](../../aspose.font.cff/cfffontmetrics/getglyphwidth/)(GlyphId) | يرجع عرض glyph. قد يتم تجاوزه بواسطة وراثي ترميز Font المحددين. |
...
| override [SetGlyphWidth](../../aspose.font.cff/cfffontmetrics/setglyphwidth/)(GlyphId, double) | يضبط عرض الرمز. |
