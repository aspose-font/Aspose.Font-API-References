...
description: "يمثل استثناء تحويل Font."
type: docs
weight: 36
url: /ar/java/com.aspose.font/fontconversionexception/
---
**Inheritance:**
...
يمثل استثناء تحويل الخط. يمكن إلقاء الاستثناء في حالة حدوث أخطاء أثناء عملية تحويل الخط.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [FontConversionException()](#FontConversionException--) | ينشئ كائن  FontConversionException  جديد. |
| [FontConversionException(String message)](#FontConversionException-java.lang.String-) | ينشئ كائن  FontConversionException  جديد. |
| [FontConversionException(String message, RuntimeException innerException)](#FontConversionException-java.lang.String-java.lang.RuntimeException-) | ينشئ كائن  FontConversionException  جديد. |
## الطرق
...
ينشئ كائن  FontConversionException  جديد.
