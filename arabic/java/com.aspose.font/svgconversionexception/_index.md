...
description: "يمثل استثناء تحويل الخط لتنسيق SVG."
type: docs
weight: 76
url: /ar/java/com.aspose.font/svgconversionexception/
---
**Inheritance:**
...
يمثل استثناء تحويل الخط لتنسيق SVG. يمكن إلقاء الاستثناء في حالة حدوث أخطاء أثناء عملية تحويل الخط.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [SvgConversionException()](#SvgConversionException--) | يقوم بتهيئة كائن جديد من SvgConversionException. |
| [SvgConversionException(String message)](#SvgConversionException-java.lang.String-) | يقوم بتهيئة كائن جديد من SvgConversionException. |
| [SvgConversionException(String message, RuntimeException innerException)](#SvgConversionException-java.lang.String-java.lang.RuntimeException-) | يقوم بتهيئة كائن جديد من SvgConversionException. |
## الطرق
...
يقوم بتهيئة كائن جديد من SvgConversionException.
