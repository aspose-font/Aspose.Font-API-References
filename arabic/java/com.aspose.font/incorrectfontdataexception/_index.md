...
description: "يمثل الاستثناءات للحالات التي تكون فيها بعض قيم كائن الخط غير صالحة."
type: docs
weight: 57
url: /ar/java/com.aspose.font/incorrectfontdataexception/
---
**Inheritance:**
...
يمثل الاستثناءات للحالات التي تكون فيها بعض قيم كائن الخط غير صالحة.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [IncorrectFontDataException()](#IncorrectFontDataException--) | ينشئ كائن FontAgrumentException جديد. |
| [IncorrectFontDataException(String message)](#IncorrectFontDataException-java.lang.String-) | ينشئ كائن FontAgrumentException جديد. |
| [IncorrectFontDataException(String message, RuntimeException innerException)](#IncorrectFontDataException-java.lang.String-java.lang.RuntimeException-) | ينشئ كائن FontAgrumentException جديد. |
## الطرق
...
ينشئ كائن FontAgrumentException جديد.
