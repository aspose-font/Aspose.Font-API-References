...
description: "يمثل قائمة معرّفات الحروف."
type: docs
weight: 51
url: /ar/java/com.aspose.font/glyphidlist/
---
**Inheritance:**
...
| [add(E arg0)](#add-E-) |  |
| [add(GlyphId glyphId)](#add-com.aspose.font.GlyphId-) | يضيف معرف الشكل إلى القائمة. |
...
| [clear()](#clear--) | يمسح القائمة. |
| [clone()](#clone--) |  |
| [contains(GlyphId glyphId)](#contains-com.aspose.font.GlyphId-) | يرجع true في حال كان معرف glyph موجودًا في القائمة. |
...
| [get(int index)](#get-int-) | يرجع معرف glyph حسب الفهرس. |
| [getClass()](#getClass--) |  |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(GlyphId glyphId)](#remove-com.aspose.font.GlyphId-) | يزيل معرف glyph من القائمة. |
...
يضيف معرف الشكل إلى القائمة.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| glyphId | [GlyphId](../../com.aspose.font/glyphid) | معرف glyph |
...
يرجع true في حال كان معرف glyph موجودًا في القائمة.
...
**Returns:**
boolean - true في حال كان معرف glyph موجودًا في القائمة، وإلا false
### contains(Object arg0) {#contains-java.lang.Object-}
```
...
يرجع معرف glyph حسب الفهرس.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| فهرس | int | فهرس glyph في القائمة |
