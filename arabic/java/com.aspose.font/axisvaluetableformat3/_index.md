...
description: "يمثل تنسيق جدول قيمة المحور 3"
type: docs
weight: 15
url: /ar/java/com.aspose.font/axisvaluetableformat3/
---
**Inheritance:**
...
يمثل تنسيق جدول قيمة المحور 3
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [AxisValueTableFormat3(int flags, int valueNameId, int axisIndex, float value, float linkedValue)](#AxisValueTableFormat3-int-int-int-float-float-) | منشئ |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getAxisIndex()](#getAxisIndex--) | يحصل على الفهرس Zero-base في مصفوفة سجلات المحور التي تحدد محور التباين التصميمي الذي ينطبق عليه جدول قيم المحور. |
| [getClass()](#getClass--) |  |
| [getFlags()](#getFlags--) | يحصل على حقل أعلام جدول قيم المحور. |
| [getFormat()](#getFormat--) | يحصل على معرف التنسيق (رقم الإصدار). |
| [getLinkedValue()](#getLinkedValue--) | القيمة الرقمية لتعيين مرتبط بالنمط من هذه القيمة. |
| [getValue()](#getValue--) | القيمة الرقمية لهذه قيمة السمة. |
...
| القيمة | float | القيمة الرقمية لهذه قيمة السمة. |
| linkedValue | float | القيمة الرقمية لتعيين مرتبط بالنمط من هذه القيمة. |
...
يحصل على الفهرس Zero-base في مصفوفة سجلات المحور التي تحدد محور التباين التصميمي الذي ينطبق عليه جدول قيم المحور.

**Returns:**
int - فهرس يبدأ من الصفر إلى مصفوفة سجلات المحور يحدد محور التباين التصميمي الذي ينطبق عليه جدول قيم المحور.
### getClass() {#getClass--}
```
...
القيمة الرقمية لتعيين مرتبط بالنمط من هذه القيمة.

**Returns:**
float - القيمة الرقمية لتعيين مرتبط بالنمط من هذه القيمة.
### getValue() {#getValue--}
```
...
القيمة الرقمية لهذه قيمة السمة.

**Returns:**
float - القيمة الرقمية لهذه السمة.
