...
description: "يمثل الاستثناء الذي يمكن إلقاؤه عند محاولة تنفيذ وظيفة مقيدة في وضع التقييم."
type: docs
weight: 60
url: /ar/java/com.aspose.font/licenserestrictionexception/
---
**Inheritance:**
...
يمثل الاستثناء الذي يمكن إلقاؤه عند محاولة تنفيذ وظيفة مقيدة في وضع التقييم.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [LicenseRestrictionException()](#LicenseRestrictionException--) | يُنشئ كائن FontCreationException جديد. |
| [LicenseRestrictionException(String message)](#LicenseRestrictionException-java.lang.String-) | يُنشئ كائن FontCreationException جديد. |
| [LicenseRestrictionException(String message, RuntimeException innerException)](#LicenseRestrictionException-java.lang.String-java.lang.RuntimeException-) | يُنشئ كائن FontCreationException جديد. |
## الطرق
...
يُنشئ كائن FontCreationException جديد.
