...
type: docs
weight: 136
url: /ar/java/com.aspose.font/fonttype/
---
**Inheritance:**
...
| حقل | الوصف |
| --- | --- |
| [CFF](#CFF) | CFF (تنسيق الخط المدمج) نوع الخط. |
| [OTF](#OTF) | خط OpenType. |
| [TTF](#TTF) | TTF (TrueType) نوع الخط وما يتعلق به. |
| [Type1](#Type1) | نوع خط Type1. |
## الطرق
...
CFF (تنسيق الخط المدمج) نوع الخط.
...
TTF (TrueType) نوع الخط وما يتعلق به.
