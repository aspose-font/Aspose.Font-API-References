...
type: docs
weight: 135
url: /ar/java/com.aspose.font/fontsavingformats/
---
**Inheritance:**
...
| --- | --- |
| [OTF](#OTF) | خط OpenType. |
| [SVG](#SVG) | تنسيق الخط SVG(Scalable Vector Graphics) |
| [TTF](#TTF) | تنسيق الخط TTF (TrueType). |
| [WOFF](#WOFF) | WOFF (Web Open Font Format). |
| [WOFF2](#WOFF2) | تنسيق ملف WOFF 2.0 |
## الطرق
...
خط OpenType. تنسيق خط OpenType هو امتداد لتنسيق خط TrueType، يضيف دعمًا لبيانات خط PostScript.
...
تنسيق الخط SVG(Scalable Vector Graphics)
