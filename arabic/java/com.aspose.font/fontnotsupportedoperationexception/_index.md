...
description: "يمثل استثناء العملية غير المدعومة."
type: docs
weight: 45
url: /ar/java/com.aspose.font/fontnotsupportedoperationexception/
---
**Inheritance:**
...
يمثل استثناء العملية غير المدعومة. يمكن رمي الاستثناء في حالة عدم دعم بعض العمليات لنوع خط معين.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [FontNotSupportedOperationException()](#FontNotSupportedOperationException--) | ينشئ كائنًا جديدًا من نوع FontNotSupportedOperationException. |
| [FontNotSupportedOperationException(String message)](#FontNotSupportedOperationException-java.lang.String-) | ينشئ كائنًا جديدًا من نوع FontNotSupportedOperationException. |
| [FontNotSupportedOperationException(String message, RuntimeException innerException)](#FontNotSupportedOperationException-java.lang.String-java.lang.RuntimeException-) | ينشئ كائنًا جديدًا من نوع FontNotSupportedOperationException. |
## الطرق
...
ينشئ كائنًا جديدًا من نوع FontNotSupportedOperationException.
