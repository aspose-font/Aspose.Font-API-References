...
description: "يمثل استثناء شائع متعلق بمعالجة Font."
type: docs
weight: 40
url: /ar/java/com.aspose.font/fontexception/
---
**Inheritance:**
...
يمثل استثناء شائع متعلق بمعالجة Font.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [FontException()](#FontException--) | ينشئ كائن  FontException  جديد. |
| [FontException(String message)](#FontException-java.lang.String-) | ينشئ كائن  FontException  جديد. |
| [FontException(String message, RuntimeException innerException)](#FontException-java.lang.String-java.lang.RuntimeException-) | ينشئ كائن  FontException  جديد. |
## الطرق
