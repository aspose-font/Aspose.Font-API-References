...
description: "يمثل استثناء متعلق بمعالجة خط WOFF."
type: docs
weight: 119
url: /ar/java/com.aspose.font/woffformatexception/
---
**Inheritance:**
...
يمثل استثناء متعلق بمعالجة خط WOFF.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [WoffFormatException()](#WoffFormatException--) | يقوم بتهيئة كائن  WoffFormatException  جديد. |
| [WoffFormatException(String message)](#WoffFormatException-java.lang.String-) | يقوم بتهيئة كائن  WoffFormatException  جديد. |
| [WoffFormatException(String message, RuntimeException innerException)](#WoffFormatException-java.lang.String-java.lang.RuntimeException-) | يقوم بتهيئة كائن  WoffFormatException  جديد. |
## الطرق
...
يقوم بتهيئة كائن  WoffFormatException  جديد.
