...
description: "حفظ الـ BLOB الممثل كسلسلة نصية في نظام الملفات الذاكرة (Memory FS) للمعالجة."
type: docs
url: /ar/javascript-cpp/core/asposefontpreparebase64/
---
## AsposeFontPrepareBase64 function
_احفظ تمثيل السلسلة BLOB في نظام الملفات الذاكرة للمعالجة._
