...
type: docs
url: /ar/javascript-cpp/metadata/asposefontgetinfo/
---
...
|  | السجلات | مصفوفة من كائنات JSON : |
|  | * NameId | معرف الاسم |
|  | * PlatformId | معرف النظام الأساسي |
|  | * PlatformSpecificId | معرف النظام الأساسي المحدد |
|  | * LanguageId | معرف اللغة |
|  | * Info | محتوى سجل الاسم |
