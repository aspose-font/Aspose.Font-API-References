...
description: "Implémentation des métriques de police CFF"
type: docs
weight: 21
url: /fr/java/com.aspose.font/cfffontmetrics/
---
**Inheritance:**
...
Implémentation des métriques de police CFF
## Méthodes
...
| [getFontMatrixForGlyph(GlyphId glyphId)](#getFontMatrixForGlyph-com.aspose.font.GlyphId-) | Calcule la matrice de transformation pour le glyphe spécifié par l'identifiant. |
...
Renvoie la largeur du glyphe. Peut être remplacée par des héritiers d'encodage de police spécifiques.
