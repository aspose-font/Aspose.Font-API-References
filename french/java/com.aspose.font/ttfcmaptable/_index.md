...
type: docs
weight: 89
url: /fr/java/com.aspose.font/ttfcmaptable/
---
**Inheritance:**
...
| [findUnicodeTable()](#findUnicodeTable--) | Recherche et renvoie le CMap Unicode. |
...
| [getPlatformTables(int platformId, int platformSpecificId)](#getPlatformTables-int-int-) | Renvoie les sous‑tables CMap pour planformId et platformSpecificId. |
...
Recherche et renvoie le CMap Unicode. s’il existe un CMap ucs-4 - le renvoie en premier ; sinon - renvoie tout CMap Unicode qu’il trouve.
...
**Returns:**
com.aspose.font.TtfCMapTable.TtfCMapSubtableDescription[] - tableau d'objets TtfCmapSubtableDescription
### getClass() {#getClass--}
```
...
**Returns:**
com.aspose.font.TtfCMapFormatBaseTable[] - sous‑tables CMap.
### getTag() {#getTag--}
```
