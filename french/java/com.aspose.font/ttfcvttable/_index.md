...
type: docs
weight: 91
url: /fr/java/com.aspose.font/ttfcvttable/
---
**Inheritance:**
...
| [getClass()](#getClass--) |  |
| [getControlValues()](#getControlValues--) | Obtient la liste des valeurs référencables par les instructions. |
...
Obtient la liste des valeurs référencables par les instructions.

**Returns:**
short[] - Liste des valeurs référencables par les instructions.
### getOffset() {#getOffset--}
```
