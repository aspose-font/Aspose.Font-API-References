...
description: "Représente la liste des identifiants de glyphes."
type: docs
weight: 51
url: /fr/java/com.aspose.font/glyphidlist/
---
**Inheritance:**
...
Représente la liste des identifiants de glyphes.
## Méthodes
...
| [add(E arg0)](#add-E-) |  |
| [add(GlyphId glyphId)](#add-com.aspose.font.GlyphId-) | Ajoute l'identifiant de glyphe à la liste. |
...
| [clear()](#clear--) | Vide la liste. |
| [clone()](#clone--) |  |
| [contains(GlyphId glyphId)](#contains-com.aspose.font.GlyphId-) | Renvoie vrai si l'identifiant du glyphe se trouve dans la liste. |
...
| [get(int index)](#get-int-) | Renvoie l'identifiant du glyphe par l'index. |
| [getClass()](#getClass--) |  |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(GlyphId glyphId)](#remove-com.aspose.font.GlyphId-) | Supprime l'identifiant du glyphe de la liste. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| glyphId | [GlyphId](../../com.aspose.font/glyphid) | identifiant du glyphe |
...
Renvoie vrai si l'identifiant du glyphe se trouve dans la liste.
...
**Returns:**
booléen - vrai si l'identifiant du glyphe se trouve dans la liste, sinon faux
### contains(Object arg0) {#contains-java.lang.Object-}
```
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | index du glyphe dans la liste |
...
**Returns:**
booléen - vrai si l'élément est supprimé avec succès ; sinon, faux
### remove(int arg0) {#remove-int-}
```
