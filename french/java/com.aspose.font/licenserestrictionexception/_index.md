...
description: "Représente l'exception qui peut être levée lors d'une tentative d'exécution d'une fonctionnalité restreinte en mode d'évaluation."
type: docs
weight: 60
url: /fr/java/com.aspose.font/licenserestrictionexception/
---
**Inheritance:**
...
Représente l'exception qui peut être levée lors d'une tentative d'exécution d'une fonctionnalité restreinte en mode d'évaluation.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [LicenseRestrictionException()](#LicenseRestrictionException--) | Initialise un nouvel objet FontCreationException. |
| [LicenseRestrictionException(String message)](#LicenseRestrictionException-java.lang.String-) | Initialise un nouvel objet FontCreationException. |
| [LicenseRestrictionException(String message, RuntimeException innerException)](#LicenseRestrictionException-java.lang.String-java.lang.RuntimeException-) | Initialise un nouvel objet FontCreationException. |
## Méthodes
...
Initialise un nouvel objet FontCreationException.
