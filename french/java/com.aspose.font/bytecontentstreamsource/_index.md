...
description: "Représente une source de flux basée sur le _content stream."
type: docs
weight: 17
url: /fr/java/com.aspose.font/bytecontentstreamsource/
---
**Inheritance:**
...
Représente une source de flux basée sur le flux \_content.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ByteContentStreamSource(byte[] fileContent)](#ByteContentStreamSource-byte---) | Initialise un nouvel objet ByteContentStreamSource. |
## Méthodes

| Méthode | Description |
| --- | --- |
| [deepClone()](#deepClone--) | Clone l'objet ByteContentStreamSource. |
...
Initialise un nouvel objet ByteContentStreamSource.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| fileContent | byte[] | Octets du fichier. |
