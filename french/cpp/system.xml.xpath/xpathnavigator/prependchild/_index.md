---
title: "System::Xml::XPath::XPathNavigator::PrependChild méthode"
linktitle: "PrependChild"
second_title: "Aspose.Font pour C++"
description: "System::Xml::XPath::XPathNavigator::PrependChild méthode. Retourne un objet XmlWriter utilisé pour créer un nouveau nœud enfant au début de la liste des nœuds enfants du nœud actuel en C++."
type: docs
weight: 6600
url: /fr/cpp/system.xml.xpath/xpathnavigator/prependchild/
---
## XPathNavigator::PrependChild() method


Retourne un objet [XmlWriter](../../../system.xml/xmlwriter/) utilisé pour créer un nouveau nœud enfant au début de la liste des nœuds enfants du nœud actuel.
