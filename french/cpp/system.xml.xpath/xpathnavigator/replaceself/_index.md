---
title: "System::Xml::XPath::XPathNavigator::ReplaceSelf méthode"
linktitle: "ReplaceSelf"
second_title: "Aspose.Font pour C++"
description: "System::Xml::XPath::XPathNavigator::ReplaceSelf méthode. Remplace le nœud actuel par le contenu de l'objet XmlReader spécifié en C++."
type: docs
weight: 7000
url: /fr/cpp/system.xml.xpath/xpathnavigator/replaceself/
---
## XPathNavigator::ReplaceSelf(SharedPtr\<XmlReader\>) method


Remplace le nœud actuel par le contenu de l'objet [XmlReader](../../../system.xml/xmlreader/) spécifié.
...
| --- | --- | --- |
| newNode | SharedPtr\<XmlReader\> | Un objet [XmlReader](../../../system.xml/xmlreader/) positionné sur les données XML du nouveau nœud. |
