---
title: "System::Xml::XPath::XPathNavigator::InsertBefore méthode"
linktitle: "InsérerAvant"
second_title: "Aspose.Font pour C++"
description: "System::Xml::XPath::XPathNavigator::InsertBefore méthode. Retourne un objet XmlWriter utilisé pour créer un nouveau nœud frère avant le nœud actuellement sélectionné en C++."
type: docs
weight: 4200
url: /fr/cpp/system.xml.xpath/xpathnavigator/insertbefore/
---
## XPathNavigator::InsertBefore() method


Retourne un objet [XmlWriter](../../../system.xml/xmlwriter/) utilisé pour créer un nouveau nœud frère avant le nœud actuellement sélectionné.
...
| --- | --- | --- |
| newSibling | SharedPtr\<XmlReader\> | Un objet [XmlReader](../../../system.xml/xmlreader/) positionné sur les données XML du nouveau nœud frère. |
