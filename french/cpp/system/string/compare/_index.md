---
title: "System::String::Compare méthode"
linktitle: "Compare"
second_title: "Aspose.Font pour C++"
description: "System::String::Compare méthode. Compare deux chaînes en C++ avec les opérateurs inférieur, égal, supérieur."
type: docs
weight: 6200
url: /fr/cpp/system/string/compare/
---
## String::Compare(const String\&, const String\&, bool, const SharedPtr\<System::Globalization::CultureInfo\>\&) method


Less-equal-greater compare deux chaînes.
...
| ci | const SharedPtr\<System::Globalization::CultureInfo\>\& | Culture à utiliser pour la comparaison. |

### ReturnValue

Valeur négative si la première sous-chaîne est inférieure à la seconde, zéro si elles correspondent, valeur positive sinon.
...
| strA | const String\& | Première chaîne à comparer. |
| strB | const String\& | Deuxième chaîne à comparer. |
| comparison_type | System::StringComparison | Mode [Comparison](../../comparison/). |
...
Less-equal-greater compare deux sous‑chaînes.
...
| --- | --- | --- |
| strA | const String\& | Première chaîne à comparer. |
| indexA | int | Début de la première sous-chaîne. |
| strB | const String\& | Deuxième chaîne à comparer. |
| indexB | int | Début de la deuxième sous-chaîne. |
| longueur | int | Nombre de caractères à comparer. |
| ignoreCase | bool | Spécifie si la comparaison est insensible à la casse. |
| ci | const SharedPtr\<System::Globalization::CultureInfo\>\& | Culture à utiliser pour la comparaison. |
