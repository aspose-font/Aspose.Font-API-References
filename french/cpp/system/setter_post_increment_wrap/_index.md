---
title: "Méthode System::setter_post_increment_wrap"
linktitle: "setter_post_increment_wrap"
second_title: "Aspose.Font pour C++"
description: "Méthode System::setter_post_increment_wrap. Le traducteur traduit les expressions post‑incrément de C#''s ciblant la propriété de l''instance qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter const) en C++."
type: docs
weight: 38000
...
Le traducteur traduit les expressions post‑incrément de C#'s ciblant la propriété de l'instance qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter const).
...
Le traducteur traduit les expressions post‑incrément de C# ciblant la propriété d'une instance qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter non const).
...
Le traducteur traduit les expressions post‑incrément de C# ciblant la propriété d'une classe qui possède un setter et un getter définis, en appel de cette fonction.
