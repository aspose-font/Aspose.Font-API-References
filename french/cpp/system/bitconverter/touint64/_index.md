...
description: "Méthode System::BitConverter::ToUInt64. Convertit huit octets du tableau spécifié à partir de l'index spécifié en une valeur entière non signée de 64 bits en C++."
type: docs
weight: 1500
url: /fr/cpp/system/bitconverter/touint64/
---
## BitConverter::ToUInt64(const System::ArrayPtr\<uint8_t\>\&, int) method


Convertit huit octets du tableau spécifié à partir de l'index indiqué en une valeur entière non signée de 64 bits.
