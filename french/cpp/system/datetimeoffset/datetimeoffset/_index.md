---
title: "Constructeur System::DateTimeOffset::DateTimeOffset"
linktitle: "DécalageDateHeure"
second_title: "Aspose.Font pour C++"
description: "Constructeur System::DateTimeOffset::DateTimeOffset. Constructeur par défaut en C++."
type: docs
weight: 100
url: /fr/cpp/system/datetimeoffset/datetimeoffset/
---
...
| --- | --- | --- |
| date_time | DateTime | Date et heure. |
...
| --- | --- | --- |
| date_time | DateTime | Date et heure. |
| décalage | TimeSpan | Décalage horaire par rapport à UTC. |
...
| --- | --- | --- |
| année | int | Année. |
| mois | int | Mois (1 à 12). |
| jour | int | Jour (1 au nombre de jours dans le mois). |
| heure | int | Heure (0 à 23). |
| minute | int | Minute (0 à 59). |
| seconde | int | Seconde (0 à 59). |
| milliseconde | int | Milliseconde (0 à 999). |
| calendrier | const SharedPtr\<Globalization::Calendar\>\& | Calendrier utilisé pour interpréter l'année, le mois et le jour. |
| décalage | TimeSpan | Décalage horaire par rapport à UTC. |
