---
title: "System::Decimal::Parse méthode"
linktitle: "Analyser"
second_title: "Aspose.Font pour C++"
description: "System::Decimal::Parse méthode. Convertit la représentation sous forme de chaîne d'un nombre décimal en une instance équivalente de la classe Decimal en C++."
type: docs
weight: 4200
url: /fr/cpp/system/decimal/parse/
---
...
| --- | --- | --- |
| s | const String\& | La représentation sous forme de chaîne d'un nombre |

### ReturnValue

Une nouvelle instance de la classe [Decimal](../) représentant une valeur équivalente à celle représentée par la chaîne spécifiée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| s | const String\& | La représentation sous forme de chaîne d'une valeur décimale à convertir |
...
| --- | --- | --- |
| s | const String\& | La représentation sous forme de chaîne d'une valeur décimale à convertir |
| styles | Globalization::NumberStyles | Une combinaison binaire des valeurs d'énumération qui fournit des informations supplémentaires sur **s**, sur les éléments de style pouvant être présents dans **s**, ou sur la conversion de **s** vers un objet [Decimal](../). |
