---
title: "System::WeakPtr::WeakPtr constructeur"
linktitle: "WeakPtr"
second_title: "Aspose.Font pour C++"
description: "System::WeakPtr::WeakPtr constructeur. Crée un pointeur faible référencant le même pointeur que x pointe en C++."
type: docs
weight: 100
url: /fr/cpp/system/weakptr/weakptr/
---
## WeakPtr::WeakPtr(const SmartPtr\<Q\>\&) constructor


Crée un pointeur faible référencant le même pointeur que x pointe.
...
| --- | --- |
| Q | Type pointé du pointeur source. |

| Paramètre | Type | Description |
| --- | --- | --- |
| x | const SmartPtr\<Q\>\& | Pointeur à partir duquel copier la valeur pointée. |
...
Crée un pointeur faible référencant le même pointeur que ptr pointe.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| ptr | const SmartPtr_\& | Pointeur à partir duquel copier la valeur pointée. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| x | const WeakPtr\<Q\>\& | Pointeur à partir duquel copier la valeur pointée. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| ptr | const WeakPtr_\& | Pointeur à partir duquel copier la valeur pointée. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| object | Pointee_ * | [Object](../../object/) pour créer un pointeur faible vers. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| x | SmartPtr_\&& | Pointeur à partir duquel déplacer la valeur pointée. |
