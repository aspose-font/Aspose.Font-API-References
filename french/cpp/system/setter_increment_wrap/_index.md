...
description: "Méthode System::setter_increment_wrap. Le traducteur traduit les expressions d'incrémentation de C# ciblant la propriété d'une classe qui possède un setter et un getter définis, en appel de cette fonction en C++."
type: docs
weight: 37500
...
| --- | --- | --- |
| hôte | Host *const | Un pointeur vers un objet dont la propriété doit être incrémentée |
