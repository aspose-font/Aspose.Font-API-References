...
description: "System::setter_decrement_wrap method. Le traducteur traduit les expressions de pré‑décrément de C#''s ciblant la propriété d'une instance qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter const) en C++."
type: docs
weight: 37200
...
Le traducteur traduit les expressions de pré‑décrément de C#'s ciblant la propriété d'une instance qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter const).
...
Le traducteur traduit les expressions de pré‑décrément de C#'s ciblant la propriété d'une instance qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter non‑const).
...
Le traducteur traduit les expressions de pré‑décrément de C#'s ciblant la propriété d'une classe qui possède un setter et un getter définis, en appel de cette fonction.
