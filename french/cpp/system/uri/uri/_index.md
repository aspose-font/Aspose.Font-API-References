---
title: "System::Uri::Uri constructeur"
linktitle: "Uri"
second_title: "Aspose.Font pour C++"
description: "System::Uri::Uri constructeur. Construit un objet Uri à partir des URI de base et relatives spécifiés en C++."
type: docs
weight: 100
url: /fr/cpp/system/uri/uri/
---
...
Construit un [Uri](../) objet à partir du [Uri](../) spécifié représentant l'URI de base et de la représentation sous forme de chaîne de l'URI relative ; un argument indique si l'URI doit être échappé.
