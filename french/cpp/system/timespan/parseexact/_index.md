---
title: "System::TimeSpan::ParseExact méthode"
linktitle: "ParseExact"
second_title: "Aspose.Font pour C++"
description: "Comment utiliser la méthode ParseExact de la classe System::TimeSpan en C++."
type: docs
weight: 4300
url: /fr/cpp/system/timespan/parseexact/
---
...
Convertit la chaîne en un objet [TimeSpan](../) équivalent en utilisant les formats spécifiés, le fournisseur de format et les styles.
...
Intervalle de temps qui correspond à la chaîne.
...
Convertit la chaîne en un objet [TimeSpan](../) équivalent en utilisant le format spécifié, le fournisseur de format et les styles.
