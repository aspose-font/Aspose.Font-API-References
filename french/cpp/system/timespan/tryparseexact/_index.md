---
title: "System::TimeSpan::TryParseExact méthode"
linktitle: "TryParseExact"
second_title: "Aspose.Font pour C++"
description: "Comment utiliser la méthode TryParseExact de la classe System::TimeSpan en C++."
type: docs
weight: 4500
url: /fr/cpp/system/timespan/tryparseexact/
---
...
Convertit une chaîne en un objet [TimeSpan](../) équivalent en utilisant les formats spécifiés, le fournisseur de format et les styles, et retourne le résultat de la conversion.
...
| fournisseur | const SharedPtr\<IFormatProvider\>\& | Fournisseur de format qui fournit des informations de formatage spécifiques à la culture. |
| styles | Globalization::TimeSpanStyles | Définit les éléments qui peuvent être présents dans la chaîne d'entrée. |
| résultat | TimeSpan\& | Intervalle de temps qui correspond à la chaîne. |

### ReturnValue

Vrai si la chaîne a été convertie avec succès ; sinon, false.
...
Convertit une chaîne en un objet [TimeSpan](../) équivalent en utilisant les formats spécifiés et le fournisseur de format, et retourne le résultat de la conversion.
...
Convertit une chaîne en objet [TimeSpan](../) équivalent en utilisant le format spécifié, le fournisseur de format et les styles, et renvoie le résultat de la conversion.
...
| --- | --- | --- |
| input | const String\& | Chaîne d'entrée. |
| format | const String\& | Chaîne de format standard ou personnalisée. |
| fournisseur | const SharedPtr\<IFormatProvider\>\& | Fournisseur de format qui fournit des informations de formatage spécifiques à la culture. |
| styles | Globalization::TimeSpanStyles | Définit les éléments qui peuvent être présents dans la chaîne d'entrée. |
| résultat | TimeSpan\& | Intervalle de temps qui correspond à la chaîne. |
...
Convertit une chaîne en objet [TimeSpan](../) équivalent en utilisant le format spécifié et le fournisseur de format, et renvoie le résultat de la conversion.
