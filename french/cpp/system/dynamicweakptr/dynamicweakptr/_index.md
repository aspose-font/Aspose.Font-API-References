---
title: "System::DynamicWeakPtr::DynamicWeakPtr constructeur"
linktitle: "DynamicWeakPtr"
second_title: "Aspose.Font pour C++"
description: "System::DynamicWeakPtr::DynamicWeakPtr constructeur. Copie-constructeur du pointeur intelligent en C++."
type: docs
weight: 100
url: /fr/cpp/system/dynamicweakptr/dynamicweakptr/
---
## DynamicWeakPtr::DynamicWeakPtr(const DynamicWeakPtr_\&) constructor


Construit par copie le pointeur intelligent.
...
| --- | --- | --- |
| ptr | const DynamicWeakPtr_\& | Pointeur intelligent à partir duquel copier les informations du pointee. |
...
| --- | --- |
| Q | Type d'objet pointé par le pointeur source. |

| Paramètre | Type | Description |
| --- | --- | --- |
| x | const SmartPtr\<Q\>\& | Pointeur intelligent à partir duquel copier les informations du pointee. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| ptr | const SmartPtr_\& | Pointeur intelligent à partir duquel copier les informations du pointee. |
...
Crée un pointeur intelligent pointant vers l'objet donné.
...
Construit par déplacement le pointeur intelligent.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| x | SmartPtr_\&& | Pointeur intelligent à partir duquel déplacer les informations du pointee. Devient inutilisable après l'appel. |
