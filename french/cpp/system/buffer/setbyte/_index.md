---
title: "Méthode System::Buffer::SetByte"
linktitle: "SetByte"
second_title: "Aspose.Font pour C++"
description: "Méthode System::Buffer::SetByte. Interprète le tableau typé spécifié comme un tableau d'octets brut et définit la valeur d'octet spécifiée à l'offset d'octet spécifié en C++."
type: docs
weight: 400
...
Interprète le tableau typé spécifié comme un tableau brut d'octets et définit la valeur d'octet spécifiée à l'offset d'octet spécifié.
...
| indice | int | Offset zéro‑base de l'octet à définir |
| valeur | uint8_t | La valeur d'octet à définir |
