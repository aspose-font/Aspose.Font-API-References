...
description: "méthode System::operator<<. Écrit une chaîne dans le flux de sortie en utilisant l'encodage UTF-8 en C++."
type: docs
weight: 29200
url: /fr/cpp/system/operator__/
---
## System::operator<<(std::ostream\&, const String\&) method


Écrit une chaîne dans le flux de sortie en utilisant l'encodage UTF-8.
...
| --- | --- | --- |
| os | std::ostream\& | Un objet de flux de sortie (instanciation de **basic_ostream** avec **char**). |
| str | const String\& | Une chaîne à envoyer au flux de sortie. |

### ReturnValue

Un flux de sortie auquel la chaîne a été ajoutée.
...
| decimal | const Decimal\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| exception | const Exception\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| guid | const Guid\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| value | const Nullable\<T\>\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| os | const OperatingSystem\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| object_ptr | const SharedPtr\<T\>\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| object | const System::Object\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| type_info | const TypeInfo\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| version | const Version\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| object_ptr | const WeakPtr\<T\>\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| date_time | DateTime | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| value | DateTimeOffset | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| time_span | TimeSpan | [Data](../../system.data/) à insérer. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| os | std::wostream\& | Un objet de flux de sortie (instanciation de **basic_ostream** avec **wchar_t**). |
| str | const String\& | Une chaîne à envoyer au flux de sortie. |
...
description: 'Méthode System::operator>>. Obtient une chaîne à partir du flux d'entrée en utilisant l'encodage UTF-8 en C++.'
type: documentation
poids: 35200
...
Obtient une chaîne à partir du flux d'entrée en utilisant l'encodage UTF-8.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| dans | std::istream\& | Un objet flux d'entrée (instanciation de **basic_ostream** avec **char**). |
| str | String\& | Une chaîne à lire depuis le flux d'entrée. |
...
Obtient une chaîne à partir du flux d'entrée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| dans | std::wistream\& | Un objet flux d'entrée (instanciation de **basic_ostream** avec **wchar_t**). |
| str | String\& | Une chaîne à lire depuis le flux d'entrée. |
