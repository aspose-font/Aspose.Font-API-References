...
Spécifie la valeur du paramètre passée à un encodeur d'image JPEG ou TIFF.
...
| TransformRotate270 | 15 | Spécifie une rotation sans perte de 270 degrés dans le sens des aiguilles d'une montre pour une image JPEG. |
