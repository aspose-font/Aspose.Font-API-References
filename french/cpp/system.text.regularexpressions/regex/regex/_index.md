---
title: "System::Text::RegularExpressions::Regex::Regex constructeur"
linktitle: "Expression régulière"
second_title: "Aspose.Font pour C++"
description: "System::Text::RegularExpressions::Regex::Regex constructeur. Construit une expression régulière vide en C++."
type: docs
weight: 100
url: /fr/cpp/system.text.regularexpressions/regex/regex/
---
...
| --- | --- | --- |
| motif | const String\& | Modèle syntaxé en C#. |
...
| --- | --- | --- |
| motif | const String\& | Modèle syntaxé en C#. |
| options | RegexOptions | [Regex](../) options de correspondance. |
...
| motif | const String\& | Modèle syntaxé en C#. |
| options | RegexOptions | [Regex](../) options de correspondance. |
| matchTimeout | TimeSpan | Délai d'attente pour interrompre la correspondance. |
