---
title: "System::Security::Cryptography::CryptoStream::Write méthode"
linktitle: "Write"
second_title: "Aspose.Font pour C++"
description: "System::Security::Cryptography::CryptoStream::Write méthode. Écrit des données dans le flux en C++."
type: docs
weight: 1400
url: /fr/cpp/system.security.cryptography/cryptostream/write/
---
...
| --- | --- | --- |
| tampon | const ArrayPtr\<uint8_t\>\& | Tampon de données source. |
| décalage | int32_t | Décalage dans le tampon source. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| tampon | const System::Details::ArrayView\<uint8_t\>\& | Tampon de données source. |
| décalage | int32_t | Décalage dans le tampon source. |
| count | int32_t | Nombre d'octets à écrire. |
