---
title: "System::Security::Cryptography::RandomNumberGenerator::GetBytes méthode"
linktitle: "GetBytes"
second_title: "Aspose.Font pour C++"
description: "System::Security::Cryptography::RandomNumberGenerator::GetBytes méthode. Remplit les éléments du tableau existant avec des octets aléatoires en C++."
type: docs
weight: 200
url: /fr/cpp/system.security.cryptography/randomnumbergenerator/getbytes/
---
## RandomNumberGenerator::GetBytes(ArrayPtr\<uint8_t\>) method


Remplit les éléments existants du tableau avec des octets aléatoires.
...
| --- | --- | --- |
| octets | ArrayPtr\<uint8_t\> | Tableau d'octets à remplir. |
...
Remplit la tranche existante du tableau avec des octets aléatoires.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| octets | ArrayPtr\<uint8_t\> | Tranche du tableau d'octets à remplir. |
| décalage | int | Indice de début de la tranche. |
...
Remplit les éléments de la vue du tableau existante avec des octets aléatoires.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| octets | System::Details::ArrayView\<uint8_t\> | Vue du tableau d'octets à remplir. |
...
Remplit la tranche de la vue du tableau existante avec des octets aléatoires.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| octets | System::Details::ArrayView\<uint8_t\> | Vue du tableau d'octets pour remplir la tranche de. |
| décalage | int | Indice de début de la tranche. |
| count | int | Taille de la tranche. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| octets | System::Details::StackArray\<uint8_t, N\>\& | Tableau d'octets sur la pile à remplir. |
...
Remplit la tranche du tableau empilé existant avec des octets aléatoires.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| octets | System::Details::StackArray\<uint8_t, N\>\& | Tableau de pile d'octets pour remplir la tranche de. |
| décalage | int | Indice de début de la tranche. |
| count | int | Taille de la tranche. |
