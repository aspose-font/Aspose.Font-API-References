---
title: "Constructeur System::Security::Cryptography::AsnEncodedData::AsnEncodedData"
linktitle: "AsnEncodedData"
second_title: "Aspose.Font pour C++"
description: "Constructeur System::Security::Cryptography::AsnEncodedData::AsnEncodedData. Constructeur en C++."
type: docs
weight: 100
url: /fr/cpp/system.security.cryptography/asnencodeddata/asnencodeddata/
---
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Données encodées au format brut d'octets. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| asn_encoded_data | const SharedPtr\<AsnEncodedData\>\& | [Object](../../../system/object/) pour copier les données depuis. |
## Remarques
...
| Paramètre | Type | Description |
| --- | --- | --- |
| oid | const SharedPtr\<Oid\>\& | [Object](../../../system/object/) identifiant des données encodées. |
| raw_data | const ByteArrayPtr\& | Données encodées au format brut d'octets. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| oid | const String\& | [Object](../../../system/object/) identifiant des données encodées. |
| raw_data | const ByteArrayPtr\& | Données encodées au format brut d'octets. |
