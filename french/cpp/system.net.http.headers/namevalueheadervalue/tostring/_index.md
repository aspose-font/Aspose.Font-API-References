---
title: "System::Net::Http::Headers::NameValueHeaderValue::ToString méthode"
linktitle: "ToString"
second_title: "Aspose.Font pour C++"
description: "System::Net::Http::Headers::NameValueHeaderValue::ToString méthode. Analogue de la méthode C# Object.ToString(). Permet de convertir des objets personnalisés en chaîne en C++."
type: docs
weight: 700
url: /fr/cpp/system.net.http.headers/namevalueheadervalue/tostring/
---
...
Renvoie une représentation sous forme de chaîne de la collection d'instances de la classe NameValueHeaderValue‑class.
...
| --- | --- | --- |
| valeurs | System::SharedPtr\<ObjectCollection\<System::SharedPtr\<NameValueHeaderValue\>\>\> | La collection des instances de la classe NameValueHeaderValue. |
| séparateur | char16_t | Un séparateur de chaîne. |
...
Une représentation sous forme de chaîne de la collection des instances de la classe NameValueHeaderValue.
...
| séparateur | char16_t | Un séparateur de chaîne. |
| leadingSeparator | bool | La valeur qui indique si le séparateur de chaîne doit être ajouté avant le premier élément de la collection. |
| destination | System::SharedPtr\<Text::StringBuilder\> | Une instance où une représentation sous forme de chaîne sera assignée. |
