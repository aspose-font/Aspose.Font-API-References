---
title: "System::Net::Http::Headers::HttpHeaderValueCollection::HttpHeaderValueCollection constructeur"
linktitle: "HttpHeaderValueCollection"
second_title: "Aspose.Font pour C++"
description: "System::Net::Http::Headers::HttpHeaderValueCollection::HttpHeaderValueCollection constructeur. Construit une nouvelle instance en C++."
type: docs
weight: 100
url: /fr/cpp/system.net.http.headers/httpheadervaluecollection/httpheadervaluecollection/
---
...
| stockage | System::SharedPtr\<HttpHeaders\> | La collection des en-têtes HTTP. |
...
| headerName | String | Le nom de l'en-tête. |
| stockage | System::SharedPtr\<HttpHeaders\> | La collection des en-têtes HTTP. |
| validateur | Action\<System::SharedPtr\<HttpHeaderValueCollection\<T\>\>, T\> | Le délégué qui est utilisé pour valider les éléments ajoutés. |
...
| headerName | String | Le nom de l'en-tête. |
| stockage | System::SharedPtr\<HttpHeaders\> | La collection des en-têtes HTTP. |
| valeurSpéciale | T | Une "valeur spéciale". |
