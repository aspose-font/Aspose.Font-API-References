---
title: "System::Xml::Schema::XmlSchema::Write méthode"
linktitle: "Write"
second_title: "Aspose.Font pour C++"
description: "System::Xml::Schema::XmlSchema::Write méthode. Écrit le schéma XML dans le flux de données fourni en C++."
type: docs
weight: 2800
url: /fr/cpp/system.xml.schema/xmlschema/write/
---
...
Écrit le [Schema](../../) XML dans le flux fourni en utilisant le [XmlNamespaceManager](../../../system.xml/xmlnamespacemanager/) spécifié.
...
| --- | --- | --- |
| flux | const SharedPtr\<IO::Stream\>\& | Le flux de données fourni. |
| namespaceManager | const SharedPtr\<XmlNamespaceManager\>\& | Le [XmlNamespaceManager](../../../system.xml/xmlnamespacemanager/). |
...
Écrit le [Schema](../../) XML dans le [IO::TextWriter](../../../system.io/textwriter/) fourni.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| writer | const SharedPtr\<IO::TextWriter\>\& | Le [IO::TextWriter](../../../system.io/textwriter/) dans lequel écrire. |
...
Écrit le [Schema](../../) XML dans le [XmlWriter](../../../system.xml/xmlwriter/) fourni.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| writer | const SharedPtr\<XmlWriter\>\& | Le [XmlWriter](../../../system.xml/xmlwriter/) dans lequel écrire. |
