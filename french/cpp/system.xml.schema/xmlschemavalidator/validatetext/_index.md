...
description: "System::Xml::Schema::XmlSchemaValidator::ValidateText method. Vérifie si la chaîne de texte spécifiée est autorisée dans le contexte de l'élément actuel, et accumule le texte pour la validation si l'élément actuel possède un contenu simple en C++."
type: docs
weight: 2000
...
| Paramètre | Type | Description |
| --- | --- | --- |
| elementValue | XmlValueGetter | Un rappel [XmlValueGetter](../../xmlvaluegetter/) utilisé pour transmettre la valeur texte sous une forme compatible avec le type du langage de définition XML [Schema](../../) (XSD) de l'attribut. |
