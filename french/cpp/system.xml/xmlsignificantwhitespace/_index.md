...
description: "Classe System::Xml::XmlSignificantWhitespace. Représente l'espace blanc entre le balisage dans un nœud à contenu mixte ou l'espace blanc à l'intérieur d'une portée xml:space=''preserve''. Cela est également appelé espace blanc significatif en C++."
type: docs
weight: 3700
...
Représente les espaces blancs entre les balises dans un nœud à contenu mixte ou les espaces blancs à l'intérieur d'une portée **xml:space='preserve'**. Cela est également appelé espace blanc significatif.
