...
description: "System::Security::SecureString::SecureString constructor. Informations RTTI en C++."
type: docs
weight: 100
url: /fr/cpp/system.security/securestring/securestring/
---
...
| --- | --- | --- |
| valeur | const char16_t * | Un pointeur vers un tableau de caractères. |
| longueur | int32_t | Le nombre d'éléments dans le tableau **value**. |
