---
title: "System::Net::WebProxy::WebProxy constructeur"
linktitle: "WebProxy"
second_title: "Aspose.Font pour C++"
description: "System::Net::WebProxy::WebProxy constructeur. Construit une nouvelle instance en C++."
type: docs
weight: 100
url: /fr/cpp/system.net/webproxy/webproxy/
---
...
| --- | --- | --- |
| Adresse | String | L'adresse du serveur proxy. |
...
| --- | --- | --- |
| Adresse | String | L'adresse du serveur proxy. |
| BypassOnLocal | bool | Une valeur qui indique si le serveur proxy doit être utilisé pour les adresses locales. |
...
| Adresse | String | L'adresse du serveur proxy. |
| BypassOnLocal | bool | Une valeur qui indique si le serveur proxy doit être utilisé pour les adresses locales. |
| BypassList | System::ArrayPtr\<String\> | La liste des adresses qui n'utilisent pas le serveur proxy. |
...
| BypassOnLocal | bool | Une valeur qui indique si le serveur proxy doit être utilisé pour les adresses locales. |
| BypassList | System::ArrayPtr\<String\> | La liste des adresses qui n'utilisent pas le serveur proxy. |
| Credentials | System::SharedPtr\<ICredentials\> | Les informations d'identification qui sont envoyées au serveur proxy pour l'authentification. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| Adresse | System::SharedPtr\<Uri\> | L'adresse du serveur proxy. |
