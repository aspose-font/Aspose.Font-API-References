---
title: "System::Net::Dns::GetHostEntry méthode"
linktitle: "GetHostEntry"
second_title: "Aspose.Font pour C++"
description: "System::Net::Dns::GetHostEntry méthode. Crée une nouvelle instance IPHostEntry-class en utilisant la chaîne spécifiée qui contient un nom d'hôte ou une adresse IP en C++."
type: docs
weight: 1200
url: /fr/cpp/system.net/dns/gethostentry/
---
## Dns::GetHostEntry(String) method


Crée une nouvelle instance IPHostEntry-class en utilisant la chaîne spécifiée qui contient un nom d'hôte ou une adresse IP.
...
Crée une nouvelle instance IPHostEntry-class en utilisant l'adresse IP spécifiée.
