---
title: "Méthode GetByteCount de System::Text::UTF7Encoding"
linktitle: "GetByteCount"
second_title: "Aspose.Font pour C++"
description: "Méthode GetByteCount de System::Text::UTF7Encoding. Obtient le nombre de caractères nécessaires pour encoder un tampon de caractères en C++."
type: docs
weight: 400
url: /fr/cpp/system.text/utf7encoding/getbytecount/
---
## UTF7Encoding::GetByteCount(ArrayPtr\<char_t\>) method


Obtenez le nombre de caractères nécessaires pour encoder un tampon de caractères.
...
| --- | --- | --- |
| chars | ArrayPtr\<char_t\> | Tampon de caractères. |
