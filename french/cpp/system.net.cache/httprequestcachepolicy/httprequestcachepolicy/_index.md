---
title: "System::Net::Cache::HttpRequestCachePolicy::HttpRequestCachePolicy constructeur"
linktitle: "HttpRequestCachePolicy"
second_title: "Aspose.Font pour C++"
description: "System::Net::Cache::HttpRequestCachePolicy::HttpRequestCachePolicy constructeur. Construit une nouvelle instance en C++."
type: docs
weight: 100
url: /fr/cpp/system.net.cache/httprequestcachepolicy/httprequestcachepolicy/
---
...
| --- | --- | --- |
| cacheSyncDate | DateTime | Le moment où les ressources stockées dans le cache doivent être revalidées. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| cacheAgeControl | HttpCacheAgeControl | Contrôle le comportement de mise en cache des ressources. |
| ageOrFreshOrStale | TimeSpan | Une durée. |
...
| --- | --- | --- |
| cacheAgeControl | HttpCacheAgeControl | Contrôle le comportement de mise en cache des ressources. |
| maxAge | TimeSpan | L'âge maximal autorisé pour les ressources. |
| freshOrStale | TimeSpan | Une durée. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| niveau | HttpRequestCacheLevel | Le comportement de mise en cache des ressources. |
