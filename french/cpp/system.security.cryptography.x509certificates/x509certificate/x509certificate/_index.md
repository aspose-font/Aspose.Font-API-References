---
title: "System::Security::Cryptography::X509Certificates::X509Certificate::X509Certificate constructeur"
linktitle: "X509Certificate"
second_title: "Aspose.Font pour C++"
description: "System::Security::Cryptography::X509Certificates::X509Certificate::X509Certificate constructor. Constructeur en C++."
type: docs
weight: 100
url: /fr/cpp/system.security.cryptography.x509certificates/x509certificate/x509certificate/
---
...
| --- | --- | --- |
| données | const ByteArrayPtr\& | Séquence d'octets représentant le certificat encodé. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Séquence d'octets représentant le certificat encodé (partie publique). |
| private_key | const ByteArrayPtr\& | Séquence d'octets représentant la clé privée. |
| key_storage_flags | X509KeyStorageFlags | Indicateurs indiquant comment stocker la clé. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Séquence d'octets représentant le certificat encodé. |
| password | const SecureStringPtr\& | Mot de passe utilisé pour accéder aux données du certificat. |
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Séquence d'octets représentant le certificat encodé. |
| password | const String\& | Mot de passe utilisé pour accéder aux données du certificat. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| cert | const SharedPtr\<X509Certificate\>\& | Un certificat utilisé pour initialiser cet objet. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| filename | const String\& | Fichier à partir duquel charger le certificat. |
