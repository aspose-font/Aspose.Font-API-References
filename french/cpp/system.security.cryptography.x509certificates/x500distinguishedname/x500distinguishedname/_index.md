---
title: "Constructeur System::Security::Cryptography::X509Certificates::X500DistinguishedName::X500DistinguishedName"
linktitle: "X500DistinguishedName"
second_title: "Aspose.Font pour C++"
description: "Constructeur System::Security::Cryptography::X509Certificates::X500DistinguishedName::X500DistinguishedName. Constructeur en C++."
type: docs
weight: 100
url: /fr/cpp/system.security.cryptography.x509certificates/x500distinguishedname/x500distinguishedname/
---
...
| --- | --- | --- |
| encoded_distinguished_name | const ByteArrayPtr\& | Nom distinctif encodé. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| encoded_distinguished_name | const SharedPtr\<AsnEncodedData\>\& | [Object](../../../system/object/) représentant le nom distinctif. |
## Remarques
...
| Paramètre | Type | Description |
| --- | --- | --- |
| distinguishedName | const SharedPtr\<X500DistinguishedName\>\& | Nom distinctif à partir duquel copier les données. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| distinguished_name | const String\& | Nom distinctif. |
...
| --- | --- | --- |
| distinguished_name | const String\& | Nom distinctif. |
| indicateurs | X500DistinguishedNameFlags | Drapeaux combinés par opérations binaires spécifiant les propriétés de construction du nom. |
