---
title: "System::Globalization::CompareInfo::LastIndexOf méthode"
linktitle: "LastIndexOf"
second_title: "Aspose.Font pour C++"
description: "System::Globalization::CompareInfo::LastIndexOf méthode. Recherche la dernière occurrence du caractère spécifié en C++."
type: docs
weight: 1200
url: /fr/cpp/system.globalization/compareinfo/lastindexof/
---
## CompareInfo::LastIndexOf(const String\&, char16_t) const method


Recherche la dernière occurrence du caractère spécifié.
...
| valeur | char16_t | Valeur de recherche. |
...
Recherche la dernière occurrence du caractère spécifié en utilisant les options de comparaison spécifiées.
...
| source | const String\& | Chaîne source. |
| valeur | char16_t | Valeur de recherche. |
| options | CompareOptions | Options de comparaison. |
...
Recherche la dernière occurrence de la sous-chaîne spécifiée.
...
Recherche la dernière occurrence de la chaîne spécifiée en utilisant les options de comparaison spécifiées.
...
Recherche la dernière occurrence de la chaîne spécifiée.
...
Recherche la dernière occurrence de la sous-chaîne spécifiée en utilisant les options de comparaison spécifiées.
