---
title: "System::Globalization::CompareInfo::Compare méthode"
linktitle: "Compare"
second_title: "Aspose.Font pour C++"
description: "System::Globalization::CompareInfo::Compare méthode. Compare des chaînes. Seuls les modes Ordinal et OrdinalIgnoreCase sont pris en charge en C++."
type: docs
weight: 200
url: /fr/cpp/system.globalization/compareinfo/compare/
---
...
| --- | --- | --- |
| a | const String\& | Chaîne LHS. |
| b | const String\& | Chaîne RHS. |
| options | CompareOptions | [String](../../../system/string/) type de comparaison. |

### ReturnValue

Valeur négative si la chaîne LHS précède celle RHS, zéro si elles correspondent, valeur positive sinon.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| string1 | const String\& | Chaîne LHS. |
| string2 | const String\& | Chaîne RHS. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| string1 | const String\& | Première chaîne. |
| offset1 | int | Indice de départ des caractères dans **string1**. |
| string2 | const String\& | Deuxième chaîne. |
