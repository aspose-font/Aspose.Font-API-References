---
title: "System::Drawing::Drawing2D::LinearGradientBrush::LinearGradientBrush constructeur"
linktitle: "LinearGradientBrush"
second_title: "Aspose.Font pour C++"
description: "System::Drawing::Drawing2D::LinearGradientBrush::LinearGradientBrush constructeur. Crée une nouvelle instance de LinearGradientBrush en C++."
type: docs
weight: 100
url: /fr/cpp/system.drawing.drawing2d/lineargradientbrush/lineargradientbrush/
---
## LinearGradientBrush::LinearGradientBrush(const Point\&, const Point\&, const Color\&, const Color\&) constructor


Construit une nouvelle instance de [LinearGradientBrush](../).
...
| --- | --- | --- |
| point1 | const Point\& | Le point de départ du dégradé |
| point2 | const Point\& | Le point final du dégradé |
| color1 | const Color\& | La couleur de départ du dégradé |
| color2 | const Color\& | La couleur finale du dégradé |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| point1 | const PointF\& | Le point de départ du dégradé |
| point2 | const PointF\& | Le point final du dégradé |
| color1 | const Color\& | La couleur de départ du dégradé |
| color2 | const Color\& | La couleur finale du dégradé |
## Remarques
...
| Paramètre | Type | Description |
| --- | --- | --- |
| rect | const Rectangle\& | Un rectangle englobant du dégradé |
| color1 | const Color\& | La couleur de départ du dégradé |
| color2 | const Color\& | La couleur finale du dégradé |
| angle | float | L'angle de la ligne d'orientation du dégradé ; mesuré en degrés dans le sens horaire à partir de l'axe x |
| isAngleScaleable | bool | Spécifie si l'angle du dégradé est affecté par la transformation associée au pinceau |
...
| color1 | const Color\& | La couleur de départ du dégradé |
| color2 | const Color\& | La couleur finale du dégradé |
| linearGradientMode | ModeDégradéLinéaire | La direction du dégradé |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| rect | const RectangleF\& | Un rectangle englobant du dégradé |
| color1 | const Color\& | La couleur de départ du dégradé |
| color2 | const Color\& | La couleur finale du dégradé |
| angle | float | L'angle de la ligne d'orientation du dégradé ; mesuré en degrés dans le sens horaire à partir de l'axe x |
| isAngleScaleable | bool | Spécifie si l'angle du dégradé est affecté par la transformation associée au pinceau |
