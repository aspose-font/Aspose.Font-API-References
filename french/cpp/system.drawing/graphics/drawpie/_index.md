---
title: "Méthode System::Drawing::Graphics::DrawPie"
linktitle: "DrawPie"
second_title: "Aspose.Font pour C++"
description: "Méthode System::Drawing::Graphics::DrawPie. Dessine le secteur spécifié en utilisant le stylo spécifié sur la surface représentée par l'objet actuel en C++."
type: docs
weight: 2400
url: /fr/cpp/system.drawing/graphics/drawpie/
---
## Graphics::DrawPie(const SharedPtr\<Pen\>\&, float, float, float, float, float, float) method


Dessine le secteur spécifié en utilisant le stylo spécifié sur la surface représentée par l'objet actuel.
...
| --- | --- | --- |
| stylo | const SharedPtr\<Pen\>\& | Un stylo à utiliser lors du dessin du secteur |
...
| angleDépart | float | Angle en degrés mesuré dans le sens horaire depuis l'axe X jusqu'au point de départ du secteur |
| angleBalayage | float | Angle en degrés mesuré dans le sens horaire depuis le **startAngle** jusqu'au point final du secteur |
...
| angleDépart | int32_t | Angle en degrés mesuré dans le sens horaire depuis l'axe X jusqu'au point de départ du secteur |
| angleBalayage | int32_t | Angle en degrés mesuré dans le sens horaire depuis le **startAngle** jusqu'au point final du secteur |
...
| --- | --- | --- |
| stylo | const SharedPtr\<Pen\>\& | Un stylo à utiliser lors du dessin du secteur |
| rect | Rectangle | Le rectangle qui définit l'ellipse |
| angleDépart | float | Angle en degrés mesuré dans le sens horaire depuis l'axe X jusqu'au point de départ du secteur |
| angleBalayage | float | Angle en degrés mesuré dans le sens horaire depuis le **startAngle** jusqu'au point final du secteur |
...
| --- | --- | --- |
| stylo | const SharedPtr\<Pen\>\& | Un stylo à utiliser lors du dessin du secteur |
| rect | RectangleF | Le rectangle qui définit l'ellipse |
| angleDépart | float | Angle en degrés mesuré dans le sens horaire depuis l'axe X jusqu'au point de départ du secteur |
| angleBalayage | float | Angle en degrés mesuré dans le sens horaire depuis le **startAngle** jusqu'au point final du secteur |
