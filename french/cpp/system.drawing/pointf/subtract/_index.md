---
title: "Méthode System::Drawing::PointF::Subtract"
linktitle: "Soustraire"
second_title: "Aspose.Font pour C++"
description: "Méthode System::Drawing::PointF::Subtract. Soustrait les valeurs de largeur et de hauteur de l'objet Size spécifié des valeurs des coordonnées X et Y de l'objet PointF spécifié, respectivement, en C++."
type: docs
weight: 1300
url: /fr/cpp/system.drawing/pointf/subtract/
---
...
| --- | --- | --- |
| point | const PointF\& | Le point à traduire |
| size | const SizeF\& | L'objet [SizeF](../../sizef/) qui spécifie les valeurs à soustraire des valeurs des coordonnées du **point**. |
