---
title: "System::Drawing::TextureBrush::TextureBrush constructeur"
linktitle: "TextureBrush"
second_title: "Aspose.Font pour C++"
description: "System::Drawing::TextureBrush::TextureBrush constructeur. Crée une nouvelle instance de la classe TextureBrush qui utilise l'image spécifiée en C++."
type: docs
weight: 100
url: /fr/cpp/system.drawing/texturebrush/texturebrush/
---
...
| --- | --- | --- |
| image | const SharedPtr\<Image\>\& | Une image utilisée par le pinceau pour remplir l'intérieur d'une forme |
| wrap_mode | Drawing2D::WrapMode | Spécifie comment l'objet pinceau est répété |
| dst_rect | Rectangle | Spécifie le rectangle englobant pour le pinceau |
...
| image | const SharedPtr\<Image\>\& | Une image utilisée par le pinceau pour remplir l'intérieur d'une forme |
| wrap_mode | Drawing2D::WrapMode | Spécifie comment l'objet pinceau est répété |
| dst_rect | RectangleF | Spécifie le rectangle englobant pour le pinceau |
...
| image | const SharedPtr\<Image\>\& | Une image utilisée par le pinceau pour remplir l'intérieur d'une forme |
| dst_rect | Rectangle | Spécifie le rectangle englobant pour le pinceau |
| image_attrs | const SharedPtr\<Imaging::ImageAttributes\>\& | Les attributs d'image |
