---
title: "Méthode System::Drawing::Region::Union"
linktitle: "Union"
second_title: "Aspose.Font pour C++"
description: "Méthode System::Drawing::Region::Union. Remplace la région représentée par l'objet actuel par le résultat de l'union de cette région et d'une région définie par le rectangle spécifié en C++."
type: docs
weight: 1900
url: /fr/cpp/system.drawing/region/union/
---
...
| --- | --- | --- |
| rect | const Rectangle\& | Un rectangle qui définit une région pour unir cette région avec |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| rect | const RectangleF\& | Un rectangle qui définit une région pour unir cette région avec |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| chemin | const SharedPtr\<Drawing2D::GraphicsPath\>\& | Un chemin qui définit une région pour unir cette région avec |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| région | const SharedPtr\<Region\>\& | Une région pour unir cette région avec |
