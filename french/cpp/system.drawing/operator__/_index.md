---
title: "System::Drawing::operator<< méthode"
linktitle: "operator<<"
second_title: "Aspose.Font pour C++"
description: "System::Drawing::operator<< méthode. Insérez des données dans le flux en utilisant l'encodage UTF-8 en C++."
type: docs
weight: 3900
url: /fr/cpp/system.drawing/operator__/
---
...
| color | Color | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| point | const Point\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| point | const PointF\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| rectangle | const Rectangle\& | [Data](../../system.data/) à insérer. |
...
| --- | --- | --- |
| flux | std::ostream\& | Flux de sortie dans lequel insérer des données. |
| rectangle | const RectangleF\& | [Data](../../system.data/) à insérer. |
