---
title: "Constructeur System::Collections::Generic::Dictionary::Dictionary"
linktitle: "Dictionnaire"
second_title: "Aspose.Font pour C++"
description: "Constructeur System::Collections::Generic::Dictionary::Dictionary. Crée un dictionnaire vide en C++."
type: docs
weight: 100
url: /fr/cpp/system.collections.generic/dictionary/dictionary/
---
...
Copie les données depuis la map.
...
| --- | --- | --- |
| map | const map_t\& | Carte à copier les données depuis. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| src | const SharedPtr\<IDictionary\<TKey, TValue\>\>\& | Dictionnaire source. |
| comparer | const SharedPtr\<IEqualityComparer\<TKey\>\>\& | [Comparer](../../comparer/) objet à utiliser. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| comparer | const SharedPtr\<IEqualityComparer\<TKey\>\>\& | [Comparer](../../comparer/) à utiliser. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| capacité | int | Capacité à allouer ; ignorée. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| capacity | int | Capacité du [Dictionary](../) après création ; ignorée. |
| comparer | const SharedPtr\<IEqualityComparer\<TKey\>\>\& | [Comparer](../../comparer/) à utiliser. |
