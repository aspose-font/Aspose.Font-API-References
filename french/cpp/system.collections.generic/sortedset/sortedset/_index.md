...
description: "System::Collections::Generic::SortedSet::SortedSet constructor. Informations RTTI en C++."
type: docs
weight: 100
url: /fr/cpp/system.collections.generic/sortedset/sortedset/
---
...
| --- | --- | --- |
| comparer | const SharedPtr\<IComparer\<T\>\>\& | Objet [Comparer](../../comparer/) à associer avec [SortedSet](../). |
...
Crée un [SortedSet](../) basé sur des valeurs énumérables.
