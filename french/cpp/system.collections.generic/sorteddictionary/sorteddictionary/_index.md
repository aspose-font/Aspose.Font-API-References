---
title: "System::Collections::Generic::SortedDictionary::SortedDictionary constructeur"
linktitle: "SortedDictionary"
second_title: "Aspose.Font pour C++"
description: "System::Collections::Generic::SortedDictionary::SortedDictionary constructeur. Construit un dictionnaire vide en C++."
type: docs
weight: 200
url: /fr/cpp/system.collections.generic/sorteddictionary/sorteddictionary/
---
...
| --- | --- | --- |
| comparer | const SharedPtr\<IComparer\<typename BasePointerType\<TKey\>::type\>\>\& | [Comparer](../../comparer/) à utiliser. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| src | const SharedPtr\<IDictionary\<TKey, TValue\>\>\& | Dictionnaire source à partir duquel copier les données. |
