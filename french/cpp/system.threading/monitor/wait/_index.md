---
title: "System::Threading::Monitor::Wait méthode"
linktitle: "Attendre"
second_title: "Aspose.Font pour C++"
description: "Méthode System::Threading::Monitor::Wait. Libère le verrou sur un objet et bloque le thread actuel jusqu'à ce qu'il récupère le verrou. Non implémenté en C++."
type: docs
weight: 700
url: /fr/cpp/system.threading/monitor/wait/
---
## Monitor::Wait(const SharedPtr\<Object\>\&) method


Libère le verrou sur un objet et bloque le thread actuel jusqu'à ce qu'il récupère le verrou Non implémenté.
...
Libère le verrou sur un objet et bloque le thread actuel jusqu'à ce qu'il récupère le verrou. Si l'intervalle d'expiration spécifié s'écoule, le thread entre dans la file d'attente prête. Non implémenté.
...
Libère le verrou sur un objet et bloque le thread actuel jusqu'à ce qu'il récupère le verrou. Si l'intervalle d'expiration spécifié s'écoule, le thread entre dans la file d'attente prête. Optionnellement, sort du domaine de synchronisation pour le contexte synchronisé avant l'attente et récupère le domaine ensuite. Non implémenté.
