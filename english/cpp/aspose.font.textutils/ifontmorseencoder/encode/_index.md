...
description: 'Aspose::Font::TextUtils::IFontMorseEncoder::Encode method. Encodes text by Morse code and returns result as set of glyphs(glyph identifiers) in C++.'
type: docs
weight: 100
